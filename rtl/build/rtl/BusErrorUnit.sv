...
module BusErrorUnit(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (out_woready_23 & auto_in_a_bits_mask[0])
      ...
      if (out_woready_23 & auto_in_a_bits_mask[0])
        ...
        accrued_2 <= io_errors_uncache_ecc_error_valid | accrued_2;
      if (out_woready_23 & auto_in_a_bits_mask[0])
        accrued_3 <= auto_in_a_bits_data[3];
      else
        accrued_3 <= io_errors_l2_ecc_error_valid | accrued_3;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pad_1 = {_RANDOM[2'h0][31:2], _RANDOM[2'h1][17:0]};
  ...
  assign auto_int_out_0 =
    |({accrued_3, accrued_2, accrued_1, accrued_0}
