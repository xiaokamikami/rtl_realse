...
module SQData8Module(
  ...
  always @(posedge clock) begin
    ...
    io_rdata_0_REG <= io_raddr_0;
    io_rdata_1_REG <= io_raddr_1;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_rdata_0_REG = _RANDOM[6'h18][13:8];
        io_rdata_1_REG = _RANDOM[6'h18][19:14];
  ...
  assign io_rdata_0_valid = _GEN[io_rdata_0_REG];
  assign io_rdata_0_data = _GEN_0[io_rdata_0_REG];
  assign io_rdata_1_valid = _GEN[io_rdata_1_REG];
  assign io_rdata_1_data = _GEN_0[io_rdata_1_REG];
