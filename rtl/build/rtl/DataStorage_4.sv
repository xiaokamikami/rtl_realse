...
module DataStorage_4(
  ...
  input  [12:0]  io_sourceC_raddr_bits_set,
  ...
  input  [12:0]  io_sinkD_waddr_bits_set,
  ...
  input  [12:0]  io_sourceD_raddr_bits_set,
  ...
  input  [12:0]  io_sourceD_waddr_bits_set,
  ...
  input  [12:0]  io_sinkC_waddr_bits_set,
  ...
  wire [15:0]  _GEN_0 = {io_sourceD_waddr_bits_way, io_sourceD_waddr_bits_set};
  wire [15:0]  _GEN_1 = {io_sourceD_raddr_bits_way, io_sourceD_raddr_bits_set};
  wire [15:0]  _GEN_2 = {io_sinkD_waddr_bits_way, io_sinkD_waddr_bits_set};
  wire [15:0]  _GEN_3 = {io_sinkC_waddr_bits_way, io_sinkC_waddr_bits_set};
  wire         sel_req_0_wen =
    ~(sinkC_req_bankSum[0])
    & (_sinkC_req_out_bankSel_T_9[0] | _sinkD_wreq_out_bankSel_T_9[0]
       | _sourceD_wreq_out_bankSel_T_9[0]);
  wire [15:0]  _GEN_4 = {io_sourceC_raddr_bits_way, io_sourceC_raddr_bits_set};
  wire [15:0]  _GEN_5 =
    sinkC_req_bankSum[0]
      ? _GEN_4
  ...
  wire [511:0] sel_req_0_index = {496'h0, _GEN_5};
  ...
  wire [511:0] sel_req_1_index = {496'h0, _GEN_6};
  ...
  wire [511:0] sel_req_2_index = {496'h0, _GEN_7};
  ...
  wire [511:0] sel_req_3_index = {496'h0, _GEN_8};
  ...
  wire [511:0] sel_req_4_index = {496'h0, _GEN_9};
  ...
  wire [511:0] sel_req_5_index = {496'h0, _GEN_10};
  ...
  wire [511:0] sel_req_6_index = {496'h0, _GEN_11};
  ...
  wire [511:0] sel_req_7_index = {496'h0, _GEN_12};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_addr_reg_REG_set = _RANDOM[2'h0][16:4];
        d_addr_reg_REG_beat = _RANDOM[2'h0][17];
        d_addr_reg_REG_1_way = _RANDOM[2'h0][22:20];
        d_addr_reg_REG_1_set = {_RANDOM[2'h0][31:23], _RANDOM[2'h1][3:0]};
        d_addr_reg_REG_1_beat = _RANDOM[2'h1][4];
        d_addr_reg_way = _RANDOM[2'h1][9:7];
        d_addr_reg_set = _RANDOM[2'h1][22:10];
        d_addr_reg_beat = _RANDOM[2'h1][23];
        c_addr_reg_REG_way = _RANDOM[2'h1][28:26];
        c_addr_reg_REG_set = {_RANDOM[2'h1][31:29], _RANDOM[2'h2][9:0]};
        c_addr_reg_REG_beat = _RANDOM[2'h2][10];
        c_addr_reg_REG_1_way = _RANDOM[2'h2][15:13];
        c_addr_reg_REG_1_set = _RANDOM[2'h2][28:16];
        c_addr_reg_REG_1_beat = _RANDOM[2'h2][29];
        c_addr_reg_way = _RANDOM[2'h3][2:0];
        c_addr_reg_set = _RANDOM[2'h3][15:3];
        c_addr_reg_beat = _RANDOM[2'h3][16];
      `endif // RANDOMIZE_REG_INIT
    end // initial
