  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h36][31];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h37][6:0];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h37][7];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h37][13:8];
        s1_in_r_fof = _RANDOM[6'h37][21];
        s1_in_r_vdIdxInField = _RANDOM[6'h37][24:22];
        s1_in_r_preIsSplit = _RANDOM[6'h3B][25];
        s1_in_r_alignedType = {_RANDOM[6'h3B][31:30], _RANDOM[6'h3C][0]};
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3C][8:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
