  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_reorder_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h4E][31:30], _RANDOM[10'h4F], _RANDOM[10'h50][15:0]};
        ld_reorder_res_0_1_0_bits_paddr =
          {_RANDOM[10'h52][31:17], _RANDOM[10'h53], _RANDOM[10'h54][0]};
        ld_reorder_res_0_1_1_valid = _RANDOM[10'h65][16];
        ld_reorder_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h66][31:17], _RANDOM[10'h67], _RANDOM[10'h68][2:0]};
        ld_reorder_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h77][29];
        ld_reorder_res_0_1_1_bits_uop_robIdx_value =
          {_RANDOM[10'h77][31:30], _RANDOM[10'h78][5:0]};
        ld_reorder_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h8D][31:30], _RANDOM[10'h8E], _RANDOM[10'h8F][15:0]};
        ld_reorder_res_0_1_1_bits_paddr =
          {_RANDOM[10'h91][31:17], _RANDOM[10'h92], _RANDOM[10'h93][0]};
        ld_reorder_res_0_1_2_valid = _RANDOM[10'hA4][16];
        ld_reorder_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'hA5][31:17], _RANDOM[10'hA6], _RANDOM[10'hA7][2:0]};
        ld_reorder_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hB6][29];
        ld_reorder_res_0_1_2_bits_uop_robIdx_value =
          {_RANDOM[10'hB6][31:30], _RANDOM[10'hB7][5:0]};
        ld_reorder_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hCC][31:30], _RANDOM[10'hCD], _RANDOM[10'hCE][15:0]};
        ld_reorder_res_0_1_2_bits_paddr =
          {_RANDOM[10'hD0][31:17], _RANDOM[10'hD1], _RANDOM[10'hD2][0]};
        ld_reorder_res_1_2_0_valid = _RANDOM[10'hE3][16];
        ld_reorder_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hE4][31:17], _RANDOM[10'hE5], _RANDOM[10'hE6][2:0]};
        ld_reorder_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hF5][29];
        ld_reorder_res_1_2_0_bits_uop_robIdx_value =
          {_RANDOM[10'hF5][31:30], _RANDOM[10'hF6][5:0]};
        ld_reorder_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h10B][31:30], _RANDOM[10'h10C], _RANDOM[10'h10D][15:0]};
        ld_reorder_res_1_2_0_bits_paddr =
          {_RANDOM[10'h10F][31:17], _RANDOM[10'h110], _RANDOM[10'h111][0]};
        ld_reorder_res_1_2_1_valid = _RANDOM[10'h122][16];
        ld_reorder_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h123][31:17], _RANDOM[10'h124], _RANDOM[10'h125][2:0]};
        ld_reorder_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h134][29];
        ld_reorder_res_1_2_1_bits_uop_robIdx_value =
          {_RANDOM[10'h134][31:30], _RANDOM[10'h135][5:0]};
        ld_reorder_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h14A][31:30], _RANDOM[10'h14B], _RANDOM[10'h14C][15:0]};
        ld_reorder_res_1_2_1_bits_paddr =
          {_RANDOM[10'h14E][31:17], _RANDOM[10'h14F], _RANDOM[10'h150][0]};
        ld_reorder_res_1_2_2_valid = _RANDOM[10'h161][16];
        ld_reorder_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h162][31:17], _RANDOM[10'h163], _RANDOM[10'h164][2:0]};
        ld_reorder_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h189][31:30], _RANDOM[10'h18A], _RANDOM[10'h18B][15:0]};
        ld_reorder_res_1_2_2_bits_paddr =
          {_RANDOM[10'h18D][31:17], _RANDOM[10'h18E], _RANDOM[10'h18F][0]};
        ld_reorder_0_valid = _RANDOM[10'h1A0][16];
        ld_reorder_0_bits_uop_pc =
          {_RANDOM[10'h1A1][31:17], _RANDOM[10'h1A2], _RANDOM[10'h1A3][2:0]};
        ld_reorder_0_bits_vaddr =
          {_RANDOM[10'h1C8][31:30], _RANDOM[10'h1C9], _RANDOM[10'h1CA][15:0]};
        ld_reorder_0_bits_paddr =
          {_RANDOM[10'h1CC][31:17], _RANDOM[10'h1CD], _RANDOM[10'h1CE][0]};
        ld_reorder_1_valid = _RANDOM[10'h1DF][16];
        ld_reorder_1_bits_uop_pc =
          {_RANDOM[10'h1E0][31:17], _RANDOM[10'h1E1], _RANDOM[10'h1E2][2:0]};
        ld_reorder_1_bits_vaddr =
          {_RANDOM[10'h207][31:30], _RANDOM[10'h208], _RANDOM[10'h209][15:0]};
        ld_reorder_1_bits_paddr =
          {_RANDOM[10'h20B][31:17], _RANDOM[10'h20C], _RANDOM[10'h20D][0]};
        ld_reorder_2_valid = _RANDOM[10'h21E][16];
        ld_reorder_2_bits_uop_pc =
          {_RANDOM[10'h21F][31:17], _RANDOM[10'h220], _RANDOM[10'h221][2:0]};
        ld_reorder_2_bits_vaddr =
          {_RANDOM[10'h246][31:30], _RANDOM[10'h247], _RANDOM[10'h248][15:0]};
        ld_reorder_2_bits_paddr =
          {_RANDOM[10'h24A][31:17], _RANDOM[10'h24B], _RANDOM[10'h24C][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_0_vaddr = 50'h0;
        entries_0_paddr = 48'h0;
