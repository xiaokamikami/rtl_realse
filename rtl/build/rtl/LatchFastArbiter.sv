...
module LatchFastArbiter(
  ...
  input         io_in_0_valid,
  input  [28:0] io_in_0_bits_tag,
  input  [12:0] io_in_0_bits_set,
  ...
  input         io_in_1_valid,
  input  [28:0] io_in_1_bits_tag,
  input  [12:0] io_in_1_bits_set,
  ...
  input         io_in_2_valid,
  input  [28:0] io_in_2_bits_tag,
  input  [12:0] io_in_2_bits_set,
  ...
  input         io_in_3_valid,
  input  [28:0] io_in_3_bits_tag,
  input  [12:0] io_in_3_bits_set,
  ...
  input         io_in_4_valid,
  input  [28:0] io_in_4_bits_tag,
  input  [12:0] io_in_4_bits_set,
  ...
  input         io_in_5_valid,
  input  [28:0] io_in_5_bits_tag,
  input  [12:0] io_in_5_bits_set,
  ...
  input         io_in_6_valid,
  input  [28:0] io_in_6_bits_tag,
  input  [12:0] io_in_6_bits_set,
  ...
  input         io_in_7_valid,
  input  [28:0] io_in_7_bits_tag,
  input  [12:0] io_in_7_bits_set,
  ...
  input         io_in_8_valid,
  input  [28:0] io_in_8_bits_tag,
  input  [12:0] io_in_8_bits_set,
  ...
  input         io_in_9_valid,
  input  [28:0] io_in_9_bits_tag,
  input  [12:0] io_in_9_bits_set,
  ...
  input  [28:0] io_in_10_bits_tag,
  input  [12:0] io_in_10_bits_set,
  ...
  input  [28:0] io_in_11_bits_tag,
  input  [12:0] io_in_11_bits_set,
  ...
  input  [28:0] io_in_12_bits_tag,
  input  [12:0] io_in_12_bits_set,
  ...
  input  [28:0] io_in_13_bits_tag,
  input  [12:0] io_in_13_bits_set,
  ...
  input         io_out_ready,
  output        io_out_valid,
  output [28:0] io_out_bits_tag,
  output [12:0] io_out_bits_set,
  ...
  reg         out_valid_reg;
  reg  [28:0] out_bits_reg_tag;
  reg  [12:0] out_bits_reg_set;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      out_valid_reg <= 1'h0;
      out_bits_reg_tag <= 29'h0;
      out_bits_reg_set <= 13'h0;
      ...
      if (latch_result) begin
        out_bits_reg_tag <=
          (chosenOH[0] ? io_in_0_bits_tag : 29'h0)
          | (chosenOH[1] ? io_in_1_bits_tag : 29'h0)
          | (chosenOH[2] ? io_in_2_bits_tag : 29'h0)
          | (chosenOH[3] ? io_in_3_bits_tag : 29'h0)
          | (chosenOH[4] ? io_in_4_bits_tag : 29'h0)
          | (chosenOH[5] ? io_in_5_bits_tag : 29'h0)
          | (chosenOH[6] ? io_in_6_bits_tag : 29'h0)
          | (chosenOH[7] ? io_in_7_bits_tag : 29'h0)
          | (chosenOH[8] ? io_in_8_bits_tag : 29'h0)
          | (chosenOH[9] ? io_in_9_bits_tag : 29'h0)
          | (chosenOH[10] ? io_in_10_bits_tag : 29'h0)
          | (chosenOH[11] ? io_in_11_bits_tag : 29'h0)
          | (chosenOH[12] ? io_in_12_bits_tag : 29'h0)
          | (chosenOH[13] ? io_in_13_bits_tag : 29'h0);
        out_bits_reg_set <=
          (chosenOH[0] ? io_in_0_bits_set : 13'h0)
          | (chosenOH[1] ? io_in_1_bits_set : 13'h0)
          | (chosenOH[2] ? io_in_2_bits_set : 13'h0)
          | (chosenOH[3] ? io_in_3_bits_set : 13'h0)
          | (chosenOH[4] ? io_in_4_bits_set : 13'h0)
          | (chosenOH[5] ? io_in_5_bits_set : 13'h0)
          | (chosenOH[6] ? io_in_6_bits_set : 13'h0)
          | (chosenOH[7] ? io_in_7_bits_set : 13'h0)
          | (chosenOH[8] ? io_in_8_bits_set : 13'h0)
          | (chosenOH[9] ? io_in_9_bits_set : 13'h0)
          | (chosenOH[10] ? io_in_10_bits_set : 13'h0)
          | (chosenOH[11] ? io_in_11_bits_set : 13'h0)
          | (chosenOH[12] ? io_in_12_bits_set : 13'h0)
          | (chosenOH[13] ? io_in_13_bits_set : 13'h0);
        out_bits_reg_off <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[3'h0][29:1];
        out_bits_reg_set = {_RANDOM[3'h0][31:30], _RANDOM[3'h1][10:0]};
        ...
        chosen_reg = _RANDOM[3'h3][22:9];
        pendingMask = {_RANDOM[3'h3][31:23], _RANDOM[3'h4][4:0]};
        rrGrantMask = _RANDOM[3'h4][18:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_tag = 29'h0;
