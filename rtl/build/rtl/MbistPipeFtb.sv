...
module MbistPipeFtb(
  ...
  reg         renReg;
  reg  [9:0]  addrRdReg;
  wire        selectedVec_0 = arrayReg == 6'h24;
  wire        doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 40'h0;
  wire        selectedVec_0_1 = arrayReg == 6'h25;
  wire        doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 40'h0;
  wire        selectedVec_0_2 = arrayReg == 6'h26;
  wire        doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = selectedVec_0_2 ? toSRAM_2_rdata : 40'h0;
  wire        selectedVec_0_3 = arrayReg == 6'h27;
  wire        doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = selectedVec_0_3 ? toSRAM_3_rdata : 40'h0;
  wire        selectedVec_0_4 = arrayReg == 6'h28;
  wire        doSpread_4 = selectedVec_0_4 | allReg;
  assign sramDataOut_4 = selectedVec_0_4 ? toSRAM_4_rdata : 40'h0;
  wire        selectedVec_0_5 = arrayReg == 6'h29;
  wire        doSpread_5 = selectedVec_0_5 | allReg;
  assign sramDataOut_5 = selectedVec_0_5 ? toSRAM_5_rdata : 40'h0;
  wire        selectedVec_0_6 = arrayReg == 6'h2A;
  wire        doSpread_6 = selectedVec_0_6 | allReg;
  assign sramDataOut_6 = selectedVec_0_6 ? toSRAM_6_rdata : 40'h0;
  wire        selectedVec_0_7 = arrayReg == 6'h2B;
  wire        doSpread_7 = selectedVec_0_7 | allReg;
  assign sramDataOut_7 = selectedVec_0_7 ? toSRAM_7_rdata : 40'h0;
  wire        activated =
    mbist_all | mbist_req
    & (mbist_array == 6'h24 | mbist_array == 6'h25 | mbist_array == 6'h26
       | mbist_array == 6'h27 | mbist_array == 6'h28 | mbist_array == 6'h29
       | mbist_array == 6'h2A | mbist_array == 6'h2B);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = _RANDOM[2'h0][12:9];
        addrReg = _RANDOM[2'h0][22:13];
        dataInReg = {_RANDOM[2'h0][31:23], _RANDOM[2'h1][30:0]};
        renReg = _RANDOM[2'h1][31];
        addrRdReg = _RANDOM[2'h2][9:0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
