  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h3E][4];
        deqDelay_0_bits_rf_4_0_addr = _RANDOM[7'h3E][11:5];
        deqDelay_0_bits_rf_3_0_addr = _RANDOM[7'h3E][21:15];
        deqDelay_0_bits_rf_2_0_addr = _RANDOM[7'h3E][31:25];
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h3F][9:3];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h3F][19:13];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h40][31:15], _RANDOM[7'h41][17:0]};
        deqDelay_0_bits_common_fuOpType = _RANDOM[7'h41][26:18];
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h57][27];
        deqDelay_0_bits_common_robIdx_value =
          {_RANDOM[7'h57][31:28], _RANDOM[7'h58][3:0]};
        deqDelay_0_bits_common_pdest = _RANDOM[7'h58][15:9];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h58][16];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h58][17];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h58][20];
        deqDelay_0_bits_common_vpu_vma = _RANDOM[7'h58][29];
        deqDelay_0_bits_common_vpu_vta = _RANDOM[7'h58][30];
        deqDelay_0_bits_common_vpu_vsew = {_RANDOM[7'h58][31], _RANDOM[7'h59][0]};
        deqDelay_0_bits_common_vpu_vlmul = _RANDOM[7'h59][3:1];
        deqDelay_0_bits_common_vpu_vm = _RANDOM[7'h59][12];
        deqDelay_0_bits_common_vpu_vstart = _RANDOM[7'h59][20:13];
        deqDelay_0_bits_common_vpu_vuopIdx = _RANDOM[7'h5A][7:1];
        deqDelay_0_bits_common_vpu_isExt = _RANDOM[7'h5E][23];
        deqDelay_0_bits_common_vpu_isNarrow = _RANDOM[7'h5E][24];
        deqDelay_0_bits_common_vpu_isDstMask = _RANDOM[7'h5E][25];
        deqDelay_0_bits_common_vpu_isOpMask = _RANDOM[7'h5E][26];
        deqDelay_0_bits_common_dataSources_0_value =
          {_RANDOM[7'h5E][31], _RANDOM[7'h5F][2:0]};
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h5F][6:3];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h5F][10:7];
        deqDelay_0_bits_common_dataSources_3_value = _RANDOM[7'h5F][14:11];
        deqDelay_0_bits_common_dataSources_4_value = _RANDOM[7'h5F][18:15];
        io_validCntDeqVec_0_REG = _RANDOM[7'h74][8:4];
        io_validCntDeqVec_1_REG = _RANDOM[7'h74][13:9];
      `endif // RANDOMIZE_REG_INIT
    end // initial
