...
module PipelineRegModule_6(
  ...
  reg         io_out_bits_r_denied;
  reg         io_out_bits_r_corrupt;
  ...
  always @(posedge clock) begin
    if (_io_out_bits_T) begin
      ...
      io_out_bits_r_denied <= io_in_bits_denied;
      io_out_bits_r_corrupt <= io_in_bits_corrupt;
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_nc = _RANDOM[3'h4][5];
        io_out_bits_r_is2lq = _RANDOM[3'h4][6];
        io_out_bits_r_denied = _RANDOM[3'h4][12];
        io_out_bits_r_corrupt = _RANDOM[3'h4][13];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_denied = io_out_bits_r_denied;
  assign io_out_bits_corrupt = io_out_bits_r_corrupt;
endmodule
