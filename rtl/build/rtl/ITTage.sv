  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        modified_reset = _RANDOM[8'h0][0];
        s1_pc_dup_0 = {_RANDOM[8'h0][31:1], _RANDOM[8'h1][18:0]};
        s1_pc_dup_1 = {_RANDOM[8'h1][31:19], _RANDOM[8'h2], _RANDOM[8'h3][4:0]};
        s1_pc_dup_2 = {_RANDOM[8'h3][31:5], _RANDOM[8'h4][22:0]};
        s1_pc_dup_3 = {_RANDOM[8'h4][31:23], _RANDOM[8'h5], _RANDOM[8'h6][8:0]};
        s2_pc_dup_s2_pc_seg_0_value = {_RANDOM[8'h6][31:9], _RANDOM[8'h7][2:0]};
        s2_pc_dup_s2_pc_seg_1_value = _RANDOM[8'h7][14:3];
        s2_pc_dup_s2_pc_seg_2_value = _RANDOM[8'h7][26:15];
        s2_pc_dup_s2_pc_seg_0_value_1 = {_RANDOM[8'h7][31:27], _RANDOM[8'h8][20:0]};
        s2_pc_dup_s2_pc_seg_1_value_1 = {_RANDOM[8'h8][31:21], _RANDOM[8'h9][0]};
        s2_pc_dup_s2_pc_seg_2_value_1 = _RANDOM[8'h9][12:1];
        s2_pc_dup_s2_pc_seg_0_value_2 = {_RANDOM[8'h9][31:13], _RANDOM[8'hA][6:0]};
        s2_pc_dup_s2_pc_seg_1_value_2 = _RANDOM[8'hA][18:7];
        s2_pc_dup_s2_pc_seg_2_value_2 = _RANDOM[8'hA][30:19];
        s2_pc_dup_s2_pc_seg_0_value_3 = {_RANDOM[8'hA][31], _RANDOM[8'hB][24:0]};
        s2_pc_dup_s2_pc_seg_1_value_3 = {_RANDOM[8'hB][31:25], _RANDOM[8'hC][4:0]};
        s2_pc_dup_s2_pc_seg_2_value_3 = _RANDOM[8'hC][16:5];
        s3_pc_dup_s3_pc_seg_0_value = {_RANDOM[8'hC][31:17], _RANDOM[8'hD][10:0]};
        s3_pc_dup_s3_pc_seg_1_value = _RANDOM[8'hD][22:11];
        s3_pc_dup_s3_pc_seg_2_value = {_RANDOM[8'hD][31:23], _RANDOM[8'hE][2:0]};
        s3_pc_dup_s3_pc_seg_0_value_1 = _RANDOM[8'hE][28:3];
        s3_pc_dup_s3_pc_seg_1_value_1 = {_RANDOM[8'hE][31:29], _RANDOM[8'hF][8:0]};
        s3_pc_dup_s3_pc_seg_2_value_1 = _RANDOM[8'hF][20:9];
        s3_pc_dup_s3_pc_seg_0_value_2 = {_RANDOM[8'hF][31:21], _RANDOM[8'h10][14:0]};
        s3_pc_dup_s3_pc_seg_1_value_2 = _RANDOM[8'h10][26:15];
        s3_pc_dup_s3_pc_seg_2_value_2 = {_RANDOM[8'h10][31:27], _RANDOM[8'h11][6:0]};
        s3_pc_dup_s3_pc_seg_0_value_3 = {_RANDOM[8'h11][31:7], _RANDOM[8'h12][0]};
        s3_pc_dup_s3_pc_seg_1_value_3 = _RANDOM[8'h12][12:1];
        s3_pc_dup_s3_pc_seg_2_value_3 = _RANDOM[8'h12][24:13];
        tickCtr = {_RANDOM[8'h12][31:29], _RANDOM[8'h13][4:0]};
        s3_tageTarget_dup_0 =
          {_RANDOM[8'h17][31:27], _RANDOM[8'h18], _RANDOM[8'h19][12:0]};
        s3_tageTarget_dup_1 = {_RANDOM[8'h19][31:13], _RANDOM[8'h1A][30:0]};
        s3_tageTarget_dup_2 = {_RANDOM[8'h1A][31], _RANDOM[8'h1B], _RANDOM[8'h1C][16:0]};
        s3_tageTarget_dup_3 =
          {_RANDOM[8'h1C][31:17], _RANDOM[8'h1D], _RANDOM[8'h1E][2:0]};
        s3_providerTarget = {_RANDOM[8'h1E][31:3], _RANDOM[8'h1F][20:0]};
        s3_altProviderTarget =
          {_RANDOM[8'h1F][31:21], _RANDOM[8'h20], _RANDOM[8'h21][6:0]};
        s3_provided = _RANDOM[8'h21][7];
        s3_provider = _RANDOM[8'h21][10:8];
        s3_altProvided = _RANDOM[8'h21][11];
        s3_altProvider = _RANDOM[8'h21][14:12];
        s3_providerU = _RANDOM[8'h21][15];
        s3_providerCtr = _RANDOM[8'h21][17:16];
        s3_altProviderCtr = _RANDOM[8'h21][19:18];
        u_valid = _RANDOM[8'h21][20];
        update_r_pc = {_RANDOM[8'h21][31:21], _RANDOM[8'h22], _RANDOM[8'h23][6:0]};
        update_r_ftb_entry_isRet = _RANDOM[8'h25][28];
        update_r_ftb_entry_isJalr = _RANDOM[8'h25][29];
        update_r_ftb_entry_tailSlot_offset = _RANDOM[8'h26][22:19];
        update_r_ftb_entry_tailSlot_sharing = _RANDOM[8'h26][23];
        update_r_ftb_entry_tailSlot_valid = _RANDOM[8'h26][24];
        update_r_ftb_entry_strong_bias_1 = _RANDOM[8'h27][22];
        update_r_cfi_idx_valid = _RANDOM[8'h27][23];
        update_r_jmp_taken = _RANDOM[8'h28][0];
        update_r_mispred_mask_2 = _RANDOM[8'h28][3];
        updateMeta_r_provider_valid = _RANDOM[8'h3A][1];
        updateMeta_r_altProvider_valid = _RANDOM[8'h3A][5];
        updateMeta_r_altDiffers = _RANDOM[8'h3A][9];
        updateMeta_r_providerU = _RANDOM[8'h3A][10];
        updateMeta_r_providerCtr = _RANDOM[8'h3A][12:11];
        updateMeta_r_altProviderCtr = _RANDOM[8'h3A][14:13];
        updateMeta_r_allocate_valid = _RANDOM[8'h3A][15];
        updateMeta_provider_bits_r = _RANDOM[8'h3D][25:23];
        updateMeta_providerTarget_r =
          {_RANDOM[8'h3D][31:26], _RANDOM[8'h3E], _RANDOM[8'h3F][11:0]};
        updateMeta_allocate_bits_r = _RANDOM[8'h3F][14:12];
        updateMeta_altProvider_bits_r = _RANDOM[8'h3F][17:15];
        updateMeta_altProviderTarget_r =
          {_RANDOM[8'h3F][31:18], _RANDOM[8'h40], _RANDOM[8'h41][3:0]};
        update_full_target_r = {_RANDOM[8'h41][31:4], _RANDOM[8'h42][21:0]};
        update_cfi_idx_bits_r = _RANDOM[8'h42][25:22];
        update_ghist_r =
          {_RANDOM[8'h42][31:26],
           _RANDOM[8'h43],
           _RANDOM[8'h44],
           ...
           _RANDOM[8'h49],
           _RANDOM[8'h4A][25:0]};
        resp_meta_allocate_valid_r = _RANDOM[8'h4A][26];
        resp_meta_allocate_bits_r = _RANDOM[8'h4A][29:27];
        tables_0_io_update_valid_REG = _RANDOM[8'h4A][30];
        tables_0_io_update_reset_u_REG = _RANDOM[8'h4A][31];
        tables_0_io_update_correct_r = _RANDOM[8'h4B][0];
        tables_0_io_update_alloc_r = _RANDOM[8'h4B][1];
        tables_0_io_update_oldCtr_r = _RANDOM[8'h4B][3:2];
        tables_0_io_update_target_offset_r_offset = _RANDOM[8'h4B][23:4];
        tables_0_io_update_target_offset_r_pointer = _RANDOM[8'h4B][27:24];
        tables_0_io_update_target_offset_r_usePCRegion = _RANDOM[8'h4B][28];
        tables_0_io_update_old_target_offset_r_offset =
          {_RANDOM[8'h4B][31:29], _RANDOM[8'h4C][16:0]};
        tables_0_io_update_old_target_offset_r_pointer = _RANDOM[8'h4C][20:17];
        tables_0_io_update_old_target_offset_r_usePCRegion = _RANDOM[8'h4C][21];
        tables_0_io_update_uValid_r = _RANDOM[8'h4C][22];
        tables_0_io_update_u_r = _RANDOM[8'h4C][23];
        tables_0_io_update_pc_r =
          {_RANDOM[8'h4C][31:24], _RANDOM[8'h4D], _RANDOM[8'h4E][9:0]};
        tables_0_io_update_ghist_r =
          {_RANDOM[8'h4E][31:10],
           ...
           _RANDOM[8'h55],
           _RANDOM[8'h56][9:0]};
        tables_1_io_update_valid_REG = _RANDOM[8'h56][10];
        tables_1_io_update_reset_u_REG = _RANDOM[8'h56][11];
        tables_1_io_update_correct_r = _RANDOM[8'h56][12];
        tables_1_io_update_alloc_r = _RANDOM[8'h56][13];
        tables_1_io_update_oldCtr_r = _RANDOM[8'h56][15:14];
        tables_1_io_update_target_offset_r_offset =
          {_RANDOM[8'h56][31:16], _RANDOM[8'h57][3:0]};
        tables_1_io_update_target_offset_r_pointer = _RANDOM[8'h57][7:4];
        tables_1_io_update_target_offset_r_usePCRegion = _RANDOM[8'h57][8];
        tables_1_io_update_old_target_offset_r_offset = _RANDOM[8'h57][28:9];
        tables_1_io_update_old_target_offset_r_pointer =
          {_RANDOM[8'h57][31:29], _RANDOM[8'h58][0]};
        tables_1_io_update_old_target_offset_r_usePCRegion = _RANDOM[8'h58][1];
        tables_1_io_update_uValid_r = _RANDOM[8'h58][2];
        tables_1_io_update_u_r = _RANDOM[8'h58][3];
        tables_1_io_update_pc_r = {_RANDOM[8'h58][31:4], _RANDOM[8'h59][21:0]};
        tables_1_io_update_ghist_r =
          {_RANDOM[8'h59][31:22],
           ...
           _RANDOM[8'h60],
           _RANDOM[8'h61][21:0]};
        tables_2_io_update_valid_REG = _RANDOM[8'h61][22];
        tables_2_io_update_reset_u_REG = _RANDOM[8'h61][23];
        tables_2_io_update_correct_r = _RANDOM[8'h61][24];
        tables_2_io_update_alloc_r = _RANDOM[8'h61][25];
        tables_2_io_update_oldCtr_r = _RANDOM[8'h61][27:26];
        tables_2_io_update_target_offset_r_offset =
          {_RANDOM[8'h61][31:28], _RANDOM[8'h62][15:0]};
        tables_2_io_update_target_offset_r_pointer = _RANDOM[8'h62][19:16];
        tables_2_io_update_target_offset_r_usePCRegion = _RANDOM[8'h62][20];
        tables_2_io_update_old_target_offset_r_offset =
          {_RANDOM[8'h62][31:21], _RANDOM[8'h63][8:0]};
        tables_2_io_update_old_target_offset_r_pointer = _RANDOM[8'h63][12:9];
        tables_2_io_update_old_target_offset_r_usePCRegion = _RANDOM[8'h63][13];
        tables_2_io_update_uValid_r = _RANDOM[8'h63][14];
        tables_2_io_update_u_r = _RANDOM[8'h63][15];
        tables_2_io_update_pc_r =
          {_RANDOM[8'h63][31:16], _RANDOM[8'h64], _RANDOM[8'h65][1:0]};
        tables_2_io_update_ghist_r =
          {_RANDOM[8'h65][31:2],
           ...
           _RANDOM[8'h6C],
           _RANDOM[8'h6D][1:0]};
        tables_3_io_update_valid_REG = _RANDOM[8'h6D][2];
        tables_3_io_update_reset_u_REG = _RANDOM[8'h6D][3];
        tables_3_io_update_correct_r = _RANDOM[8'h6D][4];
        tables_3_io_update_alloc_r = _RANDOM[8'h6D][5];
        tables_3_io_update_oldCtr_r = _RANDOM[8'h6D][7:6];
        tables_3_io_update_target_offset_r_offset = _RANDOM[8'h6D][27:8];
        tables_3_io_update_target_offset_r_pointer = _RANDOM[8'h6D][31:28];
        tables_3_io_update_target_offset_r_usePCRegion = _RANDOM[8'h6E][0];
        tables_3_io_update_old_target_offset_r_offset = _RANDOM[8'h6E][20:1];
        tables_3_io_update_old_target_offset_r_pointer = _RANDOM[8'h6E][24:21];
        tables_3_io_update_old_target_offset_r_usePCRegion = _RANDOM[8'h6E][25];
        tables_3_io_update_uValid_r = _RANDOM[8'h6E][26];
        tables_3_io_update_u_r = _RANDOM[8'h6E][27];
        tables_3_io_update_pc_r =
          {_RANDOM[8'h6E][31:28], _RANDOM[8'h6F], _RANDOM[8'h70][13:0]};
        tables_3_io_update_ghist_r =
          {_RANDOM[8'h70][31:14],
           ...
           _RANDOM[8'h77],
           _RANDOM[8'h78][13:0]};
        tables_4_io_update_valid_REG = _RANDOM[8'h78][14];
        tables_4_io_update_reset_u_REG = _RANDOM[8'h78][15];
        tables_4_io_update_correct_r = _RANDOM[8'h78][16];
        tables_4_io_update_alloc_r = _RANDOM[8'h78][17];
        tables_4_io_update_oldCtr_r = _RANDOM[8'h78][19:18];
        tables_4_io_update_target_offset_r_offset =
          {_RANDOM[8'h78][31:20], _RANDOM[8'h79][7:0]};
        tables_4_io_update_target_offset_r_pointer = _RANDOM[8'h79][11:8];
        tables_4_io_update_target_offset_r_usePCRegion = _RANDOM[8'h79][12];
        tables_4_io_update_old_target_offset_r_offset =
          {_RANDOM[8'h79][31:13], _RANDOM[8'h7A][0]};
        tables_4_io_update_old_target_offset_r_pointer = _RANDOM[8'h7A][4:1];
        tables_4_io_update_old_target_offset_r_usePCRegion = _RANDOM[8'h7A][5];
        tables_4_io_update_uValid_r = _RANDOM[8'h7A][6];
        tables_4_io_update_u_r = _RANDOM[8'h7A][7];
        tables_4_io_update_pc_r = {_RANDOM[8'h7A][31:8], _RANDOM[8'h7B][25:0]};
