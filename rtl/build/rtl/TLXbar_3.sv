...
module TLXbar_3(
  ...
  assign auto_in_1_d_valid = auto_out_d_valid & ~(auto_out_d_bits_source[5]);
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {1'h1, auto_in_0_a_bits_source} : 6'h0)
    | (muxState_1 ? {1'h0, auto_in_1_a_bits_source} : 6'h0);
  ...
  assign auto_out_d_ready =
    auto_out_d_bits_source[5] & auto_in_0_d_ready | ~(auto_out_d_bits_source[5])
    & auto_in_1_d_ready;
endmodule
