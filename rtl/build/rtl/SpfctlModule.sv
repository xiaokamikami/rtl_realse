  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_L2_PF_DELAY_LATENCY = _RANDOM[/*Zero width*/ 1'b0][9:0];
        reg_L2_PF_TP_ENABLE = _RANDOM[/*Zero width*/ 1'b0][10];
        reg_L2_PF_VBOP_ENABLE = _RANDOM[/*Zero width*/ 1'b0][11];
        reg_L2_PF_PBOP_ENABLE = _RANDOM[/*Zero width*/ 1'b0][12];
        reg_L2_PF_RECV_ENABLE = _RANDOM[/*Zero width*/ 1'b0][13];
        reg_L2_PF_STORE_ONLY = _RANDOM[/*Zero width*/ 1'b0][14];
        reg_L1D_PF_ENABLE_STRIDE = _RANDOM[/*Zero width*/ 1'b0][15];
        reg_L1D_PF_ACTIVE_STRIDE = _RANDOM[/*Zero width*/ 1'b0][21:16];
        reg_L1D_PF_ACTIVE_THRESHOLD = _RANDOM[/*Zero width*/ 1'b0][25:22];
        reg_L1D_PF_ENABLE_PHT = _RANDOM[/*Zero width*/ 1'b0][26];
        reg_L1D_PF_ENABLE_AGT = _RANDOM[/*Zero width*/ 1'b0][27];
        reg_L1D_PF_TRAIN_ON_HIT = _RANDOM[/*Zero width*/ 1'b0][28];
        reg_L1D_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][29];
        reg_L2_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][30];
        reg_L1I_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][31];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_L2_PF_DELAY_LATENCY = 10'h0;
        reg_L2_PF_TP_ENABLE = 1'h1;
