  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h26][21];
        deqDelay_0_bits_rf_2_0_addr = _RANDOM[7'h26][29:22];
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h27][8:1];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h27][19:12];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h28][31:7], _RANDOM[7'h29][9:0]};
        deqDelay_0_bits_common_fuOpType = _RANDOM[7'h29][18:10];
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h31][19];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h31][27:20];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h32][8:1];
        deqDelay_0_bits_common_rfWen = _RANDOM[7'h32][9];
        deqDelay_0_bits_common_fpWen = _RANDOM[7'h32][10];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h32][11];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h32][12];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h32][15];
        deqDelay_0_bits_common_fpu_fmt = _RANDOM[7'h32][19:18];
        deqDelay_0_bits_common_fpu_rm = _RANDOM[7'h32][22:20];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h32][26:23];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h32][30:27];
        deqDelay_0_bits_common_dataSources_2_value =
          {_RANDOM[7'h32][31], _RANDOM[7'h33][2:0]};
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[7'h33][4:3];
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[7'h33][6:5];
        deqDelay_0_bits_common_exuSources_2_value = _RANDOM[7'h33][8:7];
        io_validCntDeqVec_0_REG = _RANDOM[7'h48][10:5];
        io_validCntDeqVec_1_REG = _RANDOM[7'h48][16:11];
      `endif // RANDOMIZE_REG_INIT
    end // initial
