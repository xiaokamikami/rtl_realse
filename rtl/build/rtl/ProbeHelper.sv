...
module ProbeHelper(
  ...
  input  [12:0] io_dirResult_bits_set,
  ...
  output [12:0] io_probe_bits_set,
  output [28:0] io_probe_bits_tag,
  ...
  Queue5_MSHRRequest queue (
    ...
    .io_enq_bits_set
      ({io_dirResult_bits_clients_tag[2:0], io_dirResult_bits_set[9:0]}),
    .io_enq_bits_tag              (io_dirResult_bits_clients_tag[31:3]),
