  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[5'h3][7];
        rdata_last_REG = _RANDOM[5'hB][8];
        rdata_hold_data_0 = _RANDOM[5'hB][27:9];
        rdata_hold_data_1 = {_RANDOM[5'hB][31:28], _RANDOM[5'hC][14:0]};
        rdata_hold_data_2 = {_RANDOM[5'hC][31:15], _RANDOM[5'hD][1:0]};
        rdata_hold_data_3 = _RANDOM[5'hD][20:2];
        rdataReg =
          {_RANDOM[5'hD][31:21], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
