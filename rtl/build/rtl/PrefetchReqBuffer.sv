...
module PrefetchReqBuffer(
  ...
  reg         io_tlb_req_req_bits_r_isPrefetch;
  ...
  always @(posedge clock) begin
    ...
    io_tlb_req_req_bits_r_isPrefetch <=
      _tlb_req_arb_io_out_valid | io_tlb_req_req_bits_r_isPrefetch;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_tlb_req_req_bits_r_isPrefetch = _RANDOM[7'h4E][6];
  ...
  assign io_tlb_req_req_bits_isPrefetch = io_tlb_req_req_bits_r_isPrefetch;
