  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s3_top = {_RANDOM[7'h12][31:25], _RANDOM[7'h13], _RANDOM[7'h14][10:0]};
        s3_spec_new_addr = {_RANDOM[7'h14][31:11], _RANDOM[7'h15][28:0]};
        s3_pushed_in_s2 = _RANDOM[7'h15][29];
        s3_popped_in_s2 = _RANDOM[7'h15][30];
        s3_meta_ssp = {_RANDOM[7'h15][31], _RANDOM[7'h16][2:0]};
        s3_meta_sctr = _RANDOM[7'h16][5:3];
        s3_meta_TOSW_flag = _RANDOM[7'h16][6];
        s3_meta_TOSW_value = _RANDOM[7'h16][11:7];
        s3_meta_TOSR_flag = _RANDOM[7'h16][12];
        s3_meta_TOSR_value = _RANDOM[7'h16][17:13];
        s3_meta_NOS_flag = _RANDOM[7'h16][18];
        s3_meta_NOS_value = _RANDOM[7'h16][23:19];
        redirect_next_valid_last_REG = _RANDOM[7'h16][24];
        redirect_next_bits_r_level = _RANDOM[7'h17][14];
        redirect_next_bits_r_cfiUpdate_pc =
          {_RANDOM[7'h17][31:16], _RANDOM[7'h18], _RANDOM[7'h19][1:0]};
        redirect_next_bits_r_cfiUpdate_pd_valid = _RANDOM[7'h19][2];
        redirect_next_bits_r_cfiUpdate_pd_isRVC = _RANDOM[7'h19][3];
        redirect_next_bits_r_cfiUpdate_pd_isCall = _RANDOM[7'h19][6];
        redirect_next_bits_r_cfiUpdate_pd_isRet = _RANDOM[7'h19][7];
        redirect_next_bits_r_cfiUpdate_ssp = _RANDOM[7'h19][11:8];
        redirect_next_bits_r_cfiUpdate_sctr = _RANDOM[7'h19][14:12];
        redirect_next_bits_r_cfiUpdate_TOSW_flag = _RANDOM[7'h19][15];
        redirect_next_bits_r_cfiUpdate_TOSW_value = _RANDOM[7'h19][20:16];
        redirect_next_bits_r_cfiUpdate_TOSR_flag = _RANDOM[7'h19][21];
        redirect_next_bits_r_cfiUpdate_TOSR_value = _RANDOM[7'h19][26:22];
        redirect_next_bits_r_cfiUpdate_NOS_flag = _RANDOM[7'h19][27];
        redirect_next_bits_r_cfiUpdate_NOS_value =
          {_RANDOM[7'h19][31:28], _RANDOM[7'h1A][0]};
        updateValid = _RANDOM[7'h28][15];
        update_r_ftb_entry_isCall = _RANDOM[7'h2C][22];
        update_r_ftb_entry_isRet = _RANDOM[7'h2C][23];
        update_r_ftb_entry_tailSlot_offset = _RANDOM[7'h2D][17:14];
        update_r_ftb_entry_tailSlot_valid = _RANDOM[7'h2D][19];
        update_r_cfi_idx_valid = _RANDOM[7'h2E][18];
        update_r_cfi_idx_bits = _RANDOM[7'h2E][22:19];
        update_r_jmp_taken = _RANDOM[7'h2E][27];
        updateMeta_ssp = _RANDOM[7'h40][31:28];
        updateMeta_TOSW_flag = _RANDOM[7'h41][0];
        updateMeta_TOSW_value = _RANDOM[7'h41][5:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        modified_reset = 1'h1;
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
