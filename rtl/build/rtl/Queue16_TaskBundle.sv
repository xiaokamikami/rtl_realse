...
module Queue16_TaskBundle(
  ...
  input  [2:0]  io_enq_bits_snpHitReleaseMeta_prefetchSrc,
  ...
  assign io_deq_bits_set = empty ? io_enq_bits_set : _ram_ext_R0_data[8:0];
  assign io_deq_bits_tag = empty ? io_enq_bits_tag : _ram_ext_R0_data[39:9];
  ...
  assign io_deq_bits_reqSource = empty ? io_enq_bits_reqSource : _ram_ext_R0_data[66:62];
