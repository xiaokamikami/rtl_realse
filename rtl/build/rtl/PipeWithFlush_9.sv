  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_fuType = {_RANDOM[7'h1F][31:15], _RANDOM[7'h20][17:0]};
        bits_2_robIdx_flag = _RANDOM[7'h28][27];
        bits_2_robIdx_value = {_RANDOM[7'h28][31:28], _RANDOM[7'h29][3:0]};
        bits_2_pdest = _RANDOM[7'h29][16:9];
        bits_2_fpWen = _RANDOM[7'h29][18];
        bits_2_vecWen = _RANDOM[7'h29][19];
        bits_2_v0Wen = _RANDOM[7'h29][20];
        bits_3_fuType = {_RANDOM[7'h3E][31:27], _RANDOM[7'h3F][29:0]};
        bits_3_robIdx_flag = _RANDOM[7'h48][7];
        bits_3_robIdx_value = _RANDOM[7'h48][15:8];
        bits_3_pdest = _RANDOM[7'h48][28:21];
        bits_3_fpWen = _RANDOM[7'h48][30];
        bits_3_vecWen = _RANDOM[7'h48][31];
        bits_3_v0Wen = _RANDOM[7'h49][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
