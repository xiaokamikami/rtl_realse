      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vs1Reg =
          {_RANDOM[6'h2F][31:25],
           ...
           _RANDOM[6'h32],
           _RANDOM[6'h33][24:0]};
        outWiden = _RANDOM[6'h33][25];
        outVlFix = {_RANDOM[6'h33][31:26], _RANDOM[6'h34][1:0]};
        allVmZero = _RANDOM[6'h34][2];
        mgu_io_in_info_eew_r = _RANDOM[6'h34][4:3];
        mgu_io_in_info_vdIdx_r = _RANDOM[6'h34][11:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
