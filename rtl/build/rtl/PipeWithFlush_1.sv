  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_fuType = {_RANDOM[6'h1D], _RANDOM[6'h1E][2:0]};
        bits_2_robIdx_flag = _RANDOM[6'h24][12];
        bits_2_robIdx_value = _RANDOM[6'h24][20:13];
        bits_2_pdest = {_RANDOM[6'h24][31:26], _RANDOM[6'h25][1:0]};
        bits_2_rfWen = _RANDOM[6'h25][2];
        bits_2_loadDependency_0 = _RANDOM[6'h25][24:23];
        bits_2_loadDependency_1 = _RANDOM[6'h25][26:25];
        bits_2_loadDependency_2 = _RANDOM[6'h25][28:27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
