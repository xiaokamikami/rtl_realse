...
module BatchCluster_7(
  ...
  assign out_data =
    in_0_valid
      ? {in_0_bits_coreid, 7'h0, in_0_bits_criticalError, 7'h0, in_0_bits_valid}
      : 24'h0;
  assign out_info = in_0_valid ? {15'h180, in_0_valid} : 16'h0;
  assign status_sum_data_bytes = 11'(status_base_data_bytes + {9'h0, {2{in_0_valid}}});
