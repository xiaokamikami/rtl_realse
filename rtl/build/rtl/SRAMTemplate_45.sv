  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[3'h1][23];
        rdata_last_REG = _RANDOM[3'h5][24];
        rdata_hold_data_0 = {_RANDOM[3'h5][31:25], _RANDOM[3'h6][4:0]};
        rdata_hold_data_1 = _RANDOM[3'h6][16:5];
        rdataReg = {_RANDOM[3'h6][31:17], _RANDOM[3'h7][8:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 9'h0;
