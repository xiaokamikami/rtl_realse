...
module IssueQueueLdu(
  ...
  always @(posedge clock) begin
    ...
    io_wakeupToIQ_0_bits_rfWen_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_fpWen_REG <=
    ...
    io_wakeupToIQ_0_bits_rfWenCopy_0_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_rfWenCopy_1_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_rfWenCopy_2_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_rfWenCopy_3_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_rfWenCopy_4_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
    io_wakeupToIQ_0_bits_rfWenCopy_5_REG <= _io_wakeupToIQ_0_bits_rfWenCopy_5_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_validCntDeqVec_0_REG_1 = _RANDOM[6'h23][11:7];
        io_wakeupToIQ_0_valid_REG = _RANDOM[6'h23][12];
        io_wakeupToIQ_0_bits_rfWen_REG = _RANDOM[6'h23][13];
        io_wakeupToIQ_0_bits_fpWen_REG = _RANDOM[6'h23][14];
        io_wakeupToIQ_0_bits_pdest_REG = _RANDOM[6'h23][22:15];
        io_wakeupToIQ_0_bits_rfWenCopy_0_REG = _RANDOM[6'h23][23];
        io_wakeupToIQ_0_bits_rfWenCopy_1_REG = _RANDOM[6'h23][24];
        io_wakeupToIQ_0_bits_rfWenCopy_2_REG = _RANDOM[6'h23][25];
        io_wakeupToIQ_0_bits_rfWenCopy_3_REG = _RANDOM[6'h23][26];
        io_wakeupToIQ_0_bits_rfWenCopy_4_REG = _RANDOM[6'h23][27];
        io_wakeupToIQ_0_bits_rfWenCopy_5_REG = _RANDOM[6'h23][28];
        io_wakeupToIQ_0_bits_pdestCopy_0_REG = _RANDOM[6'h24][10:3];
        io_wakeupToIQ_0_bits_pdestCopy_1_REG = _RANDOM[6'h24][18:11];
        io_wakeupToIQ_0_bits_pdestCopy_2_REG = _RANDOM[6'h24][26:19];
        io_wakeupToIQ_0_bits_pdestCopy_3_REG =
          {_RANDOM[6'h24][31:27], _RANDOM[6'h25][2:0]};
        io_wakeupToIQ_0_bits_pdestCopy_4_REG = _RANDOM[6'h25][10:3];
        io_wakeupToIQ_0_bits_pdestCopy_5_REG = _RANDOM[6'h25][18:11];
      `endif // RANDOMIZE_REG_INIT
    end // initial
