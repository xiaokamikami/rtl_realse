  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_uop_storeSetHit = _RANDOM[6'h27][7];
        io_out_bits_r_uop_waitForRobIdx_flag = _RANDOM[6'h27][8];
        io_out_bits_r_uop_waitForRobIdx_value = _RANDOM[6'h27][16:9];
        io_out_bits_r_uop_loadWaitBit = _RANDOM[6'h27][17];
        io_out_bits_r_uop_loadWaitStrict = _RANDOM[6'h27][18];
        io_out_bits_r_uop_lqIdx_flag = _RANDOM[6'h27][24];
        io_out_bits_r_uop_lqIdx_value = _RANDOM[6'h27][31:25];
        io_out_bits_r_uop_sqIdx_flag = _RANDOM[6'h28][0];
        io_out_bits_r_uop_sqIdx_value = _RANDOM[6'h28][6:1];
        io_out_bits_r_vaddr = {_RANDOM[6'h28][31:14], _RANDOM[6'h29]};
        io_out_bits_r_paddr = {_RANDOM[6'h2C][31:1], _RANDOM[6'h2D][16:0]};
        io_out_bits_r_data =
          {_RANDOM[6'h30][31:1],
           _RANDOM[6'h31],
           _RANDOM[6'h32],
           _RANDOM[6'h33],
           _RANDOM[6'h34][1:0]};
        io_out_bits_r_isvec = _RANDOM[6'h39][2];
        io_out_bits_r_is128bit = _RANDOM[6'h39][4];
        io_out_bits_r_vecActive = _RANDOM[6'h3D][23];
        io_out_bits_r_schedIndex = _RANDOM[6'h3E][20:14];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
