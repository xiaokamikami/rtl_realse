...
module BatchCluster_4(
  ...
  assign out_data =
    in_0_valid
      ? {in_0_bits_coreid, in_0_bits_mhpmeventOverflow, 7'h0, in_0_bits_valid}
      : 80'h0;
  assign out_info = in_0_valid ? {15'h280, in_0_valid} : 16'h0;
  assign status_sum_data_bytes =
    11'(status_base_data_bytes + {7'h0, in_0_valid ? 4'hA : 4'h0});
