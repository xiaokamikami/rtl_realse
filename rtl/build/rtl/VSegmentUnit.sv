...
module VSegmentUnit(
  ...
  wire              _GEN_5 = state == 4'h8;
  wire              _GEN_6 = segmentIdx == _maxSegIdx_T;
  wire [3:0]        _GEN_7 = {1'h0, instMicroOp_uop_vpu_nf};
  wire              _GEN_8 = fieldIdx == _GEN_7;
  wire              _GEN_9 = _GEN_6 & ~(|_GEN_1);
  wire              _GEN_10 = _VSegmentUnitPipelineConnect_io_in_ready & sbufferOut_valid;
  wire [3:0]        _GEN_11 = state == 4'hD & fofBufferValid ? 4'hD : 4'h0;
  wire [15:0][3:0]  _GEN_12 =
    {{_GEN_11},
     ...
     {~_GEN_10 & (|_GEN_1) | _GEN_4
        ? 4'hA
        : _GEN_6
          & (_GEN_8 & _GEN_10 | ~(|_GEN_1) & _VSegmentUnitPipelineConnect_io_out_valid
             & ~io_sbuffer_ready)
            ? 4'hB
            : _GEN_9 ? 4'hC : 4'h3},
     ...
     {exception_pa | exception_va | exception_gpa
        ...
        : _GEN_2 & _canHandleMisalign_T & _canHandleMisalign_T_1 & _canHandleMisalign_T_3
          & isMisalignWire & ~notCross16ByteWire | _GEN_4 & instMicroOp_isVSegStore
            ? 4'h3
  ...
  wire [3:0]        stateNext = _GEN_12[state];
  wire [2:0]        _emul_T_3 =
    3'(3'({1'h0, io_in_bits_uop_vpu_veew} - {1'h0, io_in_bits_uop_vpu_vsew})
       + io_in_bits_uop_vpu_vlmul);
  wire              _GEN_13 = io_in_valid & ~instMicroOpValid;
  wire              _GEN_14 = _GEN_13 & ~isEnqFixVlUop;
  wire              _GEN_15 = io_in_valid & ~isEnqFixVlUop;
  wire [7:0][127:0] _GEN_16 =
    {{stride_7},
     ...
     {stride_1},
     {stride_0}};
  wire [127:0]      _GEN_17 = _GEN_16[stridePtrReg_value];
                ...
                {16'h0,
                 {8'h0,
                  instMicroOp_uop_vpu_veew == 2'h0
                    ? (_indexStride_T_111 ? _GEN_17[7:0] : 8'h0)
                      | (_indexStride_T_112 ? _GEN_17[15:8] : 8'h0)
                      | (_indexStride_T_100 ? _GEN_17[23:16] : 8'h0)
                      | (_indexStride_T_101 ? _GEN_17[31:24] : 8'h0)
                      | (_indexStride_T_75 ? _GEN_17[39:32] : 8'h0)
                      | (_indexStride_T_76 ? _GEN_17[47:40] : 8'h0)
                      | (_indexStride_T_77 ? _GEN_17[55:48] : 8'h0)
                      | (_indexStride_T_78 ? _GEN_17[63:56] : 8'h0)
                      | (issueIndexIdx == 8'h8 ? _GEN_17[71:64] : 8'h0)
                      | (issueIndexIdx == 8'h9 ? _GEN_17[79:72] : 8'h0)
                      | (issueIndexIdx == 8'hA ? _GEN_17[87:80] : 8'h0)
                      | (issueIndexIdx == 8'hB ? _GEN_17[95:88] : 8'h0)
                      | (issueIndexIdx == 8'hC ? _GEN_17[103:96] : 8'h0)
                      | (issueIndexIdx == 8'hD ? _GEN_17[111:104] : 8'h0)
                      | (issueIndexIdx == 8'hE ? _GEN_17[119:112] : 8'h0)
                      | (issueIndexIdx == 8'hF ? _GEN_17[127:120] : 8'h0)
                    : 8'h0}
                   | (instMicroOp_uop_vpu_veew == 2'h1
                        ? (_indexStride_T_111 ? _GEN_17[15:0] : 16'h0)
                          | (_indexStride_T_112 ? _GEN_17[31:16] : 16'h0)
                          | (_indexStride_T_100 ? _GEN_17[47:32] : 16'h0)
                          | (_indexStride_T_101 ? _GEN_17[63:48] : 16'h0)
                          | (_indexStride_T_75 ? _GEN_17[79:64] : 16'h0)
                          | (_indexStride_T_76 ? _GEN_17[95:80] : 16'h0)
                          | (_indexStride_T_77 ? _GEN_17[111:96] : 16'h0)
                          | (_indexStride_T_78 ? _GEN_17[127:112] : 16'h0)
                        : 16'h0)}
                  | (instMicroOp_uop_vpu_veew == 2'h2
                       ? (_indexStride_T_111 ? _GEN_17[31:0] : 32'h0)
                         | (_indexStride_T_112 ? _GEN_17[63:32] : 32'h0)
                         | (_indexStride_T_100 ? _GEN_17[95:64] : 32'h0)
                         | (_indexStride_T_101 ? _GEN_17[127:96] : 32'h0)
                       : 32'h0)}
               | ((&instMicroOp_uop_vpu_veew)
                    ? (_indexStride_T_111 ? _GEN_17[63:0] : 64'h0)
                      | (_indexStride_T_112 ? _GEN_17[127:64] : 64'h0)
                    : 64'h0)
             : segmentOffset));
  wire [60:0]       _GEN_18 = curPtr ? 61'(latchVaddr[63:3] + 61'h1) : latchVaddr[63:3];
  wire [63:0]       tlbReqVaddr = isMisalignReg ? {_GEN_18, 3'h0} : _vaddr_T;
  wire              _triggerBreakpoint_T_1 = state == 4'h3;
  wire [49:0]       dcacheReqVaddr =
    isMisalignReg ? {_GEN_18[46:0], 3'h0} : latchVaddr[49:0];
  reg               triggerDebugMode;
  reg               triggerBreakpoint;
  wire              _GEN_19 = io_dtlb_resp_valid & state == 4'h4;
  ...
  assign exception_va =
    ...
    & (_exception_va_T | instMicroOp_uop_exceptionVec_7 | instMicroOp_uop_exceptionVec_5
       | triggerBreakpoint | triggerDebugMode | _pmp_T_4[0]);
  assign exception_gpa =
    _GEN_2 & (instMicroOp_uop_exceptionVec_23 | instMicroOp_uop_exceptionVec_21);
  wire              _GEN_20 = exception_va | exception_gpa | exception_pa;
  ...
  wire              _GEN_21 = _segmentInactiveFinish_T_1 & _segmentInactiveFinish_T_2;
  reg               last_REG;
  wire              _GEN_22 =
  ...
  assign exception_pa = _GEN_22 | _GEN_2 & (_pmp_T_4[2] | _pmp_T_4[3] | _pmp_T_4[0]);
  wire [3:0]        _splitData_T = segmentIdx[3:0] & instMicroOp_uopFlowNumMask[3:0];
  wire [7:0][127:0] _GEN_23 =
    {{data_7}, {data_6}, {data_5}, {data_4}, {data_3}, {data_2}, {data_1}, {data_0}};
  wire [127:0]      _GEN_24 = _GEN_23[splitPtr_value];
  ...
  wire              _GEN_25 = _segmentInactiveFinish_T & (|_GEN_1);
  ...
  wire [127:0]      splitData =
    (_flowData_T_15
       ? {120'h0,
          (_splitData_T == 4'h0 ? _GEN_24[7:0] : 8'h0)
            | (_splitData_T == 4'h1 ? _GEN_24[15:8] : 8'h0)
            | (_splitData_T == 4'h2 ? _GEN_24[23:16] : 8'h0)
            | (_splitData_T == 4'h3 ? _GEN_24[31:24] : 8'h0)
            | (_splitData_T == 4'h4 ? _GEN_24[39:32] : 8'h0)
            | (_splitData_T == 4'h5 ? _GEN_24[47:40] : 8'h0)
            | (_splitData_T == 4'h6 ? _GEN_24[55:48] : 8'h0)
            | (_splitData_T == 4'h7 ? _GEN_24[63:56] : 8'h0)
            | (_splitData_T == 4'h8 ? _GEN_24[71:64] : 8'h0)
            | (_splitData_T == 4'h9 ? _GEN_24[79:72] : 8'h0)
            | (_splitData_T == 4'hA ? _GEN_24[87:80] : 8'h0)
            | (_splitData_T == 4'hB ? _GEN_24[95:88] : 8'h0)
            | (_splitData_T == 4'hC ? _GEN_24[103:96] : 8'h0)
            | (_splitData_T == 4'hD ? _GEN_24[111:104] : 8'h0)
            | (_splitData_T == 4'hE ? _GEN_24[119:112] : 8'h0)
            | ((&_splitData_T) ? _GEN_24[127:120] : 8'h0)}
       : 128'h0)
    | (_flowData_T_16
         ? {112'h0,
            (_splitData_T_65 == 3'h0 ? _GEN_24[15:0] : 16'h0)
              | (_splitData_T_65 == 3'h1 ? _GEN_24[31:16] : 16'h0)
              | (_splitData_T_65 == 3'h2 ? _GEN_24[47:32] : 16'h0)
              | (_splitData_T_65 == 3'h3 ? _GEN_24[63:48] : 16'h0)
              | (_splitData_T_65 == 3'h4 ? _GEN_24[79:64] : 16'h0)
              | (_splitData_T_65 == 3'h5 ? _GEN_24[95:80] : 16'h0)
              | (_splitData_T_65 == 3'h6 ? _GEN_24[111:96] : 16'h0)
              | ((&_splitData_T_65) ? _GEN_24[127:112] : 16'h0)}
         : 128'h0)
    | (_flowData_T_17
         ? {96'h0,
            (_splitData_T_98 == 2'h0 ? _GEN_24[31:0] : 32'h0)
              | (_splitData_T_98 == 2'h1 ? _GEN_24[63:32] : 32'h0)
              | (_splitData_T_98 == 2'h2 ? _GEN_24[95:64] : 32'h0)
              | ((&_splitData_T_98) ? _GEN_24[127:96] : 32'h0)}
         : 128'h0)
    | (_flowData_T_18
         ? {64'h0,
            (_splitData_T_119 ? 64'h0 : _GEN_24[63:0])
              | (_splitData_T_119 ? _GEN_24[127:64] : 64'h0)}
         : 128'h0) | (_flowData_T_19 ? _GEN_24 : 128'h0);
  wire [127:0]      flowData =
  ...
  wire [47:0]       dcacheReqPaddr =
    isMisalignReg ? {instMicroOp_paddr[47:12], _GEN_18[8:0], 3'h0} : instMicroOp_paddr;
  assign io_rdcache_req_valid_0 = state == 4'h6 & instMicroOp_isVSegLoad;
  wire [254:0]      _GEN_26 = {127'h0, flowData};
  wire [254:0]      _GEN_27 = {248'h0, latchVaddr[3:0], 3'h0};
  wire [254:0]      notCross16ByteData = _GEN_26 << _GEN_27;
        ...
        & ({4'h0,
            {2'h0,
             {1'h0, ~(|(instMicroOp_alignedType[1:0]))}
              ...
              | {4{instMicroOp_alignedType[1:0] == 2'h2}}}
           | {8{&(instMicroOp_alignedType[1:0])}})} << latchVaddr[3:0]};
  wire [254:0]      _Cross16ByteData_T_1 = _GEN_26 << _GEN_27;
  wire [49:0]       _GEN_28 = {latchVaddr[49:3], 3'h0};
  ...
  wire              segmentInactiveFinish =
    ...
    & ~(|_GEN_1);
  wire              _fieldIdxWire_T = fieldIdx == _GEN_7;
  wire [8:0]        _segmentIdxWire_T_2 = 9'({1'h0, segmentIdx} + 9'h1);
  wire [3:0]        _io_exceptionInfo_valid_T_5 = {deqPtr_flag, deqPtr_value};
  wire              _GEN_29 = _GEN_21 & fieldActiveWirteFinish;
  wire              _GEN_30 = _GEN_25 | _GEN_29;
  wire [3:0]        _fieldIdxWire_T_1 = 4'(fieldIdx + 4'h1);
  wire              _GEN_31 = _fieldIdxWire_T & (_segmentInactiveFinish_T | _GEN_29);
  wire              _GEN_32 = segmentIdx != _maxSegIdx_T;
  wire              _GEN_33 = _GEN_31 & _GEN_32;
  wire              _GEN_34 = segmentInactiveFinish & _GEN_32;
  ...
  wire [4:0]        _GEN_36 = {3'h0, io_in_bits_uop_vpu_veew};
  wire              _GEN_37 =
  ...
  wire [3:0]        _GEN_39 =
    _GEN_38[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[3:0] : 4'h0);
  ...
  wire [3:0]        _GEN_41 =
    _GEN_40[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[7:4] : 4'h0);
  ...
  wire [3:0]        _GEN_43 =
    _GEN_42[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[11:8] : 4'h0);
  ...
  wire [3:0]        _GEN_45 =
    _GEN_44[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[15:12] : 4'h0);
  ...
  wire [3:0]        _GEN_47 =
    _GEN_46[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[19:16] : 4'h0);
  ...
  wire [3:0]        _GEN_49 =
    _GEN_48[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[23:20] : 4'h0);
  ...
  wire [3:0]        _GEN_51 =
    _GEN_50[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[27:24] : 4'h0);
  ...
  wire [3:0]        _GEN_53 =
    _GEN_52[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[31:28] : 4'h0);
  wire [7:0]        _GEN_54 =
    {{uopq_7_uop_vecWen},
     {uopq_6_uop_vecWen},
     {uopq_5_uop_vecWen},
  ...
  wire [7:0][15:0]  _GEN_57 =
    {{{_maskDataVec_maskDataVec_7_T_8[15:8],
       _GEN_52[7:4],
       _GEN_53[3:2],
       _GEN_53[1:0] | ((&realEw) ? instMicroOp_mask[15:14] : 2'h0)}},
     {{_maskDataVec_maskDataVec_6_T_8[15:8],
       _GEN_50[7:4],
       _GEN_51[3:2],
       _GEN_51[1:0] | ((&realEw) ? instMicroOp_mask[13:12] : 2'h0)}},
     {{_maskDataVec_maskDataVec_5_T_8[15:8],
       _GEN_48[7:4],
       _GEN_49[3:2],
       _GEN_49[1:0] | ((&realEw) ? instMicroOp_mask[11:10] : 2'h0)}},
     {{_maskDataVec_maskDataVec_4_T_8[15:8],
       _GEN_46[7:4],
       _GEN_47[3:2],
       _GEN_47[1:0] | ((&realEw) ? instMicroOp_mask[9:8] : 2'h0)}},
     {{_maskDataVec_maskDataVec_3_T_8[15:8],
       _GEN_44[7:4],
       _GEN_45[3:2],
       _GEN_45[1:0] | ((&realEw) ? instMicroOp_mask[7:6] : 2'h0)}},
     {{_maskDataVec_maskDataVec_2_T_8[15:8],
       _GEN_42[7:4],
       _GEN_43[3:2],
       _GEN_43[1:0] | ((&realEw) ? instMicroOp_mask[5:4] : 2'h0)}},
     {{_maskDataVec_maskDataVec_1_T_8[15:8],
       _GEN_40[7:4],
       _GEN_41[3:2],
       _GEN_41[1:0] | ((&realEw) ? instMicroOp_mask[3:2] : 2'h0)}},
     {{_maskDataVec_maskDataVec_0_T_8[15:8],
       _GEN_38[7:4],
       _GEN_39[3:2],
       _GEN_39[1:0] | ((&realEw) ? instMicroOp_mask[1:0] : 2'h0)}}};
  ...
  wire              _GEN_63 = _GEN_15 & enqPtr_value == 3'h0;
  wire              _GEN_64 = _GEN_15 & enqPtr_value == 3'h1;
  wire              _GEN_65 = _GEN_15 & enqPtr_value == 3'h2;
  wire              _GEN_66 = _GEN_15 & enqPtr_value == 3'h3;
  wire              _GEN_67 = _GEN_15 & enqPtr_value == 3'h4;
  wire              _GEN_68 = _GEN_15 & enqPtr_value == 3'h5;
  wire              _GEN_69 = _GEN_15 & enqPtr_value == 3'h6;
  wire              _GEN_70 = _GEN_15 & (&enqPtr_value);
  ...
  wire [127:0]      mergedData =
    ((|(instMicroOp_alignedType[1:0]))
       ? 128'h0
       : {(&_splitData_T) ? pickData[7:0] : _GEN_24[127:120],
          _splitData_T == 4'hE ? pickData[7:0] : _GEN_24[119:112],
          _splitData_T == 4'hD ? pickData[7:0] : _GEN_24[111:104],
          _splitData_T == 4'hC ? pickData[7:0] : _GEN_24[103:96],
          _splitData_T == 4'hB ? pickData[7:0] : _GEN_24[95:88],
          _splitData_T == 4'hA ? pickData[7:0] : _GEN_24[87:80],
          _splitData_T == 4'h9 ? pickData[7:0] : _GEN_24[79:72],
          _splitData_T == 4'h8 ? pickData[7:0] : _GEN_24[71:64],
          _splitData_T == 4'h7 ? pickData[7:0] : _GEN_24[63:56],
          _splitData_T == 4'h6 ? pickData[7:0] : _GEN_24[55:48],
          _splitData_T == 4'h5 ? pickData[7:0] : _GEN_24[47:40],
          _splitData_T == 4'h4 ? pickData[7:0] : _GEN_24[39:32],
          _splitData_T == 4'h3 ? pickData[7:0] : _GEN_24[31:24],
          _splitData_T == 4'h2 ? pickData[7:0] : _GEN_24[23:16],
          _splitData_T == 4'h1 ? pickData[7:0] : _GEN_24[15:8],
          _splitData_T == 4'h0 ? pickData[7:0] : _GEN_24[7:0]})
    | (instMicroOp_alignedType[1:0] == 2'h1
         ? {(&_splitData_T_65) ? pickData[15:0] : _GEN_24[127:112],
            _splitData_T_65 == 3'h6 ? pickData[15:0] : _GEN_24[111:96],
            _splitData_T_65 == 3'h5 ? pickData[15:0] : _GEN_24[95:80],
            _splitData_T_65 == 3'h4 ? pickData[15:0] : _GEN_24[79:64],
            _splitData_T_65 == 3'h3 ? pickData[15:0] : _GEN_24[63:48],
            _splitData_T_65 == 3'h2 ? pickData[15:0] : _GEN_24[47:32],
            _splitData_T_65 == 3'h1 ? pickData[15:0] : _GEN_24[31:16],
            _splitData_T_65 == 3'h0 ? pickData[15:0] : _GEN_24[15:0]}
         : 128'h0)
    | (instMicroOp_alignedType[1:0] == 2'h2
         ? {(&_splitData_T_98) ? pickData[31:0] : _GEN_24[127:96],
            _splitData_T_98 == 2'h2 ? pickData[31:0] : _GEN_24[95:64],
            _splitData_T_98 == 2'h1 ? pickData[31:0] : _GEN_24[63:32],
            _splitData_T_98 == 2'h0 ? pickData[31:0] : _GEN_24[31:0]}
         : 128'h0)
    | ((&(instMicroOp_alignedType[1:0]))
         ? {_splitData_T_119 ? pickData : _GEN_24[127:64],
            _splitData_T_119 ? _GEN_24[63:0] : pickData}
         : 128'h0);
  ...
  wire [6:0]        _GEN_84 = _GEN_83[deqPtr_value];
  wire [2:0]        _vdIdxInField_T_2 =
    io_in_bits_uop_fuOpType[5] ? instMicroOp_uop_vpu_vlmul : _issueEmul_T_3;
  wire [2:0]        vdIdxInField =
    {1'h0,
     {1'h0, _vdIdxInField_T_2 == 3'h1 & _GEN_84[0]}
       | (_vdIdxInField_T_2 == 3'h2 ? _GEN_84[1:0] : 2'h0)}
    | (_vdIdxInField_T_2 == 3'h3 ? _GEN_84[2:0] : 3'h0);
  always @(posedge clock) begin
      ...
      instMicroOp_uopFlowNumMask <=
        8'({3'h0,
            (io_in_bits_uop_fuOpType[6:5] == 2'h0
               ? {_GEN_37, &_emul_T_3, _uopFlowNum_T_158, _uopFlowNum_T_157, 1'h0}
                 >> _GEN_36
               : 5'h0)
    ...
    if (_GEN_2) begin
      instMicroOp_uop_exceptionVec_3 <= triggerBreakpoint & canTriggerException;
      instMicroOp_uop_exceptionVec_7 <=
      ...
      instMicroOp_uop_exceptionVec_3 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_3;
      if (_GEN_19) begin
        instMicroOp_uop_exceptionVec_7 <=
        ...
        instMicroOp_uop_exceptionVec_7 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_7;
        instMicroOp_uop_exceptionVec_13 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_13;
        instMicroOp_uop_exceptionVec_15 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_15;
        instMicroOp_uop_exceptionVec_21 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_21;
        instMicroOp_uop_exceptionVec_23 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_23;
      end
    end
    if (_GEN_22 & canTriggerException) begin
      instMicroOp_uop_exceptionVec_5 <=
      ...
      if (_GEN_2)
        ...
        instMicroOp_uop_exceptionVec_5 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_5;
      instMicroOp_uop_exceptionVec_19 <= ~_GEN_14 & instMicroOp_uop_exceptionVec_19;
    end
    ...
    if (_GEN_19 & ~io_dtlb_resp_bits_miss) begin
    ...
    if (_GEN_22 & canTriggerException | _GEN_2 & _GEN_20 & canTriggerException)
      instMicroOp_exceptionVstart <= segmentIdx;
    if (~_GEN_22 & ~(_GEN_2 & _GEN_20) | canTriggerException) begin
      if (_GEN_14)
        instMicroOp_exceptionVl_bits <= io_in_bits_src_4[7:0];
    end
    else
      instMicroOp_exceptionVl_bits <= segmentIdx;
    if (_GEN_25 & splitPtr_value == 3'h0)
      data_0 <= mergedData;
    else if (_GEN_63)
      data_0 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h1)
      data_1 <= mergedData;
    else if (_GEN_64)
      data_1 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h2)
      data_2 <= mergedData;
    else if (_GEN_65)
      data_2 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h3)
      data_3 <= mergedData;
    else if (_GEN_66)
      data_3 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h4)
      data_4 <= mergedData;
    else if (_GEN_67)
      data_4 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h5)
      data_5 <= mergedData;
    else if (_GEN_68)
      data_5 <= io_in_bits_src_2;
    if (_GEN_25 & splitPtr_value == 3'h6)
      data_6 <= mergedData;
    else if (_GEN_69)
      data_6 <= io_in_bits_src_2;
    if (_GEN_25 & (&splitPtr_value))
      data_7 <= mergedData;
    else if (_GEN_70)
    ...
    if (writebackValid) begin
      ...
      io_uopwriteback_bits_r_uop_vecWen <=
        fofFixVlValid ? fofBuffer_vecWen : _GEN_54[deqPtr_value];
      io_uopwriteback_bits_r_uop_v0Wen <=
        fofFixVlValid ? fofBuffer_v0Wen : _GEN_55[deqPtr_value];
      io_uopwriteback_bits_r_uop_vlWen <=
        fofFixVlValid ? fofBuffer_vlWen : _GEN_56[deqPtr_value];
      ...
      io_uopwriteback_bits_r_uop_vpu_vstart <=
        fofFixVlValid
          ...
          : (|_GEN_35) | instMicroOp_uop_trigger == 4'h1
              ? instMicroOp_exceptionVstart
              : 8'h0;
      io_uopwriteback_bits_r_uop_vpu_vuopIdx <=
        fofFixVlValid ? fofBuffer_vpu_vuopIdx : _GEN_84;
      io_uopwriteback_bits_r_uop_vpu_vmask <=
        fofFixVlValid
          ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
          : {112'h0, _GEN_57[vdIdxInField]};
      ...
      io_uopwriteback_bits_r_uop_pdest <=
        fofFixVlValid ? fofBuffer_pdest : _GEN_58[deqPtr_value];
      ...
      io_uopwriteback_bits_r_data <=
        fofFixVlValid ? {120'h0, instMicroOp_exceptionVl_bits} : _GEN_23[deqPtr_value];
    end
    ...
    if (feedbackValid) begin
      io_feedback_bits_r_sqIdx_flag <= _GEN_59[deqPtr_value];
      io_feedback_bits_r_sqIdx_value <= _GEN_60[deqPtr_value];
      io_feedback_bits_r_lqIdx_flag <= _GEN_61[deqPtr_value];
      io_feedback_bits_r_lqIdx_value <= _GEN_62[deqPtr_value];
    end
  end // always @(posedge)
  ...
  wire [15:0]       _GEN_89 =
    _GEN_88[15:0]
    | (latchVaddr[3:0] == 4'hE ? io_rdcache_resp_bits_data_delayed[127:112] : 16'h0);
  wire              _GEN_90 = _GEN_2 & isMisalignWire & ~_GEN_20;
  wire              _GEN_91 =
    _io_exceptionInfo_valid_T | _segmentInactiveFinish_T | _GEN_21;
  wire              _GEN_92 = stateNext == 4'hA;
  wire [3:0]        _GEN_93 = {deqPtr_flag, deqPtr_value};
  wire [7:0]        _GEN_94 = {5'h0, issueMaxIdxInIndexLog2};
  ...
  wire [7:0]        _strideOffsetWire_T_2 =
    (_GEN_13
       ...
       : _GEN_33
           ...
           : _GEN_34 ? _segmentIdxWire_T_2[7:0] : segmentIdx) >> _GEN_94;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      instMicroOpValid <= (|stateNext) & (_GEN_14 | instMicroOpValid);
      if (_GEN_15) begin
      ...
      if (_GEN_13 | _GEN_33 | _GEN_34) begin
        if (_GEN_13)
          segmentIdx <= 8'h0;
        else if (_GEN_33)
      ...
      if (_GEN_13 | _GEN_30 | segmentInactiveFinish) begin
        if (_GEN_13)
          fieldIdx <= 4'h0;
      ...
      if (_GEN_31 | segmentInactiveFinish)
        segmentOffset <=
          64'(segmentOffset
              + (instMicroOp_uop_fuOpType[6:5] == 2'h0
                   ? {57'h0, {3'h0, 4'(_GEN_7 + 4'h1)} << instMicroOp_uop_vpu_veew}
                   : _GEN_16[3'(deqPtr_value
                                + (instMicroOp_uop_fuOpType[5]
                                     ? _strideOffset_T_2[2:0]
                                     : 3'h0))][63:0]));
      else if (_GEN_14)
        segmentOffset <= 64'h0;
      if (_segmentInactiveFinish_T | _GEN_21
      ...
      curPtr <=
        ...
        & (instMicroOp_isVSegLoad
             ...
             : isMisalignWire & ~notCross16ByteReg & _GEN_2
                 ? ~curPtr
                 : ~(_GEN_3 & _GEN_2 & _GEN_92)
                   & (_GEN_3 & _segmentInactiveFinish_T_1 & _GEN_92 & _GEN_10 ^ curPtr));
      isMisalignReg <= ~_GEN_91 & (_GEN_90 | ~_GEN_14 & isMisalignReg);
      notCross16ByteReg <=
        ~_GEN_91 & (_GEN_90 ? notCross16ByteWire : ~_GEN_14 & notCross16ByteReg);
      ...
      if (_GEN_19 & ~io_dtlb_resp_bits_miss & ~curPtr)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:552];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h229; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        instMicroOp_paddr = {_RANDOM[10'h2A][31:13], _RANDOM[10'h2B][28:0]};
        instMicroOp_mask =
          {_RANDOM[10'h2B][31:29],
           _RANDOM[10'h2C],
           _RANDOM[10'h2D],
           _RANDOM[10'h2E],
           _RANDOM[10'h2F][28:0]};
        instMicroOp_alignedType = _RANDOM[10'h2F][31:29];
        instMicroOp_vl = _RANDOM[10'h30][7:0];
        instMicroOp_uopFlowNumMask = _RANDOM[10'h30][23:16];
        instMicroOp_isVSegLoad = _RANDOM[10'h30][24];
        instMicroOp_isVSegStore = _RANDOM[10'h30][25];
        instMicroOp_exceptionVaddr =
          {_RANDOM[10'h31][31:2], _RANDOM[10'h32], _RANDOM[10'h33][1:0]};
        instMicroOp_exceptionGpaddr =
          {_RANDOM[10'h33][31:2], _RANDOM[10'h34], _RANDOM[10'h35][1:0]};
        instMicroOp_exceptionIsForVSnonLeafPTE = _RANDOM[10'h35][2];
        instMicroOp_exceptionVstart = _RANDOM[10'h35][13:6];
        instMicroOp_exceptionVl_bits = _RANDOM[10'h35][22:15];
        instMicroOp_isFof = _RANDOM[10'h35][23];
        instMicroOpValid = _RANDOM[10'h35][24];
        data_0 =
          {_RANDOM[10'h35][31:25],
           _RANDOM[10'h36],
           _RANDOM[10'h37],
           _RANDOM[10'h38],
           _RANDOM[10'h39][24:0]};
        data_1 =
          {_RANDOM[10'h39][31:25],
           _RANDOM[10'h3A],
           _RANDOM[10'h3B],
           _RANDOM[10'h3C],
           _RANDOM[10'h3D][24:0]};
        data_2 =
          {_RANDOM[10'h3D][31:25],
           _RANDOM[10'h3E],
           _RANDOM[10'h3F],
           _RANDOM[10'h40],
           _RANDOM[10'h41][24:0]};
        data_3 =
          {_RANDOM[10'h41][31:25],
           _RANDOM[10'h42],
           _RANDOM[10'h43],
           _RANDOM[10'h44],
           _RANDOM[10'h45][24:0]};
        data_4 =
          {_RANDOM[10'h45][31:25],
           _RANDOM[10'h46],
           _RANDOM[10'h47],
           _RANDOM[10'h48],
           _RANDOM[10'h49][24:0]};
        data_5 =
          {_RANDOM[10'h49][31:25],
           _RANDOM[10'h4A],
           _RANDOM[10'h4B],
           _RANDOM[10'h4C],
           _RANDOM[10'h4D][24:0]};
        data_6 =
          {_RANDOM[10'h4D][31:25],
           _RANDOM[10'h4E],
           _RANDOM[10'h4F],
           _RANDOM[10'h50],
           _RANDOM[10'h51][24:0]};
        data_7 =
          {_RANDOM[10'h51][31:25],
           _RANDOM[10'h52],
           _RANDOM[10'h53],
           _RANDOM[10'h54],
           _RANDOM[10'h55][24:0]};
        uopq_0_uop_vecWen = _RANDOM[10'h5C][14];
        uopq_0_uop_v0Wen = _RANDOM[10'h5C][15];
        uopq_0_uop_vlWen = _RANDOM[10'h5C][16];
        uopq_0_uop_vpu_vuopIdx = _RANDOM[10'h5F][15:9];
        uopq_0_uop_pdest = _RANDOM[10'h67][24:17];
        uopq_0_uop_lqIdx_flag = _RANDOM[10'h7D][16];
        uopq_0_uop_lqIdx_value = _RANDOM[10'h7D][23:17];
        uopq_0_uop_sqIdx_flag = _RANDOM[10'h7D][24];
        uopq_0_uop_sqIdx_value = _RANDOM[10'h7D][30:25];
        uopq_1_uop_vecWen = _RANDOM[10'h84][27];
        uopq_1_uop_v0Wen = _RANDOM[10'h84][28];
        uopq_1_uop_vlWen = _RANDOM[10'h84][29];
        uopq_1_uop_vpu_vuopIdx = _RANDOM[10'h87][28:22];
        uopq_1_uop_pdest = {_RANDOM[10'h8F][31:30], _RANDOM[10'h90][5:0]};
        uopq_1_uop_lqIdx_flag = _RANDOM[10'hA5][29];
        uopq_1_uop_lqIdx_value = {_RANDOM[10'hA5][31:30], _RANDOM[10'hA6][4:0]};
        uopq_1_uop_sqIdx_flag = _RANDOM[10'hA6][5];
        uopq_1_uop_sqIdx_value = _RANDOM[10'hA6][11:6];
        uopq_2_uop_vecWen = _RANDOM[10'hAD][8];
        uopq_2_uop_v0Wen = _RANDOM[10'hAD][9];
        uopq_2_uop_vlWen = _RANDOM[10'hAD][10];
        uopq_2_uop_vpu_vuopIdx = _RANDOM[10'hB0][9:3];
        uopq_2_uop_pdest = _RANDOM[10'hB8][18:11];
        uopq_2_uop_lqIdx_flag = _RANDOM[10'hCE][10];
        uopq_2_uop_lqIdx_value = _RANDOM[10'hCE][17:11];
        uopq_2_uop_sqIdx_flag = _RANDOM[10'hCE][18];
        uopq_2_uop_sqIdx_value = _RANDOM[10'hCE][24:19];
        uopq_3_uop_vecWen = _RANDOM[10'hD5][21];
        uopq_3_uop_v0Wen = _RANDOM[10'hD5][22];
        uopq_3_uop_vlWen = _RANDOM[10'hD5][23];
        uopq_3_uop_vpu_vuopIdx = _RANDOM[10'hD8][22:16];
        uopq_3_uop_pdest = _RANDOM[10'hE0][31:24];
        uopq_3_uop_lqIdx_flag = _RANDOM[10'hF6][23];
        uopq_3_uop_lqIdx_value = _RANDOM[10'hF6][30:24];
        uopq_3_uop_sqIdx_flag = _RANDOM[10'hF6][31];
        uopq_3_uop_sqIdx_value = _RANDOM[10'hF7][5:0];
        uopq_4_uop_vecWen = _RANDOM[10'hFE][2];
        uopq_4_uop_v0Wen = _RANDOM[10'hFE][3];
        uopq_4_uop_vlWen = _RANDOM[10'hFE][4];
        uopq_4_uop_vpu_vuopIdx = {_RANDOM[10'h100][31:29], _RANDOM[10'h101][3:0]};
        uopq_4_uop_pdest = _RANDOM[10'h109][12:5];
        uopq_4_uop_lqIdx_flag = _RANDOM[10'h11F][4];
        uopq_4_uop_lqIdx_value = _RANDOM[10'h11F][11:5];
        uopq_4_uop_sqIdx_flag = _RANDOM[10'h11F][12];
        uopq_4_uop_sqIdx_value = _RANDOM[10'h11F][18:13];
        uopq_5_uop_vecWen = _RANDOM[10'h126][15];
        uopq_5_uop_v0Wen = _RANDOM[10'h126][16];
        uopq_5_uop_vlWen = _RANDOM[10'h126][17];
        uopq_5_uop_vpu_vuopIdx = _RANDOM[10'h129][16:10];
        uopq_5_uop_pdest = _RANDOM[10'h131][25:18];
        uopq_5_uop_lqIdx_flag = _RANDOM[10'h147][17];
        uopq_5_uop_lqIdx_value = _RANDOM[10'h147][24:18];
        uopq_5_uop_sqIdx_flag = _RANDOM[10'h147][25];
        uopq_5_uop_sqIdx_value = _RANDOM[10'h147][31:26];
        uopq_6_uop_vecWen = _RANDOM[10'h14E][28];
        uopq_6_uop_v0Wen = _RANDOM[10'h14E][29];
        uopq_6_uop_vlWen = _RANDOM[10'h14E][30];
        uopq_6_uop_vpu_vuopIdx = _RANDOM[10'h151][29:23];
        uopq_6_uop_pdest = {_RANDOM[10'h159][31], _RANDOM[10'h15A][6:0]};
        uopq_6_uop_lqIdx_flag = _RANDOM[10'h16F][30];
        uopq_6_uop_lqIdx_value = {_RANDOM[10'h16F][31], _RANDOM[10'h170][5:0]};
        uopq_6_uop_sqIdx_flag = _RANDOM[10'h170][6];
        uopq_6_uop_sqIdx_value = _RANDOM[10'h170][12:7];
        uopq_7_uop_vecWen = _RANDOM[10'h177][9];
        uopq_7_uop_v0Wen = _RANDOM[10'h177][10];
        uopq_7_uop_vlWen = _RANDOM[10'h177][11];
        uopq_7_uop_vpu_vuopIdx = _RANDOM[10'h17A][10:4];
        uopq_7_uop_pdest = _RANDOM[10'h182][19:12];
        uopq_7_uop_lqIdx_flag = _RANDOM[10'h198][11];
        uopq_7_uop_lqIdx_value = _RANDOM[10'h198][18:12];
        uopq_7_uop_sqIdx_flag = _RANDOM[10'h198][19];
        uopq_7_uop_sqIdx_value = _RANDOM[10'h198][25:20];
        stride_0 =
          {_RANDOM[10'h199][31:1],
           _RANDOM[10'h19A],
           _RANDOM[10'h19B],
           _RANDOM[10'h19C],
           _RANDOM[10'h19D][0]};
        stride_1 =
          {_RANDOM[10'h19D][31:1],
           _RANDOM[10'h19E],
           _RANDOM[10'h19F],
           _RANDOM[10'h1A0],
           _RANDOM[10'h1A1][0]};
        stride_2 =
          {_RANDOM[10'h1A1][31:1],
           _RANDOM[10'h1A2],
           _RANDOM[10'h1A3],
           _RANDOM[10'h1A4],
           _RANDOM[10'h1A5][0]};
        stride_3 =
          {_RANDOM[10'h1A5][31:1],
           _RANDOM[10'h1A6],
           _RANDOM[10'h1A7],
           _RANDOM[10'h1A8],
           _RANDOM[10'h1A9][0]};
        stride_4 =
          {_RANDOM[10'h1A9][31:1],
           _RANDOM[10'h1AA],
           _RANDOM[10'h1AB],
           _RANDOM[10'h1AC],
           _RANDOM[10'h1AD][0]};
        stride_5 =
          {_RANDOM[10'h1AD][31:1],
           _RANDOM[10'h1AE],
           _RANDOM[10'h1AF],
           _RANDOM[10'h1B0],
           _RANDOM[10'h1B1][0]};
        stride_6 =
          {_RANDOM[10'h1B1][31:1],
           _RANDOM[10'h1B2],
           _RANDOM[10'h1B3],
           _RANDOM[10'h1B4],
           _RANDOM[10'h1B5][0]};
        stride_7 =
          {_RANDOM[10'h1B5][31:1],
           _RANDOM[10'h1B6],
           _RANDOM[10'h1B7],
           _RANDOM[10'h1B8],
           _RANDOM[10'h1B9][0]};
        enqPtr_flag = _RANDOM[10'h1B9][9];
        enqPtr_value = _RANDOM[10'h1B9][12:10];
        deqPtr_flag = _RANDOM[10'h1B9][13];
        deqPtr_value = _RANDOM[10'h1B9][16:14];
        stridePtrReg_value = _RANDOM[10'h1B9][20:18];
        segmentIdx = _RANDOM[10'h1B9][28:21];
        fieldIdx = {_RANDOM[10'h1B9][31:29], _RANDOM[10'h1BA][0]};
        segmentOffset = {_RANDOM[10'h1BA][31:1], _RANDOM[10'h1BB], _RANDOM[10'h1BC][0]};
        splitPtr_flag = _RANDOM[10'h1BC][1];
        splitPtr_value = _RANDOM[10'h1BC][4:2];
        latchVaddr = {_RANDOM[10'h1BC][31:5], _RANDOM[10'h1BD], _RANDOM[10'h1BE][4:0]};
        latchVaddrDup = {_RANDOM[10'h1BE][31:5], _RANDOM[10'h1BF], _RANDOM[10'h1C0][4:0]};
        issueMaxIdxInIndexLog2 = _RANDOM[10'h1C0][7:5];
        fofBuffer_fuOpType = _RANDOM[10'h1C6][26:18];
        fofBuffer_vecWen = _RANDOM[10'h1C6][29];
        fofBuffer_v0Wen = _RANDOM[10'h1C6][30];
        fofBuffer_vlWen = _RANDOM[10'h1C6][31];
        fofBuffer_vpu_vma = _RANDOM[10'h1C8][20];
        fofBuffer_vpu_vta = _RANDOM[10'h1C8][21];
        fofBuffer_vpu_vsew = _RANDOM[10'h1C8][23:22];
        fofBuffer_vpu_vlmul = _RANDOM[10'h1C8][26:24];
        fofBuffer_vpu_vm = _RANDOM[10'h1C9][3];
        fofBuffer_vpu_vstart = _RANDOM[10'h1C9][11:4];
        fofBuffer_vpu_vuopIdx = _RANDOM[10'h1C9][30:24];
        fofBuffer_vpu_nf = _RANDOM[10'h1CE][10:8];
        fofBuffer_vpu_veew = _RANDOM[10'h1CE][12:11];
        fofBuffer_pdest = _RANDOM[10'h1D2][7:0];
        fofBuffer_robIdx_flag = _RANDOM[10'h1D2][20];
        fofBuffer_robIdx_value = _RANDOM[10'h1D2][28:21];
        fofBufferValid = _RANDOM[10'h1E8][21];
        state = _RANDOM[10'h1E8][25:22];
        curPtr = _RANDOM[10'h1E8][26];
        isMisalignReg = _RANDOM[10'h1E8][27];
        notCross16ByteReg = _RANDOM[10'h1E8][28];
        combinedData =
          {_RANDOM[10'h1E8][31:29], _RANDOM[10'h1E9], _RANDOM[10'h1EA][28:0]};
        lowPagePaddr =
          {_RANDOM[10'h1EA][31:29], _RANDOM[10'h1EB], _RANDOM[10'h1EC][12:0]};
        triggerDebugMode = _RANDOM[10'h1F1][1];
        triggerBreakpoint = _RANDOM[10'h1F1][2];
        last_REG = _RANDOM[10'h1F1][3];
        nextBaseVaddr_r =
          {_RANDOM[10'h1F1][31:4], _RANDOM[10'h1F2], _RANDOM[10'h1F3][3:0]};
        io_uopwriteback_valid_REG = _RANDOM[10'h1F3][4];
        io_uopwriteback_bits_r_uop_exceptionVec_3 = _RANDOM[10'h1F6][4];
        io_uopwriteback_bits_r_uop_exceptionVec_5 = _RANDOM[10'h1F6][6];
        io_uopwriteback_bits_r_uop_exceptionVec_7 = _RANDOM[10'h1F6][8];
        io_uopwriteback_bits_r_uop_exceptionVec_13 = _RANDOM[10'h1F6][14];
        io_uopwriteback_bits_r_uop_exceptionVec_15 = _RANDOM[10'h1F6][16];
        io_uopwriteback_bits_r_uop_exceptionVec_19 = _RANDOM[10'h1F6][20];
        io_uopwriteback_bits_r_uop_exceptionVec_21 = _RANDOM[10'h1F6][22];
        io_uopwriteback_bits_r_uop_exceptionVec_23 = _RANDOM[10'h1F6][24];
        io_uopwriteback_bits_r_uop_trigger = _RANDOM[10'h1F6][30:27];
        io_uopwriteback_bits_r_uop_fuOpType = _RANDOM[10'h1F9][23:15];
        io_uopwriteback_bits_r_uop_vecWen = _RANDOM[10'h1F9][26];
        io_uopwriteback_bits_r_uop_v0Wen = _RANDOM[10'h1F9][27];
        io_uopwriteback_bits_r_uop_vlWen = _RANDOM[10'h1F9][28];
        io_uopwriteback_bits_r_uop_vpu_vma = _RANDOM[10'h1FB][17];
        io_uopwriteback_bits_r_uop_vpu_vta = _RANDOM[10'h1FB][18];
        io_uopwriteback_bits_r_uop_vpu_vsew = _RANDOM[10'h1FB][20:19];
        io_uopwriteback_bits_r_uop_vpu_vlmul = _RANDOM[10'h1FB][23:21];
        io_uopwriteback_bits_r_uop_vpu_vm = _RANDOM[10'h1FC][0];
        io_uopwriteback_bits_r_uop_vpu_vstart = _RANDOM[10'h1FC][8:1];
        io_uopwriteback_bits_r_uop_vpu_vuopIdx = _RANDOM[10'h1FC][27:21];
        io_uopwriteback_bits_r_uop_vpu_vmask =
          {_RANDOM[10'h1FC][31:29],
           _RANDOM[10'h1FD],
           _RANDOM[10'h1FE],
           _RANDOM[10'h1FF],
           _RANDOM[10'h200][28:0]};
        io_uopwriteback_bits_r_uop_vpu_vl =
          {_RANDOM[10'h200][31:29], _RANDOM[10'h201][4:0]};
        io_uopwriteback_bits_r_uop_vpu_nf = _RANDOM[10'h201][7:5];
        io_uopwriteback_bits_r_uop_vpu_veew = _RANDOM[10'h201][9:8];
        io_uopwriteback_bits_r_uop_pdest =
          {_RANDOM[10'h204][31:29], _RANDOM[10'h205][4:0]};
        io_uopwriteback_bits_r_uop_robIdx_flag = _RANDOM[10'h205][17];
        io_uopwriteback_bits_r_uop_robIdx_value = _RANDOM[10'h205][25:18];
        io_uopwriteback_bits_r_data =
          {_RANDOM[10'h21B][31:18],
           _RANDOM[10'h21C],
           _RANDOM[10'h21D],
           _RANDOM[10'h21E],
           _RANDOM[10'h21F][17:0]};
        io_uopwriteback_bits_r_vdIdx = _RANDOM[10'h223][20:18];
        io_uopwriteback_bits_r_vdIdxInField = _RANDOM[10'h223][23:21];
        io_feedback_valid_REG = _RANDOM[10'h227][10];
        io_feedback_bits_r_sqIdx_flag = _RANDOM[10'h228][1];
        io_feedback_bits_r_sqIdx_value = _RANDOM[10'h228][7:2];
        io_feedback_bits_r_lqIdx_flag = _RANDOM[10'h228][8];
        io_feedback_bits_r_lqIdx_value = _RANDOM[10'h228][15:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        instMicroOpValid = 1'h0;
        enqPtr_flag = 1'h0;
  ...
  NewPipelineConnectPipe_33 VSegmentUnitPipelineConnect (
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_bits_vaddr
      (isMisalignReg
         ? (notCross16ByteReg
              ...
              : curPtr ? 50'(_GEN_28 + 50'h8) : _GEN_28)
         : latchVaddr[49:0]),
    .io_in_bits_data
      (isMisalignReg
         ? (notCross16ByteReg
  ...
  assign io_exceptionInfo_valid =
    _io_exceptionInfo_valid_T & (|_GEN_35)
    & _io_exceptionInfo_valid_T_4 != _io_exceptionInfo_valid_T_5;
