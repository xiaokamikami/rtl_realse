...
module LoadMisalignBuffer(
  ...
  input  [7:0]   io_splitLoadResp_bits_uop_robIdx_value,
  ...
  wire             _GEN_65 = _GEN_55 == 11'h0;
  wire             _GEN_66 = isUncache | hasException;
  wire             flush =
  ...
  wire             _GEN_67 = _GEN_56 & (req_isvec ? io_vecWriteBack_valid_0 : _GEN_57);
  wire [2:0]       _GEN_68 = _GEN_67 ? 3'h0 : bufferState;
  wire             _GEN_69 = _GEN_58 | ~_GEN_67;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (flush) begin
        ...
        bufferState <= _GEN_70[bufferState];
        if (_GEN_64) begin
          if (_GEN_66)
            unSentLoads <= 2'h0;
          else if (_GEN_65)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_storeSetHit = _RANDOM[9'h27][7];
        req_uop_waitForRobIdx_flag = _RANDOM[9'h27][8];
        req_uop_waitForRobIdx_value = _RANDOM[9'h27][16:9];
        req_uop_loadWaitBit = _RANDOM[9'h27][17];
        req_uop_loadWaitStrict = _RANDOM[9'h27][18];
        req_uop_lqIdx_flag = _RANDOM[9'h27][24];
        req_uop_lqIdx_value = _RANDOM[9'h27][31:25];
        ...
        req_elemIdxInsideVd = {_RANDOM[9'h39][31:26], _RANDOM[9'h3A][1:0]};
        req_vecTriggerMask = _RANDOM[9'h3D][22:7];
        bufferState = _RANDOM[9'h52][15:13];
        splitLoadReqs_0_uop_exceptionVec_3 = _RANDOM[9'h55][15];
        splitLoadReqs_0_uop_exceptionVec_4 = _RANDOM[9'h55][16];
        splitLoadReqs_0_uop_exceptionVec_5 = _RANDOM[9'h55][17];
        splitLoadReqs_0_uop_exceptionVec_13 = _RANDOM[9'h55][25];
        splitLoadReqs_0_uop_exceptionVec_19 = _RANDOM[9'h55][31];
        splitLoadReqs_0_uop_exceptionVec_21 = _RANDOM[9'h56][1];
        splitLoadReqs_0_uop_trigger = _RANDOM[9'h56][9:6];
        splitLoadReqs_0_uop_preDecodeInfo_isRVC = _RANDOM[9'h56][11];
        splitLoadReqs_0_uop_ftqPtr_flag = _RANDOM[9'h56][18];
        splitLoadReqs_0_uop_ftqPtr_value = _RANDOM[9'h56][24:19];
        splitLoadReqs_0_uop_ftqOffset = _RANDOM[9'h56][28:25];
        splitLoadReqs_0_uop_fuOpType = {_RANDOM[9'h58][31:26], _RANDOM[9'h59][2:0]};
        splitLoadReqs_0_uop_rfWen = _RANDOM[9'h59][3];
        splitLoadReqs_0_uop_fpWen = _RANDOM[9'h59][4];
        splitLoadReqs_0_uop_vpu_vstart = _RANDOM[9'h5B][19:12];
        splitLoadReqs_0_uop_vpu_veew = _RANDOM[9'h60][20:19];
        splitLoadReqs_0_uop_pdest = _RANDOM[9'h64][15:8];
        splitLoadReqs_0_uop_robIdx_flag = _RANDOM[9'h64][28];
        splitLoadReqs_0_uop_robIdx_value = {_RANDOM[9'h64][31:29], _RANDOM[9'h65][4:0]};
        splitLoadReqs_0_uop_storeSetHit = _RANDOM[9'h79][22];
        splitLoadReqs_0_uop_waitForRobIdx_flag = _RANDOM[9'h79][23];
        splitLoadReqs_0_uop_waitForRobIdx_value = _RANDOM[9'h79][31:24];
        splitLoadReqs_0_uop_loadWaitBit = _RANDOM[9'h7A][0];
        splitLoadReqs_0_uop_loadWaitStrict = _RANDOM[9'h7A][1];
        splitLoadReqs_0_uop_lqIdx_flag = _RANDOM[9'h7A][7];
        splitLoadReqs_0_uop_lqIdx_value = _RANDOM[9'h7A][14:8];
        splitLoadReqs_0_uop_sqIdx_flag = _RANDOM[9'h7A][15];
        splitLoadReqs_0_uop_sqIdx_value = _RANDOM[9'h7A][21:16];
        splitLoadReqs_0_vaddr =
          {_RANDOM[9'h7A][31:29], _RANDOM[9'h7B], _RANDOM[9'h7C][14:0]};
        splitLoadReqs_0_fullva =
          {_RANDOM[9'h7C][31:15], _RANDOM[9'h7D], _RANDOM[9'h7E][14:0]};
        splitLoadReqs_0_mask = _RANDOM[9'h82][15:0];
        splitLoadReqs_0_nc = _RANDOM[9'h86][22];
        splitLoadReqs_0_mmio = _RANDOM[9'h86][23];
        splitLoadReqs_0_memBackTypeMM = _RANDOM[9'h86][24];
        splitLoadReqs_0_is128bit = _RANDOM[9'h8B][19];
        splitLoadReqs_0_vecActive = _RANDOM[9'h90][6];
        splitLoadReqs_0_mshrid = _RANDOM[9'h90][20:17];
        splitLoadReqs_0_schedIndex = {_RANDOM[9'h90][31:29], _RANDOM[9'h91][3:0]};
        splitLoadReqs_1_uop_exceptionVec_3 = _RANDOM[9'h94][10];
        splitLoadReqs_1_uop_exceptionVec_4 = _RANDOM[9'h94][11];
        splitLoadReqs_1_uop_exceptionVec_5 = _RANDOM[9'h94][12];
        splitLoadReqs_1_uop_exceptionVec_13 = _RANDOM[9'h94][20];
        splitLoadReqs_1_uop_exceptionVec_19 = _RANDOM[9'h94][26];
        splitLoadReqs_1_uop_exceptionVec_21 = _RANDOM[9'h94][28];
        splitLoadReqs_1_uop_trigger = _RANDOM[9'h95][4:1];
        splitLoadReqs_1_uop_preDecodeInfo_isRVC = _RANDOM[9'h95][6];
        splitLoadReqs_1_uop_ftqPtr_flag = _RANDOM[9'h95][13];
        splitLoadReqs_1_uop_ftqPtr_value = _RANDOM[9'h95][19:14];
        splitLoadReqs_1_uop_ftqOffset = _RANDOM[9'h95][23:20];
        splitLoadReqs_1_uop_fuOpType = _RANDOM[9'h97][29:21];
        splitLoadReqs_1_uop_rfWen = _RANDOM[9'h97][30];
        splitLoadReqs_1_uop_fpWen = _RANDOM[9'h97][31];
        splitLoadReqs_1_uop_vpu_vstart = _RANDOM[9'h9A][14:7];
        splitLoadReqs_1_uop_vpu_veew = _RANDOM[9'h9F][15:14];
        splitLoadReqs_1_uop_pdest = _RANDOM[9'hA3][10:3];
        splitLoadReqs_1_uop_robIdx_flag = _RANDOM[9'hA3][23];
        splitLoadReqs_1_uop_robIdx_value = _RANDOM[9'hA3][31:24];
        splitLoadReqs_1_uop_storeSetHit = _RANDOM[9'hB8][17];
        splitLoadReqs_1_uop_waitForRobIdx_flag = _RANDOM[9'hB8][18];
        splitLoadReqs_1_uop_waitForRobIdx_value = _RANDOM[9'hB8][26:19];
        splitLoadReqs_1_uop_loadWaitBit = _RANDOM[9'hB8][27];
        splitLoadReqs_1_uop_loadWaitStrict = _RANDOM[9'hB8][28];
        splitLoadReqs_1_uop_lqIdx_flag = _RANDOM[9'hB9][2];
        splitLoadReqs_1_uop_lqIdx_value = _RANDOM[9'hB9][9:3];
        splitLoadReqs_1_uop_sqIdx_flag = _RANDOM[9'hB9][10];
        splitLoadReqs_1_uop_sqIdx_value = _RANDOM[9'hB9][16:11];
        splitLoadReqs_1_vaddr =
          {_RANDOM[9'hB9][31:24], _RANDOM[9'hBA], _RANDOM[9'hBB][9:0]};
        splitLoadReqs_1_fullva =
          {_RANDOM[9'hBB][31:10], _RANDOM[9'hBC], _RANDOM[9'hBD][9:0]};
        splitLoadReqs_1_mask = {_RANDOM[9'hC0][31:27], _RANDOM[9'hC1][10:0]};
        splitLoadReqs_1_nc = _RANDOM[9'hC5][17];
        splitLoadReqs_1_mmio = _RANDOM[9'hC5][18];
        splitLoadReqs_1_memBackTypeMM = _RANDOM[9'hC5][19];
        splitLoadReqs_1_is128bit = _RANDOM[9'hCA][14];
        splitLoadReqs_1_vecActive = _RANDOM[9'hCF][1];
        splitLoadReqs_1_mshrid = _RANDOM[9'hCF][15:12];
        splitLoadReqs_1_schedIndex = _RANDOM[9'hCF][30:24];
        ...
        splitLoadResp_1_data =
          {_RANDOM[9'h152][31:18],
           _RANDOM[9'h153],
           _RANDOM[9'h154],
           _RANDOM[9'h155],
           _RANDOM[9'h156][18:0]};
        exceptionVec_3 = _RANDOM[9'h175][1];
        exceptionVec_4 = _RANDOM[9'h175][2];
        exceptionVec_5 = _RANDOM[9'h175][3];
        exceptionVec_13 = _RANDOM[9'h175][11];
        exceptionVec_19 = _RANDOM[9'h175][17];
        exceptionVec_21 = _RANDOM[9'h175][19];
        unSentLoads = _RANDOM[9'h175][23:22];
        curPtr = _RANDOM[9'h175][24];
        data_select = {_RANDOM[9'h175][31:26], _RANDOM[9'h176][2:0]};
        globalException = _RANDOM[9'h176][3];
        globalUncache = _RANDOM[9'h176][4];
        globalMMIO = _RANDOM[9'h176][5];
        globalNC = _RANDOM[9'h176][6];
        globalMemBackTypeMM = _RANDOM[9'h176][7];
        lowResultShift = _RANDOM[9'h176][10:8];
        lowResultWidth = _RANDOM[9'h176][13:11];
        highResultShift = _RANDOM[9'h176][16:14];
        highResultWidth = _RANDOM[9'h176][19:17];
        combinedData = {_RANDOM[9'h176][31:20], _RANDOM[9'h177], _RANDOM[9'h178][19:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        bufferState = 3'h0;
