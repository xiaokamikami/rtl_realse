...
module MainPipe(
  ...
  wire [3:0]        _s1_repl_way_en_T_3 =
    io_pseudo_error_valid & s1_has_real_tag_eq_way
      ? (_s1_real_tag_eq_way_T_4
           ? 4'h1
           : _s1_real_tag_eq_way_T_9
               ? 4'h2
               : _s1_real_tag_eq_way_T_14 ? 4'h4 : {_s1_real_tag_eq_way_T_19, 3'h0})
      : s1_req_miss_fail_cause_evict_btot
          ? s1_req_occupy_way
          : 4'h1 << io_replace_way_way;
  reg  [3:0]        s1_repl_way_en_r;
  wire [3:0]        s1_repl_way_en =
    s1_repl_way_en_last_REG ? _s1_repl_way_en_T_3 : s1_repl_way_en_r;
  wire              s1_need_replacement = s1_req_miss & ~s1_tag_match;
  wire [3:0]        s1_way_en =
    io_pseudo_error_valid | s1_need_replacement ? s1_repl_way_en : s1_tag_ecc_match_way;
  reg               s2_valid;
  reg               s2_req_miss;
  ...
  wire              s2_probe_or_atomic =
    (s2_req_probe | _io_error_bits_opType_atom_T & ~s2_sc) & ~s2_req_miss;
  wire              s2_tag_error =
  ...
  wire              store_update_meta =
    _io_replace_access_valid_T_3 & ~s3_req_probe & ~_amo_update_meta_T_3;
  wire              _io_replace_access_valid_T_2 = s3_req_source == 4'h2;
  wire              amo_update_meta =
    _io_replace_access_valid_T_2 & ~s3_req_probe & ~_amo_update_meta_T_3 & ~s3_sc_fail;
    ...
    if (reset) begin
      ...
      if (s2_fire)
        s3_error_beu_r <=
          ...
          | (|{s2_l2_error_tl_denied, s2_l2_error_tl_corrupt});
      if (_GEN_3)
        lrsc_count <= {6{_GEN_4}};
  ...
  wire [15:0][1:0]  _GEN_14 =
    {{2'h3},
     ...
     {2'h0}};
  wire              s1_isStore =
    ~s1_req_replace & ~s1_req_probe & ~s1_req_miss & s1_req_source == 4'h1;
  wire              s1_isAMO =
    ~s1_req_replace & ~s1_req_probe & ~s1_req_miss & s1_req_source == 4'h2
    & s1_req_cmd != 5'h7;
  wire              s2_amo_hit =
  ...
  wire [1:0]        _s1_extra_meta_T_26 =
    {_s1_tag_ecc_match_way_T_2 & io_extra_meta_resp_0_error_tl_denied,
     _s1_tag_ecc_match_way_T_2 & io_extra_meta_resp_0_error_tl_corrupt}
    | {_s1_tag_ecc_match_way_T_5 & io_extra_meta_resp_1_error_tl_denied,
       _s1_tag_ecc_match_way_T_5 & io_extra_meta_resp_1_error_tl_corrupt}
    | {_s1_tag_ecc_match_way_T_8 & io_extra_meta_resp_2_error_tl_denied,
       _s1_tag_ecc_match_way_T_8 & io_extra_meta_resp_2_error_tl_corrupt}
    | {_s1_tag_ecc_match_way_T_11 & io_extra_meta_resp_3_error_tl_denied,
       _s1_tag_ecc_match_way_T_11 & io_extra_meta_resp_3_error_tl_corrupt};
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid & s1_extra_meta_last_REG) begin
      s1_extra_meta_r_error_tl_denied <= _s1_extra_meta_T_26[1];
      s1_extra_meta_r_error_tl_corrupt <= _s1_extra_meta_T_26[0];
    end
    if (s1_valid & s1_repl_way_en_last_REG)
      s1_repl_way_en_r <= _s1_repl_way_en_T_3;
    if (s1_fire) begin
      ...
      s2_real_tag_has_error_r <=
        (s1_repl_way_en[0] ? io_tag_resp_0 : 43'h0)
        | (s1_repl_way_en[1] ? io_tag_resp_1 : 43'h0)
        | (s1_repl_way_en[2] ? io_tag_resp_2 : 43'h0)
        | (s1_repl_way_en[3] ? io_tag_resp_3 : 43'h0);
      ...
      s2_flag_error_tl_denied <=
        s1_extra_meta_last_REG ? _s1_extra_meta_T_26[1] : s1_extra_meta_r_error_tl_denied;
      s2_flag_error_tl_corrupt <=
        s1_extra_meta_last_REG
          ? _s1_extra_meta_T_26[0]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:171];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [7:0] i = 8'h0; i < 8'hAC; i += 8'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        s1_req_occupy_way = _RANDOM[8'h0][19:16];
        s1_req_miss_fail_cause_evict_btot = _RANDOM[8'h0][20];
        s1_req_probe = _RANDOM[8'h0][21];
        s1_req_probe_param = _RANDOM[8'h0][23:22];
        s1_req_probe_need_data = _RANDOM[8'h0][24];
        s1_req_source = _RANDOM[8'h0][28:25];
        s1_req_cmd = {_RANDOM[8'h0][31:29], _RANDOM[8'h1][1:0]};
        s1_req_vaddr = {_RANDOM[8'h1][31:2], _RANDOM[8'h2][19:0]};
        s1_req_addr = {_RANDOM[8'h2][31:20], _RANDOM[8'h3], _RANDOM[8'h4][3:0]};
        s1_req_store_data =
          {_RANDOM[8'h4][31:4],
           _RANDOM[8'h5],
           _RANDOM[8'h6],
           ...
           _RANDOM[8'h13],
           _RANDOM[8'h14][3:0]};
        s1_req_store_mask = {_RANDOM[8'h14][31:4], _RANDOM[8'h15], _RANDOM[8'h16][3:0]};
        s1_req_word_idx = _RANDOM[8'h16][6:4];
        s1_req_amo_data =
          {_RANDOM[8'h16][31:7],
           _RANDOM[8'h17],
           _RANDOM[8'h18],
           _RANDOM[8'h19],
           _RANDOM[8'h1A][6:0]};
        s1_req_amo_mask = _RANDOM[8'h1A][22:7];
        s1_req_amo_cmp =
          {_RANDOM[8'h1A][31:23],
           _RANDOM[8'h1B],
           _RANDOM[8'h1C],
           _RANDOM[8'h1D],
           _RANDOM[8'h1E][22:0]};
        s1_req_replace = _RANDOM[8'h1E][24];
        s1_req_pf_source = _RANDOM[8'h1E][31:29];
        s1_req_access = _RANDOM[8'h1F][0];
        s1_req_id = _RANDOM[8'h1F][6:1];
        ...
        s1_repl_way_en_last_REG = _RANDOM[8'h25][23];
        s1_repl_way_en_r = _RANDOM[8'h25][27:24];
        s2_valid = _RANDOM[8'h25][29];
        s2_req_miss = _RANDOM[8'h25][30];
        s2_req_miss_id = {_RANDOM[8'h25][31], _RANDOM[8'h26][2:0]};
        s2_req_probe = _RANDOM[8'h26][11];
        s2_req_probe_param = _RANDOM[8'h26][13:12];
        s2_req_probe_need_data = _RANDOM[8'h26][14];
        s2_req_source = _RANDOM[8'h26][18:15];
        s2_req_cmd = _RANDOM[8'h26][23:19];
        s2_req_vaddr = {_RANDOM[8'h26][31:24], _RANDOM[8'h27], _RANDOM[8'h28][9:0]};
        s2_req_addr = {_RANDOM[8'h28][31:10], _RANDOM[8'h29][25:0]};
        s2_req_store_data =
          {_RANDOM[8'h29][31:26],
           _RANDOM[8'h2A],
           _RANDOM[8'h2B],
           ...
           _RANDOM[8'h38],
           _RANDOM[8'h39][25:0]};
        s2_req_store_mask = {_RANDOM[8'h39][31:26], _RANDOM[8'h3A], _RANDOM[8'h3B][25:0]};
        s2_req_word_idx = _RANDOM[8'h3B][28:26];
        s2_req_amo_data =
          {_RANDOM[8'h3B][31:29],
           _RANDOM[8'h3C],
           _RANDOM[8'h3D],
           _RANDOM[8'h3E],
           _RANDOM[8'h3F][28:0]};
        s2_req_amo_mask = {_RANDOM[8'h3F][31:29], _RANDOM[8'h40][12:0]};
        s2_req_amo_cmp =
          {_RANDOM[8'h40][31:13],
           _RANDOM[8'h41],
           _RANDOM[8'h42],
           _RANDOM[8'h43],
           _RANDOM[8'h44][12:0]};
        s2_req_replace = _RANDOM[8'h44][14];
        s2_req_pf_source = _RANDOM[8'h44][21:19];
        s2_req_access = _RANDOM[8'h44][22];
        s2_req_id = _RANDOM[8'h44][28:23];
        s2_tag_errors = {_RANDOM[8'h44][31:29], _RANDOM[8'h45][0]};
        s2_tag_match = _RANDOM[8'h45][1];
        s2_has_real_tag_eq_way = _RANDOM[8'h45][2];
        s2_tag_ecc_match_way = _RANDOM[8'h45][6:3];
        s2_hit_coh_state = _RANDOM[8'h45][8:7];
        s2_has_permission = _RANDOM[8'h45][9];
        s2_new_hit_coh_state = _RANDOM[8'h45][11:10];
        s2_grow_perm_r = _RANDOM[8'h45][12];
        s2_repl_tag = {_RANDOM[8'h45][31:13], _RANDOM[8'h46][16:0]};
        s2_repl_coh_state = _RANDOM[8'h46][18:17];
        s2_has_pesudo_inj = _RANDOM[8'h46][22];
        s2_real_tag_has_error_r =
          {_RANDOM[8'h46][31:23], _RANDOM[8'h47], _RANDOM[8'h48][1:0]};
        s2_need_replacement = _RANDOM[8'h48][2];
        s2_need_eviction = _RANDOM[8'h48][3];
        s2_need_data = _RANDOM[8'h48][4];
        s2_need_tag = _RANDOM[8'h48][5];
        s2_way_en = _RANDOM[8'h48][9:6];
        s2_tag_r = {_RANDOM[8'h48][31:10], _RANDOM[8'h49][13:0]};
        s2_coh_r_state = _RANDOM[8'h49][15:14];
        s2_banked_store_wmask = _RANDOM[8'h49][23:16];
        s2_flag_error_tl_denied = _RANDOM[8'h49][24];
        s2_flag_error_tl_corrupt = _RANDOM[8'h49][25];
        s2_can_go_to_mq_no_data_r = _RANDOM[8'h49][26];
        s2_can_go_to_mq = _RANDOM[8'h49][27];
        io_data_readline_can_go_last_REG = _RANDOM[8'h49][29];
        s3_valid = _RANDOM[8'h49][30];
        s3_req_miss = _RANDOM[8'h49][31];
        s3_req_miss_id = _RANDOM[8'h4A][3:0];
        s3_req_probe = _RANDOM[8'h4A][12];
        s3_req_probe_param = _RANDOM[8'h4A][14:13];
        s3_req_probe_need_data = _RANDOM[8'h4A][15];
        s3_req_source = _RANDOM[8'h4A][19:16];
        s3_req_cmd = _RANDOM[8'h4A][24:20];
        s3_req_vaddr = {_RANDOM[8'h4A][31:25], _RANDOM[8'h4B], _RANDOM[8'h4C][10:0]};
        s3_req_addr = {_RANDOM[8'h4C][31:11], _RANDOM[8'h4D][26:0]};
        s3_req_word_idx = _RANDOM[8'h5F][29:27];
        s3_req_amo_data =
          {_RANDOM[8'h5F][31:30],
           _RANDOM[8'h60],
           _RANDOM[8'h61],
           _RANDOM[8'h62],
           _RANDOM[8'h63][29:0]};
        s3_req_amo_mask = {_RANDOM[8'h63][31:30], _RANDOM[8'h64][13:0]};
        s3_req_amo_cmp =
          {_RANDOM[8'h64][31:14],
           _RANDOM[8'h65],
           _RANDOM[8'h66],
           _RANDOM[8'h67],
           _RANDOM[8'h68][13:0]};
        s3_req_replace = _RANDOM[8'h68][15];
        s3_req_pf_source = _RANDOM[8'h68][22:20];
        s3_req_access = _RANDOM[8'h68][23];
        s3_req_id = _RANDOM[8'h68][29:24];
        s3_miss_param = _RANDOM[8'h68][31:30];
        s3_tag = {_RANDOM[8'h69][31:1], _RANDOM[8'h6A][4:0]};
        s3_tag_match = _RANDOM[8'h6A][5];
        s3_coh_state = _RANDOM[8'h6A][7:6];
        s3_hit = _RANDOM[8'h6A][8];
        s3_amo_hit = _RANDOM[8'h6A][9];
        s3_store_hit = _RANDOM[8'h6A][10];
        s3_hit_coh_state = _RANDOM[8'h6A][12:11];
        s3_new_hit_coh_state = _RANDOM[8'h6A][14:13];
        s3_way_en = _RANDOM[8'h6A][18:15];
        s3_banked_store_wmask = _RANDOM[8'h6A][26:19];
        s3_idx = {_RANDOM[8'h6A][31:27], _RANDOM[8'h6B][2:0]};
        s3_store_data_merged_without_cache_0 =
          {_RANDOM[8'h6B][31:3], _RANDOM[8'h6C], _RANDOM[8'h6D][2:0]};
        s3_store_data_merged_without_cache_1 =
          {_RANDOM[8'h6D][31:3], _RANDOM[8'h6E], _RANDOM[8'h6F][2:0]};
        s3_store_data_merged_without_cache_2 =
          {_RANDOM[8'h6F][31:3], _RANDOM[8'h70], _RANDOM[8'h71][2:0]};
        s3_store_data_merged_without_cache_3 =
          {_RANDOM[8'h71][31:3], _RANDOM[8'h72], _RANDOM[8'h73][2:0]};
        s3_store_data_merged_without_cache_4 =
          {_RANDOM[8'h73][31:3], _RANDOM[8'h74], _RANDOM[8'h75][2:0]};
        s3_store_data_merged_without_cache_5 =
          {_RANDOM[8'h75][31:3], _RANDOM[8'h76], _RANDOM[8'h77][2:0]};
        s3_store_data_merged_without_cache_6 =
          {_RANDOM[8'h77][31:3], _RANDOM[8'h78], _RANDOM[8'h79][2:0]};
        s3_store_data_merged_without_cache_7 =
          {_RANDOM[8'h79][31:3], _RANDOM[8'h7A], _RANDOM[8'h7B][2:0]};
        s3_merge_mask_0 = _RANDOM[8'h7B][10:3];
        s3_merge_mask_1 = _RANDOM[8'h7B][18:11];
        s3_merge_mask_2 = _RANDOM[8'h7B][26:19];
        s3_merge_mask_3 = {_RANDOM[8'h7B][31:27], _RANDOM[8'h7C][2:0]};
        s3_merge_mask_4 = _RANDOM[8'h7C][10:3];
        s3_merge_mask_5 = _RANDOM[8'h7C][18:11];
        s3_merge_mask_6 = _RANDOM[8'h7C][26:19];
        s3_merge_mask_7 = {_RANDOM[8'h7C][31:27], _RANDOM[8'h7D][2:0]};
        s3_need_replacement = _RANDOM[8'h7D][3];
        s3_tag_error_beu = _RANDOM[8'h7D][4];
        s3_tag_error_wb = _RANDOM[8'h7D][5];
        s3_data_error_beu_last_REG = _RANDOM[8'h7D][6];
        s3_data_error_beu_r = _RANDOM[8'h7D][7];
        s3_data_error_wb_r = _RANDOM[8'h7D][8];
        s3_l2_error_wb_tl_denied = _RANDOM[8'h7D][11];
        s3_l2_error_wb_tl_corrupt = _RANDOM[8'h7D][12];
        s3_flag_error_beu_tl_denied = _RANDOM[8'h7D][13];
        s3_flag_error_beu_tl_corrupt = _RANDOM[8'h7D][14];
        s3_error_beu_r = _RANDOM[8'h7D][15];
        s3_error_paddr_beu_r = {_RANDOM[8'h7D][31:17], _RANDOM[8'h7E], _RANDOM[8'h7F][0]};
        lrsc_count = _RANDOM[8'h81][6:1];
        lrsc_addr = {_RANDOM[8'h81][31:7], _RANDOM[8'h82][22:0]};
        s3_s_amoalu = _RANDOM[8'h82][23];
        io_block_lr_last_REG = _RANDOM[8'h82][24];
        s3_amo_data_merged_reg_0 =
          {_RANDOM[8'h82][31:25], _RANDOM[8'h83], _RANDOM[8'h84][24:0]};
        s3_amo_data_merged_reg_1 =
          {_RANDOM[8'h84][31:25], _RANDOM[8'h85], _RANDOM[8'h86][24:0]};
        s3_amo_data_merged_reg_2 =
          {_RANDOM[8'h86][31:25], _RANDOM[8'h87], _RANDOM[8'h88][24:0]};
        s3_amo_data_merged_reg_3 =
          {_RANDOM[8'h88][31:25], _RANDOM[8'h89], _RANDOM[8'h8A][24:0]};
        s3_amo_data_merged_reg_4 =
          {_RANDOM[8'h8A][31:25], _RANDOM[8'h8B], _RANDOM[8'h8C][24:0]};
        s3_amo_data_merged_reg_5 =
          {_RANDOM[8'h8C][31:25], _RANDOM[8'h8D], _RANDOM[8'h8E][24:0]};
        s3_amo_data_merged_reg_6 =
          {_RANDOM[8'h8E][31:25], _RANDOM[8'h8F], _RANDOM[8'h90][24:0]};
        s3_amo_data_merged_reg_7 =
          {_RANDOM[8'h90][31:25], _RANDOM[8'h91], _RANDOM[8'h92][24:0]};
        s2_isStore = _RANDOM[8'h92][25];
        s2_isAMO = _RANDOM[8'h92][26];
        io_replace_access_valid_last_REG = _RANDOM[8'h92][30];
        io_sms_agt_evict_req_valid_last_REG = _RANDOM[8'h93][0];
        io_sms_agt_evict_req_bits_vaddr_r = {_RANDOM[8'h93][31:1], _RANDOM[8'h94][18:0]};
        io_status_dup_0_s1_bits_set_r = _RANDOM[8'h94][26:19];
        io_status_dup_0_s2_valid_r = _RANDOM[8'h94][27];
        io_status_dup_0_s2_bits_set_r = {_RANDOM[8'h94][31:28], _RANDOM[8'h95][3:0]};
        io_status_dup_0_s3_valid_r = _RANDOM[8'h95][4];
        io_status_dup_0_s3_bits_set_r = _RANDOM[8'h95][12:5];
        io_status_dup_0_s3_bits_way_en_r = _RANDOM[8'h95][16:13];
        io_status_dup_1_s1_bits_set_r = _RANDOM[8'h95][24:17];
        io_status_dup_1_s2_valid_r = _RANDOM[8'h95][25];
        io_status_dup_1_s2_bits_set_r = {_RANDOM[8'h95][31:26], _RANDOM[8'h96][1:0]};
        io_status_dup_1_s3_valid_r = _RANDOM[8'h96][2];
        io_status_dup_1_s3_bits_set_r = _RANDOM[8'h96][10:3];
        io_status_dup_1_s3_bits_way_en_r = _RANDOM[8'h96][14:11];
        io_status_dup_2_s1_bits_set_r = _RANDOM[8'h96][22:15];
        io_status_dup_2_s2_valid_r = _RANDOM[8'h96][23];
        io_status_dup_2_s2_bits_set_r = _RANDOM[8'h96][31:24];
        io_status_dup_2_s3_valid_r = _RANDOM[8'h97][0];
        io_status_dup_2_s3_bits_set_r = _RANDOM[8'h97][8:1];
        io_status_dup_2_s3_bits_way_en_r = _RANDOM[8'h97][12:9];
        io_status_dup_3_s1_bits_set_r = _RANDOM[8'h97][20:13];
        io_status_dup_3_s2_valid_r = _RANDOM[8'h97][21];
        io_status_dup_3_s2_bits_set_r = _RANDOM[8'h97][29:22];
        io_status_dup_3_s3_valid_r = _RANDOM[8'h97][30];
        io_status_dup_3_s3_bits_set_r = {_RANDOM[8'h97][31], _RANDOM[8'h98][6:0]};
        io_status_dup_3_s3_bits_way_en_r = _RANDOM[8'h98][10:7];
        io_status_dup_4_s1_bits_set_r = _RANDOM[8'h98][18:11];
        io_status_dup_4_s2_valid_r = _RANDOM[8'h98][19];
        io_status_dup_4_s2_bits_set_r = _RANDOM[8'h98][27:20];
        io_status_dup_4_s3_valid_r = _RANDOM[8'h98][28];
        io_status_dup_4_s3_bits_set_r = {_RANDOM[8'h98][31:29], _RANDOM[8'h99][4:0]};
        io_status_dup_4_s3_bits_way_en_r = _RANDOM[8'h99][8:5];
        io_status_dup_5_s1_bits_set_r = _RANDOM[8'h99][16:9];
        io_status_dup_5_s2_valid_r = _RANDOM[8'h99][17];
        io_status_dup_5_s2_bits_set_r = _RANDOM[8'h99][25:18];
        io_status_dup_5_s3_valid_r = _RANDOM[8'h99][26];
        io_status_dup_5_s3_bits_set_r = {_RANDOM[8'h99][31:27], _RANDOM[8'h9A][2:0]};
        io_status_dup_5_s3_bits_way_en_r = _RANDOM[8'h9A][6:3];
        io_status_dup_6_s1_bits_set_r = _RANDOM[8'h9A][14:7];
        io_status_dup_6_s2_valid_r = _RANDOM[8'h9A][15];
        io_status_dup_6_s2_bits_set_r = _RANDOM[8'h9A][23:16];
        io_status_dup_6_s3_valid_r = _RANDOM[8'h9A][24];
        io_status_dup_6_s3_bits_set_r = {_RANDOM[8'h9A][31:25], _RANDOM[8'h9B][0]};
        io_status_dup_6_s3_bits_way_en_r = _RANDOM[8'h9B][4:1];
        io_status_dup_7_s1_bits_set_r = _RANDOM[8'h9B][12:5];
        io_status_dup_7_s2_valid_r = _RANDOM[8'h9B][13];
        io_status_dup_7_s2_bits_set_r = _RANDOM[8'h9B][21:14];
        io_status_dup_7_s3_valid_r = _RANDOM[8'h9B][22];
        io_status_dup_7_s3_bits_set_r = _RANDOM[8'h9B][30:23];
        io_status_dup_7_s3_bits_way_en_r = {_RANDOM[8'h9B][31], _RANDOM[8'h9C][2:0]};
        io_status_dup_8_s1_bits_set_r = _RANDOM[8'h9C][10:3];
        io_status_dup_8_s2_valid_r = _RANDOM[8'h9C][11];
        io_status_dup_8_s2_bits_set_r = _RANDOM[8'h9C][19:12];
        io_status_dup_8_s3_valid_r = _RANDOM[8'h9C][20];
        io_status_dup_8_s3_bits_set_r = _RANDOM[8'h9C][28:21];
        io_status_dup_8_s3_bits_way_en_r = {_RANDOM[8'h9C][31:29], _RANDOM[8'h9D][0]};
        io_status_dup_9_s1_bits_set_r = _RANDOM[8'h9D][8:1];
        io_status_dup_9_s2_valid_r = _RANDOM[8'h9D][9];
        io_status_dup_9_s2_bits_set_r = _RANDOM[8'h9D][17:10];
        io_status_dup_9_s3_valid_r = _RANDOM[8'h9D][18];
        io_status_dup_9_s3_bits_set_r = _RANDOM[8'h9D][26:19];
        io_status_dup_9_s3_bits_way_en_r = _RANDOM[8'h9D][30:27];
        io_status_dup_10_s1_bits_set_r = {_RANDOM[8'h9D][31], _RANDOM[8'h9E][6:0]};
        io_status_dup_10_s2_valid_r = _RANDOM[8'h9E][7];
        io_status_dup_10_s2_bits_set_r = _RANDOM[8'h9E][15:8];
        io_status_dup_10_s3_valid_r = _RANDOM[8'h9E][16];
        io_status_dup_10_s3_bits_set_r = _RANDOM[8'h9E][24:17];
        io_status_dup_10_s3_bits_way_en_r = _RANDOM[8'h9E][28:25];
        io_status_dup_11_s1_bits_set_r = {_RANDOM[8'h9E][31:29], _RANDOM[8'h9F][4:0]};
        io_status_dup_11_s2_valid_r = _RANDOM[8'h9F][5];
        io_status_dup_11_s2_bits_set_r = _RANDOM[8'h9F][13:6];
        io_status_dup_11_s3_valid_r = _RANDOM[8'h9F][14];
        io_status_dup_11_s3_bits_set_r = _RANDOM[8'h9F][22:15];
        io_status_dup_11_s3_bits_way_en_r = _RANDOM[8'h9F][26:23];
        io_status_dup_12_s1_bits_set_r = {_RANDOM[8'h9F][31:27], _RANDOM[8'hA0][2:0]};
        io_status_dup_12_s2_valid_r = _RANDOM[8'hA0][3];
        io_status_dup_12_s2_bits_set_r = _RANDOM[8'hA0][11:4];
        io_status_dup_12_s3_valid_r = _RANDOM[8'hA0][12];
        io_status_dup_12_s3_bits_set_r = _RANDOM[8'hA0][20:13];
        io_status_dup_12_s3_bits_way_en_r = _RANDOM[8'hA0][24:21];
        io_status_dup_13_s1_bits_set_r = {_RANDOM[8'hA0][31:25], _RANDOM[8'hA1][0]};
        io_status_dup_13_s2_valid_r = _RANDOM[8'hA1][1];
        io_status_dup_13_s2_bits_set_r = _RANDOM[8'hA1][9:2];
        io_status_dup_13_s3_valid_r = _RANDOM[8'hA1][10];
        io_status_dup_13_s3_bits_set_r = _RANDOM[8'hA1][18:11];
        io_status_dup_13_s3_bits_way_en_r = _RANDOM[8'hA1][22:19];
        io_status_dup_14_s1_bits_set_r = _RANDOM[8'hA1][30:23];
        io_status_dup_14_s2_valid_r = _RANDOM[8'hA1][31];
        io_status_dup_14_s2_bits_set_r = _RANDOM[8'hA2][7:0];
        io_status_dup_14_s3_valid_r = _RANDOM[8'hA2][8];
        io_status_dup_14_s3_bits_set_r = _RANDOM[8'hA2][16:9];
        io_status_dup_14_s3_bits_way_en_r = _RANDOM[8'hA2][20:17];
        io_status_dup_15_s1_bits_set_r = _RANDOM[8'hA2][28:21];
        io_status_dup_15_s2_valid_r = _RANDOM[8'hA2][29];
        io_status_dup_15_s2_bits_set_r = {_RANDOM[8'hA2][31:30], _RANDOM[8'hA3][5:0]};
        io_status_dup_15_s3_valid_r = _RANDOM[8'hA3][6];
        io_status_dup_15_s3_bits_set_r = _RANDOM[8'hA3][14:7];
        io_status_dup_15_s3_bits_way_en_r = _RANDOM[8'hA3][18:15];
        io_status_dup_16_s1_bits_set_r = _RANDOM[8'hA3][26:19];
        io_status_dup_16_s2_valid_r = _RANDOM[8'hA3][27];
        io_status_dup_16_s2_bits_set_r = {_RANDOM[8'hA3][31:28], _RANDOM[8'hA4][3:0]};
        io_status_dup_16_s3_valid_r = _RANDOM[8'hA4][4];
        io_status_dup_16_s3_bits_set_r = _RANDOM[8'hA4][12:5];
        io_status_dup_16_s3_bits_way_en_r = _RANDOM[8'hA4][16:13];
        io_status_dup_17_s1_bits_set_r = _RANDOM[8'hA4][24:17];
        io_status_dup_17_s2_valid_r = _RANDOM[8'hA4][25];
        io_status_dup_17_s2_bits_set_r = {_RANDOM[8'hA4][31:26], _RANDOM[8'hA5][1:0]};
        io_status_dup_17_s3_valid_r = _RANDOM[8'hA5][2];
        io_status_dup_17_s3_bits_set_r = _RANDOM[8'hA5][10:3];
        io_status_dup_17_s3_bits_way_en_r = _RANDOM[8'hA5][14:11];
        io_status_dup_18_s1_bits_set_r = _RANDOM[8'hA5][22:15];
        io_status_dup_18_s2_valid_r = _RANDOM[8'hA5][23];
        io_status_dup_18_s2_bits_set_r = _RANDOM[8'hA5][31:24];
        io_status_dup_18_s3_valid_r = _RANDOM[8'hA6][0];
        io_status_dup_18_s3_bits_set_r = _RANDOM[8'hA6][8:1];
        io_status_dup_18_s3_bits_way_en_r = _RANDOM[8'hA6][12:9];
        io_status_dup_19_s1_bits_set_r = _RANDOM[8'hA6][20:13];
        io_status_dup_19_s2_valid_r = _RANDOM[8'hA6][21];
        io_status_dup_19_s2_bits_set_r = _RANDOM[8'hA6][29:22];
        io_status_dup_19_s3_valid_r = _RANDOM[8'hA6][30];
        io_status_dup_19_s3_bits_set_r = {_RANDOM[8'hA6][31], _RANDOM[8'hA7][6:0]};
        io_status_dup_19_s3_bits_way_en_r = _RANDOM[8'hA7][10:7];
        io_status_dup_20_s1_bits_set_r = _RANDOM[8'hA7][18:11];
        io_status_dup_20_s2_valid_r = _RANDOM[8'hA7][19];
        io_status_dup_20_s2_bits_set_r = _RANDOM[8'hA7][27:20];
        io_status_dup_20_s3_valid_r = _RANDOM[8'hA7][28];
        io_status_dup_20_s3_bits_set_r = {_RANDOM[8'hA7][31:29], _RANDOM[8'hA8][4:0]};
        io_status_dup_20_s3_bits_way_en_r = _RANDOM[8'hA8][8:5];
        io_status_dup_21_s1_bits_set_r = _RANDOM[8'hA8][16:9];
        io_status_dup_21_s2_valid_r = _RANDOM[8'hA8][17];
        io_status_dup_21_s2_bits_set_r = _RANDOM[8'hA8][25:18];
        io_status_dup_21_s3_valid_r = _RANDOM[8'hA8][26];
        io_status_dup_21_s3_bits_set_r = {_RANDOM[8'hA8][31:27], _RANDOM[8'hA9][2:0]};
        io_status_dup_21_s3_bits_way_en_r = _RANDOM[8'hA9][6:3];
        io_status_dup_22_s1_bits_set_r = _RANDOM[8'hA9][14:7];
        io_status_dup_22_s2_valid_r = _RANDOM[8'hA9][15];
        io_status_dup_22_s2_bits_set_r = _RANDOM[8'hA9][23:16];
        io_status_dup_22_s3_valid_r = _RANDOM[8'hA9][24];
        io_status_dup_22_s3_bits_set_r = {_RANDOM[8'hA9][31:25], _RANDOM[8'hAA][0]};
        io_status_dup_22_s3_bits_way_en_r = _RANDOM[8'hAA][4:1];
        io_status_dup_23_s1_bits_set_r = _RANDOM[8'hAA][12:5];
        io_status_dup_23_s2_valid_r = _RANDOM[8'hAA][13];
        io_status_dup_23_s2_bits_set_r = _RANDOM[8'hAA][21:14];
        io_status_dup_23_s3_valid_r = _RANDOM[8'hAA][22];
        io_status_dup_23_s3_bits_set_r = _RANDOM[8'hAA][30:23];
        io_status_dup_23_s3_bits_way_en_r = {_RANDOM[8'hAA][31], _RANDOM[8'hAB][2:0]};
        io_mainpipe_info_s3_refill_resp_REG = _RANDOM[8'hAB][3];
        io_error_valid_last_REG = _RANDOM[8'hAB][4];
        io_error_bits_report_to_beu_REG = _RANDOM[8'hAB][5];
        io_perf_0_value_REG = _RANDOM[8'hAB][10];
        io_perf_0_value_REG_1 = _RANDOM[8'hAB][11];
        io_perf_1_value_REG = _RANDOM[8'hAB][12];
        io_perf_1_value_REG_1 = _RANDOM[8'hAB][13];
        io_perf_2_value_REG = _RANDOM[8'hAB][14];
        io_perf_2_value_REG_1 = _RANDOM[8'hAB][15];
        io_perf_3_value_REG = _RANDOM[8'hAB][18:16];
        io_perf_3_value_REG_1 = _RANDOM[8'hAB][21:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        last_REG = 1'h0;
  ...
  assign io_store_hit_resp_valid =
    s3_valid & (s3_store_can_go | s3_miss_can_go & _io_replace_access_valid_T_3);
