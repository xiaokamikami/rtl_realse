  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        modified_reset = _RANDOM[6'h0][0];
        s1_pc_dup_0 = {_RANDOM[6'h0][31:1], _RANDOM[6'h1][18:0]};
        s1_pc_dup_1 = {_RANDOM[6'h1][31:19], _RANDOM[6'h2], _RANDOM[6'h3][4:0]};
        s1_pc_dup_2 = {_RANDOM[6'h3][31:5], _RANDOM[6'h4][22:0]};
        s1_pc_dup_3 = {_RANDOM[6'h4][31:23], _RANDOM[6'h5], _RANDOM[6'h6][8:0]};
        s2_pc_dup_s2_pc_seg_0_value = {_RANDOM[6'h6][31:9], _RANDOM[6'h7][2:0]};
        s2_pc_dup_s2_pc_seg_1_value = _RANDOM[6'h7][14:3];
        s2_pc_dup_s2_pc_seg_2_value = _RANDOM[6'h7][26:15];
        s2_pc_dup_s2_pc_seg_0_value_1 = {_RANDOM[6'h7][31:27], _RANDOM[6'h8][20:0]};
        s2_pc_dup_s2_pc_seg_1_value_1 = {_RANDOM[6'h8][31:21], _RANDOM[6'h9][0]};
        s2_pc_dup_s2_pc_seg_2_value_1 = _RANDOM[6'h9][12:1];
        s2_pc_dup_s2_pc_seg_0_value_2 = {_RANDOM[6'h9][31:13], _RANDOM[6'hA][6:0]};
        s2_pc_dup_s2_pc_seg_1_value_2 = _RANDOM[6'hA][18:7];
        s2_pc_dup_s2_pc_seg_2_value_2 = _RANDOM[6'hA][30:19];
        s2_pc_dup_s2_pc_seg_0_value_3 = {_RANDOM[6'hA][31], _RANDOM[6'hB][24:0]};
        s2_pc_dup_s2_pc_seg_1_value_3 = {_RANDOM[6'hB][31:25], _RANDOM[6'hC][4:0]};
        s2_pc_dup_s2_pc_seg_2_value_3 = _RANDOM[6'hC][16:5];
        s3_pc_dup_s3_pc_seg_0_value = {_RANDOM[6'hC][31:17], _RANDOM[6'hD][10:0]};
        s3_pc_dup_s3_pc_seg_1_value = _RANDOM[6'hD][22:11];
        s3_pc_dup_s3_pc_seg_2_value = {_RANDOM[6'hD][31:23], _RANDOM[6'hE][2:0]};
        s3_pc_dup_s3_pc_seg_0_value_1 = _RANDOM[6'hE][28:3];
        s3_pc_dup_s3_pc_seg_1_value_1 = {_RANDOM[6'hE][31:29], _RANDOM[6'hF][8:0]};
        s3_pc_dup_s3_pc_seg_2_value_1 = _RANDOM[6'hF][20:9];
        s3_pc_dup_s3_pc_seg_0_value_2 = {_RANDOM[6'hF][31:21], _RANDOM[6'h10][14:0]};
        s3_pc_dup_s3_pc_seg_1_value_2 = _RANDOM[6'h10][26:15];
        s3_pc_dup_s3_pc_seg_2_value_2 = {_RANDOM[6'h10][31:27], _RANDOM[6'h11][6:0]};
        s3_pc_dup_s3_pc_seg_0_value_3 = {_RANDOM[6'h11][31:7], _RANDOM[6'h12][0]};
        s3_pc_dup_s3_pc_seg_1_value_3 = _RANDOM[6'h12][12:1];
        s3_pc_dup_s3_pc_seg_2_value_3 = _RANDOM[6'h12][24:13];
        ctrs_0_0 = _RANDOM[6'h12][26:25];
        ctrs_0_1 = _RANDOM[6'h12][28:27];
        ctrs_1_0 = _RANDOM[6'h12][30:29];
        ctrs_1_1 = {_RANDOM[6'h12][31], _RANDOM[6'h13][0]};
        ctrs_2_0 = _RANDOM[6'h13][2:1];
        ctrs_2_1 = _RANDOM[6'h13][4:3];
        ctrs_3_0 = _RANDOM[6'h13][6:5];
        ctrs_3_1 = _RANDOM[6'h13][8:7];
        ctrs_4_0 = _RANDOM[6'h13][10:9];
        ctrs_4_1 = _RANDOM[6'h13][12:11];
        ctrs_5_0 = _RANDOM[6'h13][14:13];
        ctrs_5_1 = _RANDOM[6'h13][16:15];
        ctrs_6_0 = _RANDOM[6'h13][18:17];
        ctrs_6_1 = _RANDOM[6'h13][20:19];
        ctrs_7_0 = _RANDOM[6'h13][22:21];
        ctrs_7_1 = _RANDOM[6'h13][24:23];
        ctrs_8_0 = _RANDOM[6'h13][26:25];
        ctrs_8_1 = _RANDOM[6'h13][28:27];
        ctrs_9_0 = _RANDOM[6'h13][30:29];
        ctrs_9_1 = {_RANDOM[6'h13][31], _RANDOM[6'h14][0]};
        ctrs_10_0 = _RANDOM[6'h14][2:1];
        ctrs_10_1 = _RANDOM[6'h14][4:3];
        ctrs_11_0 = _RANDOM[6'h14][6:5];
        ctrs_11_1 = _RANDOM[6'h14][8:7];
        ctrs_12_0 = _RANDOM[6'h14][10:9];
        ctrs_12_1 = _RANDOM[6'h14][12:11];
        ctrs_13_0 = _RANDOM[6'h14][14:13];
        ctrs_13_1 = _RANDOM[6'h14][16:15];
        ctrs_14_0 = _RANDOM[6'h14][18:17];
        ctrs_14_1 = _RANDOM[6'h14][20:19];
        ctrs_15_0 = _RANDOM[6'h14][22:21];
        ctrs_15_1 = _RANDOM[6'h14][24:23];
        ctrs_16_0 = _RANDOM[6'h14][26:25];
        ctrs_16_1 = _RANDOM[6'h14][28:27];
        ctrs_17_0 = _RANDOM[6'h14][30:29];
        ctrs_17_1 = {_RANDOM[6'h14][31], _RANDOM[6'h15][0]};
        ctrs_18_0 = _RANDOM[6'h15][2:1];
        ctrs_18_1 = _RANDOM[6'h15][4:3];
        ctrs_19_0 = _RANDOM[6'h15][6:5];
        ctrs_19_1 = _RANDOM[6'h15][8:7];
        ctrs_20_0 = _RANDOM[6'h15][10:9];
        ctrs_20_1 = _RANDOM[6'h15][12:11];
        ctrs_21_0 = _RANDOM[6'h15][14:13];
        ctrs_21_1 = _RANDOM[6'h15][16:15];
        ctrs_22_0 = _RANDOM[6'h15][18:17];
        ctrs_22_1 = _RANDOM[6'h15][20:19];
        ctrs_23_0 = _RANDOM[6'h15][22:21];
        ctrs_23_1 = _RANDOM[6'h15][24:23];
        ctrs_24_0 = _RANDOM[6'h15][26:25];
        ctrs_24_1 = _RANDOM[6'h15][28:27];
        ctrs_25_0 = _RANDOM[6'h15][30:29];
        ctrs_25_1 = {_RANDOM[6'h15][31], _RANDOM[6'h16][0]};
        ctrs_26_0 = _RANDOM[6'h16][2:1];
        ctrs_26_1 = _RANDOM[6'h16][4:3];
        ctrs_27_0 = _RANDOM[6'h16][6:5];
        ctrs_27_1 = _RANDOM[6'h16][8:7];
        ctrs_28_0 = _RANDOM[6'h16][10:9];
        ctrs_28_1 = _RANDOM[6'h16][12:11];
        ctrs_29_0 = _RANDOM[6'h16][14:13];
        ctrs_29_1 = _RANDOM[6'h16][16:15];
        ctrs_30_0 = _RANDOM[6'h16][18:17];
        ctrs_30_1 = _RANDOM[6'h16][20:19];
        ctrs_31_0 = _RANDOM[6'h16][22:21];
        ctrs_31_1 = _RANDOM[6'h16][24:23];
        state_reg = {_RANDOM[6'h16][31:25], _RANDOM[6'h17][23:0]};
        fauftb_enable = _RANDOM[6'h17][24];
        resp_meta_hit_r = _RANDOM[6'h17][25];
        resp_meta_hit_r_1 = _RANDOM[6'h17][26];
        replacer_touch_ways_0_valid_REG = _RANDOM[6'h17][27];
        replacer_touch_ways_0_bits_r = {_RANDOM[6'h17][31:28], _RANDOM[6'h18][0]};
        u_valid = _RANDOM[6'h18][1];
        u_bits_ftb_entry_isCall = _RANDOM[6'h1C][8];
        u_bits_ftb_entry_isRet = _RANDOM[6'h1C][9];
        u_bits_ftb_entry_isJalr = _RANDOM[6'h1C][10];
        u_bits_ftb_entry_valid = _RANDOM[6'h1C][11];
        u_bits_ftb_entry_brSlots_0_offset = _RANDOM[6'h1C][15:12];
        u_bits_ftb_entry_brSlots_0_sharing = _RANDOM[6'h1C][16];
        u_bits_ftb_entry_brSlots_0_valid = _RANDOM[6'h1C][17];
        u_bits_ftb_entry_brSlots_0_lower = _RANDOM[6'h1C][29:18];
        u_bits_ftb_entry_brSlots_0_tarStat = _RANDOM[6'h1C][31:30];
        u_bits_ftb_entry_tailSlot_offset = _RANDOM[6'h1D][3:0];
        u_bits_ftb_entry_tailSlot_sharing = _RANDOM[6'h1D][4];
        u_bits_ftb_entry_tailSlot_valid = _RANDOM[6'h1D][5];
        u_bits_ftb_entry_tailSlot_lower = _RANDOM[6'h1D][25:6];
        u_bits_ftb_entry_tailSlot_tarStat = _RANDOM[6'h1D][27:26];
        u_bits_ftb_entry_pftAddr = _RANDOM[6'h1D][31:28];
        u_bits_ftb_entry_carry = _RANDOM[6'h1E][0];
        u_bits_ftb_entry_last_may_be_rvi_call = _RANDOM[6'h1E][1];
        u_bits_ftb_entry_strong_bias_0 = _RANDOM[6'h1E][2];
        u_bits_ftb_entry_strong_bias_1 = _RANDOM[6'h1E][3];
        u_bits_br_taken_mask_0 = _RANDOM[6'h1E][9];
        u_bits_br_taken_mask_1 = _RANDOM[6'h1E][10];
        u_bits_meta =
          {_RANDOM[6'h1E][31:22],
           _RANDOM[6'h1F],
           _RANDOM[6'h20],
           ...
           _RANDOM[6'h25],
           _RANDOM[6'h26][25:0]};
        u_s1_valid = _RANDOM[6'h30][14];
        u_s1_tag = _RANDOM[6'h30][30:15];
        u_s1_hit_oh = {_RANDOM[6'h30][31], _RANDOM[6'h31][30:0]};
        u_s1_hit = _RANDOM[6'h31][31];
        u_s1_ftb_entry_isCall = _RANDOM[6'h32][0];
        u_s1_ftb_entry_isRet = _RANDOM[6'h32][1];
        u_s1_ftb_entry_isJalr = _RANDOM[6'h32][2];
        u_s1_ftb_entry_valid = _RANDOM[6'h32][3];
        u_s1_ftb_entry_brSlots_0_offset = _RANDOM[6'h32][7:4];
        u_s1_ftb_entry_brSlots_0_sharing = _RANDOM[6'h32][8];
        u_s1_ftb_entry_brSlots_0_valid = _RANDOM[6'h32][9];
        u_s1_ftb_entry_brSlots_0_lower = _RANDOM[6'h32][21:10];
        u_s1_ftb_entry_brSlots_0_tarStat = _RANDOM[6'h32][23:22];
        u_s1_ftb_entry_tailSlot_offset = _RANDOM[6'h32][27:24];
        u_s1_ftb_entry_tailSlot_sharing = _RANDOM[6'h32][28];
        u_s1_ftb_entry_tailSlot_valid = _RANDOM[6'h32][29];
        u_s1_ftb_entry_tailSlot_lower = {_RANDOM[6'h32][31:30], _RANDOM[6'h33][17:0]};
        u_s1_ftb_entry_tailSlot_tarStat = _RANDOM[6'h33][19:18];
        u_s1_ftb_entry_pftAddr = _RANDOM[6'h33][23:20];
        u_s1_ftb_entry_carry = _RANDOM[6'h33][24];
        u_s1_ftb_entry_last_may_be_rvi_call = _RANDOM[6'h33][25];
        u_s1_ftb_entry_strong_bias_0 = _RANDOM[6'h33][26];
        u_s1_ftb_entry_strong_bias_1 = _RANDOM[6'h33][27];
        u_s1_br_update_valids_0 = _RANDOM[6'h35][14];
        u_s1_br_update_valids_1 = _RANDOM[6'h35][15];
        u_s1_br_takens_0 = _RANDOM[6'h35][16];
        u_s1_br_takens_1 = _RANDOM[6'h35][17];
        io_perf_0_value_REG = _RANDOM[6'h35][19];
        io_perf_0_value_REG_1 = _RANDOM[6'h35][20];
        io_perf_1_value_REG = _RANDOM[6'h35][21];
        io_perf_1_value_REG_1 = _RANDOM[6'h35][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        modified_reset = 1'h1;
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
