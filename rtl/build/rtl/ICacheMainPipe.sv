...
module ICacheMainPipe(
  ...
  reg         s2_doubleline;
  reg  [1:0]  s2_itlb_exception_0;
  reg  [1:0]  s2_itlb_exception_1;
  ...
  wire [1:0]  _s2_pmp_exception_T = {2{io_pmp_0_resp_instr}};
  wire [1:0]  _s2_pmp_exception_T_1 = {2{io_pmp_1_resp_instr}};
  reg         s2_pmp_exception_REG;
  reg  [1:0]  s2_pmp_exception_r_0;
  reg  [1:0]  s2_pmp_exception_r_1;
  reg         s2_pmp_mmio_REG;
  reg         s2_pmp_mmio_r_0;
  reg         s2_pmp_mmio_r_1;
  wire        s2_pmp_mmio_0 = s2_pmp_mmio_REG ? io_pmp_0_resp_mmio : s2_pmp_mmio_r_0;
  wire        s2_pmp_mmio_1 = s2_pmp_mmio_REG ? io_pmp_1_resp_mmio : s2_pmp_mmio_r_1;
  wire [1:0]  s2_exception_0 =
    (|s2_itlb_exception_0)
      ? s2_itlb_exception_0
      : s2_pmp_exception_REG ? _s2_pmp_exception_T : s2_pmp_exception_r_0;
  wire [1:0]  s2_exception_1 =
    (|s2_itlb_exception_1)
      ? s2_itlb_exception_1
      : s2_pmp_exception_REG ? _s2_pmp_exception_T_1 : s2_pmp_exception_r_1;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s2_doubleline <= 1'h0;
      s2_itlb_exception_0 <= 2'h0;
      s2_itlb_exception_1 <= 2'h0;
      ...
      if (s1_fire) begin
        ...
        s2_itlb_exception_0 <= s1_itlb_exception_0;
        s2_itlb_exception_1 <= s1_itlb_exception_1;
  ...
  always @(posedge clock) begin
    ...
    s2_pmp_exception_REG <= s1_fire;
    if (s2_pmp_exception_REG) begin
      s2_pmp_exception_r_0 <= _s2_pmp_exception_T;
      s2_pmp_exception_r_1 <= _s2_pmp_exception_T_1;
    end
    s2_pmp_mmio_REG <= s1_fire;
    if (s2_pmp_mmio_REG) begin
      s2_pmp_mmio_r_0 <= io_pmp_0_resp_mmio;
      s2_pmp_mmio_r_1 <= io_pmp_1_resp_mmio;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_itlb_exception_0 = _RANDOM[6'h21][11:10];
        s2_itlb_exception_1 = _RANDOM[6'h21][13:12];
        s2_backendException = _RANDOM[6'h21][14];
        s2_itlb_pbmt_0 = _RANDOM[6'h21][16:15];
        s2_itlb_pbmt_1 = _RANDOM[6'h21][18:17];
        s2_waymasks_0_0 = _RANDOM[6'h21][19];
        s2_waymasks_0_1 = _RANDOM[6'h21][20];
        s2_waymasks_0_2 = _RANDOM[6'h21][21];
        s2_waymasks_0_3 = _RANDOM[6'h21][22];
        s2_waymasks_1_0 = _RANDOM[6'h21][23];
        s2_waymasks_1_1 = _RANDOM[6'h21][24];
        s2_waymasks_1_2 = _RANDOM[6'h21][25];
        s2_waymasks_1_3 = _RANDOM[6'h21][26];
        s2_SRAMhits_0 = _RANDOM[6'h21][27];
        s2_SRAMhits_1 = _RANDOM[6'h21][28];
        s2_codes_0 = _RANDOM[6'h21][29];
        s2_codes_1 = _RANDOM[6'h21][30];
        s2_codes_2 = _RANDOM[6'h21][31];
        s2_codes_3 = _RANDOM[6'h22][0];
        s2_codes_4 = _RANDOM[6'h22][1];
        s2_codes_5 = _RANDOM[6'h22][2];
        s2_codes_6 = _RANDOM[6'h22][3];
        s2_codes_7 = _RANDOM[6'h22][4];
        s2_hits_0 = _RANDOM[6'h22][5];
        s2_hits_1 = _RANDOM[6'h22][6];
        s2_datas_0 = {_RANDOM[6'h22][31:7], _RANDOM[6'h23], _RANDOM[6'h24][6:0]};
        s2_datas_1 = {_RANDOM[6'h24][31:7], _RANDOM[6'h25], _RANDOM[6'h26][6:0]};
        s2_datas_2 = {_RANDOM[6'h26][31:7], _RANDOM[6'h27], _RANDOM[6'h28][6:0]};
        s2_datas_3 = {_RANDOM[6'h28][31:7], _RANDOM[6'h29], _RANDOM[6'h2A][6:0]};
        s2_datas_4 = {_RANDOM[6'h2A][31:7], _RANDOM[6'h2B], _RANDOM[6'h2C][6:0]};
        s2_datas_5 = {_RANDOM[6'h2C][31:7], _RANDOM[6'h2D], _RANDOM[6'h2E][6:0]};
        s2_datas_6 = {_RANDOM[6'h2E][31:7], _RANDOM[6'h2F], _RANDOM[6'h30][6:0]};
        s2_datas_7 = {_RANDOM[6'h30][31:7], _RANDOM[6'h31], _RANDOM[6'h32][6:0]};
        s2_data_is_from_MSHR_0 = _RANDOM[6'h32][7];
        s2_data_is_from_MSHR_1 = _RANDOM[6'h32][8];
        s2_data_is_from_MSHR_2 = _RANDOM[6'h32][9];
        s2_data_is_from_MSHR_3 = _RANDOM[6'h32][10];
        s2_data_is_from_MSHR_4 = _RANDOM[6'h32][11];
        s2_data_is_from_MSHR_5 = _RANDOM[6'h32][12];
        s2_data_is_from_MSHR_6 = _RANDOM[6'h32][13];
        s2_data_is_from_MSHR_7 = _RANDOM[6'h32][14];
        s2_pmp_exception_REG = _RANDOM[6'h32][15];
        s2_pmp_exception_r_0 = _RANDOM[6'h32][17:16];
        s2_pmp_exception_r_1 = _RANDOM[6'h32][19:18];
        s2_pmp_mmio_REG = _RANDOM[6'h32][20];
        s2_pmp_mmio_r_0 = _RANDOM[6'h32][21];
        s2_pmp_mmio_r_1 = _RANDOM[6'h32][22];
        s2_meta_corrupt_0 = _RANDOM[6'h32][23];
        s2_meta_corrupt_1 = _RANDOM[6'h32][24];
        io_errors_0_valid_REG = _RANDOM[6'h32][25];
        io_errors_0_bits_report_to_beu_REG = _RANDOM[6'h32][26];
        io_errors_1_valid_REG = _RANDOM[6'h32][27];
        io_errors_1_bits_report_to_beu_REG = _RANDOM[6'h32][28];
        io_metaArrayFlush_0_valid_REG = _RANDOM[6'h32][29];
        io_metaArrayFlush_1_valid_REG = _RANDOM[6'h32][30];
        s2_l2_corrupt_0 = _RANDOM[6'h33][3];
        s2_l2_corrupt_1 = _RANDOM[6'h33][4];
        s2_has_send_0 = _RANDOM[6'h33][5];
        s2_has_send_1 = _RANDOM[6'h33][6];
        REG_4 = _RANDOM[6'h33][7];
        io_errors_0_bits_paddr_REG = {_RANDOM[6'h33][31:8], _RANDOM[6'h34][23:0]};
        REG_5 = _RANDOM[6'h34][24];
        io_errors_1_bits_paddr_REG =
          {_RANDOM[6'h34][31:25], _RANDOM[6'h35], _RANDOM[6'h36][8:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 50'h0;
  ...
  assign io_fetch_topdownIcacheMiss = s2_valid & _io_fetch_topdownIcacheMiss_T;
  assign io_pmp_0_req_valid = s1_valid;
  assign io_pmp_0_req_bits_addr = {s1_req_ptags_0, s1_req_vaddr_0[11:0]};
  assign io_pmp_1_req_valid = s1_valid;
