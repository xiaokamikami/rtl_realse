  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_2_fuOpType = _RANDOM[7'h21][9:1];
        inPipe_1_2_robIdx_flag = _RANDOM[7'h29][10];
        inPipe_1_2_robIdx_value = _RANDOM[7'h29][18:11];
        inPipe_1_2_pdest = _RANDOM[7'h29][31:24];
        inPipe_1_2_rfWen = _RANDOM[7'h2A][0];
        inPipe_1_2_fpWen = _RANDOM[7'h2A][1];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h2A][6];
        inPipe_1_3_robIdx_flag = _RANDOM[7'h48][22];
        inPipe_1_3_robIdx_value = _RANDOM[7'h48][30:23];
        inPipe_1_3_pdest = _RANDOM[7'h49][11:4];
        inPipe_1_3_fpWen = _RANDOM[7'h49][13];
        inPipe_1_3_fpu_wflags = _RANDOM[7'h49][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
