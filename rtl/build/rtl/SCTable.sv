...
module SCTable(
  ...
  always @(posedge clock) begin
    if (io_req_valid) begin
      ...
      s1_resp_invalid_by_conflict <=
        ~(io_req_bits_pc[1]) & _GEN_0 | io_req_bits_pc[1] & _GEN_2;
  ...
  SRAMTemplate_68 table_0 (
    .clock                          (clock),
    .reset                          (reset),
    .io_r_req_valid                 (io_req_valid & ~(io_req_bits_pc[1])),
    .io_r_req_bits_setIdx           (io_req_bits_pc[8:2]),
    ...
    .io_w_req_bits_setIdx           (io_update_pc[8:2]),
