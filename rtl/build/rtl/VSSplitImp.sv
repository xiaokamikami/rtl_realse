...
module VSSplitImp(
  ...
  wire         _VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_19;
  ...
  VSSplitBufferImp splitBuffer (
    ...
    .io_in_bits_data
      (_VSSplitSkidBuffer_io_out_bits_data),
    .io_in_bits_baseAddr
      (_VSSplitSkidBuffer_io_out_bits_baseAddr),
    .io_in_bits_uopAddr
    ...
    .io_in_bits_uop_exceptionVec_19
      (_VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_19),
    ...
    .io_in_bits_uop_rfWen
      (_VSSplitSkidBuffer_io_out_bits_uop_rfWen),
    .io_in_bits_uop_fpWen
      (_VSSplitSkidBuffer_io_out_bits_uop_fpWen),
    ...
    .io_vstdMisalign_storeMisalignBufferRobIdx_flag
      (io_vstdMisalign_storeMisalignBufferRobIdx_flag),
    .io_vstdMisalign_storeMisalignBufferRobIdx_value
      (io_vstdMisalign_storeMisalignBufferRobIdx_value),
    .io_vstdMisalign_storeMisalignBufferUopIdx
      (io_vstdMisalign_storeMisalignBufferUopIdx)
  );
