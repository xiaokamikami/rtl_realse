...
module VSSplitBufferImp(
  ...
  input          io_vstdMisalign_storeMisalignBufferRobIdx_flag,
  input  [7:0]   io_vstdMisalign_storeMisalignBufferRobIdx_value,
  input  [6:0]   io_vstdMisalign_storeMisalignBufferUopIdx
);
  ...
  wire         addrAligned =
    ...
    & _vaddr_T[2:0] == 3'h0 | ~uopq_preIsSplit;
  ...
  wire         _io_out_valid_T_1 =
    ...
    & (io_vstdMisalign_storeMisalignBufferEmpty
       | io_vstdMisalign_storeMisalignBufferRobIdx_flag ^ uopq_uop_robIdx_flag
       ^ io_vstdMisalign_storeMisalignBufferRobIdx_value > uopq_uop_robIdx_value
       | {io_vstdMisalign_storeMisalignBufferRobIdx_flag,
          io_vstdMisalign_storeMisalignBufferRobIdx_value} == {uopq_uop_robIdx_flag,
                                                               uopq_uop_robIdx_value}
       & io_vstdMisalign_storeMisalignBufferUopIdx > uopq_uop_uopIdx);
  reg          dataIssued;
  wire [4:0]   _GEN_1 =
    {3'h0,
  ...
  wire         _io_vstd_valid_T = issueValid & vecActive;
  ...
  wire         io_vstd_valid_0 = _io_vstd_valid_T & ~dataIssued;
  always @(posedge clock) begin
    if (doEnqueue) begin
      ...
      uopq_uop_exceptionVec_19 <= io_in_bits_uop_exceptionVec_19;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      dataIssued <= ~_GEN_2 & ~_canAccept_T_2 & (io_vstd_valid_0 | dataIssued);
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_exceptionVec_19 = _RANDOM[7'h12][19];
        uopq_uop_trigger = _RANDOM[7'h12][29:26];
        uopq_uop_preDecodeInfo_isRVC = _RANDOM[7'h12][31];
        uopq_uop_ftqPtr_flag = _RANDOM[7'h13][6];
        uopq_uop_ftqPtr_value = _RANDOM[7'h13][12:7];
        uopq_uop_ftqOffset = _RANDOM[7'h13][16:13];
        uopq_uop_fuOpType = _RANDOM[7'h15][22:14];
        uopq_uop_rfWen = _RANDOM[7'h15][23];
        uopq_uop_fpWen = _RANDOM[7'h15][24];
        uopq_uop_vpu_vstart = _RANDOM[7'h18][7:0];
        uopq_uop_vpu_vuopIdx = _RANDOM[7'h18][26:20];
        uopq_uop_vpu_veew = _RANDOM[7'h1D][8:7];
        uopq_uop_uopIdx = _RANDOM[7'h1D][28:22];
        uopq_uop_pdest = {_RANDOM[7'h20][31:28], _RANDOM[7'h21][3:0]};
        uopq_uop_robIdx_flag = _RANDOM[7'h21][16];
        uopq_uop_robIdx_value = _RANDOM[7'h21][24:17];
        uopq_uop_storeSetHit = _RANDOM[7'h36][10];
        uopq_uop_waitForRobIdx_flag = _RANDOM[7'h36][11];
        uopq_uop_waitForRobIdx_value = _RANDOM[7'h36][19:12];
        uopq_uop_loadWaitBit = _RANDOM[7'h36][20];
        uopq_uop_loadWaitStrict = _RANDOM[7'h36][21];
        uopq_uop_lqIdx_flag = _RANDOM[7'h36][27];
        uopq_uop_lqIdx_value = {_RANDOM[7'h36][31:28], _RANDOM[7'h37][2:0]};
        uopq_uop_sqIdx_flag = _RANDOM[7'h37][3];
        uopq_uop_sqIdx_value = _RANDOM[7'h37][9:4];
        uopq_preIsSplit = _RANDOM[7'h3B][21];
        uopq_mBIndex = _RANDOM[7'h3B][25:22];
        uopq_alignedType = _RANDOM[7'h3B][28:26];
        uopq_indexVlMaxInVd = {_RANDOM[7'h3B][31:29], _RANDOM[7'h3C][4:0]};
        regOffset = _RANDOM[7'h3C][8:5];
        uopq_usAligned128 = _RANDOM[7'h3C][9];
        uopq_usMask = {_RANDOM[7'h3C][31:10], _RANDOM[7'h3D][9:0]};
        allocated = _RANDOM[7'h3D][10];
        splitIdx = _RANDOM[7'h3D][15:11];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:16],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
  ...
  assign io_out_valid = _io_vstd_valid_T & _io_out_valid_T_1;
  ...
  assign io_out_bits_uop_exceptionVec_19 = uopq_uop_exceptionVec_19;
