...
module UncacheEntry_5(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_uncache_resp_valid) begin
        denied <= io_uncache_resp_bits_denied;
        corrupt <= io_uncache_resp_bits_corrupt;
      end
      else begin
        denied <= _GEN & denied;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_storeSetHit = _RANDOM[7'h27][7];
        req_uop_waitForRobIdx_flag = _RANDOM[7'h27][8];
        req_uop_waitForRobIdx_value = _RANDOM[7'h27][16:9];
        req_uop_loadWaitBit = _RANDOM[7'h27][17];
        req_uop_loadWaitStrict = _RANDOM[7'h27][18];
        req_uop_lqIdx_flag = _RANDOM[7'h27][24];
        req_uop_lqIdx_value = _RANDOM[7'h27][31:25];
        req_uop_sqIdx_flag = _RANDOM[7'h28][0];
        req_uop_sqIdx_value = _RANDOM[7'h28][6:1];
        req_uop_replayInst = _RANDOM[7'h28][8];
        req_vaddr = {_RANDOM[7'h28][31:14], _RANDOM[7'h29]};
        req_fullva = {_RANDOM[7'h2A], _RANDOM[7'h2B]};
        req_paddr = {_RANDOM[7'h2C][31:1], _RANDOM[7'h2D][16:0]};
        req_gpaddr = {_RANDOM[7'h2D][31:17], _RANDOM[7'h2E], _RANDOM[7'h2F][16:0]};
        req_mask = {_RANDOM[7'h2F][31:17], _RANDOM[7'h30][0]};
        req_nc = _RANDOM[7'h34][7];
        req_mmio = _RANDOM[7'h34][8];
        req_memBackTypeMM = _RANDOM[7'h34][9];
        req_isHyper = _RANDOM[7'h34][11];
        req_isForVSnonLeafPTE = _RANDOM[7'h34][12];
        req_isvec = _RANDOM[7'h39][2];
        req_is128bit = _RANDOM[7'h39][4];
        req_vecActive = _RANDOM[7'h3D][23];
        req_schedIndex = _RANDOM[7'h3E][20:14];
        slaveAccept = _RANDOM[7'h52][13];
        slaveId = _RANDOM[7'h52][17:14];
        uncacheState = _RANDOM[7'h52][19:18];
        uncacheData = {_RANDOM[7'h52][31:20], _RANDOM[7'h53], _RANDOM[7'h54][19:0]};
        denied = _RANDOM[7'h54][21];
        corrupt = _RANDOM[7'h54][22];
        needFlushReg = _RANDOM[7'h54][23];
        pendingld_last_REG = _RANDOM[7'h54][24];
        pendingPtr_next_r_flag = _RANDOM[7'h54][25];
        pendingPtr_next_r_value = {_RANDOM[7'h54][31:26], _RANDOM[7'h55][1:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
