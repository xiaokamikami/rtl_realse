  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_2_fuOpType = _RANDOM[8'h34][28:20];
        inPipe_1_2_src_2 =
          {_RANDOM[8'h3C][31:29],
           _RANDOM[8'h3D],
           _RANDOM[8'h3E],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[8'h44][31:29],
           ...
           _RANDOM[8'h47],
           _RANDOM[8'h48][28:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[8'h4A][29];
        inPipe_1_2_robIdx_value = {_RANDOM[8'h4A][31:30], _RANDOM[8'h4B][5:0]};
        inPipe_1_2_pdest = _RANDOM[8'h4B][17:11];
        inPipe_1_2_vecWen = _RANDOM[8'h4B][18];
        inPipe_1_2_v0Wen = _RANDOM[8'h4B][19];
        inPipe_1_2_fpu_wflags = _RANDOM[8'h4B][22];
        inPipe_1_2_vpu_vma = _RANDOM[8'h4B][31];
        inPipe_1_2_vpu_vta = _RANDOM[8'h4C][0];
        inPipe_1_2_vpu_vsew = _RANDOM[8'h4C][2:1];
        inPipe_1_2_vpu_vlmul = _RANDOM[8'h4C][5:3];
        inPipe_1_2_vpu_vm = _RANDOM[8'h4C][14];
        inPipe_1_2_vpu_vstart = _RANDOM[8'h4C][22:15];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[8'h4D][9:3];
        inPipe_1_2_vpu_isNarrow = _RANDOM[8'h51][26];
        inPipe_1_2_vpu_isDstMask = _RANDOM[8'h51][27];
        inPipe_1_3_fuOpType = {_RANDOM[8'h67][31:25], _RANDOM[8'h68][1:0]};
        inPipe_1_3_src_2 =
          {_RANDOM[8'h70][31:2],
           _RANDOM[8'h71],
           _RANDOM[8'h72],
        ...
        inPipe_1_3_src_4 =
          {_RANDOM[8'h78][31:2],
           ...
           _RANDOM[8'h7B],
           _RANDOM[8'h7C][1:0]};
        inPipe_1_3_robIdx_flag = _RANDOM[8'h7E][2];
        inPipe_1_3_robIdx_value = _RANDOM[8'h7E][10:3];
        inPipe_1_3_pdest = _RANDOM[8'h7E][22:16];
        inPipe_1_3_vecWen = _RANDOM[8'h7E][23];
        inPipe_1_3_v0Wen = _RANDOM[8'h7E][24];
        inPipe_1_3_fpu_wflags = _RANDOM[8'h7E][27];
        inPipe_1_3_vpu_vma = _RANDOM[8'h7F][4];
        inPipe_1_3_vpu_vta = _RANDOM[8'h7F][5];
        inPipe_1_3_vpu_vsew = _RANDOM[8'h7F][7:6];
        inPipe_1_3_vpu_vlmul = _RANDOM[8'h7F][10:8];
        inPipe_1_3_vpu_vm = _RANDOM[8'h7F][19];
        inPipe_1_3_vpu_vstart = _RANDOM[8'h7F][27:20];
        inPipe_1_3_vpu_vuopIdx = _RANDOM[8'h80][14:8];
        inPipe_1_3_vpu_isNarrow = _RANDOM[8'h84][31];
        inPipe_1_3_vpu_isDstMask = _RANDOM[8'h85][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
