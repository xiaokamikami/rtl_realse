...
module IPrefetchPipe(
  ...
  wire        s2_mmio_0 =
    (s2_pmp_mmio_REG ? io_pmp_0_resp_mmio : s2_pmp_mmio_r_0) | s2_itlb_pbmt_0 == 2'h1
    | s2_itlb_pbmt_0 == 2'h2;
  ...
  wire        s2_miss_1 =
    ...
    & ~s2_mmio_0
    & ~((s2_pmp_mmio_REG ? io_pmp_1_resp_mmio : s2_pmp_mmio_r_1) | s2_itlb_pbmt_1 == 2'h1
        | s2_itlb_pbmt_1 == 2'h2);
  reg         has_send_0;
  reg         has_send_1;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_itlb_exception_0 = _RANDOM[5'h11][13:12];
        s2_itlb_exception_1 = _RANDOM[5'h11][15:14];
        s2_itlb_pbmt_0 = _RANDOM[5'h11][17:16];
        s2_itlb_pbmt_1 = _RANDOM[5'h11][19:18];
        s2_waymasks_0 = _RANDOM[5'h11][23:20];
        s2_waymasks_1 = _RANDOM[5'h11][27:24];
        s2_pmp_exception_REG = _RANDOM[5'h11][28];
        s2_pmp_exception_r_0 = _RANDOM[5'h11][30:29];
        s2_pmp_exception_r_1 = {_RANDOM[5'h11][31], _RANDOM[5'h12][0]};
        s2_pmp_mmio_REG = _RANDOM[5'h12][1];
        s2_pmp_mmio_r_0 = _RANDOM[5'h12][2];
        s2_pmp_mmio_r_1 = _RANDOM[5'h12][3];
        s2_MSHR_hits_valid = _RANDOM[5'h12][4];
        s2_MSHR_hits_valid_1 = _RANDOM[5'h12][5];
        has_send_0 = _RANDOM[5'h12][6];
        has_send_1 = _RANDOM[5'h12][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 50'h0;
