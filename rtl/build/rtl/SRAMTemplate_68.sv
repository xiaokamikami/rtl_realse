...
module SRAMTemplate_68(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h1][19];
        rdata_last_REG = _RANDOM[4'h9][20];
        rdata_hold_data_0 = _RANDOM[4'h9][26:21];
        rdata_hold_data_1 = {_RANDOM[4'h9][31:27], _RANDOM[4'hA][0]};
        rdata_hold_data_2 = _RANDOM[4'hA][6:1];
        rdata_hold_data_3 = _RANDOM[4'hA][12:7];
        rdataReg = {_RANDOM[4'hA][31:13], _RANDOM[4'hB][4:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
  ...
  sram_array_1p128x24m6s1h0l1b_bp_sc array (
  ...
  assign io_r_resp_data_0 = rdata_last_REG ? _array_RW0_rdata[5:0] : rdata_hold_data_0;
  assign io_r_resp_data_1 = rdata_last_REG ? _array_RW0_rdata[11:6] : rdata_hold_data_1;
  assign io_r_resp_data_2 = rdata_last_REG ? _array_RW0_rdata[17:12] : rdata_hold_data_2;
  assign io_r_resp_data_3 = rdata_last_REG ? _array_RW0_rdata[23:18] : rdata_hold_data_3;
