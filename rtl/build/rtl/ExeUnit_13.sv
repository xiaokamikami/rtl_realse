  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_2_fuOpType = {_RANDOM[8'h34][31:28], _RANDOM[8'h35][4:0]};
        inPipe_1_2_src_2 =
          {_RANDOM[8'h3D][31:5],
           _RANDOM[8'h3E],
           _RANDOM[8'h3F],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[8'h45][31:5],
           ...
           _RANDOM[8'h48],
           _RANDOM[8'h49][4:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[8'h4B][5];
        inPipe_1_2_robIdx_value = _RANDOM[8'h4B][13:6];
        inPipe_1_2_pdest = _RANDOM[8'h4B][25:19];
        inPipe_1_2_vecWen = _RANDOM[8'h4B][26];
        inPipe_1_2_v0Wen = _RANDOM[8'h4B][27];
        inPipe_1_2_fpu_wflags = _RANDOM[8'h4B][30];
        inPipe_1_2_vpu_vma = _RANDOM[8'h4C][7];
        inPipe_1_2_vpu_vta = _RANDOM[8'h4C][8];
        inPipe_1_2_vpu_vsew = _RANDOM[8'h4C][10:9];
        inPipe_1_2_vpu_vlmul = _RANDOM[8'h4C][13:11];
        inPipe_1_2_vpu_vm = _RANDOM[8'h4C][22];
        inPipe_1_2_vpu_vstart = _RANDOM[8'h4C][30:23];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[8'h4D][17:11];
        inPipe_1_2_vpu_isNarrow = _RANDOM[8'h52][2];
        inPipe_1_2_vpu_isDstMask = _RANDOM[8'h52][3];
        inPipe_1_3_fuOpType = _RANDOM[8'h68][9:1];
        inPipe_1_3_src_2 =
          {_RANDOM[8'h70][31:10],
           _RANDOM[8'h71],
           _RANDOM[8'h72],
        ...
        inPipe_1_3_src_4 =
          {_RANDOM[8'h78][31:10],
           ...
           _RANDOM[8'h7B],
           _RANDOM[8'h7C][9:0]};
        inPipe_1_3_robIdx_flag = _RANDOM[8'h7E][10];
        inPipe_1_3_robIdx_value = _RANDOM[8'h7E][18:11];
        inPipe_1_3_pdest = _RANDOM[8'h7E][30:24];
        inPipe_1_3_vecWen = _RANDOM[8'h7E][31];
        inPipe_1_3_v0Wen = _RANDOM[8'h7F][0];
        inPipe_1_3_fpu_wflags = _RANDOM[8'h7F][3];
        inPipe_1_3_vpu_vma = _RANDOM[8'h7F][12];
        inPipe_1_3_vpu_vta = _RANDOM[8'h7F][13];
        inPipe_1_3_vpu_vsew = _RANDOM[8'h7F][15:14];
        inPipe_1_3_vpu_vlmul = _RANDOM[8'h7F][18:16];
        inPipe_1_3_vpu_vm = _RANDOM[8'h7F][27];
        inPipe_1_3_vpu_vstart = {_RANDOM[8'h7F][31:28], _RANDOM[8'h80][3:0]};
        inPipe_1_3_vpu_vuopIdx = _RANDOM[8'h80][22:16];
        inPipe_1_3_vpu_isNarrow = _RANDOM[8'h85][7];
        inPipe_1_3_vpu_isDstMask = _RANDOM[8'h85][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
