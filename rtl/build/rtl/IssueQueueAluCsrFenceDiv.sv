  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h29][8];
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h29][16:9];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h29][27:20];
        deqDelay_0_bits_rcIdx_0 = _RANDOM[7'h2A][11:7];
        deqDelay_0_bits_rcIdx_1 = _RANDOM[7'h2A][16:12];
        deqDelay_0_bits_immType = _RANDOM[7'h2A][20:17];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h2A][31:21], _RANDOM[7'h2B][23:0]};
        deqDelay_0_bits_common_fuOpType = {_RANDOM[7'h2B][31:24], _RANDOM[7'h2C][0]};
        deqDelay_0_bits_common_imm =
          {_RANDOM[7'h30][31:1], _RANDOM[7'h31], _RANDOM[7'h32][0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h32][1];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h32][9:2];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h32][22:15];
        deqDelay_0_bits_common_rfWen = _RANDOM[7'h32][23];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h32][27:24];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h32][31:28];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[7'h33][2:0];
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[7'h33][5:3];
        deqDelay_0_bits_common_loadDependency_0 = _RANDOM[7'h33][13:12];
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[7'h33][15:14];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[7'h33][17:16];
        io_validCntDeqVec_0_REG = _RANDOM[7'h48][16:11];
      `endif // RANDOMIZE_REG_INIT
    end // initial
