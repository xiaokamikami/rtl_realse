...
module PTW(
  ...
  wire             _GEN_2 = perfEvents_0_2 & jmp_bitmap_check_w;
  wire             _GEN_3 = perfEvents_0_2 & io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_4 = _GEN_3 | _GEN_2;
  wire             _GEN_5 = perfEvents_0_2 & ~io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_6 =
    ((|io_req_bits_req_info_s2xlate) ? io_csr_vsatp_mode : io_csr_satp_mode) == 4'h9;
  wire             _GEN_7 = _GEN_6 & io_req_bits_l3Hit;
  wire             _GEN_8 = _GEN_7 | io_req_bits_l2Hit;
  wire             _GEN_9 = _GEN_5 | _GEN_2;
  wire             _GEN_10 = _GEN_5 | _GEN_4;
  wire             _check_gpa_high_fail_T = io_req_bits_req_info_s2xlate == 2'h2;
  wire             _GEN_11 = io_hptw_resp_valid & ~w_hptw_resp;
  wire             g_perm_fail =
  ...
  wire             _GEN_12 = io_hptw_resp_valid & ~w_last_hptw_resp;
  wire             _GEN_13 = _GEN_12 & stage1Hit;
  wire             _GEN_14 = _GEN_12 & ~stage1Hit;
  ...
  wire             _GEN_17 = mem_addr_update & _GEN_16;
  wire             vs_finish = _GEN_17 & s2xlate;
  wire             _GEN_18 = s2xlate & need_last_s2xlate;
  wire             finish =
    mem_addr_update & ~_GEN_16 & (io_llptw_valid_0 | ~_GEN_18 & io_resp_valid_0);
  reg              perfEvents_5_2;
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin
      ppn <= _GEN_8 ? io_req_bits_ppn : current_satp_ppn;
      l3Hit <= _GEN_7;
    ...
    hptw_resp_stage2 <= _GEN_13 | ~_GEN_3 & hptw_resp_stage2;
    if (_GEN_14 | _GEN_13 | _GEN_11) begin
    ...
    if (update_full_gvpn_mem_resp)
      ...
      full_gvpn_reg <=
        _GEN_20[full_gvpn_reg_idx] == 2'h0
          ? (_GEN_23[full_gvpn_reg_idx]
               ? {_GEN_21[full_gvpn_reg_idx][40:1],
                  _GEN_19[full_gvpn_reg_idx][0],
                  |full_gvpn_reg_idx_hi_1,
                  |(_full_gvpn_reg_idx_T_2[2:1]),
                  _full_gvpn_reg_idx_T_4}
               : {_GEN_21[full_gvpn_reg_idx], _GEN_22[full_gvpn_reg_idx]})
          : {_GEN_20[full_gvpn_reg_idx] == 2'h1
               ? {_GEN_21[full_gvpn_reg_idx][40:6], _GEN_19[full_gvpn_reg_idx][5:0]}
               : _GEN_20[full_gvpn_reg_idx] == 2'h2
                   ? {_GEN_21[full_gvpn_reg_idx][40:15], _GEN_19[full_gvpn_reg_idx][14:0]}
                   : {_GEN_21[full_gvpn_reg_idx][40:24],
                      _GEN_19[full_gvpn_reg_idx][23:0]},
             |full_gvpn_reg_idx_hi_1,
             |(_full_gvpn_reg_idx_T_2[2:1]),
             _full_gvpn_reg_idx_T_4};
  ...
  wire             _GEN_25 = ~_GEN_4 & need_last_s2xlate;
  wire             _GEN_26 = io_resp_ready & io_resp_valid_0;
  wire [1:0]       _GEN_27 =
    io_req_bits_l2Hit ? 2'h1 : _GEN_6 ? {1'h1, ~io_req_bits_l3Hit} : 2'h2;
  wire [14:0]      gvpn_wire = _GEN_8 ? io_req_bits_ppn[43:29] : current_satp_ppn[43:29];
  wire             _GEN_28 = ~_GEN_5 & (_GEN_26 & stage1Hit | ~_GEN_4 & idle);
  ...
  wire             _GEN_29 = (&io_req_bits_req_info_s2xlate) & check_gpa_high_fail_1;
  wire             _GEN_30 = io_hptw_req_ready & io_hptw_req_valid_0;
  wire             _GEN_31 = _GEN_30 & ~s_hptw_req;
  wire             _GEN_32 =
  ...
  wire             _GEN_33 =
    ...
    & (_GEN_5
         ? ~_check_gpa_high_fail_T & (&io_req_bits_req_info_s2xlate)
           & (~check_gpa_high_fail_1 | _GEN_25)
         : _GEN_25);
  wire             _GEN_34 = _GEN_30 & ~s_last_hptw_req;
  wire             _GEN_35 = sent_to_pmp & ~mem_addr_update;
  wire             _GEN_36 = accessFault & ~idle;
  wire             _GEN_37 = guestFault & ~idle;
  wire             _GEN_38 = _GEN_37 | _GEN_36;
  wire             _GEN_39 = io_mem_resp_valid & ~w_mem_resp;
  wire             _GEN_40 =
    bitmap_enable & (~(|req_s2xlate) | onlyS1xlate) & (_find_pte_T | pte_perm_w)
    & pte_perm_v & ~pageFault;
  wire             _GEN_41 =
    (~whether_need_bitmap_check | _GEN_40) & (~_GEN_39 | bitmap_enable)
    & (_GEN_38 | s_llptw_req);
  wire             _GEN_42 = io_bitmap_req_ready & ~s_bitmap_check;
  wire             _GEN_43 = ~w_bitmap_resp & io_bitmap_resp_valid;
  wire             _GEN_44 =
    _GEN_43 | whether_need_bitmap_check & ~_GEN_40 | _GEN_39 & ~bitmap_enable | _GEN_37
    | _GEN_36 | _GEN_14 | _GEN_11 & _GEN_32
    | (_GEN_5
         ? (_check_gpa_high_fail_T
              ? check_gpa_high_fail | mem_addr_update
              : _GEN_29 | mem_addr_update)
         : mem_addr_update);
  wire             _GEN_45 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_46 = ~mem_addr_update | _GEN_16;
  wire             _GEN_47 = guestFault | accessFault | pageFault | ppn_af;
  wire             _GEN_48 = io_resp_valid_0 & _GEN_26;
  wire             _GEN_49 = ~_GEN_18 & _GEN_48;
  wire             _GEN_50 = _GEN_16 | io_llptw_valid_0 | _GEN_18;
  wire             _GEN_51 = ~mem_addr_update | _GEN_50 | ~_GEN_48;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s_pmp_check <=
        flush | _GEN_37 | _GEN_36 | _GEN_35 | ~(_GEN_11 & ~_GEN_32)
        & (~_GEN_5 | _check_gpa_high_fail_T | (&io_req_bits_req_info_s2xlate))
        & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_17 | s2xlate) & (perfEvents_4_2 | _GEN_38 | ~_GEN_35 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_16 | (io_llptw_valid_0 ? _GEN_45 | _GEN_41 : _GEN_49 | _GEN_41)
             : _GEN_41);
      w_mem_resp <= flush | _GEN_39 | ~perfEvents_4_2 & (_GEN_38 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_16 & s2xlate)
        & (_GEN_37 | _GEN_36 | _GEN_31
           | (~_GEN_5 | _check_gpa_high_fail_T | ~(&io_req_bits_req_info_s2xlate)
              | check_gpa_high_fail_1) & s_hptw_req);
      w_hptw_resp <= flush | _GEN_37 | _GEN_36 | _GEN_11 | ~_GEN_31 & w_hptw_resp;
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_16 | io_llptw_valid_0 | ~(_GEN_18 & ~_GEN_47))
        & (_GEN_37 | _GEN_36 | _GEN_34
           | (~(_GEN_5 & _check_gpa_high_fail_T) | check_gpa_high_fail) & ~_GEN_3
           & s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_37 | _GEN_36 | _GEN_15 | ~_GEN_34 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_16
               & (io_llptw_valid_0
                    ? ~_GEN_45 & _GEN_44
                    : _GEN_18 ? _GEN_47 & _GEN_44 : ~_GEN_48 & _GEN_44)
             : _GEN_44);
      s_bitmap_check <=
        flush | _GEN_42 | ~(whether_need_bitmap_check & _GEN_40)
        & (_GEN_38 | ~_GEN_2 & s_bitmap_check);
      w_bitmap_resp <= flush | _GEN_43 | ~_GEN_42 & (_GEN_38 | w_bitmap_resp);
      whether_need_bitmap_check <=
        ~(flush | whether_need_bitmap_check)
        & (_GEN_39 ? bitmap_enable : ~_GEN_38 & whether_need_bitmap_check);
      bitmap_checkfailed <=
        ~flush & _GEN_51
        & (_GEN_43 ? io_bitmap_resp_bits_cf : ~_GEN_38 & bitmap_checkfailed);
      idle <=
        flush
        | (_GEN_46 ? _GEN_28 : io_llptw_valid_0 ? _GEN_45 | _GEN_28 : _GEN_49 | _GEN_28);
      if (_GEN_14)
        hptw_pageFault <= io_hptw_resp_bits_h_resp_gpf;
      else if (_GEN_11)
        hptw_pageFault <= _hptw_resp_gpf_T;
      else
        hptw_pageFault <= ~_GEN_10 & hptw_pageFault;
      if (_GEN_14 | _GEN_11)
        hptw_accessFault <= io_hptw_resp_bits_h_resp_gaf;
      else
        hptw_accessFault <= ~_GEN_10 & hptw_accessFault;
      if (_GEN_46)
        need_last_s2xlate <= ~_GEN_38 & _GEN_33;
      else if (io_llptw_valid_0)
        need_last_s2xlate <= ~(_GEN_45 | _GEN_38) & _GEN_33;
      else
        need_last_s2xlate <= ~(_GEN_18 | _GEN_38) & _GEN_33;
      first_gvpn_check_fail <=
        ~flush & _GEN_51
        & (_GEN_5
             ? (_check_gpa_high_fail_T
                  ? check_gpa_high_fail | first_gvpn_check_fail
                  : _GEN_29 | first_gvpn_check_fail)
             : first_gvpn_check_fail);
      pte_valid <= _GEN_39 | ~_GEN_5 & (_GEN_2 | pte_valid);
      accessFault <=
        ~flush
        & (~mem_addr_update | _GEN_50 | ~io_resp_valid_0
             ? ~_GEN_9 & _GEN_24
             : ~(_GEN_26 | _GEN_9) & _GEN_24);
      update_full_gvpn_mem_resp <=
        ~update_full_gvpn_mem_resp & (_GEN_39 | update_full_gvpn_mem_resp);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        hptw_resp_entry_perm_g = _RANDOM[6'h28][30];
        hptw_resp_entry_perm_u = _RANDOM[6'h28][31];
