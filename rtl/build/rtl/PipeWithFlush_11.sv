  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_robIdx_value = {_RANDOM[7'h28][31:26], _RANDOM[7'h29][1:0]};
        bits_2_pdest = _RANDOM[7'h29][14:7];
        bits_2_fpWen = _RANDOM[7'h29][16];
        bits_3_robIdx_flag = _RANDOM[7'h48][3];
        bits_3_robIdx_value = _RANDOM[7'h48][11:4];
        bits_3_pdest = _RANDOM[7'h48][24:17];
        bits_3_fpWen = _RANDOM[7'h48][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
