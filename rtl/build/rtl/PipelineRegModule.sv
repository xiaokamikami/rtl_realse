...
module PipelineRegModule(
  ...
  reg  [7:0]  io_out_bits_r_robIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_robIdx_value = _RANDOM[3'h0][9:2];
        io_out_bits_r_cmd = _RANDOM[3'h0][14:10];
        io_out_bits_r_addr = {_RANDOM[3'h0][31:15], _RANDOM[3'h1][30:0]};
        io_out_bits_r_vaddr = {_RANDOM[3'h1][31], _RANDOM[3'h2], _RANDOM[3'h3][16:0]};
        io_out_bits_r_data = {_RANDOM[3'h3][31:17], _RANDOM[3'h4], _RANDOM[3'h5][16:0]};
        io_out_bits_r_mask = _RANDOM[3'h5][24:17];
        io_out_bits_r_id = _RANDOM[3'h5][31:25];
        io_out_bits_r_nc = _RANDOM[3'h6][4];
        io_out_bits_r_memBackTypeMM = _RANDOM[3'h6][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
