  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_storeSetHit = _RANDOM[6'h2A][25];
        entryReg_payload_waitForRobIdx_flag = _RANDOM[6'h2A][26];
        entryReg_payload_waitForRobIdx_value =
          {_RANDOM[6'h2A][31:27], _RANDOM[6'h2B][2:0]};
        entryReg_payload_loadWaitBit = _RANDOM[6'h2B][3];
        entryReg_payload_loadWaitStrict = _RANDOM[6'h2B][4];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2B][10];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2B][17:11];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2B][18];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2B][24:19];
        enqDelayValidReg_last_REG = _RANDOM[6'h2C][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
