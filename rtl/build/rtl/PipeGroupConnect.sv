  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataVec_0_numLsElem = _RANDOM[8'h28][18:14];
        dataVec_1_instr = {_RANDOM[8'h28][31:19], _RANDOM[8'h29][18:0]};
        dataVec_1_exceptionVec_0 = _RANDOM[8'h2B][15];
        dataVec_1_exceptionVec_1 = _RANDOM[8'h2B][16];
        dataVec_1_exceptionVec_2 = _RANDOM[8'h2B][17];
        dataVec_1_exceptionVec_3 = _RANDOM[8'h2B][18];
        dataVec_1_exceptionVec_4 = _RANDOM[8'h2B][19];
        dataVec_1_exceptionVec_5 = _RANDOM[8'h2B][20];
        dataVec_1_exceptionVec_6 = _RANDOM[8'h2B][21];
        dataVec_1_exceptionVec_7 = _RANDOM[8'h2B][22];
        dataVec_1_exceptionVec_8 = _RANDOM[8'h2B][23];
        dataVec_1_exceptionVec_9 = _RANDOM[8'h2B][24];
        dataVec_1_exceptionVec_10 = _RANDOM[8'h2B][25];
        dataVec_1_exceptionVec_11 = _RANDOM[8'h2B][26];
        dataVec_1_exceptionVec_12 = _RANDOM[8'h2B][27];
        dataVec_1_exceptionVec_13 = _RANDOM[8'h2B][28];
        dataVec_1_exceptionVec_14 = _RANDOM[8'h2B][29];
        dataVec_1_exceptionVec_15 = _RANDOM[8'h2B][30];
        dataVec_1_exceptionVec_16 = _RANDOM[8'h2B][31];
        dataVec_1_exceptionVec_17 = _RANDOM[8'h2C][0];
        dataVec_1_exceptionVec_18 = _RANDOM[8'h2C][1];
        dataVec_1_exceptionVec_19 = _RANDOM[8'h2C][2];
        dataVec_1_exceptionVec_20 = _RANDOM[8'h2C][3];
        dataVec_1_exceptionVec_21 = _RANDOM[8'h2C][4];
        dataVec_1_exceptionVec_22 = _RANDOM[8'h2C][5];
        dataVec_1_exceptionVec_23 = _RANDOM[8'h2C][6];
        dataVec_1_isFetchMalAddr = _RANDOM[8'h2C][7];
        dataVec_1_hasException = _RANDOM[8'h2C][8];
        dataVec_1_trigger = _RANDOM[8'h2C][12:9];
        dataVec_1_preDecodeInfo_isRVC = _RANDOM[8'h2C][14];
        dataVec_1_pred_taken = _RANDOM[8'h2C][19];
        dataVec_1_crossPageIPFFix = _RANDOM[8'h2C][20];
        dataVec_1_ftqPtr_flag = _RANDOM[8'h2C][21];
        dataVec_1_ftqPtr_value = _RANDOM[8'h2C][27:22];
        dataVec_1_ftqOffset = _RANDOM[8'h2C][31:28];
        dataVec_1_srcType_0 = _RANDOM[8'h2D][3:0];
        dataVec_1_srcType_1 = _RANDOM[8'h2D][7:4];
        dataVec_1_srcType_2 = _RANDOM[8'h2D][11:8];
        dataVec_1_srcType_3 = _RANDOM[8'h2D][15:12];
        dataVec_1_srcType_4 = _RANDOM[8'h2D][19:16];
        dataVec_1_ldest = _RANDOM[8'h2D][25:20];
        dataVec_1_fuType = {_RANDOM[8'h2D][31:26], _RANDOM[8'h2E][28:0]};
        dataVec_1_fuOpType = {_RANDOM[8'h2E][31:29], _RANDOM[8'h2F][5:0]};
        dataVec_1_rfWen = _RANDOM[8'h2F][6];
        dataVec_1_fpWen = _RANDOM[8'h2F][7];
        dataVec_1_vecWen = _RANDOM[8'h2F][8];
        dataVec_1_v0Wen = _RANDOM[8'h2F][9];
        dataVec_1_vlWen = _RANDOM[8'h2F][10];
        dataVec_1_isXSTrap = _RANDOM[8'h2F][11];
        dataVec_1_waitForward = _RANDOM[8'h2F][12];
        dataVec_1_blockBackward = _RANDOM[8'h2F][13];
        dataVec_1_flushPipe = _RANDOM[8'h2F][14];
        dataVec_1_selImm = _RANDOM[8'h2F][19:16];
        dataVec_1_imm = {_RANDOM[8'h2F][31:20], _RANDOM[8'h30][19:0]};
        dataVec_1_fpu_typeTagOut = _RANDOM[8'h30][21:20];
        dataVec_1_fpu_wflags = _RANDOM[8'h30][22];
        dataVec_1_fpu_typ = _RANDOM[8'h30][24:23];
        dataVec_1_fpu_fmt = _RANDOM[8'h30][26:25];
        dataVec_1_fpu_rm = _RANDOM[8'h30][29:27];
        dataVec_1_vpu_vill = _RANDOM[8'h30][30];
        dataVec_1_vpu_vma = _RANDOM[8'h30][31];
        dataVec_1_vpu_vta = _RANDOM[8'h31][0];
        dataVec_1_vpu_vsew = _RANDOM[8'h31][2:1];
        dataVec_1_vpu_vlmul = _RANDOM[8'h31][5:3];
        dataVec_1_vpu_specVill = _RANDOM[8'h31][6];
        dataVec_1_vpu_specVma = _RANDOM[8'h31][7];
        dataVec_1_vpu_specVta = _RANDOM[8'h31][8];
        dataVec_1_vpu_specVsew = _RANDOM[8'h31][10:9];
        dataVec_1_vpu_specVlmul = _RANDOM[8'h31][13:11];
        dataVec_1_vpu_vm = _RANDOM[8'h31][14];
        dataVec_1_vpu_vstart = _RANDOM[8'h31][22:15];
        dataVec_1_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h31][30];
        dataVec_1_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h31][31];
        dataVec_1_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h32][0];
        dataVec_1_vpu_vmask =
          {_RANDOM[8'h32][31:11],
           _RANDOM[8'h33],
           _RANDOM[8'h34],
           _RANDOM[8'h35],
           _RANDOM[8'h36][10:0]};
        dataVec_1_vpu_nf = _RANDOM[8'h36][21:19];
        dataVec_1_vpu_veew = _RANDOM[8'h36][23:22];
        dataVec_1_vpu_isExt = _RANDOM[8'h36][25];
        dataVec_1_vpu_isNarrow = _RANDOM[8'h36][26];
        dataVec_1_vpu_isDstMask = _RANDOM[8'h36][27];
        dataVec_1_vpu_isOpMask = _RANDOM[8'h36][28];
        dataVec_1_vpu_isDependOldVd = _RANDOM[8'h36][30];
        dataVec_1_vpu_isWritePartVd = _RANDOM[8'h36][31];
        dataVec_1_vpu_isVleff = _RANDOM[8'h37][0];
        dataVec_1_vlsInstr = _RANDOM[8'h37][1];
        dataVec_1_wfflags = _RANDOM[8'h37][2];
        dataVec_1_isMove = _RANDOM[8'h37][3];
        dataVec_1_uopIdx = _RANDOM[8'h37][11:5];
        dataVec_1_isVset = _RANDOM[8'h37][12];
        dataVec_1_firstUop = _RANDOM[8'h37][13];
        dataVec_1_lastUop = _RANDOM[8'h37][14];
        dataVec_1_numWB = _RANDOM[8'h37][28:22];
        dataVec_1_commitType = _RANDOM[8'h37][31:29];
        dataVec_1_psrc_0 = _RANDOM[8'h39][10:3];
        dataVec_1_psrc_1 = _RANDOM[8'h39][18:11];
        dataVec_1_psrc_2 = _RANDOM[8'h39][26:19];
        dataVec_1_psrc_3 = {_RANDOM[8'h39][31:27], _RANDOM[8'h3A][2:0]};
        dataVec_1_psrc_4 = _RANDOM[8'h3A][10:3];
        dataVec_1_pdest = _RANDOM[8'h3A][18:11];
        dataVec_1_robIdx_flag = _RANDOM[8'h3A][31];
        dataVec_1_robIdx_value = _RANDOM[8'h3B][7:0];
        dataVec_1_instrSize = _RANDOM[8'h3B][10:8];
        dataVec_1_dirtyFs = _RANDOM[8'h3B][11];
        dataVec_1_dirtyVs = _RANDOM[8'h3B][12];
        dataVec_1_traceBlockInPipe_itype = _RANDOM[8'h3B][16:13];
        dataVec_1_traceBlockInPipe_iretire = _RANDOM[8'h3B][20:17];
        dataVec_1_traceBlockInPipe_ilastsize = _RANDOM[8'h3B][21];
        dataVec_1_eliminatedMove = _RANDOM[8'h3B][22];
        dataVec_1_numLsElem = _RANDOM[8'h50][31:27];
        dataVec_2_instr = _RANDOM[8'h51];
        dataVec_2_exceptionVec_0 = _RANDOM[8'h53][28];
        dataVec_2_exceptionVec_1 = _RANDOM[8'h53][29];
        dataVec_2_exceptionVec_2 = _RANDOM[8'h53][30];
        dataVec_2_exceptionVec_3 = _RANDOM[8'h53][31];
        dataVec_2_exceptionVec_4 = _RANDOM[8'h54][0];
        dataVec_2_exceptionVec_5 = _RANDOM[8'h54][1];
        dataVec_2_exceptionVec_6 = _RANDOM[8'h54][2];
        dataVec_2_exceptionVec_7 = _RANDOM[8'h54][3];
        dataVec_2_exceptionVec_8 = _RANDOM[8'h54][4];
        dataVec_2_exceptionVec_9 = _RANDOM[8'h54][5];
        dataVec_2_exceptionVec_10 = _RANDOM[8'h54][6];
        dataVec_2_exceptionVec_11 = _RANDOM[8'h54][7];
        dataVec_2_exceptionVec_12 = _RANDOM[8'h54][8];
        dataVec_2_exceptionVec_13 = _RANDOM[8'h54][9];
        dataVec_2_exceptionVec_14 = _RANDOM[8'h54][10];
        dataVec_2_exceptionVec_15 = _RANDOM[8'h54][11];
        dataVec_2_exceptionVec_16 = _RANDOM[8'h54][12];
        dataVec_2_exceptionVec_17 = _RANDOM[8'h54][13];
        dataVec_2_exceptionVec_18 = _RANDOM[8'h54][14];
        dataVec_2_exceptionVec_19 = _RANDOM[8'h54][15];
        dataVec_2_exceptionVec_20 = _RANDOM[8'h54][16];
        dataVec_2_exceptionVec_21 = _RANDOM[8'h54][17];
        dataVec_2_exceptionVec_22 = _RANDOM[8'h54][18];
        dataVec_2_exceptionVec_23 = _RANDOM[8'h54][19];
        dataVec_2_isFetchMalAddr = _RANDOM[8'h54][20];
        dataVec_2_hasException = _RANDOM[8'h54][21];
        dataVec_2_trigger = _RANDOM[8'h54][25:22];
        dataVec_2_preDecodeInfo_isRVC = _RANDOM[8'h54][27];
        dataVec_2_pred_taken = _RANDOM[8'h55][0];
        dataVec_2_crossPageIPFFix = _RANDOM[8'h55][1];
        dataVec_2_ftqPtr_flag = _RANDOM[8'h55][2];
        dataVec_2_ftqPtr_value = _RANDOM[8'h55][8:3];
        dataVec_2_ftqOffset = _RANDOM[8'h55][12:9];
        dataVec_2_srcType_0 = _RANDOM[8'h55][16:13];
        dataVec_2_srcType_1 = _RANDOM[8'h55][20:17];
        dataVec_2_srcType_2 = _RANDOM[8'h55][24:21];
        dataVec_2_srcType_3 = _RANDOM[8'h55][28:25];
        dataVec_2_srcType_4 = {_RANDOM[8'h55][31:29], _RANDOM[8'h56][0]};
        dataVec_2_ldest = _RANDOM[8'h56][6:1];
        dataVec_2_fuType = {_RANDOM[8'h56][31:7], _RANDOM[8'h57][9:0]};
        dataVec_2_fuOpType = _RANDOM[8'h57][18:10];
        dataVec_2_rfWen = _RANDOM[8'h57][19];
        dataVec_2_fpWen = _RANDOM[8'h57][20];
        dataVec_2_vecWen = _RANDOM[8'h57][21];
        dataVec_2_v0Wen = _RANDOM[8'h57][22];
        dataVec_2_vlWen = _RANDOM[8'h57][23];
        dataVec_2_isXSTrap = _RANDOM[8'h57][24];
        dataVec_2_waitForward = _RANDOM[8'h57][25];
        dataVec_2_blockBackward = _RANDOM[8'h57][26];
        dataVec_2_flushPipe = _RANDOM[8'h57][27];
        dataVec_2_selImm = {_RANDOM[8'h57][31:29], _RANDOM[8'h58][0]};
        dataVec_2_imm = {_RANDOM[8'h58][31:1], _RANDOM[8'h59][0]};
        dataVec_2_fpu_typeTagOut = _RANDOM[8'h59][2:1];
        dataVec_2_fpu_wflags = _RANDOM[8'h59][3];
        dataVec_2_fpu_typ = _RANDOM[8'h59][5:4];
        dataVec_2_fpu_fmt = _RANDOM[8'h59][7:6];
        dataVec_2_fpu_rm = _RANDOM[8'h59][10:8];
        dataVec_2_vpu_vill = _RANDOM[8'h59][11];
        dataVec_2_vpu_vma = _RANDOM[8'h59][12];
        dataVec_2_vpu_vta = _RANDOM[8'h59][13];
        dataVec_2_vpu_vsew = _RANDOM[8'h59][15:14];
        dataVec_2_vpu_vlmul = _RANDOM[8'h59][18:16];
        dataVec_2_vpu_specVill = _RANDOM[8'h59][19];
        dataVec_2_vpu_specVma = _RANDOM[8'h59][20];
        dataVec_2_vpu_specVta = _RANDOM[8'h59][21];
        dataVec_2_vpu_specVsew = _RANDOM[8'h59][23:22];
        dataVec_2_vpu_specVlmul = _RANDOM[8'h59][26:24];
        dataVec_2_vpu_vm = _RANDOM[8'h59][27];
        dataVec_2_vpu_vstart = {_RANDOM[8'h59][31:28], _RANDOM[8'h5A][3:0]};
        dataVec_2_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h5A][11];
        dataVec_2_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h5A][12];
        dataVec_2_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h5A][13];
        dataVec_2_vpu_vmask =
          {_RANDOM[8'h5A][31:24],
           _RANDOM[8'h5B],
           _RANDOM[8'h5C],
           _RANDOM[8'h5D],
           _RANDOM[8'h5E][23:0]};
        dataVec_2_vpu_nf = _RANDOM[8'h5F][2:0];
        dataVec_2_vpu_veew = _RANDOM[8'h5F][4:3];
        dataVec_2_vpu_isExt = _RANDOM[8'h5F][6];
        dataVec_2_vpu_isNarrow = _RANDOM[8'h5F][7];
        dataVec_2_vpu_isDstMask = _RANDOM[8'h5F][8];
        dataVec_2_vpu_isOpMask = _RANDOM[8'h5F][9];
        dataVec_2_vpu_isDependOldVd = _RANDOM[8'h5F][11];
        dataVec_2_vpu_isWritePartVd = _RANDOM[8'h5F][12];
        dataVec_2_vpu_isVleff = _RANDOM[8'h5F][13];
        dataVec_2_vlsInstr = _RANDOM[8'h5F][14];
        dataVec_2_wfflags = _RANDOM[8'h5F][15];
        dataVec_2_isMove = _RANDOM[8'h5F][16];
        dataVec_2_uopIdx = _RANDOM[8'h5F][24:18];
        dataVec_2_isVset = _RANDOM[8'h5F][25];
        dataVec_2_firstUop = _RANDOM[8'h5F][26];
        dataVec_2_lastUop = _RANDOM[8'h5F][27];
        dataVec_2_numWB = _RANDOM[8'h60][9:3];
        dataVec_2_commitType = _RANDOM[8'h60][12:10];
        dataVec_2_psrc_0 = _RANDOM[8'h61][23:16];
        dataVec_2_psrc_1 = _RANDOM[8'h61][31:24];
        dataVec_2_psrc_2 = _RANDOM[8'h62][7:0];
        dataVec_2_psrc_3 = _RANDOM[8'h62][15:8];
        dataVec_2_psrc_4 = _RANDOM[8'h62][23:16];
        dataVec_2_pdest = _RANDOM[8'h62][31:24];
        dataVec_2_robIdx_flag = _RANDOM[8'h63][12];
        dataVec_2_robIdx_value = _RANDOM[8'h63][20:13];
        dataVec_2_instrSize = _RANDOM[8'h63][23:21];
        dataVec_2_dirtyFs = _RANDOM[8'h63][24];
        dataVec_2_dirtyVs = _RANDOM[8'h63][25];
        dataVec_2_traceBlockInPipe_itype = _RANDOM[8'h63][29:26];
        dataVec_2_traceBlockInPipe_iretire = {_RANDOM[8'h63][31:30], _RANDOM[8'h64][1:0]};
        dataVec_2_traceBlockInPipe_ilastsize = _RANDOM[8'h64][2];
        dataVec_2_eliminatedMove = _RANDOM[8'h64][3];
        dataVec_2_numLsElem = _RANDOM[8'h79][12:8];
        dataVec_3_instr = {_RANDOM[8'h79][31:13], _RANDOM[8'h7A][12:0]};
        dataVec_3_exceptionVec_0 = _RANDOM[8'h7C][9];
        dataVec_3_exceptionVec_1 = _RANDOM[8'h7C][10];
        dataVec_3_exceptionVec_2 = _RANDOM[8'h7C][11];
        dataVec_3_exceptionVec_3 = _RANDOM[8'h7C][12];
        dataVec_3_exceptionVec_4 = _RANDOM[8'h7C][13];
        dataVec_3_exceptionVec_5 = _RANDOM[8'h7C][14];
        dataVec_3_exceptionVec_6 = _RANDOM[8'h7C][15];
        dataVec_3_exceptionVec_7 = _RANDOM[8'h7C][16];
        dataVec_3_exceptionVec_8 = _RANDOM[8'h7C][17];
        dataVec_3_exceptionVec_9 = _RANDOM[8'h7C][18];
        dataVec_3_exceptionVec_10 = _RANDOM[8'h7C][19];
        dataVec_3_exceptionVec_11 = _RANDOM[8'h7C][20];
        dataVec_3_exceptionVec_12 = _RANDOM[8'h7C][21];
        dataVec_3_exceptionVec_13 = _RANDOM[8'h7C][22];
        dataVec_3_exceptionVec_14 = _RANDOM[8'h7C][23];
        dataVec_3_exceptionVec_15 = _RANDOM[8'h7C][24];
        dataVec_3_exceptionVec_16 = _RANDOM[8'h7C][25];
        dataVec_3_exceptionVec_17 = _RANDOM[8'h7C][26];
        dataVec_3_exceptionVec_18 = _RANDOM[8'h7C][27];
        dataVec_3_exceptionVec_19 = _RANDOM[8'h7C][28];
        dataVec_3_exceptionVec_20 = _RANDOM[8'h7C][29];
        dataVec_3_exceptionVec_21 = _RANDOM[8'h7C][30];
        dataVec_3_exceptionVec_22 = _RANDOM[8'h7C][31];
        dataVec_3_exceptionVec_23 = _RANDOM[8'h7D][0];
        dataVec_3_isFetchMalAddr = _RANDOM[8'h7D][1];
        dataVec_3_hasException = _RANDOM[8'h7D][2];
        dataVec_3_trigger = _RANDOM[8'h7D][6:3];
        dataVec_3_preDecodeInfo_isRVC = _RANDOM[8'h7D][8];
        dataVec_3_pred_taken = _RANDOM[8'h7D][13];
        dataVec_3_crossPageIPFFix = _RANDOM[8'h7D][14];
        dataVec_3_ftqPtr_flag = _RANDOM[8'h7D][15];
        dataVec_3_ftqPtr_value = _RANDOM[8'h7D][21:16];
        dataVec_3_ftqOffset = _RANDOM[8'h7D][25:22];
        dataVec_3_srcType_0 = _RANDOM[8'h7D][29:26];
        dataVec_3_srcType_1 = {_RANDOM[8'h7D][31:30], _RANDOM[8'h7E][1:0]};
        dataVec_3_srcType_2 = _RANDOM[8'h7E][5:2];
        dataVec_3_srcType_3 = _RANDOM[8'h7E][9:6];
        dataVec_3_srcType_4 = _RANDOM[8'h7E][13:10];
        dataVec_3_ldest = _RANDOM[8'h7E][19:14];
        dataVec_3_fuType = {_RANDOM[8'h7E][31:20], _RANDOM[8'h7F][22:0]};
        dataVec_3_fuOpType = _RANDOM[8'h7F][31:23];
        dataVec_3_rfWen = _RANDOM[8'h80][0];
        dataVec_3_fpWen = _RANDOM[8'h80][1];
        dataVec_3_vecWen = _RANDOM[8'h80][2];
        dataVec_3_v0Wen = _RANDOM[8'h80][3];
        dataVec_3_vlWen = _RANDOM[8'h80][4];
        dataVec_3_isXSTrap = _RANDOM[8'h80][5];
        dataVec_3_waitForward = _RANDOM[8'h80][6];
        dataVec_3_blockBackward = _RANDOM[8'h80][7];
        dataVec_3_flushPipe = _RANDOM[8'h80][8];
        dataVec_3_selImm = _RANDOM[8'h80][13:10];
        dataVec_3_imm = {_RANDOM[8'h80][31:14], _RANDOM[8'h81][13:0]};
        dataVec_3_fpu_typeTagOut = _RANDOM[8'h81][15:14];
        dataVec_3_fpu_wflags = _RANDOM[8'h81][16];
        dataVec_3_fpu_typ = _RANDOM[8'h81][18:17];
        dataVec_3_fpu_fmt = _RANDOM[8'h81][20:19];
        dataVec_3_fpu_rm = _RANDOM[8'h81][23:21];
        dataVec_3_vpu_vill = _RANDOM[8'h81][24];
        dataVec_3_vpu_vma = _RANDOM[8'h81][25];
        dataVec_3_vpu_vta = _RANDOM[8'h81][26];
        dataVec_3_vpu_vsew = _RANDOM[8'h81][28:27];
        dataVec_3_vpu_vlmul = _RANDOM[8'h81][31:29];
        dataVec_3_vpu_specVill = _RANDOM[8'h82][0];
        dataVec_3_vpu_specVma = _RANDOM[8'h82][1];
        dataVec_3_vpu_specVta = _RANDOM[8'h82][2];
        dataVec_3_vpu_specVsew = _RANDOM[8'h82][4:3];
        dataVec_3_vpu_specVlmul = _RANDOM[8'h82][7:5];
        dataVec_3_vpu_vm = _RANDOM[8'h82][8];
        dataVec_3_vpu_vstart = _RANDOM[8'h82][16:9];
        dataVec_3_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h82][24];
        dataVec_3_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h82][25];
        dataVec_3_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h82][26];
        dataVec_3_vpu_vmask =
          {_RANDOM[8'h83][31:5],
           _RANDOM[8'h84],
           _RANDOM[8'h85],
           _RANDOM[8'h86],
           _RANDOM[8'h87][4:0]};
        dataVec_3_vpu_nf = _RANDOM[8'h87][15:13];
        dataVec_3_vpu_veew = _RANDOM[8'h87][17:16];
        dataVec_3_vpu_isExt = _RANDOM[8'h87][19];
        dataVec_3_vpu_isNarrow = _RANDOM[8'h87][20];
        dataVec_3_vpu_isDstMask = _RANDOM[8'h87][21];
        dataVec_3_vpu_isOpMask = _RANDOM[8'h87][22];
        dataVec_3_vpu_isDependOldVd = _RANDOM[8'h87][24];
        dataVec_3_vpu_isWritePartVd = _RANDOM[8'h87][25];
        dataVec_3_vpu_isVleff = _RANDOM[8'h87][26];
        dataVec_3_vlsInstr = _RANDOM[8'h87][27];
        dataVec_3_wfflags = _RANDOM[8'h87][28];
        dataVec_3_isMove = _RANDOM[8'h87][29];
        dataVec_3_uopIdx = {_RANDOM[8'h87][31], _RANDOM[8'h88][5:0]};
        dataVec_3_isVset = _RANDOM[8'h88][6];
        dataVec_3_firstUop = _RANDOM[8'h88][7];
        dataVec_3_lastUop = _RANDOM[8'h88][8];
        dataVec_3_numWB = _RANDOM[8'h88][22:16];
        dataVec_3_commitType = _RANDOM[8'h88][25:23];
        dataVec_3_psrc_0 = {_RANDOM[8'h89][31:29], _RANDOM[8'h8A][4:0]};
        dataVec_3_psrc_1 = _RANDOM[8'h8A][12:5];
        dataVec_3_psrc_2 = _RANDOM[8'h8A][20:13];
        dataVec_3_psrc_3 = _RANDOM[8'h8A][28:21];
        dataVec_3_psrc_4 = {_RANDOM[8'h8A][31:29], _RANDOM[8'h8B][4:0]};
        dataVec_3_pdest = _RANDOM[8'h8B][12:5];
        dataVec_3_robIdx_flag = _RANDOM[8'h8B][25];
        dataVec_3_robIdx_value = {_RANDOM[8'h8B][31:26], _RANDOM[8'h8C][1:0]};
        dataVec_3_instrSize = _RANDOM[8'h8C][4:2];
        dataVec_3_dirtyFs = _RANDOM[8'h8C][5];
        dataVec_3_dirtyVs = _RANDOM[8'h8C][6];
        dataVec_3_traceBlockInPipe_itype = _RANDOM[8'h8C][10:7];
        dataVec_3_traceBlockInPipe_iretire = _RANDOM[8'h8C][14:11];
        dataVec_3_traceBlockInPipe_ilastsize = _RANDOM[8'h8C][15];
        dataVec_3_eliminatedMove = _RANDOM[8'h8C][16];
        dataVec_3_numLsElem = _RANDOM[8'hA1][25:21];
        dataVec_4_instr = {_RANDOM[8'hA1][31:26], _RANDOM[8'hA2][25:0]};
        dataVec_4_exceptionVec_0 = _RANDOM[8'hA4][22];
        dataVec_4_exceptionVec_1 = _RANDOM[8'hA4][23];
        dataVec_4_exceptionVec_2 = _RANDOM[8'hA4][24];
        dataVec_4_exceptionVec_3 = _RANDOM[8'hA4][25];
        dataVec_4_exceptionVec_4 = _RANDOM[8'hA4][26];
        dataVec_4_exceptionVec_5 = _RANDOM[8'hA4][27];
        dataVec_4_exceptionVec_6 = _RANDOM[8'hA4][28];
        dataVec_4_exceptionVec_7 = _RANDOM[8'hA4][29];
        dataVec_4_exceptionVec_8 = _RANDOM[8'hA4][30];
        dataVec_4_exceptionVec_9 = _RANDOM[8'hA4][31];
        dataVec_4_exceptionVec_10 = _RANDOM[8'hA5][0];
        dataVec_4_exceptionVec_11 = _RANDOM[8'hA5][1];
        dataVec_4_exceptionVec_12 = _RANDOM[8'hA5][2];
        dataVec_4_exceptionVec_13 = _RANDOM[8'hA5][3];
        dataVec_4_exceptionVec_14 = _RANDOM[8'hA5][4];
        dataVec_4_exceptionVec_15 = _RANDOM[8'hA5][5];
        dataVec_4_exceptionVec_16 = _RANDOM[8'hA5][6];
        dataVec_4_exceptionVec_17 = _RANDOM[8'hA5][7];
        dataVec_4_exceptionVec_18 = _RANDOM[8'hA5][8];
        dataVec_4_exceptionVec_19 = _RANDOM[8'hA5][9];
        dataVec_4_exceptionVec_20 = _RANDOM[8'hA5][10];
        dataVec_4_exceptionVec_21 = _RANDOM[8'hA5][11];
        dataVec_4_exceptionVec_22 = _RANDOM[8'hA5][12];
        dataVec_4_exceptionVec_23 = _RANDOM[8'hA5][13];
        dataVec_4_isFetchMalAddr = _RANDOM[8'hA5][14];
        dataVec_4_hasException = _RANDOM[8'hA5][15];
        dataVec_4_trigger = _RANDOM[8'hA5][19:16];
        dataVec_4_preDecodeInfo_isRVC = _RANDOM[8'hA5][21];
        dataVec_4_pred_taken = _RANDOM[8'hA5][26];
        dataVec_4_crossPageIPFFix = _RANDOM[8'hA5][27];
        dataVec_4_ftqPtr_flag = _RANDOM[8'hA5][28];
        dataVec_4_ftqPtr_value = {_RANDOM[8'hA5][31:29], _RANDOM[8'hA6][2:0]};
        dataVec_4_ftqOffset = _RANDOM[8'hA6][6:3];
        dataVec_4_srcType_0 = _RANDOM[8'hA6][10:7];
        dataVec_4_srcType_1 = _RANDOM[8'hA6][14:11];
        dataVec_4_srcType_2 = _RANDOM[8'hA6][18:15];
        dataVec_4_srcType_3 = _RANDOM[8'hA6][22:19];
        dataVec_4_srcType_4 = _RANDOM[8'hA6][26:23];
        dataVec_4_ldest = {_RANDOM[8'hA6][31:27], _RANDOM[8'hA7][0]};
        dataVec_4_fuType = {_RANDOM[8'hA7][31:1], _RANDOM[8'hA8][3:0]};
        dataVec_4_fuOpType = _RANDOM[8'hA8][12:4];
        dataVec_4_rfWen = _RANDOM[8'hA8][13];
        dataVec_4_fpWen = _RANDOM[8'hA8][14];
        dataVec_4_vecWen = _RANDOM[8'hA8][15];
        dataVec_4_v0Wen = _RANDOM[8'hA8][16];
        dataVec_4_vlWen = _RANDOM[8'hA8][17];
        dataVec_4_isXSTrap = _RANDOM[8'hA8][18];
        dataVec_4_waitForward = _RANDOM[8'hA8][19];
        dataVec_4_blockBackward = _RANDOM[8'hA8][20];
        dataVec_4_flushPipe = _RANDOM[8'hA8][21];
        dataVec_4_selImm = _RANDOM[8'hA8][26:23];
        dataVec_4_imm = {_RANDOM[8'hA8][31:27], _RANDOM[8'hA9][26:0]};
        dataVec_4_fpu_typeTagOut = _RANDOM[8'hA9][28:27];
        dataVec_4_fpu_wflags = _RANDOM[8'hA9][29];
        dataVec_4_fpu_typ = _RANDOM[8'hA9][31:30];
        dataVec_4_fpu_fmt = _RANDOM[8'hAA][1:0];
        dataVec_4_fpu_rm = _RANDOM[8'hAA][4:2];
        dataVec_4_vpu_vill = _RANDOM[8'hAA][5];
        dataVec_4_vpu_vma = _RANDOM[8'hAA][6];
        dataVec_4_vpu_vta = _RANDOM[8'hAA][7];
        dataVec_4_vpu_vsew = _RANDOM[8'hAA][9:8];
        dataVec_4_vpu_vlmul = _RANDOM[8'hAA][12:10];
        dataVec_4_vpu_specVill = _RANDOM[8'hAA][13];
        dataVec_4_vpu_specVma = _RANDOM[8'hAA][14];
        dataVec_4_vpu_specVta = _RANDOM[8'hAA][15];
        dataVec_4_vpu_specVsew = _RANDOM[8'hAA][17:16];
        dataVec_4_vpu_specVlmul = _RANDOM[8'hAA][20:18];
        dataVec_4_vpu_vm = _RANDOM[8'hAA][21];
        dataVec_4_vpu_vstart = _RANDOM[8'hAA][29:22];
        dataVec_4_vpu_fpu_isFoldTo1_2 = _RANDOM[8'hAB][5];
        dataVec_4_vpu_fpu_isFoldTo1_4 = _RANDOM[8'hAB][6];
        dataVec_4_vpu_fpu_isFoldTo1_8 = _RANDOM[8'hAB][7];
        dataVec_4_vpu_vmask =
          {_RANDOM[8'hAB][31:18],
           _RANDOM[8'hAC],
           _RANDOM[8'hAD],
           _RANDOM[8'hAE],
           _RANDOM[8'hAF][17:0]};
        dataVec_4_vpu_nf = _RANDOM[8'hAF][28:26];
        dataVec_4_vpu_veew = _RANDOM[8'hAF][30:29];
        dataVec_4_vpu_isExt = _RANDOM[8'hB0][0];
        dataVec_4_vpu_isNarrow = _RANDOM[8'hB0][1];
        dataVec_4_vpu_isDstMask = _RANDOM[8'hB0][2];
        dataVec_4_vpu_isOpMask = _RANDOM[8'hB0][3];
        dataVec_4_vpu_isDependOldVd = _RANDOM[8'hB0][5];
        dataVec_4_vpu_isWritePartVd = _RANDOM[8'hB0][6];
        dataVec_4_vpu_isVleff = _RANDOM[8'hB0][7];
        dataVec_4_vlsInstr = _RANDOM[8'hB0][8];
        dataVec_4_wfflags = _RANDOM[8'hB0][9];
        dataVec_4_isMove = _RANDOM[8'hB0][10];
        dataVec_4_uopIdx = _RANDOM[8'hB0][18:12];
        dataVec_4_isVset = _RANDOM[8'hB0][19];
        dataVec_4_firstUop = _RANDOM[8'hB0][20];
        dataVec_4_lastUop = _RANDOM[8'hB0][21];
        dataVec_4_numWB = {_RANDOM[8'hB0][31:29], _RANDOM[8'hB1][3:0]};
        dataVec_4_commitType = _RANDOM[8'hB1][6:4];
        dataVec_4_psrc_0 = _RANDOM[8'hB2][17:10];
        dataVec_4_psrc_1 = _RANDOM[8'hB2][25:18];
        dataVec_4_psrc_2 = {_RANDOM[8'hB2][31:26], _RANDOM[8'hB3][1:0]};
        dataVec_4_psrc_3 = _RANDOM[8'hB3][9:2];
        dataVec_4_psrc_4 = _RANDOM[8'hB3][17:10];
        dataVec_4_pdest = _RANDOM[8'hB3][25:18];
        dataVec_4_robIdx_flag = _RANDOM[8'hB4][6];
        dataVec_4_robIdx_value = _RANDOM[8'hB4][14:7];
        dataVec_4_instrSize = _RANDOM[8'hB4][17:15];
        dataVec_4_dirtyFs = _RANDOM[8'hB4][18];
        dataVec_4_dirtyVs = _RANDOM[8'hB4][19];
        dataVec_4_traceBlockInPipe_itype = _RANDOM[8'hB4][23:20];
        dataVec_4_traceBlockInPipe_iretire = _RANDOM[8'hB4][27:24];
        dataVec_4_traceBlockInPipe_ilastsize = _RANDOM[8'hB4][28];
        dataVec_4_eliminatedMove = _RANDOM[8'hB4][29];
        dataVec_4_numLsElem = _RANDOM[8'hCA][6:2];
        dataVec_5_instr = {_RANDOM[8'hCA][31:7], _RANDOM[8'hCB][6:0]};
        dataVec_5_exceptionVec_0 = _RANDOM[8'hCD][3];
        dataVec_5_exceptionVec_1 = _RANDOM[8'hCD][4];
        dataVec_5_exceptionVec_2 = _RANDOM[8'hCD][5];
        dataVec_5_exceptionVec_3 = _RANDOM[8'hCD][6];
        dataVec_5_exceptionVec_4 = _RANDOM[8'hCD][7];
        dataVec_5_exceptionVec_5 = _RANDOM[8'hCD][8];
        dataVec_5_exceptionVec_6 = _RANDOM[8'hCD][9];
        dataVec_5_exceptionVec_7 = _RANDOM[8'hCD][10];
        dataVec_5_exceptionVec_8 = _RANDOM[8'hCD][11];
        dataVec_5_exceptionVec_9 = _RANDOM[8'hCD][12];
        dataVec_5_exceptionVec_10 = _RANDOM[8'hCD][13];
        dataVec_5_exceptionVec_11 = _RANDOM[8'hCD][14];
        dataVec_5_exceptionVec_12 = _RANDOM[8'hCD][15];
        dataVec_5_exceptionVec_13 = _RANDOM[8'hCD][16];
        dataVec_5_exceptionVec_14 = _RANDOM[8'hCD][17];
        dataVec_5_exceptionVec_15 = _RANDOM[8'hCD][18];
        dataVec_5_exceptionVec_16 = _RANDOM[8'hCD][19];
        dataVec_5_exceptionVec_17 = _RANDOM[8'hCD][20];
        dataVec_5_exceptionVec_18 = _RANDOM[8'hCD][21];
        dataVec_5_exceptionVec_19 = _RANDOM[8'hCD][22];
        dataVec_5_exceptionVec_20 = _RANDOM[8'hCD][23];
        dataVec_5_exceptionVec_21 = _RANDOM[8'hCD][24];
        dataVec_5_exceptionVec_22 = _RANDOM[8'hCD][25];
        dataVec_5_exceptionVec_23 = _RANDOM[8'hCD][26];
        dataVec_5_isFetchMalAddr = _RANDOM[8'hCD][27];
        dataVec_5_hasException = _RANDOM[8'hCD][28];
        dataVec_5_trigger = {_RANDOM[8'hCD][31:29], _RANDOM[8'hCE][0]};
        dataVec_5_preDecodeInfo_isRVC = _RANDOM[8'hCE][2];
        dataVec_5_pred_taken = _RANDOM[8'hCE][7];
        dataVec_5_crossPageIPFFix = _RANDOM[8'hCE][8];
        dataVec_5_ftqPtr_flag = _RANDOM[8'hCE][9];
        dataVec_5_ftqPtr_value = _RANDOM[8'hCE][15:10];
        dataVec_5_ftqOffset = _RANDOM[8'hCE][19:16];
        dataVec_5_srcType_0 = _RANDOM[8'hCE][23:20];
        dataVec_5_srcType_1 = _RANDOM[8'hCE][27:24];
        dataVec_5_srcType_2 = _RANDOM[8'hCE][31:28];
        dataVec_5_srcType_3 = _RANDOM[8'hCF][3:0];
        dataVec_5_srcType_4 = _RANDOM[8'hCF][7:4];
        dataVec_5_ldest = _RANDOM[8'hCF][13:8];
        dataVec_5_fuType = {_RANDOM[8'hCF][31:14], _RANDOM[8'hD0][16:0]};
        dataVec_5_fuOpType = _RANDOM[8'hD0][25:17];
        dataVec_5_rfWen = _RANDOM[8'hD0][26];
        dataVec_5_fpWen = _RANDOM[8'hD0][27];
        dataVec_5_vecWen = _RANDOM[8'hD0][28];
        dataVec_5_v0Wen = _RANDOM[8'hD0][29];
        dataVec_5_vlWen = _RANDOM[8'hD0][30];
        dataVec_5_isXSTrap = _RANDOM[8'hD0][31];
        dataVec_5_waitForward = _RANDOM[8'hD1][0];
        dataVec_5_blockBackward = _RANDOM[8'hD1][1];
        dataVec_5_flushPipe = _RANDOM[8'hD1][2];
        dataVec_5_selImm = _RANDOM[8'hD1][7:4];
        dataVec_5_imm = {_RANDOM[8'hD1][31:8], _RANDOM[8'hD2][7:0]};
        dataVec_5_fpu_typeTagOut = _RANDOM[8'hD2][9:8];
        dataVec_5_fpu_wflags = _RANDOM[8'hD2][10];
        dataVec_5_fpu_typ = _RANDOM[8'hD2][12:11];
        dataVec_5_fpu_fmt = _RANDOM[8'hD2][14:13];
        dataVec_5_fpu_rm = _RANDOM[8'hD2][17:15];
        dataVec_5_vpu_vill = _RANDOM[8'hD2][18];
        dataVec_5_vpu_vma = _RANDOM[8'hD2][19];
        dataVec_5_vpu_vta = _RANDOM[8'hD2][20];
        dataVec_5_vpu_vsew = _RANDOM[8'hD2][22:21];
        dataVec_5_vpu_vlmul = _RANDOM[8'hD2][25:23];
        dataVec_5_vpu_specVill = _RANDOM[8'hD2][26];
        dataVec_5_vpu_specVma = _RANDOM[8'hD2][27];
        dataVec_5_vpu_specVta = _RANDOM[8'hD2][28];
        dataVec_5_vpu_specVsew = _RANDOM[8'hD2][30:29];
        dataVec_5_vpu_specVlmul = {_RANDOM[8'hD2][31], _RANDOM[8'hD3][1:0]};
        dataVec_5_vpu_vm = _RANDOM[8'hD3][2];
        dataVec_5_vpu_vstart = _RANDOM[8'hD3][10:3];
        dataVec_5_vpu_fpu_isFoldTo1_2 = _RANDOM[8'hD3][18];
        dataVec_5_vpu_fpu_isFoldTo1_4 = _RANDOM[8'hD3][19];
        dataVec_5_vpu_fpu_isFoldTo1_8 = _RANDOM[8'hD3][20];
        dataVec_5_vpu_vmask =
          {_RANDOM[8'hD3][31],
           _RANDOM[8'hD4],
           _RANDOM[8'hD5],
           _RANDOM[8'hD6],
           _RANDOM[8'hD7][30:0]};
        dataVec_5_vpu_nf = _RANDOM[8'hD8][9:7];
        dataVec_5_vpu_veew = _RANDOM[8'hD8][11:10];
        dataVec_5_vpu_isExt = _RANDOM[8'hD8][13];
        dataVec_5_vpu_isNarrow = _RANDOM[8'hD8][14];
        dataVec_5_vpu_isDstMask = _RANDOM[8'hD8][15];
        dataVec_5_vpu_isOpMask = _RANDOM[8'hD8][16];
        dataVec_5_vpu_isDependOldVd = _RANDOM[8'hD8][18];
        dataVec_5_vpu_isWritePartVd = _RANDOM[8'hD8][19];
        dataVec_5_vpu_isVleff = _RANDOM[8'hD8][20];
        dataVec_5_vlsInstr = _RANDOM[8'hD8][21];
        dataVec_5_wfflags = _RANDOM[8'hD8][22];
        dataVec_5_isMove = _RANDOM[8'hD8][23];
        dataVec_5_uopIdx = _RANDOM[8'hD8][31:25];
        dataVec_5_isVset = _RANDOM[8'hD9][0];
        dataVec_5_firstUop = _RANDOM[8'hD9][1];
        dataVec_5_lastUop = _RANDOM[8'hD9][2];
        dataVec_5_numWB = _RANDOM[8'hD9][16:10];
        dataVec_5_commitType = _RANDOM[8'hD9][19:17];
        dataVec_5_psrc_0 = _RANDOM[8'hDA][30:23];
        dataVec_5_psrc_1 = {_RANDOM[8'hDA][31], _RANDOM[8'hDB][6:0]};
        dataVec_5_psrc_2 = _RANDOM[8'hDB][14:7];
        dataVec_5_psrc_3 = _RANDOM[8'hDB][22:15];
        dataVec_5_psrc_4 = _RANDOM[8'hDB][30:23];
        dataVec_5_pdest = {_RANDOM[8'hDB][31], _RANDOM[8'hDC][6:0]};
        dataVec_5_robIdx_flag = _RANDOM[8'hDC][19];
        dataVec_5_robIdx_value = _RANDOM[8'hDC][27:20];
        dataVec_5_instrSize = _RANDOM[8'hDC][30:28];
        dataVec_5_dirtyFs = _RANDOM[8'hDC][31];
        dataVec_5_dirtyVs = _RANDOM[8'hDD][0];
        dataVec_5_traceBlockInPipe_itype = _RANDOM[8'hDD][4:1];
        dataVec_5_traceBlockInPipe_iretire = _RANDOM[8'hDD][8:5];
        dataVec_5_traceBlockInPipe_ilastsize = _RANDOM[8'hDD][9];
        dataVec_5_eliminatedMove = _RANDOM[8'hDD][10];
        dataVec_5_numLsElem = _RANDOM[8'hF2][19:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVec_0 = 1'h0;
        validVec_1 = 1'h0;
