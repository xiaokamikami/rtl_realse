...
module SCTable_1(
  ...
  wire [6:0]  s0_bank_idx = {io_req_bits_pc[8:5], _GEN[3:1]};
  reg  [7:0]  s1_idx;
  ...
  wire [6:0]  update_bank_idx = {io_update_pc[8:5], _GEN_0[3:1]};
  wire        _GEN_1 = io_update_mask_0 | io_update_mask_1;
  wire        _GEN_2 = _GEN_1 & ~(_GEN_0[0]);
  wire [3:0]  _GEN_3 =
    {updateWayMask_3, updateWayMask_2, updateWayMask_1, updateWayMask_0};
  wire        _GEN_4 = _GEN_1 & _GEN_0[0];
  wire        ctrPos =
  ...
  wire [5:0]  _GEN_5 = io_update_pc[1] ? 6'h0 : update_wdata_0;
  wire [5:0]  _GEN_6 = io_update_pc[1] ? update_wdata_1 : 6'h0;
  wire [5:0]  _GEN_7 = io_update_pc[1] ? update_wdata_0 : 6'h0;
  wire [5:0]  _GEN_8 = io_update_pc[1] ? 6'h0 : update_wdata_1;
  always @(posedge clock) begin
    if (io_req_valid) begin
      s1_idx <= {io_req_bits_pc[8:5], _GEN};
      s1_resp_invalid_by_conflict <= ~(_GEN[0]) & _GEN_2 | _GEN[0] & _GEN_4;
  ...
  SRAMTemplate_68 table_0 (
    ...
    .io_r_req_bits_setIdx           (s0_bank_idx),
    ...
    .io_w_req_bits_setIdx           (update_bank_idx),
  ...
  WrBypass_33 wrbypasses_1 (
    ...
    .io_write_idx        (update_idx),
    .io_write_data_0     (_GEN_7 | _GEN_8),
    .io_write_data_1     (_GEN_7 | _GEN_8),
    .io_write_way_mask_0
      (io_update_pc[1] & updateWayMask_0 | ~(io_update_pc[1]) & updateWayMask_2),
    .io_write_way_mask_1
      (io_update_pc[1] & updateWayMask_1 | ~(io_update_pc[1]) & updateWayMask_3),
