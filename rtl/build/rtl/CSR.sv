  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        tlb_priv_virt_changed_old_data = _RANDOM[5'h6][26];
        io_out_bits_res_redirect_valid_r = _RANDOM[5'h6][27];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[5'h6][28];
        io_out_bits_res_redirect_bits_ftqIdx_r_value =
          {_RANDOM[5'h6][31:29], _RANDOM[5'h7][2:0]};
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[5'h7][6:3];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h7][7];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h7][15:8];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h7][23:16];
        io_out_bits_ctrl_rfWen_r = _RANDOM[5'h7][24];
        io_error_0_REG = _RANDOM[5'h1C][0];
        io_error_0_REG_1 = _RANDOM[5'h1C][1];
        io_csrio_isPerfCnt_r = _RANDOM[5'h1C][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        waddrReg = 12'h0;
        wdataReg = 64'h0;
