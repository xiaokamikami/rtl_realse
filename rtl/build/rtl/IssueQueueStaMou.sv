  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_immType = _RANDOM[6'h4][24:21];
        ...
        deqDelay_0_bits_common_sqIdx_flag = _RANDOM[6'hB][8];
        deqDelay_0_bits_common_sqIdx_value = _RANDOM[6'hB][14:9];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[6'hB][26:23];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[6'hB][29:27];
        deqDelay_0_bits_common_loadDependency_0 = _RANDOM[6'hC][2:1];
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[6'hC][4:3];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[6'hC][6:5];
        io_validCntDeqVec_0_REG_1 = {_RANDOM[6'h20][31:29], _RANDOM[6'h21][1:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
