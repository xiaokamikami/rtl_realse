      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[7'h45][31:5],
           ...
           _RANDOM[7'h48],
           _RANDOM[7'h49][4:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[7'h4B][5];
        inPipe_1_2_robIdx_value = _RANDOM[7'h4B][13:6];
        inPipe_1_2_pdest = _RANDOM[7'h4B][26:19];
        inPipe_1_2_rfWen = _RANDOM[7'h4B][27];
        inPipe_1_2_vecWen = _RANDOM[7'h4B][29];
        inPipe_1_2_v0Wen = _RANDOM[7'h4B][30];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h4C][2];
        inPipe_1_2_vpu_vma = _RANDOM[7'h4C][11];
        inPipe_1_2_vpu_vta = _RANDOM[7'h4C][12];
        inPipe_1_2_vpu_vm = _RANDOM[7'h4C][26];
        inPipe_1_2_vpu_vstart = {_RANDOM[7'h4C][31:27], _RANDOM[7'h4D][2:0]};
        inPipe_1_2_vpu_vuopIdx = _RANDOM[7'h4D][21:15];
        inPipe_1_2_vpu_isDstMask = _RANDOM[7'h52][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
