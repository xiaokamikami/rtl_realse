...
module MbistPipeIcacheDataWay1(
  input         clock,
  input         reset,
  ...
  wire        activated =
    ...
    & (mbist_array == 5'hC | mbist_array == 5'hD | mbist_array == 5'hE
       ...
       | mbist_array == 5'h12 | mbist_array == 5'h13);
