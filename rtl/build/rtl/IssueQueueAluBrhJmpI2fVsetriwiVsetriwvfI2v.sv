  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h2B][12];
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h2B][20:13];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h2B][31:24];
        deqDelay_0_bits_rcIdx_0 = _RANDOM[7'h2C][15:11];
        deqDelay_0_bits_rcIdx_1 = _RANDOM[7'h2C][20:16];
        deqDelay_0_bits_immType = _RANDOM[7'h2C][24:21];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h2C][31:25], _RANDOM[7'h2D][27:0]};
        deqDelay_0_bits_common_fuOpType = {_RANDOM[7'h2D][31:28], _RANDOM[7'h2E][4:0]};
        deqDelay_0_bits_common_imm =
          {_RANDOM[7'h32][31:5], _RANDOM[7'h33], _RANDOM[7'h34][4:0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h34][5];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h34][13:6];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h34][26:19];
        deqDelay_0_bits_common_rfWen = _RANDOM[7'h34][27];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h34][31:28];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h35][3:0];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[7'h35][6:4];
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[7'h35][9:7];
        deqDelay_0_bits_common_loadDependency_0 = _RANDOM[7'h35][17:16];
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[7'h35][19:18];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[7'h35][21:20];
        io_validCntDeqVec_0_REG = _RANDOM[7'h4A][20:15];
        io_validCntDeqVec_1_REG = _RANDOM[7'h4A][26:21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
