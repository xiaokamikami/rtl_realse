...
module skidBufferConnect(
  ...
  reg          dataBuffer_uop_exceptionVec_19;
  ...
  always @(posedge clock) begin
    ...
    dataBuffer_uop_exceptionVec_19 <= ~_dataBuffer_T_2 & dataBuffer_uop_exceptionVec_19;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_uop_exceptionVec_19 = _RANDOM[6'h12][20];
        ...
        dataBuffer_uop_storeSetHit = _RANDOM[6'h36][11];
        dataBuffer_uop_waitForRobIdx_flag = _RANDOM[6'h36][12];
        dataBuffer_uop_waitForRobIdx_value = _RANDOM[6'h36][20:13];
        dataBuffer_uop_loadWaitBit = _RANDOM[6'h36][21];
        dataBuffer_uop_loadWaitStrict = _RANDOM[6'h36][22];
        dataBuffer_uop_lqIdx_flag = _RANDOM[6'h36][28];
        dataBuffer_uop_lqIdx_value = {_RANDOM[6'h36][31:29], _RANDOM[6'h37][3:0]};
        dataBuffer_uop_sqIdx_flag = _RANDOM[6'h37][4];
        dataBuffer_uop_sqIdx_value = _RANDOM[6'h37][10:5];
        dataBuffer_preIsSplit = _RANDOM[6'h3B][22];
        dataBuffer_mBIndex = _RANDOM[6'h3B][26:23];
        dataBuffer_alignedType = _RANDOM[6'h3B][29:27];
        dataBuffer_indexVlMaxInVd = {_RANDOM[6'h3B][31:30], _RANDOM[6'h3C][5:0]};
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3C][9:6];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][10];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:11], _RANDOM[6'h3D][10:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
  ...
  assign io_out_bits_uop_exceptionVec_19 = state & dataBuffer_uop_exceptionVec_19;
