  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h2][29];
        rdata_last_REG = _RANDOM[4'h4][30];
        rdata_hold_data_0 =
          {_RANDOM[4'h4][31], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7][0]};
        rdataReg = {_RANDOM[4'h7][31:1], _RANDOM[4'h8], _RANDOM[4'h9][2:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 8'h0;
