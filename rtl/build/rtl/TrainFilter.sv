  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h45][31:8], _RANDOM[10'h46][25:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h5B][26];
        ld_in_reordered_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h5C][31:27], _RANDOM[10'h5D], _RANDOM[10'h5E][12:0]};
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h6E][7];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h6E][15:8];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h84][31:8], _RANDOM[10'h85][25:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h9A][26];
        ld_in_reordered_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'h9B][31:27], _RANDOM[10'h9C], _RANDOM[10'h9D][12:0]};
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hAD][7];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hAD][15:8];
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hC3][31:8], _RANDOM[10'hC4][25:0]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hD9][26];
        ld_in_reordered_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hDA][31:27], _RANDOM[10'hDB], _RANDOM[10'hDC][12:0]};
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hEC][7];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hEC][15:8];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h102][31:8], _RANDOM[10'h103][25:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h118][26];
        ld_in_reordered_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h119][31:27], _RANDOM[10'h11A], _RANDOM[10'h11B][12:0]};
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h12B][7];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h12B][15:8];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h141][31:8], _RANDOM[10'h142][25:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h157][26];
        ld_in_reordered_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h158][31:27], _RANDOM[10'h159], _RANDOM[10'h15A][12:0]};
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h180][31:8], _RANDOM[10'h181][25:0]};
        ld_in_reordered_0_valid = _RANDOM[10'h196][26];
        ld_in_reordered_0_bits_uop_pc =
          {_RANDOM[10'h197][31:27], _RANDOM[10'h198], _RANDOM[10'h199][12:0]};
        ld_in_reordered_0_bits_vaddr = {_RANDOM[10'h1BF][31:8], _RANDOM[10'h1C0][25:0]};
        ld_in_reordered_1_valid = _RANDOM[10'h1D5][26];
        ld_in_reordered_1_bits_uop_pc =
          {_RANDOM[10'h1D6][31:27], _RANDOM[10'h1D7], _RANDOM[10'h1D8][12:0]};
        ld_in_reordered_1_bits_vaddr = {_RANDOM[10'h1FE][31:8], _RANDOM[10'h1FF][25:0]};
        ld_in_reordered_2_valid = _RANDOM[10'h214][26];
        ld_in_reordered_2_bits_uop_pc =
          {_RANDOM[10'h215][31:27], _RANDOM[10'h216], _RANDOM[10'h217][12:0]};
        ld_in_reordered_2_bits_vaddr = {_RANDOM[10'h23D][31:8], _RANDOM[10'h23E][25:0]};
        REG = _RANDOM[10'h253][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
