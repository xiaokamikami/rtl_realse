  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_fuType = {_RANDOM[6'h1F][31:14], _RANDOM[6'h20][16:0]};
        bits_2_robIdx_flag = _RANDOM[6'h28][26];
        bits_2_robIdx_value = {_RANDOM[6'h28][31:27], _RANDOM[6'h29][2:0]};
        bits_2_pdest = _RANDOM[6'h29][15:8];
        bits_2_fpWen = _RANDOM[6'h29][17];
        bits_2_vecWen = _RANDOM[6'h29][18];
        bits_2_v0Wen = _RANDOM[6'h29][19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
