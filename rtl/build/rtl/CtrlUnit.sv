...
module CtrlUnit(
  ...
  wire              pseudoError_gen_0_valid =
    ctrlRegs_0[0] & ~(ctrlRegs_0[3]) & (~(ctrlRegs_0[2]) | ~(|counterRegs_0));
  wire              pseudoError_gen_1_valid =
    ctrlRegs_0[0] & ctrlRegs_0[3] & (~(ctrlRegs_0[2]) | ~(|counterRegs_0));
  ...
  wire [15:0][63:0] _GEN =
    {{64'h0},
     ...
     {ctrlRegs_0}};
  wire              _GEN_0 =
    _CtrlUnitPseudoErrorPipelineConnect0_io_in_ready & pseudoError_gen_0_valid;
  wire              newCtrlReg_ese = ctrlRegs_0[1] & ctrlRegs_0[0];
  wire              _GEN_1 =
    _CtrlUnitPseudoErrorPipelineConnect1_io_in_ready & pseudoError_gen_1_valid;
  ...
  NewPipelineConnectPipe_27 CtrlUnitPseudoErrorPipelineConnect0 (
    .clock               (clock),
    .reset               (reset),
    .io_in_ready         (_CtrlUnitPseudoErrorPipelineConnect0_io_in_ready),
    .io_in_valid         (pseudoError_gen_0_valid),
  ...
  NewPipelineConnectPipe_27 CtrlUnitPseudoErrorPipelineConnect1 (
    .clock               (clock),
    .reset               (reset),
    .io_in_ready         (_CtrlUnitPseudoErrorPipelineConnect1_io_in_ready),
    .io_in_valid         (pseudoError_gen_1_valid),
    .io_in_bits_0_valid  (ctrlRegs_0[4]),
    .io_in_bits_0_mask   (maskRegs_0),
    .io_in_bits_1_valid  (ctrlRegs_0[5]),
    .io_in_bits_1_mask   (maskRegs_1),
