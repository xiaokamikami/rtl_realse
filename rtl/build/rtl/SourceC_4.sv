...
module SourceC_4(
  ...
  output [12:0]  io_bs_raddr_bits_set,
  ...
  reg  [28:0] task_latch_tag;
  reg  [12:0] task_latch_set;
  reg  [2:0]  task_latch_param;
  reg  [3:0]  task_latch_source;
  reg  [2:0]  task_latch_way;
  wire [12:0] task_set = bs_busy ? task_latch_set : io_task_bits_set;
  ...
  reg  [28:0] s1_task_tag;
  reg  [12:0] s1_task_set;
  reg  [2:0]  s1_task_param;
  reg  [3:0]  s1_task_source;
  reg         s1_valid;
  reg         pipeOut_pipe_v;
  reg  [2:0]  pipeOut_pipe_b_task_opcode;
  reg  [28:0] pipeOut_pipe_b_task_tag;
  reg  [12:0] pipeOut_pipe_b_task_set;
  ...
  reg  [28:0] pipeOut_pipe_pipe_b_task_tag;
  reg  [12:0] pipeOut_pipe_pipe_b_task_set;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        task_latch_tag = {_RANDOM[3'h0][31:6], _RANDOM[3'h1][2:0]};
        task_latch_set = _RANDOM[3'h1][15:3];
        ...
        s1_task_tag = {_RANDOM[3'h1][31:30], _RANDOM[3'h2][26:0]};
        s1_task_set = {_RANDOM[3'h2][31:27], _RANDOM[3'h3][7:0]};
        ...
        pipeOut_pipe_b_task_tag = {_RANDOM[3'h3][31:25], _RANDOM[3'h4][21:0]};
        pipeOut_pipe_b_task_set = {_RANDOM[3'h4][31:22], _RANDOM[3'h5][2:0]};
        ...
        pipeOut_pipe_pipe_b_task_tag = {_RANDOM[3'h5][31:19], _RANDOM[3'h6][15:0]};
        pipeOut_pipe_pipe_b_task_set = _RANDOM[3'h6][28:16];
