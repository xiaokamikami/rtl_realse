  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outIsVwsll = _RANDOM[6'h2F][9];
        outIsVwsllEewVdIs64 = _RANDOM[6'h2F][10];
        outIsVwsllEewVdIs32 = _RANDOM[6'h2F][11];
        outIsVwsllEewVdIs16 = _RANDOM[6'h2F][12];
        outEewVs1_oneHot = _RANDOM[6'h2F][16:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
