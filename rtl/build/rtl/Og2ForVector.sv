  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_toExuData_3_0_fuType = {_RANDOM[9'h34][31:3], _RANDOM[9'h35][5:0]};
        s2_toExuData_3_0_fuOpType = _RANDOM[9'h35][14:6];
        ...
        s2_toExuData_3_0_src_4 =
          {_RANDOM[9'h45][31:15],
           ...
           _RANDOM[9'h48],
           _RANDOM[9'h49][14:0]};
        s2_toExuData_3_0_robIdx_flag = _RANDOM[9'h4B][15];
        s2_toExuData_3_0_robIdx_value = _RANDOM[9'h4B][23:16];
        s2_toExuData_3_0_pdest = {_RANDOM[9'h4B][31:29], _RANDOM[9'h4C][3:0]};
        s2_toExuData_3_0_vecWen = _RANDOM[9'h4C][4];
        s2_toExuData_3_0_v0Wen = _RANDOM[9'h4C][5];
        s2_toExuData_3_0_vlWen = _RANDOM[9'h4C][6];
        s2_toExuData_3_0_vpu_vma = _RANDOM[9'h4C][8];
        s2_toExuData_3_0_vpu_vta = _RANDOM[9'h4C][9];
        s2_toExuData_3_0_vpu_vsew = _RANDOM[9'h4C][11:10];
        s2_toExuData_3_0_vpu_vlmul = _RANDOM[9'h4C][14:12];
        s2_toExuData_3_0_vpu_vm = _RANDOM[9'h4C][23];
        s2_toExuData_3_0_vpu_vstart = _RANDOM[9'h4C][31:24];
        s2_toExuData_3_0_vpu_vuopIdx = _RANDOM[9'h4D][18:12];
        s2_toExuData_3_0_vpu_lastUop = _RANDOM[9'h4D][19];
        s2_toExuData_3_0_vpu_vmask =
          {_RANDOM[9'h4D][31:20],
           ...
           _RANDOM[9'h50],
           _RANDOM[9'h51][19:0]};
        s2_toExuData_3_0_vpu_nf = _RANDOM[9'h51][30:28];
        s2_toExuData_3_0_vpu_veew = {_RANDOM[9'h51][31], _RANDOM[9'h52][0]};
        s2_toExuData_3_0_vpu_isVleff = _RANDOM[9'h52][9];
        s2_toExuData_3_0_ftqIdx_flag = _RANDOM[9'h52][11];
        s2_toExuData_3_0_ftqIdx_value = _RANDOM[9'h52][17:12];
        s2_toExuData_3_0_ftqOffset = _RANDOM[9'h52][21:18];
        s2_toExuData_3_0_numLsElem = _RANDOM[9'h52][26:22];
        s2_toExuData_3_0_sqIdx_flag = _RANDOM[9'h52][27];
        s2_toExuData_3_0_sqIdx_value = {_RANDOM[9'h52][31:28], _RANDOM[9'h53][1:0]};
        s2_toExuData_3_0_lqIdx_flag = _RANDOM[9'h53][2];
        s2_toExuData_3_0_lqIdx_value = _RANDOM[9'h53][9:3];
        s2_toExuData_3_0_dataSources_0_value = _RANDOM[9'h53][13:10];
        s2_toExuData_3_0_dataSources_1_value = _RANDOM[9'h53][17:14];
        s2_toExuData_3_0_dataSources_2_value = _RANDOM[9'h53][21:18];
        s2_toExuData_3_0_dataSources_3_value = _RANDOM[9'h53][25:22];
        s2_toExuData_3_0_dataSources_4_value = _RANDOM[9'h53][29:26];
        s2_toExuData_2_0_fuType =
          {_RANDOM[9'h67][31], _RANDOM[9'h68], _RANDOM[9'h69][1:0]};
        s2_toExuData_2_0_fuOpType = _RANDOM[9'h69][10:2];
        ...
        s2_toExuData_2_0_src_4 =
          {_RANDOM[9'h79][31:11],
           ...
           _RANDOM[9'h7C],
           _RANDOM[9'h7D][10:0]};
        s2_toExuData_2_0_robIdx_flag = _RANDOM[9'h7F][11];
        s2_toExuData_2_0_robIdx_value = _RANDOM[9'h7F][19:12];
        s2_toExuData_2_0_pdest = _RANDOM[9'h7F][31:25];
        s2_toExuData_2_0_vecWen = _RANDOM[9'h80][0];
        s2_toExuData_2_0_v0Wen = _RANDOM[9'h80][1];
        s2_toExuData_2_0_fpu_wflags = _RANDOM[9'h80][4];
        s2_toExuData_2_0_vpu_vma = _RANDOM[9'h80][13];
        s2_toExuData_2_0_vpu_vta = _RANDOM[9'h80][14];
        s2_toExuData_2_0_vpu_vsew = _RANDOM[9'h80][16:15];
        s2_toExuData_2_0_vpu_vlmul = _RANDOM[9'h80][19:17];
        s2_toExuData_2_0_vpu_vm = _RANDOM[9'h80][28];
        s2_toExuData_2_0_vpu_vstart = {_RANDOM[9'h80][31:29], _RANDOM[9'h81][4:0]};
        s2_toExuData_2_0_vpu_vuopIdx = _RANDOM[9'h81][23:17];
        s2_toExuData_2_0_vpu_isExt = _RANDOM[9'h86][7];
        s2_toExuData_2_0_vpu_isNarrow = _RANDOM[9'h86][8];
        s2_toExuData_2_0_vpu_isDstMask = _RANDOM[9'h86][9];
        s2_toExuData_2_0_vpu_isOpMask = _RANDOM[9'h86][10];
        s2_toExuData_2_0_dataSources_0_value = _RANDOM[9'h86][18:15];
        s2_toExuData_2_0_dataSources_1_value = _RANDOM[9'h86][22:19];
        s2_toExuData_2_0_dataSources_2_value = _RANDOM[9'h86][26:23];
        s2_toExuData_2_0_dataSources_3_value = _RANDOM[9'h86][30:27];
        s2_toExuData_2_0_dataSources_4_value = {_RANDOM[9'h86][31], _RANDOM[9'h87][2:0]};
        s2_toExuData_1_1_fuType = {_RANDOM[9'h9B][31:4], _RANDOM[9'h9C][6:0]};
        s2_toExuData_1_1_fuOpType = _RANDOM[9'h9C][15:7];
        ...
        s2_toExuData_1_1_src_4 =
          {_RANDOM[9'hAC][31:16],
           ...
           _RANDOM[9'hAF],
           _RANDOM[9'hB0][15:0]};
        s2_toExuData_1_1_robIdx_flag = _RANDOM[9'hB2][16];
        s2_toExuData_1_1_robIdx_value = _RANDOM[9'hB2][24:17];
        s2_toExuData_1_1_pdest = {_RANDOM[9'hB2][31:30], _RANDOM[9'hB3][5:0]};
        s2_toExuData_1_1_fpWen = _RANDOM[9'hB3][6];
        s2_toExuData_1_1_vecWen = _RANDOM[9'hB3][7];
        s2_toExuData_1_1_v0Wen = _RANDOM[9'hB3][8];
        s2_toExuData_1_1_fpu_wflags = _RANDOM[9'hB3][11];
        s2_toExuData_1_1_vpu_vma = _RANDOM[9'hB3][20];
        s2_toExuData_1_1_vpu_vta = _RANDOM[9'hB3][21];
        s2_toExuData_1_1_vpu_vsew = _RANDOM[9'hB3][23:22];
        s2_toExuData_1_1_vpu_vlmul = _RANDOM[9'hB3][26:24];
        s2_toExuData_1_1_vpu_vm = _RANDOM[9'hB4][3];
        s2_toExuData_1_1_vpu_vstart = _RANDOM[9'hB4][11:4];
        s2_toExuData_1_1_vpu_fpu_isFoldTo1_2 = _RANDOM[9'hB4][19];
        s2_toExuData_1_1_vpu_fpu_isFoldTo1_4 = _RANDOM[9'hB4][20];
        s2_toExuData_1_1_vpu_fpu_isFoldTo1_8 = _RANDOM[9'hB4][21];
        s2_toExuData_1_1_vpu_vuopIdx = _RANDOM[9'hB4][30:24];
        s2_toExuData_1_1_vpu_lastUop = _RANDOM[9'hB4][31];
        s2_toExuData_1_1_vpu_isNarrow = _RANDOM[9'hB9][15];
        s2_toExuData_1_1_vpu_isDstMask = _RANDOM[9'hB9][16];
        s2_toExuData_1_1_dataSources_0_value = _RANDOM[9'hB9][25:22];
        s2_toExuData_1_1_dataSources_1_value = _RANDOM[9'hB9][29:26];
        s2_toExuData_1_1_dataSources_2_value =
          {_RANDOM[9'hB9][31:30], _RANDOM[9'hBA][1:0]};
        s2_toExuData_1_1_dataSources_3_value = _RANDOM[9'hBA][5:2];
        s2_toExuData_1_1_dataSources_4_value = _RANDOM[9'hBA][9:6];
        s2_toExuData_1_0_fuType = {_RANDOM[9'hCE][31:11], _RANDOM[9'hCF][13:0]};
        s2_toExuData_1_0_fuOpType = _RANDOM[9'hCF][22:14];
        ...
        s2_toExuData_1_0_src_4 =
          {_RANDOM[9'hDF][31:23],
           ...
           _RANDOM[9'hE2],
           _RANDOM[9'hE3][22:0]};
        s2_toExuData_1_0_robIdx_flag = _RANDOM[9'hE5][23];
        s2_toExuData_1_0_robIdx_value = _RANDOM[9'hE5][31:24];
        s2_toExuData_1_0_pdest = _RANDOM[9'hE6][11:5];
        s2_toExuData_1_0_vecWen = _RANDOM[9'hE6][12];
        s2_toExuData_1_0_v0Wen = _RANDOM[9'hE6][13];
        s2_toExuData_1_0_fpu_wflags = _RANDOM[9'hE6][16];
        s2_toExuData_1_0_vpu_vma = _RANDOM[9'hE6][25];
        s2_toExuData_1_0_vpu_vta = _RANDOM[9'hE6][26];
        s2_toExuData_1_0_vpu_vsew = _RANDOM[9'hE6][28:27];
        s2_toExuData_1_0_vpu_vlmul = _RANDOM[9'hE6][31:29];
        s2_toExuData_1_0_vpu_vm = _RANDOM[9'hE7][8];
        s2_toExuData_1_0_vpu_vstart = _RANDOM[9'hE7][16:9];
        s2_toExuData_1_0_vpu_vuopIdx = {_RANDOM[9'hE7][31:29], _RANDOM[9'hE8][3:0]};
        s2_toExuData_1_0_vpu_isExt = _RANDOM[9'hEC][19];
        s2_toExuData_1_0_vpu_isNarrow = _RANDOM[9'hEC][20];
        s2_toExuData_1_0_vpu_isDstMask = _RANDOM[9'hEC][21];
        s2_toExuData_1_0_vpu_isOpMask = _RANDOM[9'hEC][22];
        s2_toExuData_1_0_dataSources_0_value = _RANDOM[9'hEC][30:27];
        s2_toExuData_1_0_dataSources_1_value = {_RANDOM[9'hEC][31], _RANDOM[9'hED][2:0]};
        s2_toExuData_1_0_dataSources_2_value = _RANDOM[9'hED][6:3];
        s2_toExuData_1_0_dataSources_3_value = _RANDOM[9'hED][10:7];
        s2_toExuData_1_0_dataSources_4_value = _RANDOM[9'hED][14:11];
        s2_toExuData_0_1_fuType = {_RANDOM[9'h101][31:16], _RANDOM[9'h102][18:0]};
        s2_toExuData_0_1_fuOpType = _RANDOM[9'h102][27:19];
        s2_toExuData_0_1_src_0 =
          {_RANDOM[9'h102][31:28],
           _RANDOM[9'h103],
           _RANDOM[9'h104],
           _RANDOM[9'h105],
           _RANDOM[9'h106][27:0]};
        s2_toExuData_0_1_src_1 =
          {_RANDOM[9'h106][31:28],
           _RANDOM[9'h107],
           _RANDOM[9'h108],
           _RANDOM[9'h109],
           _RANDOM[9'h10A][27:0]};
        s2_toExuData_0_1_src_2 =
          {_RANDOM[9'h10A][31:28],
           _RANDOM[9'h10B],
           _RANDOM[9'h10C],
           _RANDOM[9'h10D],
           _RANDOM[9'h10E][27:0]};
        s2_toExuData_0_1_src_3 =
          {_RANDOM[9'h10E][31:28],
           _RANDOM[9'h10F],
           _RANDOM[9'h110],
           _RANDOM[9'h111],
           _RANDOM[9'h112][27:0]};
        s2_toExuData_0_1_src_4 =
          {_RANDOM[9'h112][31:28],
           _RANDOM[9'h113],
           _RANDOM[9'h114],
           _RANDOM[9'h115],
           _RANDOM[9'h116][27:0]};
        s2_toExuData_0_1_robIdx_flag = _RANDOM[9'h118][28];
        s2_toExuData_0_1_robIdx_value = {_RANDOM[9'h118][31:29], _RANDOM[9'h119][4:0]};
        s2_toExuData_0_1_pdest = _RANDOM[9'h119][17:10];
        s2_toExuData_0_1_rfWen = _RANDOM[9'h119][18];
        s2_toExuData_0_1_fpWen = _RANDOM[9'h119][19];
        s2_toExuData_0_1_vecWen = _RANDOM[9'h119][20];
        s2_toExuData_0_1_v0Wen = _RANDOM[9'h119][21];
        s2_toExuData_0_1_vlWen = _RANDOM[9'h119][22];
        s2_toExuData_0_1_fpu_wflags = _RANDOM[9'h119][25];
        s2_toExuData_0_1_vpu_vma = _RANDOM[9'h11A][2];
        s2_toExuData_0_1_vpu_vta = _RANDOM[9'h11A][3];
        s2_toExuData_0_1_vpu_vsew = _RANDOM[9'h11A][5:4];
        s2_toExuData_0_1_vpu_vlmul = _RANDOM[9'h11A][8:6];
        s2_toExuData_0_1_vpu_vm = _RANDOM[9'h11A][17];
        s2_toExuData_0_1_vpu_vstart = _RANDOM[9'h11A][25:18];
        s2_toExuData_0_1_vpu_fpu_isFoldTo1_2 = _RANDOM[9'h11B][1];
        s2_toExuData_0_1_vpu_fpu_isFoldTo1_4 = _RANDOM[9'h11B][2];
        s2_toExuData_0_1_vpu_fpu_isFoldTo1_8 = _RANDOM[9'h11B][3];
        s2_toExuData_0_1_vpu_vuopIdx = _RANDOM[9'h11B][12:6];
        s2_toExuData_0_1_vpu_lastUop = _RANDOM[9'h11B][13];
        s2_toExuData_0_1_vpu_isNarrow = _RANDOM[9'h11F][29];
        s2_toExuData_0_1_vpu_isDstMask = _RANDOM[9'h11F][30];
        s2_toExuData_0_1_dataSources_0_value = _RANDOM[9'h120][7:4];
        s2_toExuData_0_1_dataSources_1_value = _RANDOM[9'h120][11:8];
        s2_toExuData_0_1_dataSources_2_value = _RANDOM[9'h120][15:12];
        s2_toExuData_0_1_dataSources_3_value = _RANDOM[9'h120][19:16];
        s2_toExuData_0_1_dataSources_4_value = _RANDOM[9'h120][23:20];
        s2_toExuData_0_0_fuType = {_RANDOM[9'h134][31:25], _RANDOM[9'h135][27:0]};
        s2_toExuData_0_0_fuOpType = {_RANDOM[9'h135][31:28], _RANDOM[9'h136][4:0]};
        ...
        s2_toExuData_0_0_src_4 =
          {_RANDOM[9'h146][31:5],
           ...
           _RANDOM[9'h149],
           _RANDOM[9'h14A][4:0]};
        s2_toExuData_0_0_robIdx_flag = _RANDOM[9'h14C][5];
        s2_toExuData_0_0_robIdx_value = _RANDOM[9'h14C][13:6];
        s2_toExuData_0_0_pdest = _RANDOM[9'h14C][25:19];
        s2_toExuData_0_0_vecWen = _RANDOM[9'h14C][26];
        s2_toExuData_0_0_v0Wen = _RANDOM[9'h14C][27];
        s2_toExuData_0_0_fpu_wflags = _RANDOM[9'h14C][30];
        s2_toExuData_0_0_vpu_vma = _RANDOM[9'h14D][7];
        s2_toExuData_0_0_vpu_vta = _RANDOM[9'h14D][8];
        s2_toExuData_0_0_vpu_vsew = _RANDOM[9'h14D][10:9];
        s2_toExuData_0_0_vpu_vlmul = _RANDOM[9'h14D][13:11];
        s2_toExuData_0_0_vpu_vm = _RANDOM[9'h14D][22];
        s2_toExuData_0_0_vpu_vstart = _RANDOM[9'h14D][30:23];
        s2_toExuData_0_0_vpu_vuopIdx = _RANDOM[9'h14E][17:11];
        s2_toExuData_0_0_vpu_isExt = _RANDOM[9'h153][1];
        s2_toExuData_0_0_vpu_isNarrow = _RANDOM[9'h153][2];
        s2_toExuData_0_0_vpu_isDstMask = _RANDOM[9'h153][3];
        s2_toExuData_0_0_vpu_isOpMask = _RANDOM[9'h153][4];
        s2_toExuData_0_0_dataSources_0_value = _RANDOM[9'h153][12:9];
        s2_toExuData_0_0_dataSources_1_value = _RANDOM[9'h153][16:13];
        s2_toExuData_0_0_dataSources_2_value = _RANDOM[9'h153][20:17];
        s2_toExuData_0_0_dataSources_3_value = _RANDOM[9'h153][24:21];
        s2_toExuData_0_0_dataSources_4_value = _RANDOM[9'h153][28:25];
        s2_flush_next_valid_last_REG = _RANDOM[9'h167][30];
        s2_flush_next_bits_r_robIdx_flag = _RANDOM[9'h168][0];
        s2_flush_next_bits_r_robIdx_value = _RANDOM[9'h168][8:1];
        s2_flush_next_bits_r_level = _RANDOM[9'h168][20];
        s2_flush_next_valid_last_REG_1 = _RANDOM[9'h179][20];
        s2_flush_next_bits_r_1_robIdx_flag = _RANDOM[9'h179][22];
        s2_flush_next_bits_r_1_robIdx_value = _RANDOM[9'h179][30:23];
        s2_flush_next_bits_r_1_level = _RANDOM[9'h17A][10];
        s2_flush_next_valid_last_REG_2 = _RANDOM[9'h18B][10];
        s2_flush_next_bits_r_2_robIdx_flag = _RANDOM[9'h18B][12];
        s2_flush_next_bits_r_2_robIdx_value = _RANDOM[9'h18B][20:13];
        s2_flush_next_bits_r_2_level = _RANDOM[9'h18C][0];
        s2_flush_next_valid_last_REG_3 = _RANDOM[9'h19D][0];
        s2_flush_next_bits_r_3_robIdx_flag = _RANDOM[9'h19D][2];
        s2_flush_next_bits_r_3_robIdx_value = _RANDOM[9'h19D][10:3];
        s2_flush_next_bits_r_3_level = _RANDOM[9'h19D][22];
        s2_flush_next_valid_last_REG_4 = _RANDOM[9'h1AE][22];
        s2_flush_next_bits_r_4_robIdx_flag = _RANDOM[9'h1AE][24];
        s2_flush_next_bits_r_4_robIdx_value =
          {_RANDOM[9'h1AE][31:25], _RANDOM[9'h1AF][0]};
        s2_flush_next_bits_r_4_level = _RANDOM[9'h1AF][12];
        s2_flush_next_valid_last_REG_5 = _RANDOM[9'h1C0][12];
        s2_flush_next_bits_r_5_robIdx_flag = _RANDOM[9'h1C0][14];
        s2_flush_next_bits_r_5_robIdx_value = _RANDOM[9'h1C0][22:15];
        s2_flush_next_bits_r_5_level = _RANDOM[9'h1C1][2];
        s2_flush_next_valid_last_REG_6 = _RANDOM[9'h1D2][2];
        s2_flush_next_bits_r_6_robIdx_flag = _RANDOM[9'h1D2][4];
        s2_flush_next_bits_r_6_robIdx_value = _RANDOM[9'h1D2][12:5];
        s2_flush_next_bits_r_6_level = _RANDOM[9'h1D2][24];
        r_1_imm = {_RANDOM[9'h1E4][31:28], _RANDOM[9'h1E5][27:0]};
        r_1_immType = _RANDOM[9'h1E5][31:28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s2_flush_next_valid_last_REG = 1'h0;
        s2_flush_next_valid_last_REG_1 = 1'h0;
