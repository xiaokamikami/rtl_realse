...
module NewIFU(
  ...
  output         io_uncacheInter_toUncache_bits_flush,
  ...
  reg               is_first_instr;
  reg  [3:0]        mmio_state;
  wire              _io_uncacheInter_toUncache_bits_memPageTypeNC_T =
    f3_itlb_pbmt == 2'h1;
  wire              f3_req_is_mmio =
    f3_valid
    & (f3_pmp_mmio | _io_uncacheInter_toUncache_bits_memPageTypeNC_T
       | f3_itlb_pbmt == 2'h2) & ~((|f3_exception_0) | (|f3_exception_1));
  wire [6:0]        _f3_wb_not_flush_T_1 =
    {f3_ftq_req_ftqIdx_flag, f3_ftq_req_ftqIdx_value};
  wire              f3_mmio_req_commit = f3_req_is_mmio & mmio_state == 4'hB;
  wire              _mmio_redirect_T = mmio_state == 4'hA;
  reg               f3_mmio_sent_to_ibuffer;
  reg               io_mmioCommitRead_valid_REG;
  ...
  wire              _GEN_10 = mmio_state == 4'h9;
  wire              _io_uncacheInter_toUncache_bits_flush_T =
    f3_ftq_flush_self | f3_ftq_flush_by_older;
  wire              _GEN_11 =
    _io_uncacheInter_toUncache_bits_flush_T | mmioF3Flush & ~f3_need_not_flush;
  wire              _io_uncacheInter_toUncache_bits_addr_T = mmio_state == 4'h8;
  ...
  assign io_toIbuffer_valid_0 =
    f3_valid
    & (~f3_req_is_mmio | f3_req_is_mmio & _mmio_redirect_T & ~f3_mmio_sent_to_ibuffer)
    & ~f3_flush;
  wire [3:0]        _GEN_12 =
                                                      ...
                                                      : io_toIbuffer_bits_enqEnable_0[2]
                                                          ...
                                                          : io_toIbuffer_bits_enqEnable_0[1]
                                                              ...
                                                              : {io_toIbuffer_bits_enqEnable_0[0],
                                                                 15'h0};
  wire [3:0]        _GEN_14 =
    {{_GEN_13[5:4], _GEN_13[7]} & 3'h5, 1'h0} | {_GEN_13[7:6], _GEN_13[9:8]} & 4'h5;
  ...
  wire              _GEN_18 = io_iTLBInter_resp_ready_0 & io_iTLBInter_resp_valid;
  wire              _GEN_19 = mmio_state == 4'hA;
  wire              _GEN_20 = mmio_state != 4'hB;
  wire              _GEN_21 = _GEN_7 | _GEN_8 | _GEN_9 | _GEN_10 | _GEN_19;
  wire              _GEN_22 = _GEN_5 | _GEN_6 | _GEN_21 | _GEN_20;
  wire              _GEN_23 = _GEN_21 | _GEN_20;
  wire              _GEN_24 = _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3 | _GEN_5;
  wire              f3_hasLastHalf =
    ...
    {{mmio_state},
     ...
     {{3'h5,
       (|{io_rob_commits_7_valid
         ...
         | _io_uncacheInter_toUncache_bits_memPageTypeNC_T & io_toIbuffer_ready}},
     {io_uncacheInter_fromUncache_valid ? 4'hA : mmio_state},
     {{3'h4, io_uncacheInter_toUncache_ready & io_uncacheInter_toUncache_valid_0}},
     {{2'h2, |exception_2, 1'h0}},
     {4'h7},
     {_GEN_18 ? ((|exception_1) ? 4'hA : 4'h6) : mmio_state},
     {{3'h2, io_iTLBInter_req_ready & io_iTLBInter_req_valid_0}},
     {io_uncacheInter_fromUncache_valid ? (needResend ? 4'h4 : 4'hA) : mmio_state},
     ...
     {f3_req_is_mmio
        ? (_io_uncacheInter_toUncache_bits_memPageTypeNC_T ? 4'h2 : 4'h1)
        : mmio_state}};
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      is_first_instr <= 1'h1;
      mmio_state <= 4'h0;
      f3_mmio_sent_to_ibuffer <= 1'h0;
      io_mmioCommitRead_valid_REG <= 1'h0;
      ...
      f3_valid <=
        ~(f3_flush & ~f3_req_is_mmio | mmioF3Flush & f3_req_is_mmio & ~f3_need_not_flush)
        & (f2_fire & ~f2_flush
        ...
        & (_GEN_24
             ...
             : _GEN_6
                 ? (_GEN_18
                      ...
                      : mmio_resend_isForVSnonLeafPTE)
                 : _GEN_23 & mmio_resend_isForVSnonLeafPTE);
      is_first_instr <= ~(is_first_instr & f3_fire) & is_first_instr;
      f3_mmio_sent_to_ibuffer <=
        ~(~f3_req_is_mmio | f3_mmio_req_commit | mmioF3Flush & ~f3_need_not_flush
          | f3_ftq_flush_self | f3_ftq_flush_by_older)
        & (f3_fire | f3_mmio_sent_to_ibuffer);
      io_mmioCommitRead_valid_REG <= f3_req_is_mmio & f3_valid;
  ...
  wire [11:0]       _GEN_26 = {1'h0, f1_ftq_req_startAddr[10:0]};
  wire [6:0]        _GEN_27 = {2'h0, f1_ftq_req_startAddr[5:1]};
  ...
  always @(posedge clock) begin
    ...
    if (f1_fire) begin
      ...
      f2_pc_lower_result_1 <= 12'(_GEN_26 + 12'h2);
      f2_pc_lower_result_2 <= 12'(_GEN_26 + 12'h4);
      f2_pc_lower_result_3 <= 12'(_GEN_26 + 12'h6);
      f2_pc_lower_result_4 <= 12'(_GEN_26 + 12'h8);
      f2_pc_lower_result_5 <= 12'(_GEN_26 + 12'hA);
      f2_pc_lower_result_6 <= 12'(_GEN_26 + 12'hC);
      f2_pc_lower_result_7 <= 12'(_GEN_26 + 12'hE);
      f2_pc_lower_result_8 <= 12'(_GEN_26 + 12'h10);
      f2_pc_lower_result_9 <= 12'(_GEN_26 + 12'h12);
      f2_pc_lower_result_10 <= 12'(_GEN_26 + 12'h14);
      f2_pc_lower_result_11 <= 12'(_GEN_26 + 12'h16);
      f2_pc_lower_result_12 <= 12'(_GEN_26 + 12'h18);
      f2_pc_lower_result_13 <= 12'(_GEN_26 + 12'h1A);
      f2_pc_lower_result_14 <= 12'(_GEN_26 + 12'h1C);
      f2_pc_lower_result_15 <= 12'(_GEN_26 + 12'h1E);
      ...
      f2_cut_ptr_1 <= 7'(_GEN_27 + 7'h1);
      f2_cut_ptr_2 <= 7'(_GEN_27 + 7'h2);
      f2_cut_ptr_3 <= 7'(_GEN_27 + 7'h3);
      f2_cut_ptr_4 <= 7'(_GEN_27 + 7'h4);
      f2_cut_ptr_5 <= 7'(_GEN_27 + 7'h5);
      f2_cut_ptr_6 <= 7'(_GEN_27 + 7'h6);
      f2_cut_ptr_7 <= 7'(_GEN_27 + 7'h7);
      f2_cut_ptr_8 <= 7'(_GEN_27 + 7'h8);
      f2_cut_ptr_9 <= 7'(_GEN_27 + 7'h9);
      f2_cut_ptr_10 <= 7'(_GEN_27 + 7'hA);
      f2_cut_ptr_11 <= 7'(_GEN_27 + 7'hB);
      f2_cut_ptr_12 <= 7'(_GEN_27 + 7'hC);
      f2_cut_ptr_13 <= 7'(_GEN_27 + 7'hD);
      f2_cut_ptr_14 <= 7'(_GEN_27 + 7'hE);
      f2_cut_ptr_15 <= 7'(_GEN_27 + 7'hF);
      f2_cut_ptr_16 <= 7'(_GEN_27 + 7'h10);
    ...
    if (_GEN_11) begin
      ...
      if (~_GEN_4) begin
        ...
        else if (_GEN_5 | _GEN_6 | _GEN_7 | _GEN_8 | _GEN_9
                 | ~(_GEN_10 & io_uncacheInter_fromUncache_valid)) begin
        end
        else
    ...
    if (wb_enable) begin
      ...
      wb_false_lastHalf_r <=
        ~_GEN_31[f3_last_validIdx] & _GEN_30[f3_last_validIdx] & _GEN_29[f3_last_validIdx]
        & ~_GEN_28[f3_last_validIdx] & ~f3_req_is_mmio;
      wb_false_target <= _GEN_32[f3_last_validIdx];
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mmio_state = _RANDOM[8'h7D][26:23];
        f3_mmio_sent_to_ibuffer = _RANDOM[8'h7D][27];
        io_mmioCommitRead_valid_REG = _RANDOM[8'h7D][28];
        io_mmioCommitRead_mmioFtqPtr_REG_flag = _RANDOM[8'h7D][29];
        io_mmioCommitRead_mmioFtqPtr_REG_value =
          {_RANDOM[8'h7D][31:30], _RANDOM[8'h7E][3:0]};
        fromFtqRedirectReg_bits_r_ftqIdx_flag = _RANDOM[8'h7E][14];
        fromFtqRedirectReg_bits_r_ftqIdx_value = _RANDOM[8'h7E][20:15];
        fromFtqRedirectReg_bits_r_ftqOffset = _RANDOM[8'h7E][24:21];
        fromFtqRedirectReg_bits_r_level = _RANDOM[8'h7E][25];
        fromFtqRedirectReg_valid_REG = _RANDOM[8'h8F][26];
        mmioF3Flush = _RANDOM[8'h8F][27];
        f3_mmio_use_seq_pc = _RANDOM[8'h8F][28];
        REG = _RANDOM[8'h8F][29];
        f3_lastHalf_valid = _RANDOM[8'h8F][30];
        predChecker_io_in_fire_in_REG = _RANDOM[8'h91][17];
        f3_lastHalf_disable = _RANDOM[8'h91][18];
        mmioFlushWb_valid_REG = _RANDOM[8'h91][20];
        mmio_redirect_REG = _RANDOM[8'h91][21];
        wb_enable_REG = _RANDOM[8'h91][22];
        wb_valid = _RANDOM[8'h91][23];
        wb_ftq_req_ftqIdx_flag = _RANDOM[8'h96][14];
        wb_ftq_req_ftqIdx_value = _RANDOM[8'h96][20:15];
        wb_check_result_stage1_fixedTaken_0 = _RANDOM[8'h98][20];
        wb_check_result_stage1_fixedTaken_1 = _RANDOM[8'h98][21];
        wb_check_result_stage1_fixedTaken_2 = _RANDOM[8'h98][22];
        wb_check_result_stage1_fixedTaken_3 = _RANDOM[8'h98][23];
        wb_check_result_stage1_fixedTaken_4 = _RANDOM[8'h98][24];
        wb_check_result_stage1_fixedTaken_5 = _RANDOM[8'h98][25];
        wb_check_result_stage1_fixedTaken_6 = _RANDOM[8'h98][26];
        wb_check_result_stage1_fixedTaken_7 = _RANDOM[8'h98][27];
        wb_check_result_stage1_fixedTaken_8 = _RANDOM[8'h98][28];
        wb_check_result_stage1_fixedTaken_9 = _RANDOM[8'h98][29];
        wb_check_result_stage1_fixedTaken_10 = _RANDOM[8'h98][30];
        wb_check_result_stage1_fixedTaken_11 = _RANDOM[8'h98][31];
        wb_check_result_stage1_fixedTaken_12 = _RANDOM[8'h99][0];
        wb_check_result_stage1_fixedTaken_13 = _RANDOM[8'h99][1];
        wb_check_result_stage1_fixedTaken_14 = _RANDOM[8'h99][2];
        wb_check_result_stage1_fixedTaken_15 = _RANDOM[8'h99][3];
        wb_instr_range = _RANDOM[8'h99][19:4];
        wb_pc_lower_result_0 = _RANDOM[8'h99][31:20];
        wb_pc_lower_result_1 = _RANDOM[8'h9A][11:0];
        wb_pc_lower_result_2 = _RANDOM[8'h9A][23:12];
        wb_pc_lower_result_3 = {_RANDOM[8'h9A][31:24], _RANDOM[8'h9B][3:0]};
        wb_pc_lower_result_4 = _RANDOM[8'h9B][15:4];
        wb_pc_lower_result_5 = _RANDOM[8'h9B][27:16];
        wb_pc_lower_result_6 = {_RANDOM[8'h9B][31:28], _RANDOM[8'h9C][7:0]};
        wb_pc_lower_result_7 = _RANDOM[8'h9C][19:8];
        wb_pc_lower_result_8 = _RANDOM[8'h9C][31:20];
        wb_pc_lower_result_9 = _RANDOM[8'h9D][11:0];
        wb_pc_lower_result_10 = _RANDOM[8'h9D][23:12];
        wb_pc_lower_result_11 = {_RANDOM[8'h9D][31:24], _RANDOM[8'h9E][3:0]};
        wb_pc_lower_result_12 = _RANDOM[8'h9E][15:4];
        wb_pc_lower_result_13 = _RANDOM[8'h9E][27:16];
        wb_pc_lower_result_14 = {_RANDOM[8'h9E][31:28], _RANDOM[8'h9F][7:0]};
        wb_pc_lower_result_15 = _RANDOM[8'h9F][19:8];
        wb_pc_high = {_RANDOM[8'h9F][31:20], _RANDOM[8'hA0][26:0]};
        wb_pc_high_plus1 = {_RANDOM[8'hA0][31:27], _RANDOM[8'hA1], _RANDOM[8'hA2][1:0]};
        wb_pd_0_isRVC = _RANDOM[8'hA2][3];
        wb_pd_0_brType = _RANDOM[8'hA2][5:4];
        wb_pd_0_isCall = _RANDOM[8'hA2][6];
        wb_pd_0_isRet = _RANDOM[8'hA2][7];
        wb_pd_1_isRVC = _RANDOM[8'hA2][9];
        wb_pd_1_brType = _RANDOM[8'hA2][11:10];
        wb_pd_1_isCall = _RANDOM[8'hA2][12];
        wb_pd_1_isRet = _RANDOM[8'hA2][13];
        wb_pd_2_isRVC = _RANDOM[8'hA2][15];
        wb_pd_2_brType = _RANDOM[8'hA2][17:16];
        wb_pd_2_isCall = _RANDOM[8'hA2][18];
        wb_pd_2_isRet = _RANDOM[8'hA2][19];
        wb_pd_3_isRVC = _RANDOM[8'hA2][21];
        wb_pd_3_brType = _RANDOM[8'hA2][23:22];
        wb_pd_3_isCall = _RANDOM[8'hA2][24];
        wb_pd_3_isRet = _RANDOM[8'hA2][25];
        wb_pd_4_isRVC = _RANDOM[8'hA2][27];
        wb_pd_4_brType = _RANDOM[8'hA2][29:28];
        wb_pd_4_isCall = _RANDOM[8'hA2][30];
        wb_pd_4_isRet = _RANDOM[8'hA2][31];
        wb_pd_5_isRVC = _RANDOM[8'hA3][1];
        wb_pd_5_brType = _RANDOM[8'hA3][3:2];
        wb_pd_5_isCall = _RANDOM[8'hA3][4];
        wb_pd_5_isRet = _RANDOM[8'hA3][5];
        wb_pd_6_isRVC = _RANDOM[8'hA3][7];
        wb_pd_6_brType = _RANDOM[8'hA3][9:8];
        wb_pd_6_isCall = _RANDOM[8'hA3][10];
        wb_pd_6_isRet = _RANDOM[8'hA3][11];
        wb_pd_7_isRVC = _RANDOM[8'hA3][13];
        wb_pd_7_brType = _RANDOM[8'hA3][15:14];
        wb_pd_7_isCall = _RANDOM[8'hA3][16];
        wb_pd_7_isRet = _RANDOM[8'hA3][17];
        wb_pd_8_isRVC = _RANDOM[8'hA3][19];
        wb_pd_8_brType = _RANDOM[8'hA3][21:20];
        wb_pd_8_isCall = _RANDOM[8'hA3][22];
        wb_pd_8_isRet = _RANDOM[8'hA3][23];
        wb_pd_9_isRVC = _RANDOM[8'hA3][25];
        wb_pd_9_brType = _RANDOM[8'hA3][27:26];
        wb_pd_9_isCall = _RANDOM[8'hA3][28];
        wb_pd_9_isRet = _RANDOM[8'hA3][29];
        wb_pd_10_isRVC = _RANDOM[8'hA3][31];
        wb_pd_10_brType = _RANDOM[8'hA4][1:0];
        wb_pd_10_isCall = _RANDOM[8'hA4][2];
        wb_pd_10_isRet = _RANDOM[8'hA4][3];
        wb_pd_11_isRVC = _RANDOM[8'hA4][5];
        wb_pd_11_brType = _RANDOM[8'hA4][7:6];
        wb_pd_11_isCall = _RANDOM[8'hA4][8];
        wb_pd_11_isRet = _RANDOM[8'hA4][9];
        wb_pd_12_isRVC = _RANDOM[8'hA4][11];
        wb_pd_12_brType = _RANDOM[8'hA4][13:12];
        wb_pd_12_isCall = _RANDOM[8'hA4][14];
        wb_pd_12_isRet = _RANDOM[8'hA4][15];
        wb_pd_13_isRVC = _RANDOM[8'hA4][17];
        wb_pd_13_brType = _RANDOM[8'hA4][19:18];
        wb_pd_13_isCall = _RANDOM[8'hA4][20];
        wb_pd_13_isRet = _RANDOM[8'hA4][21];
        wb_pd_14_isRVC = _RANDOM[8'hA4][23];
        wb_pd_14_brType = _RANDOM[8'hA4][25:24];
        wb_pd_14_isCall = _RANDOM[8'hA4][26];
        wb_pd_14_isRet = _RANDOM[8'hA4][27];
        wb_pd_15_isRVC = _RANDOM[8'hA4][29];
        wb_pd_15_brType = _RANDOM[8'hA4][31:30];
        wb_pd_15_isCall = _RANDOM[8'hA5][0];
        wb_pd_15_isRet = _RANDOM[8'hA5][1];
        wb_instr_valid_0 = _RANDOM[8'hA5][2];
        wb_instr_valid_1 = _RANDOM[8'hA5][3];
        wb_instr_valid_2 = _RANDOM[8'hA5][4];
        wb_instr_valid_3 = _RANDOM[8'hA5][5];
        wb_instr_valid_4 = _RANDOM[8'hA5][6];
        wb_instr_valid_5 = _RANDOM[8'hA5][7];
        wb_instr_valid_6 = _RANDOM[8'hA5][8];
        wb_instr_valid_7 = _RANDOM[8'hA5][9];
        wb_instr_valid_8 = _RANDOM[8'hA5][10];
        wb_instr_valid_9 = _RANDOM[8'hA5][11];
        wb_instr_valid_10 = _RANDOM[8'hA5][12];
        wb_instr_valid_11 = _RANDOM[8'hA5][13];
        wb_instr_valid_12 = _RANDOM[8'hA5][14];
        wb_instr_valid_13 = _RANDOM[8'hA5][15];
        wb_instr_valid_14 = _RANDOM[8'hA5][16];
        wb_instr_valid_15 = _RANDOM[8'hA5][17];
        wb_lastIdx = _RANDOM[8'hA5][21:18];
        wb_false_lastHalf_r = _RANDOM[8'hA5][22];
        wb_false_target = {_RANDOM[8'hA5][31:23], _RANDOM[8'hA6], _RANDOM[8'hA7][8:0]};
        REG_1 = _RANDOM[8'hA7][9];
        REG_2 = _RANDOM[8'hA7][10];
        REG_3 = _RANDOM[8'hA7][11];
        f3_perf_info_only_0_hit = _RANDOM[8'hA7][12];
        f3_perf_info_only_0_miss = _RANDOM[8'hA7][13];
        f3_perf_info_hit_0_hit_1 = _RANDOM[8'hA7][14];
        f3_perf_info_hit_0_miss_1 = _RANDOM[8'hA7][15];
        f3_perf_info_miss_0_hit_1 = _RANDOM[8'hA7][16];
        f3_perf_info_miss_0_miss_1 = _RANDOM[8'hA7][17];
        f3_perf_info_bank_hit_1 = _RANDOM[8'hA7][22];
        f3_perf_info_hit = _RANDOM[8'hA7][23];
        io_perf_0_value_REG = _RANDOM[8'hA7][24];
        io_perf_0_value_REG_1 = _RANDOM[8'hA7][25];
        io_perf_1_value_REG = _RANDOM[8'hA7][26];
        io_perf_1_value_REG_1 = _RANDOM[8'hA7][27];
        io_perf_2_value_REG = _RANDOM[8'hA7][28];
        io_perf_2_value_REG_1 = _RANDOM[8'hA7][29];
        io_perf_3_value_REG = _RANDOM[8'hA7][30];
        io_perf_3_value_REG_1 = _RANDOM[8'hA7][31];
        io_perf_4_value_REG = _RANDOM[8'hA8][0];
        io_perf_4_value_REG_1 = _RANDOM[8'hA8][1];
        io_perf_5_value_REG = _RANDOM[8'hA8][2];
        io_perf_5_value_REG_1 = _RANDOM[8'hA8][3];
        io_perf_6_value_REG = _RANDOM[8'hA8][4];
        io_perf_6_value_REG_1 = _RANDOM[8'hA8][5];
        io_perf_7_value_REG = _RANDOM[8'hA8][6];
        io_perf_7_value_REG_1 = _RANDOM[8'hA8][7];
        io_perf_8_value_REG = _RANDOM[8'hA8][8];
        io_perf_8_value_REG_1 = _RANDOM[8'hA8][9];
        io_perf_9_value_REG = _RANDOM[8'hA8][10];
        io_perf_9_value_REG_1 = _RANDOM[8'hA8][11];
        io_perf_10_value_REG = _RANDOM[8'hA8][12];
        io_perf_10_value_REG_1 = _RANDOM[8'hA8][13];
        io_perf_11_value_REG = _RANDOM[8'hA8][14];
        io_perf_11_value_REG_1 = _RANDOM[8'hA8][15];
        io_perf_12_value_REG = _RANDOM[8'hA8][16];
        io_perf_12_value_REG_1 = _RANDOM[8'hA8][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        f1_valid = 1'h0;
        f2_valid = 1'h0;
  ...
  assign io_toIbuffer_bits_isLastInFtqEntry_0 = _GEN_13[15];
  assign io_toIbuffer_bits_isLastInFtqEntry_1 = _GEN_13[14];
  assign io_toIbuffer_bits_isLastInFtqEntry_2 = _GEN_13[13];
  assign io_toIbuffer_bits_isLastInFtqEntry_3 = _GEN_13[12];
  assign io_toIbuffer_bits_isLastInFtqEntry_4 = _GEN_13[11];
  assign io_toIbuffer_bits_isLastInFtqEntry_5 = _GEN_13[10];
  assign io_toIbuffer_bits_isLastInFtqEntry_6 = _GEN_13[9];
  assign io_toIbuffer_bits_isLastInFtqEntry_7 = _GEN_14[0];
  assign io_toIbuffer_bits_isLastInFtqEntry_8 = _GEN_14[1];
  assign io_toIbuffer_bits_isLastInFtqEntry_9 = _GEN_14[2];
  assign io_toIbuffer_bits_isLastInFtqEntry_10 = _GEN_14[3];
  assign io_toIbuffer_bits_isLastInFtqEntry_11 = _GEN_13[4];
  assign io_toIbuffer_bits_isLastInFtqEntry_12 = _GEN_13[3];
  assign io_toIbuffer_bits_isLastInFtqEntry_13 = _GEN_13[2];
  assign io_toIbuffer_bits_isLastInFtqEntry_14 = _GEN_13[1];
  assign io_toIbuffer_bits_isLastInFtqEntry_15 = _GEN_13[0];
  ...
  assign io_uncacheInter_toUncache_bits_flush =
    _io_uncacheInter_toUncache_bits_flush_T | mmioF3Flush & ~f3_need_not_flush;
  ...
  assign io_pmp_req_valid = mmio_state == 4'h6 & f3_req_is_mmio;
  assign io_pmp_req_bits_addr = mmio_resend_addr;
  assign io_mmioCommitRead_valid = io_mmioCommitRead_valid_REG;
