  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_exceptionVec_19 = _RANDOM[6'h7][30];
        ...
        data_uop_storeSetHit = _RANDOM[6'h2B][21];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h2B][22];
        data_uop_waitForRobIdx_value = _RANDOM[6'h2B][30:23];
        data_uop_loadWaitBit = _RANDOM[6'h2B][31];
        data_uop_loadWaitStrict = _RANDOM[6'h2C][0];
        data_uop_lqIdx_flag = _RANDOM[6'h2C][6];
        data_uop_lqIdx_value = _RANDOM[6'h2C][13:7];
        data_uop_sqIdx_flag = _RANDOM[6'h2C][14];
        data_uop_sqIdx_value = _RANDOM[6'h2C][20:15];
        data_mBIndex = {_RANDOM[6'h2C][31:29], _RANDOM[6'h2D][0]};
        data_elemIdx = _RANDOM[6'h2D][8:1];
        data_elemIdxInsideVd = _RANDOM[6'h2D][16:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
