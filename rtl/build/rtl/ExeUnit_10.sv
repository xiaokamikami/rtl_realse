  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_2_robIdx_flag = _RANDOM[7'h29][2];
        inPipe_1_2_robIdx_value = _RANDOM[7'h29][10:3];
        inPipe_1_2_pdest = _RANDOM[7'h29][23:16];
        inPipe_1_2_fpWen = _RANDOM[7'h29][25];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h29][28];
        inPipe_1_3_robIdx_flag = _RANDOM[7'h48][12];
        inPipe_1_3_robIdx_value = _RANDOM[7'h48][20:13];
        inPipe_1_3_pdest = {_RANDOM[7'h48][31:26], _RANDOM[7'h49][1:0]};
        inPipe_1_3_fpWen = _RANDOM[7'h49][3];
        inPipe_1_3_fpu_wflags = _RANDOM[7'h49][6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
