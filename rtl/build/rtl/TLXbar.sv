...
module TLXbar(
  ...
  wire [15:0] _GEN_4 =
    ...
    | {_readys_filter_T_1,
       ...
       auto_out_3_d_valid,
       auto_out_2_d_valid};
  wire [14:0] _GEN_5 = _GEN_4[14:0] | {_readys_filter_T_1[8], _GEN_4[15:2]};
  wire [12:0] _GEN_6 = _GEN_5[12:0] | {_readys_filter_T_1[8], _GEN_4[15], _GEN_5[14:4]};
  wire [8:0]  readys_readys =
    ~({readys_mask[8],
       _readys_filter_T_1[8] | readys_mask[7],
       _GEN_4[15] | readys_mask[6],
       _GEN_5[14:13] | readys_mask[5:4],
       _GEN_6[12:9] | readys_mask[3:0]}
      & (_GEN_6[8:0] | {_readys_filter_T_1[8], _GEN_4[15], _GEN_5[14:13], _GEN_6[12:8]}));
