...
module VTypeBuffer(
  ...
  wire [6:0]      _deqPtrNext_new_ptr_T_1 =
    7'({deqPtrVec_0_flag, shiftAmount}
       + {3'h0,
          ((|state) ? 4'h0 : commitCount) | (_spclWalkCount_T ? spclWalkCount : 4'h0)});
  ...
  wire            commitValidVec_1 =
    ~(|state) & (|(commitSize[6:1])) | _spclWalkCount_T & (|(spclWalkSize[6:1]));
  wire            walkValidVec_1 =
    _walkCount_T & (|(walkSize[6:1])) | _spclWalkCount_T & (|(spclWalkSize[6:1]));
  wire            _walkValidVec_2_T_4 = spclWalkSize > 7'h2;
  wire            commitValidVec_2 =
    ~(|state) & commitSize > 7'h2 | _spclWalkCount_T & _walkValidVec_2_T_4;
  wire            walkValidVec_2 =
    _walkCount_T & walkSize > 7'h2 | _spclWalkCount_T & _walkValidVec_2_T_4;
  wire            commitValidVec_3 =
    ~(|state) & (|(commitSize[6:2])) | _spclWalkCount_T & (|(spclWalkSize[6:2]));
  wire            walkValidVec_3 =
    _walkCount_T & (|(walkSize[6:2])) | _spclWalkCount_T & (|(spclWalkSize[6:2]));
  wire            _walkValidVec_4_T_4 = spclWalkSize > 7'h4;
  wire            commitValidVec_4 =
    ~(|state) & commitSize > 7'h4 | _spclWalkCount_T & _walkValidVec_4_T_4;
  wire            walkValidVec_4 =
    _walkCount_T & walkSize > 7'h4 | _spclWalkCount_T & _walkValidVec_4_T_4;
  wire            _walkValidVec_5_T_4 = spclWalkSize > 7'h5;
  wire            commitValidVec_5 =
    ~(|state) & commitSize > 7'h5 | _spclWalkCount_T & _walkValidVec_5_T_4;
  wire            walkValidVec_5 =
    _walkCount_T & walkSize > 7'h5 | _spclWalkCount_T & _walkValidVec_5_T_4;
  wire            _walkValidVec_6_T_4 = spclWalkSize > 7'h6;
  wire            commitValidVec_6 =
    ~(|state) & commitSize > 7'h6 | _spclWalkCount_T & _walkValidVec_6_T_4;
  wire            walkValidVec_6 =
    _walkCount_T & walkSize > 7'h6 | _spclWalkCount_T & _walkValidVec_6_T_4;
  wire            commitValidVec_7 =
    ~(|state) & (|(commitSize[6:3])) | _spclWalkCount_T & (|(spclWalkSize[6:3]));
  wire            walkValidVec_7 =
    _walkCount_T & (|(walkSize[6:3])) | _spclWalkCount_T & (|(spclWalkSize[6:3]));
  assign commitCount =
    (|state)
      ? 4'h0
      : 4'({1'h0,
  ...
  assign walkCount =
    _walkCount_T ? 4'({1'h0, 3'(_GEN_8 + _GEN_9)} + {1'h0, 3'(_GEN_10 + _GEN_11)}) : 4'h0;
  assign spclWalkCount =
    _spclWalkCount_T
      ? 4'({1'h0, 3'(_GEN_8 + _GEN_9)} + {1'h0, 3'(_GEN_10 + _GEN_11)})
      : 4'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        commitSize = _RANDOM[4'h9][14:8];
        walkSize = _RANDOM[4'h9][21:15];
        spclWalkSize = _RANDOM[4'h9][28:22];
        useSnapshot = _RANDOM[4'h9][29];
        snapshotVType_illegal = _RANDOM[4'h9][30];
        snapshotVType_vma = _RANDOM[4'h9][31];
        snapshotVType_vta = _RANDOM[4'hA][0];
        snapshotVType_vsew = _RANDOM[4'hA][2:1];
        snapshotVType_vlmul = _RANDOM[4'hA][5:3];
        allowEnqueue_last_REG = _RANDOM[4'hA][6];
        allowEnqueueForDispatch_last_REG = _RANDOM[4'hA][7];
        decodeResumeVType_valid = _RANDOM[4'hA][8];
        decodeResumeVType_bits_illegal = _RANDOM[4'hA][9];
        decodeResumeVType_bits_vma = _RANDOM[4'hA][10];
        decodeResumeVType_bits_vta = _RANDOM[4'hA][11];
        decodeResumeVType_bits_vsew = _RANDOM[4'hA][13:12];
        decodeResumeVType_bits_vlmul = _RANDOM[4'hA][16:14];
        walkToArchVType = _RANDOM[4'hA][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        state = 2'h0;
        enqPtrVec_0_flag = 1'h0;
  ...
  SyncDataModuleTemplate__64entry_4 vtypeBuffer (
    .clock                    (clock),
    .reset                    (reset),
    .io_raddr_0
