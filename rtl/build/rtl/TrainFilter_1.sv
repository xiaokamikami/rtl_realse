  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h3B][31:22], _RANDOM[10'h3C], _RANDOM[10'h3D][7:0]};
        ld_in_reordered_res_0_1_0_bits_miss = _RANDOM[10'h47][11];
        ld_in_reordered_res_0_1_0_bits_meta_prefetch = _RANDOM[10'h52][6:4];
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h52][8];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h64][21];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h64][29:22];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h7A][31:22], _RANDOM[10'h7B], _RANDOM[10'h7C][7:0]};
        ld_in_reordered_res_0_1_1_bits_miss = _RANDOM[10'h86][11];
        ld_in_reordered_res_0_1_1_bits_meta_prefetch = _RANDOM[10'h91][6:4];
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h91][8];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hA3][21];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hA3][29:22];
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hB9][31:22], _RANDOM[10'hBA], _RANDOM[10'hBB][7:0]};
        ld_in_reordered_res_0_1_2_bits_miss = _RANDOM[10'hC5][11];
        ld_in_reordered_res_0_1_2_bits_meta_prefetch = _RANDOM[10'hD0][6:4];
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hD0][8];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hE2][21];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hE2][29:22];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'hF8][31:22], _RANDOM[10'hF9], _RANDOM[10'hFA][7:0]};
        ld_in_reordered_res_1_2_0_bits_miss = _RANDOM[10'h104][11];
        ld_in_reordered_res_1_2_0_bits_meta_prefetch = _RANDOM[10'h10F][6:4];
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h10F][8];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h121][21];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h121][29:22];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h137][31:22], _RANDOM[10'h138], _RANDOM[10'h139][7:0]};
        ld_in_reordered_res_1_2_1_bits_miss = _RANDOM[10'h143][11];
        ld_in_reordered_res_1_2_1_bits_meta_prefetch = _RANDOM[10'h14E][6:4];
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h14E][8];
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h176][31:22], _RANDOM[10'h177], _RANDOM[10'h178][7:0]};
        ld_in_reordered_res_1_2_2_bits_miss = _RANDOM[10'h182][11];
        ld_in_reordered_res_1_2_2_bits_meta_prefetch = _RANDOM[10'h18D][6:4];
        ld_in_reordered_0_valid = _RANDOM[10'h18D][8];
        ld_in_reordered_0_bits_vaddr =
          {_RANDOM[10'h1B5][31:22], _RANDOM[10'h1B6], _RANDOM[10'h1B7][7:0]};
        ld_in_reordered_0_bits_miss = _RANDOM[10'h1C1][11];
        ld_in_reordered_0_bits_meta_prefetch = _RANDOM[10'h1CC][6:4];
        ld_in_reordered_1_valid = _RANDOM[10'h1CC][8];
        ld_in_reordered_1_bits_vaddr =
          {_RANDOM[10'h1F4][31:22], _RANDOM[10'h1F5], _RANDOM[10'h1F6][7:0]};
        ld_in_reordered_1_bits_miss = _RANDOM[10'h200][11];
        ld_in_reordered_1_bits_meta_prefetch = _RANDOM[10'h20B][6:4];
        ld_in_reordered_2_valid = _RANDOM[10'h20B][8];
        ld_in_reordered_2_bits_vaddr =
          {_RANDOM[10'h233][31:22], _RANDOM[10'h234], _RANDOM[10'h235][7:0]};
        ld_in_reordered_2_bits_miss = _RANDOM[10'h23F][11];
        ld_in_reordered_2_bits_meta_prefetch = _RANDOM[10'h24A][6:4];
        REG = _RANDOM[10'h24A][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
