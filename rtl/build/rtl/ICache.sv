...
module ICache(
  ...
  wire         _mainPipe_io_fetch_topdownIcacheMiss;
  ...
  always @(posedge clock) begin
    io_perf_0_value_REG <= _mainPipe_io_fetch_topdownIcacheMiss;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_perf_0_value_REG = _RANDOM[3'h5][11];
        io_perf_0_value_REG_1 = _RANDOM[3'h5][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        softPrefetchValid = 1'h0;
        softPrefetch_startAddr = 50'h0;
  ...
  ICacheMainPipe mainPipe (
    ...
    .io_fetch_topdownIcacheMiss                   (_mainPipe_io_fetch_topdownIcacheMiss),
    .io_flush                                     (io_flush),
    .io_pmp_0_req_valid                           (io_pmp_0_req_valid),
    ...
    .io_pmp_1_req_valid                           (io_pmp_1_req_valid),
  ...
  IPrefetchPipe prefetcher (
    ...
    .io_pmp_0_req_valid                            (io_pmp_2_req_valid),
    ...
    .io_pmp_1_req_valid                            (io_pmp_3_req_valid),
