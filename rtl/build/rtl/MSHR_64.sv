...
module MSHR_64(
  ...
  input  [12:0] io_alloc_bits_set,
  input  [28:0] io_alloc_bits_tag,
  ...
  output [12:0] io_status_bits_set,
  output [28:0] io_status_bits_tag,
  ...
  input  [12:0] io_nestedwb_set,
  input  [28:0] io_nestedwb_tag,
  ...
  output [12:0] io_tasks_sink_a_bits_set,
  output [28:0] io_tasks_sink_a_bits_tag,
  ...
  output [12:0] io_tasks_source_b_bits_set,
  output [28:0] io_tasks_source_b_bits_tag,
  ...
  output [12:0] io_tasks_sink_c_bits_set,
  output [28:0] io_tasks_sink_c_bits_tag,
  ...
  output [12:0] io_tasks_source_d_bits_set,
  output [28:0] io_tasks_source_d_bits_tag,
  ...
  output [28:0] io_tasks_source_a_bits_tag,
  output [12:0] io_tasks_source_a_bits_set,
  ...
  output [28:0] io_tasks_source_c_bits_tag,
  output [12:0] io_tasks_source_c_bits_set,
  ...
  output [28:0] io_tasks_prefetch_train_bits_tag,
  output [12:0] io_tasks_prefetch_train_bits_set,
  ...
  output [28:0] io_tasks_prefetch_resp_bits_tag,
  output [12:0] io_tasks_prefetch_resp_bits_set,
  input         io_tasks_dir_write_ready,
  output        io_tasks_dir_write_valid,
  output [12:0] io_tasks_dir_write_bits_set,
  ...
  output [12:0] io_tasks_tag_write_bits_set,
  output [2:0]  io_tasks_tag_write_bits_way,
  output [28:0] io_tasks_tag_write_bits_tag,
  ...
  output [31:0] io_tasks_client_tag_write_bits_tag,
  ...
  input  [28:0] io_dirResult_bits_self_tag,
  ...
  input  [31:0] io_dirResult_bits_clients_tag,
  input  [3:0]  io_dirResult_bits_clients_way,
  input         io_dirResult_bits_clients_error,
  input  [12:0] io_c_status_set,
  input  [28:0] io_c_status_tag,
  ...
  input  [12:0] io_b_status_set,
  input  [28:0] io_b_status_tag,
  ...
  wire            _GEN_7 =
    ...
    & {io_nestedwb_tag,
       io_nestedwb_set[12:10]} == (io_dirResult_valid
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_set = {_RANDOM[4'h0][31:23], _RANDOM[4'h1][3:0]};
        req_tag = {_RANDOM[4'h1][31:4], _RANDOM[4'h2][0]};
        ...
        req_reqSource = _RANDOM[4'h3][24:20];
        req_valid = _RANDOM[4'h3][25];
        iam = _RANDOM[4'h3][27:26];
        meta_reg_self_dirty = _RANDOM[4'h4][12];
        meta_reg_self_state = _RANDOM[4'h4][14:13];
        meta_reg_self_clientStates_0 = _RANDOM[4'h4][16:15];
        meta_reg_self_prefetch = _RANDOM[4'h4][17];
        meta_reg_self_hit = _RANDOM[4'h4][18];
        meta_reg_self_way = _RANDOM[4'h4][21:19];
        meta_reg_self_tag = {_RANDOM[4'h4][31:22], _RANDOM[4'h5][18:0]};
        meta_reg_self_error = _RANDOM[4'h5][19];
        meta_reg_clients_states_0_state = _RANDOM[4'h5][21:20];
        meta_reg_clients_states_0_hit = _RANDOM[4'h5][22];
        meta_reg_clients_tag = {_RANDOM[4'h5][31:24], _RANDOM[4'h6][23:0]};
        meta_reg_clients_way = _RANDOM[4'h6][27:24];
        meta_reg_clients_error = _RANDOM[4'h6][28];
  ...
  assign io_tasks_source_a_bits_reqSource = _probe_clients_T_1 ? 5'h13 : req_reqSource;
  ...
  assign io_tasks_client_tag_write_bits_tag = {req_tag, req_set[12:10]};
