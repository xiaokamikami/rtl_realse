...
module SliceCtrl(
  ...
  output [12:0]  io_s_dir_w_bits_set,
  ...
  input  [28:0]  io_dir_result_bits_self_tag,
  ...
  output [12:0]  io_cmo_req_bits_set,
  output [28:0]  io_cmo_req_bits_tag
);
  ...
  always @(posedge clock) begin
    if (_GEN) begin
      ...
      req_reg_set <= {51'h0, io_req_bits_set[12:0]};
      req_reg_tag <= {35'h0, io_req_bits_tag[28:0]};
    ...
    if (data_wen & ~w_counter) begin
      ...
      if (io_dir_result_valid) begin
        if (req_reg_cmd == 8'h3)
          ...
          req_reg_data_0 <= {35'h0, io_dir_result_bits_self_tag};
        else if (req_reg_cmd == 8'h1)
          req_reg_data_0 <= {32'h0, io_dir_result_bits_clients_tag};
        else if (_GEN)
  ...
  assign io_s_dir_w_bits_set = req_reg_set[12:0];
  ...
  assign io_s_tag_w_bits_set = req_reg_set[12:0];
  assign io_s_tag_w_bits_way = req_reg_way[2:0];
  assign io_s_tag_w_bits_tag = req_reg_tag[28:0];
  ...
  assign io_dir_read_bits_tag = req_reg_tag[28:0];
  assign io_dir_read_bits_set = req_reg_set[12:0];
  assign io_bs_r_addr_valid = io_bs_r_addr_valid_0;
  assign io_bs_r_addr_bits_way = req_reg_way[2:0];
  assign io_bs_r_addr_bits_set = req_reg_set[12:0];
  ...
  assign io_cmo_req_bits_set = io_req_bits_set[12:0];
  assign io_cmo_req_bits_tag = io_req_bits_tag[28:0];
endmodule
