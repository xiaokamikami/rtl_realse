...
module Directory_4(
  ...
  output [28:0] io_result_bits_self_tag,
  ...
  input  [12:0] io_tagWReq_bits_set,
  input  [2:0]  io_tagWReq_bits_way,
  input  [28:0] io_tagWReq_bits_tag,
  ...
  input  [31:0] io_clientTagWreq_bits_tag
);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        setReg_r = _RANDOM[3'h3][20:8];
        setReg = {_RANDOM[3'h3][31:21], _RANDOM[3'h4][1:0]};
        replacerInfoReg_r_channel = _RANDOM[3'h4][4:2];
        replacerInfoReg_r_opcode = _RANDOM[3'h4][7:5];
        replacerInfoReg_channel = _RANDOM[3'h4][15:13];
        replacerInfoReg_opcode = _RANDOM[3'h4][18:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        reqValidReg = 1'h0;
    end // initial
  ...
  SubDirectory clientDir (
    ...
    .io_read_bits_tag          ({io_read_bits_tag, io_read_bits_set[12:10]}),
