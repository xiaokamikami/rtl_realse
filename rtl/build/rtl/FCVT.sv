  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fireReg_last_r = _RANDOM[6'h32][16];
        outIs16bits_REG = _RANDOM[6'h32][17];
        outIs16bits = _RANDOM[6'h32][18];
        outIs32bits_REG = _RANDOM[6'h32][19];
        outIs32bits = _RANDOM[6'h32][20];
        result_r = {_RANDOM[6'h32][31], _RANDOM[6'h33], _RANDOM[6'h34][30:0]};
        result_r_1 = {_RANDOM[6'h34][31], _RANDOM[6'h35], _RANDOM[6'h36][30:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
