...
module StoreUnit(
  ...
  output        io_misalign_stout_bits_uop_robIdx_flag,
  output [7:0]  io_misalign_stout_bits_uop_robIdx_value,
  ...
  output        io_lsq_replenish_uop_sqIdx_flag,
  output [5:0]  io_lsq_replenish_uop_sqIdx_value,
  ...
  input         io_sqCommitPtr_flag,
  input  [5:0]  io_sqCommitPtr_value,
  input  [6:0]  io_sqCommitUopIdx,
  input         io_sqCommitRobIdx_flag,
  input  [7:0]  io_sqCommitRobIdx_value,
  output        io_s0_s1_s2_valid
);
  ...
  wire        _GEN = io_stin_ready_0 | ~s0_out_isvec;
  ...
  wire [6:0]  s0_uop_uopIdx =
    io_misalign_stin_valid
      ? io_misalign_stin_bits_uop_uopIdx
      : _GEN ? 7'h0 : io_vecstin_bits_uop_uopIdx;
  ...
  wire [8:0]  _s0_misalignNeedReplay_T_4 = {s0_uop_robIdx_flag, s0_uop_robIdx_value};
  ...
  wire        _s0_fire_T_1 =
    ...
    & ~(io_redirect_valid
        & (io_redirect_bits_level
           & _s0_misalignNeedReplay_T_4 == _sx_ready_1_flushItself_T_2
  ...
  wire [49:0] _s0_vaddr_T_1 = s0_out_isvec ? io_vecstin_bits_vaddr[49:0] : 50'h0;
  wire [49:0] s0_vaddr =
    io_misalign_stin_valid
  ...
  wire [15:0] _s0_out_mask_T_14 =
    s0_rs_corss16Bytes & ~s0_addr_aligned
      ...
      : io_misalign_stin_valid
          ...
          : io_stin_ready_0
              ? (s0_isCbo ? 16'hFFFF : _s0_mask_T_20[15:0])
  ...
  wire [5:0]  _GEN_0 =
    {s2_in_uop_exceptionVec_23,
     s2_in_uop_exceptionVec_19,
     s2_in_uop_exceptionVec_15,
     s2_out_af,
     s2_exception_new_vec_6,
     s2_in_uop_exceptionVec_3};
  wire        s2_exception =
    s2_exception_REG & (s2_trigger_debug_mode | (|_GEN_0)) & s2_vecActive;
  ...
  wire        s2_actually_uncache =
    ...
    & ~(s2_vecActive
        & (s2_in_uop_exceptionVec_7 | s2_in_uop_exceptionVec_15
           | s2_in_uop_exceptionVec_23))
    & (_s2_actually_uncache_T_2 & ~io_pmp_st & io_pmp_mmio | s2_in_nc | s2_in_mmio)
  ...
  assign s2_exception_new_vec_6 =
    s2_actually_uncache & ~s2_in_isvec & (s2_in_isMisalign | s2_in_isFrmMisAlignBuf)
    & ~(s2_un_misalign_exception_REG
        & (s2_trigger_debug_mode
           | (|{s2_in_uop_exceptionVec_23,
                ...
                s2_in_uop_exceptionVec_3})));
  reg         s2_mis_align_r;
  wire        s2_mis_align = s2_valid & s2_mis_align_r;
  reg         s2_misalignNeedReplay;
  ...
  reg         sx_in_1_r_output_uop_exceptionVec_19;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_s0_fire_T_1) begin
        ...
        s1_misalignNeedReplay <=
          (s0_out_isvec | s0_rs_corss16Bytes)
          & ~({s0_uop_sqIdx_flag,
               s0_uop_sqIdx_value} == {io_sqCommitPtr_flag, io_sqCommitPtr_value}
              | _s0_misalignNeedReplay_T_4 == {io_sqCommitRobIdx_flag,
                                               io_sqCommitRobIdx_value}
              & s0_uop_uopIdx == io_sqCommitUopIdx);
      ...
      if (_s1_fire_T_1) begin
        ...
        s2_misalignNeedReplay <=
          s1_toMisalignBufferValid & (~io_misalign_enq_req_ready | s1_misalignNeedReplay);
      end
      io_feedback_slow_valid_last_REG <= feedback_slow_valid;
      if (_s2_fire_T_1)
        s3_valid <=
          (~s2_mmio & ~s2_isCbo | s2_exception)
          & (~s2_mis_align | s2_in_isvec & (s2_misalignNeedReplay | s2_exception)
             | ~s2_in_isvec & ~s2_misalignNeedReplay & s2_exception)
  ...
  always @(posedge clock) begin
    if (_s0_fire_T_1) begin
      ...
      s1_in_uop_exceptionVec_19 <=
        io_misalign_stin_valid
          ...
          : ~io_stin_ready_0 & s0_out_isvec & io_vecstin_bits_uop_exceptionVec_19;
      ...
      s1_in_uop_vpu_vstart <=
        io_misalign_stin_valid
          ...
          : _GEN ? 8'h0 : io_vecstin_bits_uop_vpu_vstart;
      s1_in_uop_vpu_veew <=
        io_misalign_stin_valid
          ? io_misalign_stin_bits_uop_vpu_veew
          : _GEN ? 2'h0 : io_vecstin_bits_uop_vpu_veew;
      s1_in_uop_uopIdx <= s0_uop_uopIdx;
      s1_in_uop_robIdx_flag <= s0_uop_robIdx_flag;
      s1_in_uop_robIdx_value <= s0_uop_robIdx_value;
      s1_in_uop_sqIdx_flag <= s0_uop_sqIdx_flag;
    ...
    if (_s2_fire_T_1) begin
      ...
      s3_in_uop_exceptionVec_19 <= s2_in_uop_exceptionVec_19;
      ...
      s3_vecFeedback <=
        s2_vecFeedback_REG & ~(~s2_exception & s2_misalignNeedReplay) & s2_in_isvec
        & ~s2_in_isFrmMisAlignBuf;
    ...
    if (_prev_fire_T_4) begin
      ...
      sx_in_1_r_output_uop_exceptionVec_19 <= s3_in_uop_exceptionVec_19;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:361];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [8:0] i = 9'h0; i < 9'h16A; i += 9'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        s1_in_uop_sqIdx_flag = _RANDOM[9'h2A][0];
        s1_in_uop_sqIdx_value = _RANDOM[9'h2A][6:1];
        s1_in_vaddr = {_RANDOM[9'h2A][31:14], _RANDOM[9'h2B]};
        s1_in_mask = {_RANDOM[9'h31][31:17], _RANDOM[9'h32][0]};
        s1_in_wlineflag = _RANDOM[9'h36][2];
        s1_in_isvec = _RANDOM[9'h3B][2];
        s1_in_is128bit = _RANDOM[9'h3B][4];
        s1_in_elemIdx = _RANDOM[9'h3B][14:7];
        s1_in_alignedType = _RANDOM[9'h3B][17:15];
        s1_in_mbIndex = _RANDOM[9'h3B][21:18];
        s1_in_vecBaseVaddr = {_RANDOM[9'h3C][31:3], _RANDOM[9'h3D][20:0]};
        s1_in_vecActive = _RANDOM[9'h3F][23];
        s1_in_isFrmMisAlignBuf = _RANDOM[9'h40][22];
        s1_in_isMisalign = _RANDOM[9'h40][23];
        s1_in_isFinalSplit = _RANDOM[9'h40][24];
        s1_in_misalignWith16Byte = _RANDOM[9'h40][25];
        s1_vecActive = _RANDOM[9'h40][28];
        s1_isCbo = _RANDOM[9'h40][29];
        s1_isvec = _RANDOM[9'h40][30];
        s1_misalignNeedReplay = _RANDOM[9'h40][31];
        s1_frm_mab_vec = _RANDOM[9'h41][0];
        s1_mis_align_last_REG = _RANDOM[9'h71][20];
        s1_toMisalignBufferValid_last_REG = _RANDOM[9'h71][21];
        s2_valid = _RANDOM[9'h71][22];
        s2_in_uop_exceptionVec_3 = _RANDOM[9'h74][22];
        s2_in_uop_exceptionVec_7 = _RANDOM[9'h74][26];
        s2_in_uop_exceptionVec_15 = _RANDOM[9'h75][2];
        s2_in_uop_exceptionVec_19 = _RANDOM[9'h75][6];
        s2_in_uop_exceptionVec_23 = _RANDOM[9'h75][10];
        s2_in_uop_trigger = _RANDOM[9'h75][16:13];
        s2_in_uop_fuOpType = _RANDOM[9'h78][9:1];
        s2_in_uop_vpu_veew = _RANDOM[9'h7F][27:26];
        s2_in_uop_robIdx_flag = _RANDOM[9'h84][3];
        s2_in_uop_robIdx_value = _RANDOM[9'h84][11:4];
        s2_in_uop_sqIdx_flag = _RANDOM[9'h99][22];
        s2_in_uop_sqIdx_value = _RANDOM[9'h99][28:23];
        s2_in_fullva = {_RANDOM[9'h9B][31:22], _RANDOM[9'h9C], _RANDOM[9'h9D][21:0]};
        s2_in_vaNeedExt = _RANDOM[9'h9D][22];
        s2_in_paddr = {_RANDOM[9'h9D][31:23], _RANDOM[9'h9E], _RANDOM[9'h9F][6:0]};
        s2_in_gpaddr = {_RANDOM[9'h9F][31:7], _RANDOM[9'hA0], _RANDOM[9'hA1][6:0]};
        s2_in_mask = _RANDOM[9'hA1][22:7];
        s2_in_nc = _RANDOM[9'hA5][29];
        s2_in_mmio = _RANDOM[9'hA5][30];
        s2_in_isHyper = _RANDOM[9'hA6][1];
        s2_in_isForVSnonLeafPTE = _RANDOM[9'hA6][2];
        s2_in_isvec = _RANDOM[9'hAA][24];
        s2_in_elemIdx = {_RANDOM[9'hAA][31:29], _RANDOM[9'hAB][4:0]};
        s2_in_mbIndex = _RANDOM[9'hAB][11:8];
        s2_in_vecVaddrOffset = {_RANDOM[9'hAD][31:11], _RANDOM[9'hAE][28:0]};
        s2_in_vecActive = _RANDOM[9'hAF][13];
        s2_in_isFrmMisAlignBuf = _RANDOM[9'hB0][12];
        s2_in_isMisalign = _RANDOM[9'hB0][13];
        s2_in_isFinalSplit = _RANDOM[9'hB0][14];
        s2_vecActive = _RANDOM[9'hB0][18];
        s2_frm_mab_vec = _RANDOM[9'hB0][19];
        s2_pbmt = _RANDOM[9'hB0][21:20];
        s2_trigger_debug_mode = _RANDOM[9'hB0][22];
        s2_tlb_hit = _RANDOM[9'hB0][23];
        s2_exception_REG = _RANDOM[9'hB0][24];
        s2_un_misalign_exception_REG = _RANDOM[9'hB0][25];
        s2_mmio_REG = _RANDOM[9'hB0][26];
        s2_actually_uncache_REG = _RANDOM[9'hB0][27];
        s2_isCbo = _RANDOM[9'hB0][28];
        s2_out_uop_exceptionVec_7_REG = _RANDOM[9'hB0][29];
        s2_mis_align_r = _RANDOM[9'hB0][30];
        s2_misalignNeedReplay = _RANDOM[9'hB0][31];
        io_feedback_slow_valid_last_REG = _RANDOM[9'hB1][0];
        io_feedback_slow_bits_r_sqIdx_flag = _RANDOM[9'hB1][23];
        io_feedback_slow_bits_r_sqIdx_value = _RANDOM[9'hB1][29:24];
        io_feedback_slow_bits_hit_r = _RANDOM[9'hB2][6];
        s2_vecFeedback_REG = _RANDOM[9'hB2][7];
        s2_misalign_stout_bits_need_rep_r = _RANDOM[9'hB2][8];
        s3_valid = _RANDOM[9'hF1][5];
        s3_in_uop_exceptionVec_3 = _RANDOM[9'hF4][5];
        s3_in_uop_exceptionVec_6 = _RANDOM[9'hF4][8];
        s3_in_uop_exceptionVec_7 = _RANDOM[9'hF4][9];
        s3_in_uop_exceptionVec_15 = _RANDOM[9'hF4][17];
        s3_in_uop_exceptionVec_19 = _RANDOM[9'hF4][21];
        s3_in_uop_exceptionVec_23 = _RANDOM[9'hF4][25];
        s3_in_uop_trigger = _RANDOM[9'hF4][31:28];
        s3_in_uop_vpu_vstart = _RANDOM[9'hFA][9:2];
        s3_in_uop_robIdx_flag = _RANDOM[9'h103][18];
        s3_in_uop_robIdx_value = _RANDOM[9'h103][26:19];
        s3_in_fullva = {_RANDOM[9'h11B][31:5], _RANDOM[9'h11C], _RANDOM[9'h11D][4:0]};
        s3_in_vaNeedExt = _RANDOM[9'h11D][5];
        s3_in_gpaddr = {_RANDOM[9'h11E][31:22], _RANDOM[9'h11F], _RANDOM[9'h120][21:0]};
        s3_in_mask = {_RANDOM[9'h120][31:22], _RANDOM[9'h121][5:0]};
        s3_in_nc = _RANDOM[9'h125][12];
        s3_in_mmio = _RANDOM[9'h125][13];
        s3_in_memBackTypeMM = _RANDOM[9'h125][14];
        s3_in_isForVSnonLeafPTE = _RANDOM[9'h125][17];
        s3_in_isvec = _RANDOM[9'h12A][7];
        s3_in_elemIdx = _RANDOM[9'h12A][19:12];
        s3_in_mbIndex = _RANDOM[9'h12A][26:23];
        s3_vecFeedback = _RANDOM[9'h130][1];
        s3_exception = _RANDOM[9'h130][2];
        sx_valid_1_r = _RANDOM[9'h130][3];
        sx_in_1_r_output_uop_exceptionVec_3 = _RANDOM[9'h133][3];
        sx_in_1_r_output_uop_exceptionVec_6 = _RANDOM[9'h133][6];
        sx_in_1_r_output_uop_exceptionVec_7 = _RANDOM[9'h133][7];
        sx_in_1_r_output_uop_exceptionVec_15 = _RANDOM[9'h133][15];
        sx_in_1_r_output_uop_exceptionVec_19 = _RANDOM[9'h133][19];
        sx_in_1_r_output_uop_exceptionVec_23 = _RANDOM[9'h133][23];
        sx_in_1_r_output_uop_trigger = _RANDOM[9'h133][29:26];
        sx_in_1_r_output_uop_vpu_vstart = _RANDOM[9'h139][7:0];
        sx_in_1_r_output_uop_robIdx_flag = _RANDOM[9'h142][16];
        sx_in_1_r_output_uop_robIdx_value = _RANDOM[9'h142][24:17];
        sx_in_1_r_output_debug_isMMIO = _RANDOM[9'h160][24];
        sx_in_1_r_output_debug_isNCIO = _RANDOM[9'h160][25];
        sx_in_1_r_vecFeedback = _RANDOM[9'h164][9];
        sx_in_1_r_hasException = _RANDOM[9'h164][13];
        sx_in_1_r_elemIdx = _RANDOM[9'h164][21:14];
        sx_in_1_r_mbIndex = _RANDOM[9'h164][28:25];
        sx_in_1_r_mask = {_RANDOM[9'h164][31:29], _RANDOM[9'h165][12:0]};
        sx_in_1_r_vaddr =
          {_RANDOM[9'h165][31:13], _RANDOM[9'h166], _RANDOM[9'h167][12:0]};
        sx_in_1_r_vaNeedExt = _RANDOM[9'h167][13];
        sx_in_1_r_gpaddr = {_RANDOM[9'h167][31:14], _RANDOM[9'h168]};
        sx_in_1_r_isForVSnonLeafPTE = _RANDOM[9'h169][0];
        sx_in_vec_1_r = _RANDOM[9'h169][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_vecActive = 1'h1;
  ...
  assign io_misalign_stout_bits_uop_exceptionVec_19 = s2_in_uop_exceptionVec_19;
  ...
  assign io_misalign_stout_bits_uop_robIdx_flag = s2_in_uop_robIdx_flag;
  assign io_misalign_stout_bits_uop_robIdx_value = s2_in_uop_robIdx_value;
  ...
  assign io_lsq_replenish_uop_exceptionVec_19 = s2_in_uop_exceptionVec_19;
  ...
  assign io_lsq_replenish_uop_sqIdx_flag = s2_in_uop_sqIdx_flag;
  assign io_lsq_replenish_uop_sqIdx_value = s2_in_uop_sqIdx_value;
  ...
  assign io_lsq_replenish_updateAddrValid =
    ~s2_mis_align & (~s2_in_isFrmMisAlignBuf | s2_in_isFinalSplit) | ~s2_in_isvec
    & s2_exception & ~s2_misalignNeedReplay | s2_in_isvec & s2_exception;
  assign io_feedback_slow_valid = io_feedback_slow_valid_last_REG;
  assign io_feedback_slow_bits_hit = io_feedback_slow_bits_hit_r & ~s2_misalignNeedReplay;
  ...
  assign io_stld_nuke_query_bits_matchType = s1_isCbo ? 2'h2 : {1'h0, s1_in_is128bit};
  ...
  assign io_stout_bits_uop_exceptionVec_19 = sx_in_1_r_output_uop_exceptionVec_19;
  ...
  assign io_vecstout_bits_exceptionVec_19 = sx_in_1_r_output_uop_exceptionVec_19;
  ...
  assign io_misalign_enq_req_valid = s1_toMisalignBufferValid & ~s1_misalignNeedReplay;
  ...
  assign io_s0_s1_s2_valid = s0_valid | s1_valid | s2_valid;
endmodule
