...
module LoadPipe(
  ...
  wire [1:0]       _s1_hit_error_T_16 =
    {_s1_tag_match_way_dup_dc_T_3 & io_extra_meta_resp_0_error_tl_denied,
     _s1_tag_match_way_dup_dc_T_3 & io_extra_meta_resp_0_error_tl_corrupt}
    | {_s1_tag_match_way_dup_dc_T_7 & io_extra_meta_resp_1_error_tl_denied,
       _s1_tag_match_way_dup_dc_T_7 & io_extra_meta_resp_1_error_tl_corrupt}
    | {_s1_tag_match_way_dup_dc_T_11 & io_extra_meta_resp_2_error_tl_denied,
       _s1_tag_match_way_dup_dc_T_11 & io_extra_meta_resp_2_error_tl_corrupt}
    | {_s1_tag_match_way_dup_dc_T_15 & io_extra_meta_resp_3_error_tl_denied,
       _s1_tag_match_way_dup_dc_T_15 & io_extra_meta_resp_3_error_tl_corrupt};
  ...
  wire             s1_will_send_miss_req =
    s1_valid
    & ~(s1_tag_match_dup_dc & s1_has_permission & _s1_hit_meta_T_8 == _GEN_0[_r_T]);
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid) begin
      ...
      s2_tl_error_tl_denied <= s1_tag_match_dup_dc & _s1_hit_error_T_16[1];
      s2_tl_error_tl_corrupt <= s1_tag_match_dup_dc & _s1_hit_error_T_16[0];
      s2_hit_prefetch <=
    ...
    io_perf_5_value_REG <= s2_valid & ~s2_is_prefetch;
    io_perf_5_value_REG_1 <= io_perf_5_value_REG;
    io_perf_6_value_REG <= s2_valid & ~s2_is_prefetch & real_miss;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_load128Req = _RANDOM[6'h8][28];
        s1_bank_oh = {_RANDOM[6'h8][31:29], _RANDOM[6'h9][5:0]};
        s2_valid = _RANDOM[6'h9][13];
        s2_valid_dup = _RANDOM[6'h9][14];
        s2_req_cmd = _RANDOM[6'h9][19:15];
        s2_req_instrtype = _RANDOM[6'h11][17:14];
        s2_load128Req = _RANDOM[6'h12][8];
        s2_paddr = {_RANDOM[6'h12][31:9], _RANDOM[6'h13][24:0]};
        s2_vaddr = {_RANDOM[6'h13][31:25], _RANDOM[6'h14], _RANDOM[6'h15][10:0]};
        s2_real_way_en = {_RANDOM[6'h15][31:30], _RANDOM[6'h16][1:0]};
        s2_tag_errors = _RANDOM[6'h16][12:9];
        s2_tag_match_way = _RANDOM[6'h16][16:13];
        s2_tag_match = _RANDOM[6'h16][17];
        s2_hit_coh_state = _RANDOM[6'h16][22:21];
        s2_has_permission = _RANDOM[6'h16][23];
        s2_new_hit_coh_state = _RANDOM[6'h16][25:24];
        s2_grow_perm_btot = _RANDOM[6'h16][26];
        s2_can_send_miss_req = _RANDOM[6'h16][27];
        s2_can_send_miss_req_dup = _RANDOM[6'h16][28];
        s2_nack_data = _RANDOM[6'h16][30];
        s2_tl_error_tl_denied = _RANDOM[6'h16][31];
        s2_tl_error_tl_corrupt = _RANDOM[6'h17][0];
        s2_hit_prefetch = _RANDOM[6'h17][3:1];
        io_miss_req_bits_pf_source_REG = _RANDOM[6'h17][7:5];
        io_miss_req_bits_pf_source_REG_1 = _RANDOM[6'h17][10:8];
        s3_valid = _RANDOM[6'h17][13];
        s3_load128Req = _RANDOM[6'h17][14];
        s3_vaddr = {_RANDOM[6'h17][31:15], _RANDOM[6'h18], _RANDOM[6'h19][0]};
        s3_paddr = {_RANDOM[6'h19][31:1], _RANDOM[6'h1A][16:0]};
        s3_hit = _RANDOM[6'h1A][17];
        s3_tag_match_way = _RANDOM[6'h1A][21:18];
        s3_req_instrtype = _RANDOM[6'h1A][25:22];
        s3_banked_data_resp_word =
          {_RANDOM[6'h1A][31:26],
           ...
           _RANDOM[6'h1D],
           _RANDOM[6'h1E][25:0]};
        s3_tag_error = _RANDOM[6'h1E][26];
        s3_tl_error_tl_denied = _RANDOM[6'h1E][27];
        s3_tl_error_tl_corrupt = _RANDOM[6'h1E][28];
        s3_hit_prefetch = _RANDOM[6'h1E][31:29];
        io_replace_access_bits_set_REG = _RANDOM[6'h1F][7:0];
        io_replace_access_bits_set_REG_1 = _RANDOM[6'h1F][15:8];
        io_replace_access_bits_way_REG = _RANDOM[6'h1F][17:16];
        io_replace_access_bits_way_REG_1 = _RANDOM[6'h1F][19:18];
        io_perf_0_value_REG = _RANDOM[6'h1F][20];
        io_perf_0_value_REG_1 = _RANDOM[6'h1F][21];
        io_perf_1_value_REG = _RANDOM[6'h1F][22];
        io_perf_1_value_REG_1 = _RANDOM[6'h1F][23];
        io_perf_2_value_REG = _RANDOM[6'h1F][24];
        io_perf_2_value_REG_1 = _RANDOM[6'h1F][25];
        io_perf_3_value_REG = _RANDOM[6'h1F][26];
        io_perf_3_value_REG_1 = _RANDOM[6'h1F][27];
        io_perf_4_value_REG = _RANDOM[6'h1F][28];
        io_perf_4_value_REG_1 = _RANDOM[6'h1F][29];
        io_perf_5_value_REG = _RANDOM[6'h1F][30];
        io_perf_5_value_REG_1 = _RANDOM[6'h1F][31];
        io_perf_6_value_REG = _RANDOM[6'h20][0];
        io_perf_6_value_REG_1 = _RANDOM[6'h20][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s2_valid = 1'h0;
  ...
  assign io_prefetch_info_naive_total_prefetch = s2_valid & s2_is_prefetch;
  assign io_prefetch_info_naive_late_hit_prefetch = _late_prefetch_hit_T & s2_is_prefetch;
