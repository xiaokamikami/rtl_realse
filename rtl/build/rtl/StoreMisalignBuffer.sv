...
module StoreMisalignBuffer(
  ...
  input         io_splitStoreResp_bits_uop_robIdx_flag,
  input  [7:0]  io_splitStoreResp_bits_uop_robIdx_value,
  ...
  output        io_toVecSplit_empty,
  output        io_toVecSplit_robIdx_flag,
  output [7:0]  io_toVecSplit_robIdx_value,
  output [6:0]  io_toVecSplit_uopIdx
);
  ...
  wire             canEnq =
    _GEN & _GEN_1 | ~req_valid & ~reqRedirect & reqSel_oldest_valid;
  wire             _io_enq_1_req_ready_T_2 = cross4KBPageBoundary & _GEN & _GEN_1;
  ...
  wire             _io_writeBack_bits_uop_exceptionVec_19_T =
  ...
  wire             _GEN_22 = canEnq | req_valid;
  wire             _GEN_23 = cross4KBPageBoundary & ~s2_needRevoke;
  wire             _GEN_24 = req_valid & ~s2_needRevoke;
  wire             _GEN_25 = bufferState == 3'h2;
  wire             _GEN_26 = bufferState == 3'h3;
  wire             _GEN_27 = io_splitStoreResp_valid & _GEN_4;
  wire             _GEN_28 = bufferState == 3'h4;
  wire             _GEN_29 = io_vecWriteBack_0_valid_0 | io_vecWriteBack_1_valid_0;
  wire             _GEN_30 = io_writeBack_ready & io_writeBack_valid_0;
  wire             _GEN_31 = _GEN_30 & (~isCrossPage | globalUncache | globalException);
  wire             _GEN_32 =
    bufferState == 3'h5 & io_sqControl_toStoreMisalignBuffer_doDeq;
  wire             _GEN_33 = _GEN_0 | _GEN_2 | _GEN_25 | _GEN_26;
  wire             _GEN_34 = _GEN_0 | _GEN_2 | _GEN_25;
  wire             _GEN_35 = ~_GEN_32 & isCrossPage;
  wire             _GEN_36 = _GEN_2 & cross16BytesBoundary;
  ...
  wire [3:0]       lowAddrStore_uop_trigger = _GEN_36 ? req_uop_trigger : 4'h0;
  wire [7:0]       lowAddrStore_uop_vpu_vstart = _GEN_36 ? req_uop_vpu_vstart : 8'h0;
  wire [1:0]       lowAddrStore_uop_vpu_veew = _GEN_36 ? req_uop_vpu_veew : 2'h0;
  wire [6:0]       lowAddrStore_uop_uopIdx = _GEN_36 ? req_uop_uopIdx : 7'h0;
  wire             lowAddrStore_uop_robIdx_flag =
    _GEN_2 & cross16BytesBoundary & req_uop_robIdx_flag;
  wire [7:0]       lowAddrStore_uop_robIdx_value = _GEN_36 ? req_uop_robIdx_value : 8'h0;
  wire             lowAddrStore_uop_sqIdx_flag =
    _GEN_2 & cross16BytesBoundary & req_uop_sqIdx_flag;
  wire [5:0]       lowAddrStore_uop_sqIdx_value = _GEN_36 ? req_uop_sqIdx_value : 6'h0;
  wire [8:0]       _GEN_38 =
    req_vaddr[2:0] == 3'h5 | req_vaddr[2:0] == 3'h6 | (&(req_vaddr[2:0]))
      ? 9'h3
      : req_uop_fuOpType;
  wire             _GEN_39 =
    io_splitStoreResp_valid & _GEN_26
    & _flush_flushItself_T_1 == {io_splitStoreResp_bits_uop_robIdx_flag,
  ...
  wire [2:0]       _GEN_42 = _GEN_32 ? 3'h0 : bufferState;
  wire             _GEN_43 =
    _GEN_33 | ~(_GEN_28 ? (req_isvec ? _GEN_29 : _GEN_31) : _GEN_32);
  wire [7:0][2:0]  _GEN_44 =
    {{_GEN_42},
     {_GEN_42},
     {_GEN_42},
     {req_isvec
        ? (_GEN_29 ? 3'h0 : bufferState)
        : _GEN_31 ? 3'h0 : {2'h2, _GEN_30 & isCrossPage}},
     {REG
        ? 3'h4
     ...
     {3'h2},
     {(_GEN_23 ? robMatch : _GEN_24) ? 3'h1 : bufferState}};
  wire [7:0][8:0]  _GEN_45 =
    {{_GEN_38}, {_GEN_38}, {_GEN_38}, {9'h2}, {9'h3}, {9'h3}, {9'h3}, {req_uop_fuOpType}};
  wire [3:0][8:0]  _GEN_46 =
    {{_GEN_45[req_vaddr[2:0]]}, {_GEN_14[req_vaddr[1:0]]}, {9'h0}, {req_uop_fuOpType}};
  wire [7:0][8:0]  _GEN_47 =
    {{_GEN_38}, {_GEN_38}, {_GEN_38}, {9'h2}, {9'h2}, {9'h1}, {9'h0}, {req_uop_fuOpType}};
  wire [3:0][8:0]  _GEN_48 =
    {{_GEN_47[req_vaddr[2:0]]}, {_GEN_18[req_vaddr[1:0]]}, {9'h0}, {req_uop_fuOpType}};
  wire [7:0]       _GEN_49 =
    {{_GEN_35},
     {_GEN_35},
     {_GEN_35},
     {req_isvec ? ~_GEN_29 & isCrossPage : ~_GEN_31 & isCrossPage},
     {isCrossPage},
     {isCrossPage},
     {isCrossPage},
     {_GEN_23 ? robMatch | isCrossPage : ~_GEN_24 & isCrossPage}};
    ...
    if (reset) begin
      ...
      req_valid <=
        ...
        & (_GEN_33
             ? _GEN_22
             : _GEN_28
                 ? (req_isvec ? ~_GEN_29 & _GEN_22 : ~_GEN_31 & _GEN_22)
                 : ~_GEN_32 & _GEN_22);
      if (_GEN_41) begin
        bufferState <= 3'h0;
        unSentStores <= 2'h0;
      ...
      if (_GEN_36) begin
        ...
        splitStoreReqs_0_uop_fuOpType <= _GEN_36 ? _GEN_46[alignedType] : 9'h0;
        ...
        splitStoreReqs_0_mask <= _GEN_11 ? 16'h0 : _GEN_17[alignedType];
      end
      splitStoreReqs_0_is128bit <= _GEN_37 & splitStoreReqs_0_is128bit;
      if (_GEN_36) begin
        ...
        splitStoreReqs_1_uop_fuOpType <= _GEN_36 ? _GEN_48[alignedType] : 9'h0;
        ...
        splitStoreReqs_1_mask <= _GEN_11 ? 16'h0 : _GEN_21[alignedType];
      end
      splitStoreReqs_1_is128bit <= _GEN_37 & splitStoreReqs_1_is128bit;
      if (_GEN_39 & curPtr)
      ...
      if (_GEN_39) begin
        ...
        exceptionVec_19 <=
          ~isUncache
          & (hasException
               ? exceptionVec_19 | io_splitStoreResp_bits_uop_exceptionVec_19
               : io_splitStoreResp_bits_need_rep & exceptionVec_19);
        exceptionVec_23 <=
          ~isUncache
          & (hasException
      ...
      curPtr <=
        ~_GEN_41
        & (~_GEN_39 | _GEN_40 | io_splitStoreResp_bits_need_rep
             ? _GEN_37
               & (_GEN_33
                    ? curPtr
                    : _GEN_28
                        ? (req_isvec ? ~_GEN_29 & curPtr : ~_GEN_31 & curPtr)
                        : ~_GEN_32 & curPtr)
             : 1'(curPtr - 1'h1));
      globalException <=
        ~_GEN_41
        & (_GEN_34
             ? globalException
             : _GEN_26
                 ? (_GEN_27 ? hasException : globalException)
                 : _GEN_28
                     ? (req_isvec
                          ? ~_GEN_29 & globalException
                          : ~_GEN_31 & globalException)
      ...
      globalUncache <=
        ...
        & (_GEN_34
             ? globalUncache
             : _GEN_26
                 ? (_GEN_27 ? isUncache : globalUncache)
                 : _GEN_28
                     ? (req_isvec ? ~_GEN_29 & globalUncache : ~_GEN_31 & globalUncache)
                     : ~_GEN_32 & globalUncache);
      globalMMIO <=
        ~_GEN_41
        & (_GEN_34
             ? globalMMIO
             : _GEN_26
                 ? (_GEN_27 ? io_splitStoreResp_bits_mmio : globalMMIO)
                 : _GEN_28
                     ? (req_isvec ? ~_GEN_29 & globalMMIO : ~_GEN_31 & globalMMIO)
                     : ~_GEN_32 & globalMMIO);
      globalNC <=
        ~_GEN_41
        & (_GEN_34
             ? globalNC
             : _GEN_26
                 ? (_GEN_27 ? io_splitStoreResp_bits_nc : globalNC)
                 : _GEN_28
                     ? (req_isvec ? ~_GEN_29 & globalNC : ~_GEN_31 & globalNC)
                     : ~_GEN_32 & globalNC);
      globalMemBackTypeMM <=
        ~_GEN_41
        & (_GEN_34
             ? globalMemBackTypeMM
             : _GEN_26
                 ? (_GEN_27 ? io_splitStoreResp_bits_memBackTypeMM : globalMemBackTypeMM)
                 : _GEN_28
                     ? (req_isvec
                          ? ~_GEN_29 & globalMemBackTypeMM
                          : ~_GEN_31 & globalMemBackTypeMM)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_vaddr = {_RANDOM[9'h28][31:14], _RANDOM[9'h29]};
        req_vaNeedExt = _RANDOM[9'h2C][0];
        req_gpaddr = {_RANDOM[9'h2D][31:17], _RANDOM[9'h2E], _RANDOM[9'h2F][16:0]};
        req_mask = {_RANDOM[9'h2F][31:17], _RANDOM[9'h30][0]};
        req_isForVSnonLeafPTE = _RANDOM[9'h34][12];
        req_isvec = _RANDOM[9'h39][2];
        req_elemIdx = _RANDOM[9'h39][14:7];
        req_alignedType = _RANDOM[9'h39][17:15];
        req_mbIndex = _RANDOM[9'h39][21:18];
        req_portIndex = _RANDOM[9'h3E][28];
        bufferState = {_RANDOM[9'h3E][31:30], _RANDOM[9'h3F][0]};
        s2_canEnq_next_r = _RANDOM[9'h3F][1];
        s2_reqSelPort_next_r = _RANDOM[9'h3F][2];
        splitStoreReqs_0_uop_exceptionVec_0 = _RANDOM[9'h41][31];
        splitStoreReqs_0_uop_exceptionVec_1 = _RANDOM[9'h42][0];
        splitStoreReqs_0_uop_exceptionVec_2 = _RANDOM[9'h42][1];
        splitStoreReqs_0_uop_exceptionVec_4 = _RANDOM[9'h42][3];
        splitStoreReqs_0_uop_exceptionVec_5 = _RANDOM[9'h42][4];
        splitStoreReqs_0_uop_exceptionVec_8 = _RANDOM[9'h42][7];
        splitStoreReqs_0_uop_exceptionVec_9 = _RANDOM[9'h42][8];
        splitStoreReqs_0_uop_exceptionVec_10 = _RANDOM[9'h42][9];
        splitStoreReqs_0_uop_exceptionVec_11 = _RANDOM[9'h42][10];
        splitStoreReqs_0_uop_exceptionVec_12 = _RANDOM[9'h42][11];
        splitStoreReqs_0_uop_exceptionVec_13 = _RANDOM[9'h42][12];
        splitStoreReqs_0_uop_exceptionVec_14 = _RANDOM[9'h42][13];
        splitStoreReqs_0_uop_exceptionVec_16 = _RANDOM[9'h42][15];
        splitStoreReqs_0_uop_exceptionVec_17 = _RANDOM[9'h42][16];
        splitStoreReqs_0_uop_exceptionVec_18 = _RANDOM[9'h42][17];
        splitStoreReqs_0_uop_exceptionVec_19 = _RANDOM[9'h42][18];
        splitStoreReqs_0_uop_exceptionVec_20 = _RANDOM[9'h42][19];
        splitStoreReqs_0_uop_exceptionVec_21 = _RANDOM[9'h42][20];
        splitStoreReqs_0_uop_exceptionVec_22 = _RANDOM[9'h42][21];
        splitStoreReqs_0_uop_trigger = _RANDOM[9'h42][28:25];
        splitStoreReqs_0_uop_fuOpType = _RANDOM[9'h45][21:13];
        splitStoreReqs_0_uop_vpu_vstart = {_RANDOM[9'h47][31], _RANDOM[9'h48][6:0]};
        splitStoreReqs_0_uop_vpu_veew = _RANDOM[9'h4D][7:6];
        splitStoreReqs_0_uop_uopIdx = _RANDOM[9'h4D][27:21];
        splitStoreReqs_0_uop_robIdx_flag = _RANDOM[9'h51][15];
        splitStoreReqs_0_uop_robIdx_value = _RANDOM[9'h51][23:16];
        splitStoreReqs_0_uop_sqIdx_flag = _RANDOM[9'h67][2];
        splitStoreReqs_0_uop_sqIdx_value = _RANDOM[9'h67][8:3];
        splitStoreReqs_0_vaddr =
          {_RANDOM[9'h67][31:16], _RANDOM[9'h68], _RANDOM[9'h69][1:0]};
        splitStoreReqs_0_mask = {_RANDOM[9'h6E][31:19], _RANDOM[9'h6F][2:0]};
        splitStoreReqs_0_is128bit = _RANDOM[9'h78][6];
        splitStoreReqs_1_uop_exceptionVec_0 = _RANDOM[9'h80][26];
        splitStoreReqs_1_uop_exceptionVec_1 = _RANDOM[9'h80][27];
        splitStoreReqs_1_uop_exceptionVec_2 = _RANDOM[9'h80][28];
        splitStoreReqs_1_uop_exceptionVec_4 = _RANDOM[9'h80][30];
        splitStoreReqs_1_uop_exceptionVec_5 = _RANDOM[9'h80][31];
        splitStoreReqs_1_uop_exceptionVec_8 = _RANDOM[9'h81][2];
        splitStoreReqs_1_uop_exceptionVec_9 = _RANDOM[9'h81][3];
        splitStoreReqs_1_uop_exceptionVec_10 = _RANDOM[9'h81][4];
        splitStoreReqs_1_uop_exceptionVec_11 = _RANDOM[9'h81][5];
        splitStoreReqs_1_uop_exceptionVec_12 = _RANDOM[9'h81][6];
        splitStoreReqs_1_uop_exceptionVec_13 = _RANDOM[9'h81][7];
        splitStoreReqs_1_uop_exceptionVec_14 = _RANDOM[9'h81][8];
        splitStoreReqs_1_uop_exceptionVec_16 = _RANDOM[9'h81][10];
        splitStoreReqs_1_uop_exceptionVec_17 = _RANDOM[9'h81][11];
        splitStoreReqs_1_uop_exceptionVec_18 = _RANDOM[9'h81][12];
        splitStoreReqs_1_uop_exceptionVec_19 = _RANDOM[9'h81][13];
        splitStoreReqs_1_uop_exceptionVec_20 = _RANDOM[9'h81][14];
        splitStoreReqs_1_uop_exceptionVec_21 = _RANDOM[9'h81][15];
        splitStoreReqs_1_uop_exceptionVec_22 = _RANDOM[9'h81][16];
        splitStoreReqs_1_uop_trigger = _RANDOM[9'h81][23:20];
        splitStoreReqs_1_uop_fuOpType = _RANDOM[9'h84][16:8];
        splitStoreReqs_1_uop_vpu_vstart = {_RANDOM[9'h86][31:26], _RANDOM[9'h87][1:0]};
        splitStoreReqs_1_uop_vpu_veew = _RANDOM[9'h8C][2:1];
        splitStoreReqs_1_uop_uopIdx = _RANDOM[9'h8C][22:16];
        splitStoreReqs_1_uop_robIdx_flag = _RANDOM[9'h90][10];
        splitStoreReqs_1_uop_robIdx_value = _RANDOM[9'h90][18:11];
        splitStoreReqs_1_uop_sqIdx_flag = _RANDOM[9'hA5][29];
        splitStoreReqs_1_uop_sqIdx_value = {_RANDOM[9'hA5][31:30], _RANDOM[9'hA6][3:0]};
        splitStoreReqs_1_vaddr = {_RANDOM[9'hA6][31:11], _RANDOM[9'hA7][28:0]};
        splitStoreReqs_1_mask = _RANDOM[9'hAD][29:14];
        splitStoreReqs_1_is128bit = _RANDOM[9'hB7][1];
        splitStoreResp_1_paddr =
          {_RANDOM[9'h127][31:21], _RANDOM[9'h128], _RANDOM[9'h129][4:0]};
        isCrossPage = _RANDOM[9'h13A][17];
        exceptionVec_3 = _RANDOM[9'h13A][21];
        exceptionVec_6 = _RANDOM[9'h13A][24];
        exceptionVec_7 = _RANDOM[9'h13A][25];
        exceptionVec_15 = _RANDOM[9'h13B][1];
        exceptionVec_19 = _RANDOM[9'h13B][5];
        exceptionVec_23 = _RANDOM[9'h13B][9];
        unSentStores = _RANDOM[9'h13B][11:10];
        curPtr = _RANDOM[9'h13B][14];
        globalException = _RANDOM[9'h13B][15];
        globalUncache = _RANDOM[9'h13B][16];
        globalMMIO = _RANDOM[9'h13B][17];
        globalNC = _RANDOM[9'h13B][18];
        globalMemBackTypeMM = _RANDOM[9'h13B][19];
        REG = _RANDOM[9'h13B][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        bufferState = 3'h0;
  ...
  assign io_writeBack_bits_uop_exceptionVec_3 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_3;
  assign io_writeBack_bits_uop_exceptionVec_6 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_6;
  assign io_writeBack_bits_uop_exceptionVec_7 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_7;
  assign io_writeBack_bits_uop_exceptionVec_15 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_15;
  assign io_writeBack_bits_uop_exceptionVec_19 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_19;
  assign io_writeBack_bits_uop_exceptionVec_23 =
    _io_writeBack_bits_uop_exceptionVec_19_T & exceptionVec_23;
  ...
  assign io_vecWriteBack_0_bits_exceptionVec_19 = exceptionVec_19;
  ...
  assign io_vecWriteBack_1_bits_exceptionVec_19 = exceptionVec_19;
  ...
  assign io_toVecSplit_empty = ~req_valid;
  assign io_toVecSplit_robIdx_flag = req_uop_robIdx_flag;
  assign io_toVecSplit_robIdx_value = req_uop_robIdx_value;
  assign io_toVecSplit_uopIdx = req_uop_uopIdx;
endmodule
