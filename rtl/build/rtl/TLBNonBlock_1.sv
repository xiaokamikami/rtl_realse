...
module TLBNonBlock_1(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      resp_gpa_refill <=
        ~_GEN_14 & (_readResult_T_68 | ~_GEN_9 & (_readResult_T_32 | resp_gpa_refill));
      if (_GEN_14) begin
        if (_GEN_10) begin
        end
        else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        need_clear_need_gpa = _RANDOM[7'h10][7];
        need_gpa_robidx_flag = _RANDOM[7'h10][8];
        need_gpa_robidx_value = _RANDOM[7'h10][16:9];
        need_gpa_vpn = {_RANDOM[7'h10][31:17], _RANDOM[7'h11][22:0]};
        resp_gpa_gvpn = {_RANDOM[7'h11][31:23], _RANDOM[7'h12], _RANDOM[7'h13][2:0]};
        resp_gpa_refill = _RANDOM[7'h13][3];
        resp_s1_level = _RANDOM[7'h13][5:4];
        resp_s1_isLeaf = _RANDOM[7'h13][6];
        resp_s1_isFakePte = _RANDOM[7'h13][7];
        io_requestor_0_resp_bits_fullva_r =
          {_RANDOM[7'h13][31:10], _RANDOM[7'h14], _RANDOM[7'h15][9:0]};
        io_requestor_1_resp_bits_fullva_r =
          {_RANDOM[7'h15][31:10], _RANDOM[7'h16], _RANDOM[7'h17][9:0]};
        readResult_p_hit_last_REG = _RANDOM[7'h17][30];
        readResult_p_ppn = {_RANDOM[7'h17][31], _RANDOM[7'h18], _RANDOM[7'h19][2:0]};
        readResult_p_pbmt = _RANDOM[7'h19][4:3];
        readResult_p_perm_pf = _RANDOM[7'h19][5];
        readResult_p_perm_af = _RANDOM[7'h19][6];
        readResult_p_perm_v = _RANDOM[7'h19][7];
        readResult_p_perm_d = _RANDOM[7'h19][8];
        readResult_p_perm_a = _RANDOM[7'h19][9];
        readResult_p_perm_u = _RANDOM[7'h19][11];
        readResult_p_perm_x = _RANDOM[7'h19][12];
        readResult_p_perm_w = _RANDOM[7'h19][13];
        readResult_p_perm_r = _RANDOM[7'h19][14];
        readResult_p_gvpn = {_RANDOM[7'h19][31:15], _RANDOM[7'h1A][26:0]};
        readResult_p_g_pbmt = _RANDOM[7'h1A][28:27];
        readResult_p_g_perm_pf = _RANDOM[7'h1A][29];
        readResult_p_g_perm_af = _RANDOM[7'h1A][30];
        readResult_p_g_perm_d = _RANDOM[7'h1B][0];
        readResult_p_g_perm_a = _RANDOM[7'h1B][1];
        readResult_p_g_perm_x = _RANDOM[7'h1B][4];
        readResult_p_g_perm_w = _RANDOM[7'h1B][5];
        readResult_p_g_perm_r = _RANDOM[7'h1B][6];
        readResult_p_s2xlate = _RANDOM[7'h1B][8:7];
        readResult_p_s1_level = _RANDOM[7'h1B][10:9];
        readResult_p_s1_isLeaf = _RANDOM[7'h1B][11];
        readResult_p_s1_isFakePte = _RANDOM[7'h1B][12];
        readResult_lastCycleRedirect_REG_valid = _RANDOM[7'h1B][13];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h1B][15];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[7'h1B][23:16];
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h1C][3];
        readResult_p_hit_last_REG_1 = _RANDOM[7'h2D][12];
        readResult_p_ppn_1 = {_RANDOM[7'h2D][31:13], _RANDOM[7'h2E][16:0]};
        readResult_p_pbmt_1 = _RANDOM[7'h2E][18:17];
        readResult_p_perm_1_pf = _RANDOM[7'h2E][19];
        readResult_p_perm_1_af = _RANDOM[7'h2E][20];
        readResult_p_perm_1_v = _RANDOM[7'h2E][21];
        readResult_p_perm_1_d = _RANDOM[7'h2E][22];
        readResult_p_perm_1_a = _RANDOM[7'h2E][23];
        readResult_p_perm_1_u = _RANDOM[7'h2E][25];
        readResult_p_perm_1_x = _RANDOM[7'h2E][26];
        readResult_p_perm_1_w = _RANDOM[7'h2E][27];
        readResult_p_perm_1_r = _RANDOM[7'h2E][28];
        readResult_p_gvpn_1 =
          {_RANDOM[7'h2E][31:29], _RANDOM[7'h2F], _RANDOM[7'h30][8:0]};
        readResult_p_g_pbmt_1 = _RANDOM[7'h30][10:9];
        readResult_p_g_perm_1_pf = _RANDOM[7'h30][11];
        readResult_p_g_perm_1_af = _RANDOM[7'h30][12];
        readResult_p_g_perm_1_d = _RANDOM[7'h30][14];
        readResult_p_g_perm_1_a = _RANDOM[7'h30][15];
        readResult_p_g_perm_1_x = _RANDOM[7'h30][18];
        readResult_p_g_perm_1_w = _RANDOM[7'h30][19];
        readResult_p_g_perm_1_r = _RANDOM[7'h30][20];
        readResult_p_s2xlate_1 = _RANDOM[7'h30][22:21];
        readResult_p_s1_level_1 = _RANDOM[7'h30][24:23];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h30][25];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h30][26];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[7'h30][27];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[7'h30][29];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[7'h30][31:30], _RANDOM[7'h31][5:0]};
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[7'h31][17];
        REG = _RANDOM[7'h42][27];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h42][28];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h42][29];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h42][30];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h42][31];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h43][0];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[7'h43][1];
        REG_1 = _RANDOM[7'h43][3];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h43][4];
        io_requestor_1_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h43][5];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h43][6];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h43][7];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h43][8];
        io_requestor_1_resp_bits_excp_0_af_st_REG = _RANDOM[7'h43][9];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h43][11:10];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h43][31:12], _RANDOM[7'h44][14:0]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[7'h44][30:15];
        ptw_resp_bits_reg_s1_entry_vmid = {_RANDOM[7'h44][31], _RANDOM[7'h45][12:0]};
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h45][13];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h45][18];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h45][24:23];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h47][6:4];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h47][31];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h48][0];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h48][1];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h48][2];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h48][3];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h48][4];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h48][5];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h48][6];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h48][31:17], _RANDOM[7'h49][22:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h4A][20:7];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h4A][21];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h4C][6:5];
        ptw_already_back_last_REG = _RANDOM[7'h4C][21];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h4C][24:23];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h4C][31:25], _RANDOM[7'h4D][27:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[7'h4D][31:28], _RANDOM[7'h4E][11:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h4E][25:12];
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h4E][26];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h4E][31];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h4F][5:4];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h50][19:17];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h51][12];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h51][13];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h51][14];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h51][15];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h51][16];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h51][17];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h51][18];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h51][19];
        ptw_resp_bits_reg_1_s2_entry_tag =
          {_RANDOM[7'h51][31:30], _RANDOM[7'h52], _RANDOM[7'h53][3:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h53][31:20], _RANDOM[7'h54][1:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h54][2];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h55][19:18];
        ptw_already_back_last_REG_1 = _RANDOM[7'h56][2];
        result_ok_last_REG = _RANDOM[7'h56][4];
        result_ok_last_REG_1 = _RANDOM[7'h56][5];
        io_perf_0_value_REG = _RANDOM[7'h56][7:6];
        io_perf_0_value_REG_1 = _RANDOM[7'h56][9:8];
        io_perf_1_value_REG = _RANDOM[7'h56][11:10];
        io_perf_1_value_REG_1 = _RANDOM[7'h56][13:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
  ...
  assign io_requestor_0_resp_bits_pbmt_0 =
    privNeedTranslate_0 ? _GEN_17[req_out_s2xlate_0] : 2'h0;
  ...
  assign io_requestor_1_resp_bits_pbmt_0 =
    privNeedTranslate_1 ? _GEN_18[req_out_s2xlate_1] : 2'h0;
