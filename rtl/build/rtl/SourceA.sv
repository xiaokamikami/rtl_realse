...
module SourceA(
  ...
  reg          s1_full;
  reg  [28:0]  s0_task_tag;
  reg  [12:0]  s0_task_set;
  reg  [5:0]   s0_task_off;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s0_task_tag = _RANDOM[4'h0][30:2];
        s0_task_set = {_RANDOM[4'h0][31], _RANDOM[4'h1][11:0]};
        ...
        s0_count = _RANDOM[4'h3][10];
        s1_task_tag = {_RANDOM[4'h3][31:12], _RANDOM[4'h4][8:0]};
        s1_task_set = _RANDOM[4'h4][21:9];
        s1_task_off = _RANDOM[4'h4][27:22];
        s1_task_opcode = _RANDOM[4'h5][30:28];
        s1_task_param = {_RANDOM[4'h5][31], _RANDOM[4'h6][1:0]};
        s1_task_source = _RANDOM[4'h6][5:2];
        s1_task_size = _RANDOM[4'h6][12:10];
        s1_pb_latch_REG = _RANDOM[4'h6][20];
        s1_pb_latch_r_data =
          {_RANDOM[4'h6][31:21],
           _RANDOM[4'h7],
           _RANDOM[4'h8],
           ...
           _RANDOM[4'hD],
           _RANDOM[4'hE][20:0]};
        s1_pb_latch_r_mask = {_RANDOM[4'hE][31:21], _RANDOM[4'hF][20:0]};
        beatsLeft = _RANDOM[4'hF][22];
        state_0 = _RANDOM[4'hF][23];
        state_1 = _RANDOM[4'hF][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_full = 1'h0;
