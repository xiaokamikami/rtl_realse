  ...
  assign out_data =
    in_0_valid
      ? {in_0_bits_coreid,
         ...
         7'h0,
         in_0_bits_fromAIASeip,
         7'h0,
         in_0_bits_fromAIAMeip,
         7'h0,
         in_0_bits_platformIRPVstip,
         7'h0,
         in_0_bits_platformIRPVseip,
         7'h0,
         in_0_bits_platformIRPStip,
         7'h0,
         in_0_bits_platformIRPSeip,
         7'h0,
         in_0_bits_platformIRPMsip,
         7'h0,
         in_0_bits_platformIRPMtip,
         7'h0,
         in_0_bits_platformIRPMeip,
         7'h0,
         in_0_bits_valid}
      : 96'h0;
  assign out_info = in_0_valid ? {15'h200, in_0_valid} : 16'h0;
  assign status_sum_data_bytes =
    11'(status_base_data_bytes + {7'h0, in_0_valid ? 4'hC : 4'h0});
