...
module VfofBuffer(
  ...
  input  [7:0]   io_mergeUopWriteback_0_bits_robidx_value,
  ...
  input  [7:0]   io_mergeUopWriteback_1_bits_robidx_value,
  ...
  wire       _GEN_0 =
    wbIsfof_0 & wbIsfof_1
      ? (io_mergeUopWriteback_1_bits_vl > io_mergeUopWriteback_0_bits_vl
        ...
        & {io_mergeUopWriteback_1_bits_exceptionVec_21,
           ...
           io_mergeUopWriteback_1_bits_exceptionVec_3} == 6'h0
      : wbIsfof_0 & ~wbIsfof_1;
  wire [7:0] wbBits_oldest_bits_vpu_vl =
    _GEN_0 ? io_mergeUopWriteback_0_bits_vl : io_mergeUopWriteback_1_bits_vl;
  wire [5:0] _GEN_1 =
    {_GEN_0
       ? io_mergeUopWriteback_0_bits_exceptionVec_21
       : io_mergeUopWriteback_1_bits_exceptionVec_21,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entries_vl = _RANDOM[6'h28][20:13];
        entries_hasException = _RANDOM[6'h28][21];
        valid = _RANDOM[6'h28][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_uop_fuOpType = 9'h0;
        entries_uop_vecWen = 1'h0;
