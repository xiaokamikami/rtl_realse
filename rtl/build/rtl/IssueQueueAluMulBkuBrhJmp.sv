  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h2A][30];
        deqDelay_0_bits_rf_1_0_addr = {_RANDOM[7'h2A][31], _RANDOM[7'h2B][6:0]};
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h2B][17:10];
        deqDelay_0_bits_rcIdx_0 = {_RANDOM[7'h2B][31:29], _RANDOM[7'h2C][1:0]};
        deqDelay_0_bits_rcIdx_1 = _RANDOM[7'h2C][6:2];
        deqDelay_0_bits_immType = _RANDOM[7'h2C][10:7];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h2C][31:11], _RANDOM[7'h2D][13:0]};
        deqDelay_0_bits_common_fuOpType = _RANDOM[7'h2D][22:14];
        deqDelay_0_bits_common_imm =
          {_RANDOM[7'h31][31:23], _RANDOM[7'h32], _RANDOM[7'h33][22:0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h33][23];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h33][31:24];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h34][12:5];
        deqDelay_0_bits_common_rfWen = _RANDOM[7'h34][13];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h34][17:14];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h34][21:18];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[7'h34][24:22];
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[7'h34][27:25];
        deqDelay_0_bits_common_loadDependency_0 = _RANDOM[7'h35][3:2];
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[7'h35][5:4];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[7'h35][7:6];
        io_validCntDeqVec_0_REG = _RANDOM[7'h4A][6:1];
        io_validCntDeqVec_1_REG = _RANDOM[7'h4A][12:7];
      `endif // RANDOMIZE_REG_INIT
    end // initial
