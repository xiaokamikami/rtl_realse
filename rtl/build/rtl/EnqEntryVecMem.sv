  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2D][12];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2D][19:13];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2D][20];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2D][26:21];
        enqDelayValidReg_last_REG = _RANDOM[6'h2E][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
