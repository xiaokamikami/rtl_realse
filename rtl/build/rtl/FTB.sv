...
module FTB(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        modified_reset = _RANDOM[7'h0][0];
        s1_pc_dup_0 = {_RANDOM[7'h0][31:1], _RANDOM[7'h1][18:0]};
        s1_pc_dup_1 = {_RANDOM[7'h1][31:19], _RANDOM[7'h2], _RANDOM[7'h3][4:0]};
        s1_pc_dup_2 = {_RANDOM[7'h3][31:5], _RANDOM[7'h4][22:0]};
        s1_pc_dup_3 = {_RANDOM[7'h4][31:23], _RANDOM[7'h5], _RANDOM[7'h6][8:0]};
        s2_pc_dup_s2_pc_seg_0_value = {_RANDOM[7'h6][31:9], _RANDOM[7'h7][2:0]};
        s2_pc_dup_s2_pc_seg_1_value = _RANDOM[7'h7][14:3];
        s2_pc_dup_s2_pc_seg_2_value = _RANDOM[7'h7][26:15];
        s2_pc_dup_s2_pc_seg_0_value_1 = {_RANDOM[7'h7][31:27], _RANDOM[7'h8][20:0]};
        s2_pc_dup_s2_pc_seg_1_value_1 = {_RANDOM[7'h8][31:21], _RANDOM[7'h9][0]};
        s2_pc_dup_s2_pc_seg_2_value_1 = _RANDOM[7'h9][12:1];
        s2_pc_dup_s2_pc_seg_0_value_2 = {_RANDOM[7'h9][31:13], _RANDOM[7'hA][6:0]};
        s2_pc_dup_s2_pc_seg_1_value_2 = _RANDOM[7'hA][18:7];
        s2_pc_dup_s2_pc_seg_2_value_2 = _RANDOM[7'hA][30:19];
        s2_pc_dup_s2_pc_seg_0_value_3 = {_RANDOM[7'hA][31], _RANDOM[7'hB][24:0]};
        s2_pc_dup_s2_pc_seg_1_value_3 = {_RANDOM[7'hB][31:25], _RANDOM[7'hC][4:0]};
        s2_pc_dup_s2_pc_seg_2_value_3 = _RANDOM[7'hC][16:5];
        s3_pc_dup_s3_pc_seg_0_value = {_RANDOM[7'hC][31:17], _RANDOM[7'hD][10:0]};
        s3_pc_dup_s3_pc_seg_1_value = _RANDOM[7'hD][22:11];
        s3_pc_dup_s3_pc_seg_2_value = {_RANDOM[7'hD][31:23], _RANDOM[7'hE][2:0]};
        s3_pc_dup_s3_pc_seg_0_value_1 = _RANDOM[7'hE][28:3];
        s3_pc_dup_s3_pc_seg_1_value_1 = {_RANDOM[7'hE][31:29], _RANDOM[7'hF][8:0]};
        s3_pc_dup_s3_pc_seg_2_value_1 = _RANDOM[7'hF][20:9];
        s3_pc_dup_s3_pc_seg_0_value_2 = {_RANDOM[7'hF][31:21], _RANDOM[7'h10][14:0]};
        s3_pc_dup_s3_pc_seg_1_value_2 = _RANDOM[7'h10][26:15];
        s3_pc_dup_s3_pc_seg_2_value_2 = {_RANDOM[7'h10][31:27], _RANDOM[7'h11][6:0]};
        s3_pc_dup_s3_pc_seg_0_value_3 = {_RANDOM[7'h11][31:7], _RANDOM[7'h12][0]};
        s3_pc_dup_s3_pc_seg_1_value_3 = _RANDOM[7'h12][12:1];
        s3_pc_dup_s3_pc_seg_2_value_3 = _RANDOM[7'h12][24:13];
        s0_close_ftb_req = _RANDOM[7'h12][25];
        s1_close_ftb_req = _RANDOM[7'h12][26];
        s2_close_ftb_req = _RANDOM[7'h12][27];
        s2_fauftb_ftb_entry_dup_0_isCall = _RANDOM[7'h12][28];
        s2_fauftb_ftb_entry_dup_0_isRet = _RANDOM[7'h12][29];
        s2_fauftb_ftb_entry_dup_0_isJalr = _RANDOM[7'h12][30];
        s2_fauftb_ftb_entry_dup_0_valid = _RANDOM[7'h12][31];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_offset = _RANDOM[7'h13][3:0];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_sharing = _RANDOM[7'h13][4];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_valid = _RANDOM[7'h13][5];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_lower = _RANDOM[7'h13][17:6];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_tarStat = _RANDOM[7'h13][19:18];
        s2_fauftb_ftb_entry_dup_0_tailSlot_offset = _RANDOM[7'h13][23:20];
        s2_fauftb_ftb_entry_dup_0_tailSlot_sharing = _RANDOM[7'h13][24];
        s2_fauftb_ftb_entry_dup_0_tailSlot_valid = _RANDOM[7'h13][25];
        s2_fauftb_ftb_entry_dup_0_tailSlot_lower =
          {_RANDOM[7'h13][31:26], _RANDOM[7'h14][13:0]};
        s2_fauftb_ftb_entry_dup_0_tailSlot_tarStat = _RANDOM[7'h14][15:14];
        s2_fauftb_ftb_entry_dup_0_pftAddr = _RANDOM[7'h14][19:16];
        s2_fauftb_ftb_entry_dup_0_carry = _RANDOM[7'h14][20];
        s2_fauftb_ftb_entry_dup_0_last_may_be_rvi_call = _RANDOM[7'h14][21];
        s2_fauftb_ftb_entry_dup_0_strong_bias_0 = _RANDOM[7'h14][22];
        s2_fauftb_ftb_entry_dup_0_strong_bias_1 = _RANDOM[7'h14][23];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_offset = _RANDOM[7'h14][31:28];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_valid = _RANDOM[7'h15][1];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_lower = _RANDOM[7'h15][13:2];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_tarStat = _RANDOM[7'h15][15:14];
        s2_fauftb_ftb_entry_dup_1_tailSlot_offset = _RANDOM[7'h15][19:16];
        s2_fauftb_ftb_entry_dup_1_tailSlot_sharing = _RANDOM[7'h15][20];
        s2_fauftb_ftb_entry_dup_1_tailSlot_valid = _RANDOM[7'h15][21];
        s2_fauftb_ftb_entry_dup_1_tailSlot_lower =
          {_RANDOM[7'h15][31:22], _RANDOM[7'h16][9:0]};
        s2_fauftb_ftb_entry_dup_1_tailSlot_tarStat = _RANDOM[7'h16][11:10];
        s2_fauftb_ftb_entry_dup_1_pftAddr = _RANDOM[7'h16][15:12];
        s2_fauftb_ftb_entry_dup_1_carry = _RANDOM[7'h16][16];
        s2_fauftb_ftb_entry_dup_1_strong_bias_0 = _RANDOM[7'h16][18];
        s2_fauftb_ftb_entry_dup_1_strong_bias_1 = _RANDOM[7'h16][19];
        s2_fauftb_ftb_entry_dup_2_isCall = _RANDOM[7'h16][20];
        s2_fauftb_ftb_entry_dup_2_isRet = _RANDOM[7'h16][21];
        s2_fauftb_ftb_entry_dup_2_isJalr = _RANDOM[7'h16][22];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_offset = _RANDOM[7'h16][27:24];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_valid = _RANDOM[7'h16][29];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_lower =
          {_RANDOM[7'h16][31:30], _RANDOM[7'h17][9:0]};
        s2_fauftb_ftb_entry_dup_2_brSlots_0_tarStat = _RANDOM[7'h17][11:10];
        s2_fauftb_ftb_entry_dup_2_tailSlot_offset = _RANDOM[7'h17][15:12];
        s2_fauftb_ftb_entry_dup_2_tailSlot_sharing = _RANDOM[7'h17][16];
        s2_fauftb_ftb_entry_dup_2_tailSlot_valid = _RANDOM[7'h17][17];
        s2_fauftb_ftb_entry_dup_2_tailSlot_lower =
          {_RANDOM[7'h17][31:18], _RANDOM[7'h18][5:0]};
        s2_fauftb_ftb_entry_dup_2_tailSlot_tarStat = _RANDOM[7'h18][7:6];
        s2_fauftb_ftb_entry_dup_2_pftAddr = _RANDOM[7'h18][11:8];
        s2_fauftb_ftb_entry_dup_2_carry = _RANDOM[7'h18][12];
        s2_fauftb_ftb_entry_dup_2_last_may_be_rvi_call = _RANDOM[7'h18][13];
        s2_fauftb_ftb_entry_dup_2_strong_bias_0 = _RANDOM[7'h18][14];
        s2_fauftb_ftb_entry_dup_2_strong_bias_1 = _RANDOM[7'h18][15];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_offset = _RANDOM[7'h18][23:20];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_valid = _RANDOM[7'h18][25];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_lower =
          {_RANDOM[7'h18][31:26], _RANDOM[7'h19][5:0]};
        s2_fauftb_ftb_entry_dup_3_brSlots_0_tarStat = _RANDOM[7'h19][7:6];
        s2_fauftb_ftb_entry_dup_3_tailSlot_offset = _RANDOM[7'h19][11:8];
        s2_fauftb_ftb_entry_dup_3_tailSlot_sharing = _RANDOM[7'h19][12];
        s2_fauftb_ftb_entry_dup_3_tailSlot_valid = _RANDOM[7'h19][13];
        s2_fauftb_ftb_entry_dup_3_tailSlot_lower =
          {_RANDOM[7'h19][31:14], _RANDOM[7'h1A][1:0]};
        s2_fauftb_ftb_entry_dup_3_tailSlot_tarStat = _RANDOM[7'h1A][3:2];
        s2_fauftb_ftb_entry_dup_3_pftAddr = _RANDOM[7'h1A][7:4];
        s2_fauftb_ftb_entry_dup_3_carry = _RANDOM[7'h1A][8];
        s2_fauftb_ftb_entry_dup_3_strong_bias_0 = _RANDOM[7'h1A][10];
        s2_fauftb_ftb_entry_dup_3_strong_bias_1 = _RANDOM[7'h1A][11];
        s2_fauftb_ftb_entry_hit_dup_0 = _RANDOM[7'h1A][12];
        s2_fauftb_ftb_entry_hit_dup_1 = _RANDOM[7'h1A][13];
        s2_fauftb_ftb_entry_hit_dup_2 = _RANDOM[7'h1A][14];
        s2_fauftb_ftb_entry_hit_dup_3 = _RANDOM[7'h1A][15];
        s2_ftbBank_dup_0_isCall = _RANDOM[7'h1A][17];
        s2_ftbBank_dup_0_isRet = _RANDOM[7'h1A][18];
        s2_ftbBank_dup_0_isJalr = _RANDOM[7'h1A][19];
        s2_ftbBank_dup_0_valid = _RANDOM[7'h1A][20];
        s2_ftbBank_dup_0_brSlots_0_offset = _RANDOM[7'h1A][24:21];
        s2_ftbBank_dup_0_brSlots_0_sharing = _RANDOM[7'h1A][25];
        s2_ftbBank_dup_0_brSlots_0_valid = _RANDOM[7'h1A][26];
        s2_ftbBank_dup_0_brSlots_0_lower = {_RANDOM[7'h1A][31:27], _RANDOM[7'h1B][6:0]};
        s2_ftbBank_dup_0_brSlots_0_tarStat = _RANDOM[7'h1B][8:7];
        s2_ftbBank_dup_0_tailSlot_offset = _RANDOM[7'h1B][12:9];
        s2_ftbBank_dup_0_tailSlot_sharing = _RANDOM[7'h1B][13];
        s2_ftbBank_dup_0_tailSlot_valid = _RANDOM[7'h1B][14];
        s2_ftbBank_dup_0_tailSlot_lower = {_RANDOM[7'h1B][31:15], _RANDOM[7'h1C][2:0]};
        s2_ftbBank_dup_0_tailSlot_tarStat = _RANDOM[7'h1C][4:3];
        s2_ftbBank_dup_0_pftAddr = _RANDOM[7'h1C][8:5];
        s2_ftbBank_dup_0_carry = _RANDOM[7'h1C][9];
        s2_ftbBank_dup_0_last_may_be_rvi_call = _RANDOM[7'h1C][10];
        s2_ftbBank_dup_0_strong_bias_0 = _RANDOM[7'h1C][11];
        s2_ftbBank_dup_0_strong_bias_1 = _RANDOM[7'h1C][12];
        s2_ftbBank_dup_1_brSlots_0_offset = _RANDOM[7'h1C][20:17];
        s2_ftbBank_dup_1_brSlots_0_valid = _RANDOM[7'h1C][22];
        s2_ftbBank_dup_1_brSlots_0_lower = {_RANDOM[7'h1C][31:23], _RANDOM[7'h1D][2:0]};
        s2_ftbBank_dup_1_brSlots_0_tarStat = _RANDOM[7'h1D][4:3];
        s2_ftbBank_dup_1_tailSlot_offset = _RANDOM[7'h1D][8:5];
        s2_ftbBank_dup_1_tailSlot_sharing = _RANDOM[7'h1D][9];
        s2_ftbBank_dup_1_tailSlot_valid = _RANDOM[7'h1D][10];
        s2_ftbBank_dup_1_tailSlot_lower = _RANDOM[7'h1D][30:11];
        s2_ftbBank_dup_1_tailSlot_tarStat = {_RANDOM[7'h1D][31], _RANDOM[7'h1E][0]};
        s2_ftbBank_dup_1_pftAddr = _RANDOM[7'h1E][4:1];
        s2_ftbBank_dup_1_carry = _RANDOM[7'h1E][5];
        s2_ftbBank_dup_1_strong_bias_0 = _RANDOM[7'h1E][7];
        s2_ftbBank_dup_1_strong_bias_1 = _RANDOM[7'h1E][8];
        s2_ftbBank_dup_2_isCall = _RANDOM[7'h1E][9];
        s2_ftbBank_dup_2_isRet = _RANDOM[7'h1E][10];
        s2_ftbBank_dup_2_isJalr = _RANDOM[7'h1E][11];
        s2_ftbBank_dup_2_brSlots_0_offset = _RANDOM[7'h1E][16:13];
        s2_ftbBank_dup_2_brSlots_0_valid = _RANDOM[7'h1E][18];
        s2_ftbBank_dup_2_brSlots_0_lower = _RANDOM[7'h1E][30:19];
        s2_ftbBank_dup_2_brSlots_0_tarStat = {_RANDOM[7'h1E][31], _RANDOM[7'h1F][0]};
        s2_ftbBank_dup_2_tailSlot_offset = _RANDOM[7'h1F][4:1];
        s2_ftbBank_dup_2_tailSlot_sharing = _RANDOM[7'h1F][5];
        s2_ftbBank_dup_2_tailSlot_valid = _RANDOM[7'h1F][6];
        s2_ftbBank_dup_2_tailSlot_lower = _RANDOM[7'h1F][26:7];
        s2_ftbBank_dup_2_tailSlot_tarStat = _RANDOM[7'h1F][28:27];
        s2_ftbBank_dup_2_pftAddr = {_RANDOM[7'h1F][31:29], _RANDOM[7'h20][0]};
        s2_ftbBank_dup_2_carry = _RANDOM[7'h20][1];
        s2_ftbBank_dup_2_last_may_be_rvi_call = _RANDOM[7'h20][2];
        s2_ftbBank_dup_2_strong_bias_0 = _RANDOM[7'h20][3];
        s2_ftbBank_dup_2_strong_bias_1 = _RANDOM[7'h20][4];
        s2_ftbBank_dup_3_brSlots_0_offset = _RANDOM[7'h20][12:9];
        s2_ftbBank_dup_3_brSlots_0_valid = _RANDOM[7'h20][14];
        s2_ftbBank_dup_3_brSlots_0_lower = _RANDOM[7'h20][26:15];
        s2_ftbBank_dup_3_brSlots_0_tarStat = _RANDOM[7'h20][28:27];
        s2_ftbBank_dup_3_tailSlot_offset = {_RANDOM[7'h20][31:29], _RANDOM[7'h21][0]};
        s2_ftbBank_dup_3_tailSlot_sharing = _RANDOM[7'h21][1];
        s2_ftbBank_dup_3_tailSlot_valid = _RANDOM[7'h21][2];
        s2_ftbBank_dup_3_tailSlot_lower = _RANDOM[7'h21][22:3];
        s2_ftbBank_dup_3_tailSlot_tarStat = _RANDOM[7'h21][24:23];
        s2_ftbBank_dup_3_pftAddr = _RANDOM[7'h21][28:25];
        s2_ftbBank_dup_3_carry = _RANDOM[7'h21][29];
        s2_ftbBank_dup_3_strong_bias_0 = _RANDOM[7'h21][31];
        s2_ftbBank_dup_3_strong_bias_1 = _RANDOM[7'h22][0];
        s3_ftb_entry_dup_0_isCall = _RANDOM[7'h22][1];
        s3_ftb_entry_dup_0_isRet = _RANDOM[7'h22][2];
        s3_ftb_entry_dup_0_isJalr = _RANDOM[7'h22][3];
        s3_ftb_entry_dup_0_valid = _RANDOM[7'h22][4];
        s3_ftb_entry_dup_0_brSlots_0_offset = _RANDOM[7'h22][8:5];
        s3_ftb_entry_dup_0_brSlots_0_sharing = _RANDOM[7'h22][9];
        s3_ftb_entry_dup_0_brSlots_0_valid = _RANDOM[7'h22][10];
        s3_ftb_entry_dup_0_brSlots_0_lower = _RANDOM[7'h22][22:11];
        s3_ftb_entry_dup_0_brSlots_0_tarStat = _RANDOM[7'h22][24:23];
        s3_ftb_entry_dup_0_tailSlot_offset = _RANDOM[7'h22][28:25];
        s3_ftb_entry_dup_0_tailSlot_sharing = _RANDOM[7'h22][29];
        s3_ftb_entry_dup_0_tailSlot_valid = _RANDOM[7'h22][30];
        s3_ftb_entry_dup_0_tailSlot_lower = {_RANDOM[7'h22][31], _RANDOM[7'h23][18:0]};
        s3_ftb_entry_dup_0_tailSlot_tarStat = _RANDOM[7'h23][20:19];
        s3_ftb_entry_dup_0_pftAddr = _RANDOM[7'h23][24:21];
        s3_ftb_entry_dup_0_carry = _RANDOM[7'h23][25];
        s3_ftb_entry_dup_0_last_may_be_rvi_call = _RANDOM[7'h23][26];
        s3_ftb_entry_dup_0_strong_bias_0 = _RANDOM[7'h23][27];
        s3_ftb_entry_dup_0_strong_bias_1 = _RANDOM[7'h23][28];
        s3_ftb_entry_dup_1_brSlots_0_valid = _RANDOM[7'h24][6];
        s3_ftb_entry_dup_1_brSlots_0_lower = _RANDOM[7'h24][18:7];
        s3_ftb_entry_dup_1_brSlots_0_tarStat = _RANDOM[7'h24][20:19];
        s3_ftb_entry_dup_1_tailSlot_sharing = _RANDOM[7'h24][25];
        s3_ftb_entry_dup_1_tailSlot_valid = _RANDOM[7'h24][26];
        s3_ftb_entry_dup_1_tailSlot_lower = {_RANDOM[7'h24][31:27], _RANDOM[7'h25][14:0]};
        s3_ftb_entry_dup_1_tailSlot_tarStat = _RANDOM[7'h25][16:15];
        s3_ftb_entry_dup_1_pftAddr = _RANDOM[7'h25][20:17];
        s3_ftb_entry_dup_1_carry = _RANDOM[7'h25][21];
        s3_ftb_entry_dup_1_strong_bias_0 = _RANDOM[7'h25][23];
        s3_ftb_entry_dup_1_strong_bias_1 = _RANDOM[7'h25][24];
        s3_ftb_entry_dup_2_isCall = _RANDOM[7'h25][25];
        s3_ftb_entry_dup_2_isRet = _RANDOM[7'h25][26];
        s3_ftb_entry_dup_2_isJalr = _RANDOM[7'h25][27];
        s3_ftb_entry_dup_2_brSlots_0_valid = _RANDOM[7'h26][2];
        s3_ftb_entry_dup_2_brSlots_0_lower = _RANDOM[7'h26][14:3];
        s3_ftb_entry_dup_2_brSlots_0_tarStat = _RANDOM[7'h26][16:15];
        s3_ftb_entry_dup_2_tailSlot_sharing = _RANDOM[7'h26][21];
        s3_ftb_entry_dup_2_tailSlot_valid = _RANDOM[7'h26][22];
        s3_ftb_entry_dup_2_tailSlot_lower = {_RANDOM[7'h26][31:23], _RANDOM[7'h27][10:0]};
        s3_ftb_entry_dup_2_tailSlot_tarStat = _RANDOM[7'h27][12:11];
        s3_ftb_entry_dup_2_pftAddr = _RANDOM[7'h27][16:13];
        s3_ftb_entry_dup_2_carry = _RANDOM[7'h27][17];
        s3_ftb_entry_dup_2_strong_bias_0 = _RANDOM[7'h27][19];
        s3_ftb_entry_dup_2_strong_bias_1 = _RANDOM[7'h27][20];
        s3_ftb_entry_dup_3_brSlots_0_offset = _RANDOM[7'h27][28:25];
        s3_ftb_entry_dup_3_brSlots_0_valid = _RANDOM[7'h27][30];
        s3_ftb_entry_dup_3_brSlots_0_lower = {_RANDOM[7'h27][31], _RANDOM[7'h28][10:0]};
        s3_ftb_entry_dup_3_brSlots_0_tarStat = _RANDOM[7'h28][12:11];
        s3_ftb_entry_dup_3_tailSlot_offset = _RANDOM[7'h28][16:13];
        s3_ftb_entry_dup_3_tailSlot_sharing = _RANDOM[7'h28][17];
        s3_ftb_entry_dup_3_tailSlot_valid = _RANDOM[7'h28][18];
        s3_ftb_entry_dup_3_tailSlot_lower = {_RANDOM[7'h28][31:19], _RANDOM[7'h29][6:0]};
        s3_ftb_entry_dup_3_tailSlot_tarStat = _RANDOM[7'h29][8:7];
        s3_ftb_entry_dup_3_pftAddr = _RANDOM[7'h29][12:9];
        s3_ftb_entry_dup_3_carry = _RANDOM[7'h29][13];
        s3_ftb_entry_dup_3_strong_bias_0 = _RANDOM[7'h29][15];
        s3_ftb_entry_dup_3_strong_bias_1 = _RANDOM[7'h29][16];
        real_s3_fallThroughErr_dup_0 = _RANDOM[7'h29][17];
        real_s3_fallThroughErr_dup_1 = _RANDOM[7'h29][18];
        real_s3_fallThroughErr_dup_2 = _RANDOM[7'h29][19];
        real_s3_fallThroughErr_dup_3 = _RANDOM[7'h29][20];
        s2_ftb_hit_dup_0 = _RANDOM[7'h29][21];
        s2_ftb_hit_dup_1 = _RANDOM[7'h29][22];
        s2_ftb_hit_dup_2 = _RANDOM[7'h29][23];
        s2_ftb_hit_dup_3 = _RANDOM[7'h29][24];
        s3_hit_dup_0 = _RANDOM[7'h29][25];
        s3_hit_dup_1 = _RANDOM[7'h29][26];
        s3_hit_dup_2 = _RANDOM[7'h29][27];
        s3_hit_dup_3 = _RANDOM[7'h29][28];
        s3_multi_hit_dup_0 = _RANDOM[7'h29][29];
        s3_multi_hit_dup_1 = _RANDOM[7'h29][30];
        s3_multi_hit_dup_2 = _RANDOM[7'h29][31];
        s3_multi_hit_dup_3 = _RANDOM[7'h2A][0];
        s2_ftb_meta = _RANDOM[7'h2C][3:1];
        fauftb_ftb_entry_consistent_counter = _RANDOM[7'h2E][12:4];
        update_valid = _RANDOM[7'h2E][13];
        update_r_ftb_entry_isCall = _RANDOM[7'h32][20];
        update_r_ftb_entry_isRet = _RANDOM[7'h32][21];
        update_r_ftb_entry_isJalr = _RANDOM[7'h32][22];
        update_r_ftb_entry_valid = _RANDOM[7'h32][23];
        update_r_ftb_entry_brSlots_0_offset = _RANDOM[7'h32][27:24];
        update_r_ftb_entry_brSlots_0_sharing = _RANDOM[7'h32][28];
        update_r_ftb_entry_brSlots_0_valid = _RANDOM[7'h32][29];
        update_r_ftb_entry_brSlots_0_lower = {_RANDOM[7'h32][31:30], _RANDOM[7'h33][9:0]};
        update_r_ftb_entry_brSlots_0_tarStat = _RANDOM[7'h33][11:10];
        update_r_ftb_entry_tailSlot_offset = _RANDOM[7'h33][15:12];
        update_r_ftb_entry_tailSlot_sharing = _RANDOM[7'h33][16];
        update_r_ftb_entry_tailSlot_valid = _RANDOM[7'h33][17];
        update_r_ftb_entry_tailSlot_lower = {_RANDOM[7'h33][31:18], _RANDOM[7'h34][5:0]};
        update_r_ftb_entry_tailSlot_tarStat = _RANDOM[7'h34][7:6];
        update_r_ftb_entry_pftAddr = _RANDOM[7'h34][11:8];
        update_r_ftb_entry_carry = _RANDOM[7'h34][12];
        update_r_ftb_entry_last_may_be_rvi_call = _RANDOM[7'h34][13];
        update_r_ftb_entry_strong_bias_0 = _RANDOM[7'h34][14];
        update_r_ftb_entry_strong_bias_1 = _RANDOM[7'h34][15];
        update_r_false_hit = _RANDOM[7'h34][30];
        update_r_old_entry = _RANDOM[7'h35][1];
        update_meta_r =
          {_RANDOM[7'h46][31:26],
           _RANDOM[7'h47],
           _RANDOM[7'h48],
           ...
           _RANDOM[7'h4D],
           _RANDOM[7'h4E][29:0]};
        last_stage_pc_higher = {_RANDOM[7'h4E][31:30], _RANDOM[7'h4F][26:0]};
        last_stage_pc_middle = {_RANDOM[7'h4F][31:27], _RANDOM[7'h50][2:0]};
        last_stage_pc_higher_plus_one = _RANDOM[7'h50][31:3];
        last_stage_pc_higher_minus_one = _RANDOM[7'h51][28:0];
        last_stage_pc_middle_plus_one = {_RANDOM[7'h51][31:29], _RANDOM[7'h52][5:0]};
        last_stage_pc_middle_minus_one = _RANDOM[7'h52][14:6];
        io_out_s2_full_pred_0_fallThroughAddr_stashed_carry = _RANDOM[7'h52][15];
        last_stage_pc_higher_1 = {_RANDOM[7'h52][31:16], _RANDOM[7'h53][12:0]};
        last_stage_pc_middle_1 = _RANDOM[7'h53][20:13];
        last_stage_pc_higher_plus_one_1 = {_RANDOM[7'h53][31:21], _RANDOM[7'h54][17:0]};
        last_stage_pc_higher_minus_one_1 = {_RANDOM[7'h54][31:18], _RANDOM[7'h55][14:0]};
        last_stage_pc_middle_plus_one_1 = _RANDOM[7'h55][23:15];
        last_stage_pc_middle_minus_one_1 = {_RANDOM[7'h55][31:24], _RANDOM[7'h56][0]};
        io_out_s2_full_pred_1_fallThroughAddr_stashed_carry = _RANDOM[7'h56][1];
        last_stage_pc_higher_2 = _RANDOM[7'h56][30:2];
        last_stage_pc_middle_2 = {_RANDOM[7'h56][31], _RANDOM[7'h57][6:0]};
        last_stage_pc_higher_plus_one_2 = {_RANDOM[7'h57][31:7], _RANDOM[7'h58][3:0]};
        last_stage_pc_higher_minus_one_2 = {_RANDOM[7'h58][31:4], _RANDOM[7'h59][0]};
        last_stage_pc_middle_plus_one_2 = _RANDOM[7'h59][9:1];
        last_stage_pc_middle_minus_one_2 = _RANDOM[7'h59][18:10];
        io_out_s2_full_pred_2_fallThroughAddr_stashed_carry = _RANDOM[7'h59][19];
        last_stage_pc_higher_3 = {_RANDOM[7'h59][31:20], _RANDOM[7'h5A][16:0]};
        last_stage_pc_middle_3 = _RANDOM[7'h5A][24:17];
        last_stage_pc_higher_plus_one_3 = {_RANDOM[7'h5A][31:25], _RANDOM[7'h5B][21:0]};
        last_stage_pc_higher_minus_one_3 = {_RANDOM[7'h5B][31:22], _RANDOM[7'h5C][18:0]};
        last_stage_pc_middle_plus_one_3 = _RANDOM[7'h5C][27:19];
        last_stage_pc_middle_minus_one_3 = {_RANDOM[7'h5C][31:28], _RANDOM[7'h5D][4:0]};
        io_out_s2_full_pred_3_fallThroughAddr_stashed_carry = _RANDOM[7'h5D][5];
        last_stage_pc_higher_4 = {_RANDOM[7'h5D][31:6], _RANDOM[7'h5E][2:0]};
        last_stage_pc_middle_4 = _RANDOM[7'h5E][10:3];
        last_stage_pc_higher_plus_one_4 = {_RANDOM[7'h5E][31:11], _RANDOM[7'h5F][7:0]};
        last_stage_pc_higher_minus_one_4 = {_RANDOM[7'h5F][31:8], _RANDOM[7'h60][4:0]};
        last_stage_pc_middle_plus_one_4 = _RANDOM[7'h60][13:5];
        last_stage_pc_middle_minus_one_4 = _RANDOM[7'h60][22:14];
        last_stage_pc_higher_5 = {_RANDOM[7'h60][31:23], _RANDOM[7'h61][19:0]};
        last_stage_pc_middle_5 = _RANDOM[7'h61][27:20];
        last_stage_pc_higher_plus_one_5 = {_RANDOM[7'h61][31:28], _RANDOM[7'h62][24:0]};
        last_stage_pc_higher_minus_one_5 = {_RANDOM[7'h62][31:25], _RANDOM[7'h63][21:0]};
        last_stage_pc_middle_plus_one_5 = _RANDOM[7'h63][30:22];
        last_stage_pc_middle_minus_one_5 = {_RANDOM[7'h63][31], _RANDOM[7'h64][7:0]};
        last_stage_pc_higher_6 = {_RANDOM[7'h64][31:8], _RANDOM[7'h65][4:0]};
        last_stage_pc_middle_6 = _RANDOM[7'h65][12:5];
        last_stage_pc_higher_plus_one_6 = {_RANDOM[7'h65][31:13], _RANDOM[7'h66][9:0]};
        last_stage_pc_higher_minus_one_6 = {_RANDOM[7'h66][31:10], _RANDOM[7'h67][6:0]};
        last_stage_pc_middle_plus_one_6 = _RANDOM[7'h67][15:7];
        last_stage_pc_middle_minus_one_6 = _RANDOM[7'h67][24:16];
        last_stage_pc_higher_7 = {_RANDOM[7'h67][31:25], _RANDOM[7'h68][21:0]};
        last_stage_pc_middle_7 = _RANDOM[7'h68][29:22];
        last_stage_pc_higher_plus_one_7 = {_RANDOM[7'h68][31:30], _RANDOM[7'h69][26:0]};
        last_stage_pc_higher_minus_one_7 = {_RANDOM[7'h69][31:27], _RANDOM[7'h6A][23:0]};
        last_stage_pc_middle_plus_one_7 = {_RANDOM[7'h6A][31:24], _RANDOM[7'h6B][0]};
        last_stage_pc_middle_minus_one_7 = _RANDOM[7'h6B][9:1];
        io_out_last_stage_meta_r = _RANDOM[7'h6B][12:10];
        io_s1_ready_REG = _RANDOM[7'h6B][13];
        ftbBank_io_update_write_way_REG = _RANDOM[7'h6B][15:14];
        ftbBank_io_update_write_alloc_REG = _RANDOM[7'h6B][16];
        io_perf_0_value_REG = _RANDOM[7'h6B][19];
        io_perf_0_value_REG_1 = _RANDOM[7'h6B][20];
        io_perf_1_value_REG = _RANDOM[7'h6B][21];
        io_perf_1_value_REG_1 = _RANDOM[7'h6B][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        modified_reset = 1'h1;
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
  ...
  FTBBank ftbBank (
    ...
    .io_update_write_data_valid
      ((update_now | _write_valid_delay_io_out) & ~update_need_read),
