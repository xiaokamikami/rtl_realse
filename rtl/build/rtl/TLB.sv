...
module TLB(
  ...
  wire             _hit_noS2_hit_asid_hit_T =
    io_ptw_resp_bits_s1_entry_asid == _csr_delay_io_out_satp_asid;
  wire             _GEN_0 = io_ptw_resp_bits_s1_entry_level != 2'h2;
  wire             _s1_gpaddr_T_22 = io_ptw_resp_bits_s1_entry_level == 2'h1;
  wire             _s1_gpaddr_T_24 = io_ptw_resp_bits_s1_entry_level == 2'h0;
  wire [7:0]       _GEN_1 =
  ...
  wire             _readResult_T_32 =
    ...
    & need_gpa_vpn == (onlyS2_3 ? _GEN_8[readResult_level] : _GEN_7[readResult_level]);
  wire             _GEN_9 = _readResult_T_8 | _readResult_T_18;
  ...
  wire             _readResult_T_44 = io_flushPipe_1 | need_clear_need_gpa;
  ...
  wire             _readResult_T_68 =
    io_ptw_resp_valid & need_gpa
    & need_gpa_vpn == (onlyS2_3
                         ? _GEN_13[readResult_level_2]
                         : _GEN_12[readResult_level_2]);
  wire             _GEN_14 = _readResult_T_44 | _readResult_T_54;
  ...
  wire             _readResult_T_80 = io_flushPipe_2 | need_clear_need_gpa;
  wire             _readResult_T_90 =
  ...
  assign maybe_need_gpa_not_allow_refill =
    ~_readResult_T_80 & _readResult_T_90 | ~_readResult_T_44 & _readResult_T_54
    | ~_readResult_T_8 & _readResult_T_18;
  ...
  wire             _GEN_19 = _readResult_T_80 | _readResult_T_90;
  wire             _GEN_20 = _GEN_19 | ~_readResult_T_104;
  wire             hit_read_2 =
    _entries_io_r_resp_2_bits_hit | readResult_p_hit_last_REG_2;
  wire             miss_read_2 =
    ~hit_read_2 & privNeedTranslate_2 | hasGpf_2 & ~readResult_p_hit_last_REG_2
  ...
  wire             s1_valid = privNeedTranslate_0 & ~onlyS2;
  ...
  wire             s1_valid_1 = privNeedTranslate_1 & ~onlyS2_1;
  ...
  wire             s1_valid_2 = privNeedTranslate_2 & ~onlyS2_2;
  wire             s2_valid_2 = privNeedTranslate_2 & _s2_valid_T_2;
                  ...
                  : (ptw_just_back_level == 2'h0
                       ...
                       : ptw_just_back_level == 2'h1
                           ...
                           : (ptw_just_back_level != 2'h2 | ptw_just_back_tag_match_2)
                             & ptw_just_back_tag_match_3) & hit_vmid_hit
                    & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
             : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
               & (_s1_gpaddr_T_24
                  ...
                  : (ptw_just_back_level_1 == 2'h0
                       ...
                       : ptw_just_back_level_1 == 2'h1
                           ...
                           : (ptw_just_back_level_1 != 2'h2 | ptw_just_back_tag_match_1_2)
                             & ptw_just_back_tag_match_1_3) & hit_vmid_hit
                    & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
             : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
               & (_s1_gpaddr_T_24
  ...
  wire             _GEN_27 =
    ...
    & ((|io_ptw_resp_bits_s2xlate)
         ? (onlyS2_3
              ? hit_onlyS2_hit_vmid_hit
                & (_s2_ppn_T_19
                     ? _hit_onlyS2_hit_level_match_T_3 & hit_onlyS2_hit_tag_match_1
                       & (io_ptw_resp_bits_s2_entry_n
                            ? io_ptw_resp_bits_s2_entry_tag[8:4] == req_out_2_vaddr[20:16]
                            : io_ptw_resp_bits_s2_entry_tag[8:0] == req_out_2_vaddr[20:12])
                     : _s2_ppn_T_17
                         ? _hit_onlyS2_hit_level_match_T_3 & hit_onlyS2_hit_tag_match_1
                         : (_GEN_2 | hit_onlyS2_hit_tag_match_2)
                           & hit_onlyS2_hit_tag_match_3)
              : (hit_level == 2'h0
                   ? _hit_level_match_T_3 & hit_tag_match_1
                     & ((onlyS1_7
                           ? io_ptw_resp_bits_s1_entry_n
                           : io_ptw_resp_bits_s1_entry_n
                             & (|io_ptw_resp_bits_s2_entry_level)
                   ...
                   : hit_level == 2'h1
                       ? _hit_level_match_T_3 & hit_tag_match_1
                       : (hit_level != 2'h2 | hit_tag_match_2) & hit_tag_match_3)
                & hit_vmid_hit & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
         : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
           & (_s1_gpaddr_T_24
                ? _hit_noS2_hit_level_match_T_3 & hit_noS2_hit_tag_match_1
                  & (io_ptw_resp_bits_s1_entry_n
                       ? io_ptw_resp_bits_s1_entry_tag[5:1] == req_out_2_vaddr[20:16]
                       : io_ptw_resp_bits_s1_entry_tag[5:0] == req_out_2_vaddr[20:15])
                : _s1_gpaddr_T_22
                    ? _hit_noS2_hit_level_match_T_3 & hit_noS2_hit_tag_match_1
                    : (_GEN_0 | hit_noS2_hit_tag_match_2) & hit_noS2_hit_tag_match_3)
           & ((|io_ptw_resp_bits_s1_entry_level) | io_ptw_resp_bits_s1_entry_n
              | _GEN_1[req_out_2_vaddr[14:12]]))
    & miss_req_s2xlate_reg == io_ptw_resp_bits_s2xlate & req_out_v_2
    & privNeedTranslate_2;
  wire [2:0]       _GEN_28 = _GEN_4[req_out_2_vaddr[14:12]];
  wire [3:0][43:0] _GEN_29 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], req_out_2_vaddr[38:12]}},
     ...
     {io_ptw_resp_bits_s1_entry_n
        ...
        : {io_ptw_resp_bits_s1_entry_ppn, _GEN_28}}};
  wire [26:0]      s2_gvpn =
    onlyS2_3 ? req_out_2_vaddr[38:12] : _GEN_29[io_ptw_resp_bits_s1_entry_level][26:0];
  ...
  wire [3:0][43:0] _GEN_32 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], req_out_2_vaddr[38:12]}},
     ...
     {io_ptw_resp_bits_s1_entry_n
        ? {io_ptw_resp_bits_s1_entry_ppn[40:1], req_out_2_vaddr[15:12]}
        : {io_ptw_resp_bits_s1_entry_ppn, _GEN_28}}};
  wire             _s2_valid_T_3 = onlyS2_3 | (&io_ptw_resp_bits_s2xlate);
  wire             af_6 =
    ~onlyS2_3 & io_ptw_resp_bits_s1_af | _s2_valid_T_3 & io_ptw_resp_bits_s2_gaf;
  wire             _instrPf_T_3 =
  ...
  wire             s1_valid_3 = privNeedTranslate_2 & ~onlyS2_3;
  wire             s2_valid_3 = privNeedTranslate_2 & _s2_valid_T_3;
    ...
    _GEN_27
      ...
      : (~(readResult_p_hit_last_REG_2
        ...
        & ~((_instrPf_T_2 | ~readResult_2_4_0_a) & s1_valid_2 & ~af_5 & ~isFakePte_2
            & ~isNonLeaf_2);
  wire             _GEN_33 = req_out_v_2 & io_flushPipe_2 & privNeedTranslate_2;
  assign io_requestor_2_resp_valid_0 =
    _GEN_33 | _GEN_27 | req_out_v_2 & ~(miss_v & privNeedTranslate_2);
  ...
  wire [2:0]       _GEN_34 = _GEN_4[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_36 = _GEN_4[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_38 = _GEN_4[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_40 = _GEN_4[io_requestor_0_req_bits_vaddr[14:12]];
  ...
  wire [2:0]       _GEN_42 = _GEN_4[io_requestor_1_req_bits_vaddr[14:12]];
  ...
  wire [2:0]       _GEN_44 = _GEN_4[io_requestor_2_req_bits_vaddr[14:12]];
  ...
  always @(posedge clock) begin
      ...
      if (_GEN_15) begin
        if (_GEN_10) begin
          ...
          resp_gpa_gvpn <=
            onlyS2_3
              ? _GEN_52
              : ~(_s1_gpaddr_isNonLeaf_T | io_ptw_resp_bits_s1_entry_perm_w)
    ...
    if (io_ptw_resp_valid) begin
      ...
      readResult_p_ppn_2 <=
        readResult_onlyS2_2 | (&req_in_s2xlate_2)
          ? _GEN_50[io_ptw_resp_bits_s2_entry_level][35:0]
    ...
    io_perf_0_value_REG <=
      2'({1'h0, privNeedTranslate_0 & result_ok_last_REG}
         + 2'({1'h0, privNeedTranslate_1 & result_ok_last_REG_1}
              + {1'h0, _perfEvents_T_2}));
    io_perf_0_value_REG_1 <= io_perf_0_value_REG;
    io_perf_1_value_REG <=
      2'({1'h0, io_ptw_req_0_ready & io_ptw_req_0_valid_0}
         + 2'({1'h0, io_ptw_req_1_ready & io_ptw_req_1_valid_0}
              + {1'h0, privNeedTranslate_2 & result_ok_last_REG_2 & miss_read_2}));
            ...
            : (readResult_resp_hit_level_2 == 2'h0
                 ...
                 : readResult_resp_hit_level_2 == 2'h1
                     ...
                     : (readResult_resp_hit_level_2 != 2'h2
                       ...
                       & readResult_resp_hit_tag_match_2_3) & hit_vmid_hit
              & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
       : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
         & (_s1_gpaddr_T_24
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      need_clear_need_gpa <=
        ~_readResult_T_80 & _readResult_T_90 & readResult_p_hit_fast_2;
      resp_gpa_refill <=
        ~_GEN_19
      ...
      if (_GEN_20) begin
        ...
        else if (_readResult_T_68 | ~_GEN_10)
          resp_s1_level <= io_ptw_resp_bits_s1_entry_level;
        if (_GEN_15) begin
          if (_GEN_10) begin
          end
                ...
                : (readResult_resp_hit_level == 2'h0
                     ...
                     : readResult_resp_hit_level == 2'h1
                         ...
                         : (readResult_resp_hit_level != 2'h2
                           ...
                           & readResult_resp_hit_tag_match_3) & hit_vmid_hit
                  & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
           : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
             & (_s1_gpaddr_T_24
                ...
                : (readResult_resp_hit_level_1 == 2'h0
                     ...
                     : readResult_resp_hit_level_1 == 2'h1
                         ...
                         : (readResult_resp_hit_level_1 != 2'h2
                           ...
                           & readResult_resp_hit_tag_match_1_3) & hit_vmid_hit
                  & (_hit_vasid_hit_T | io_ptw_resp_bits_s1_entry_perm_g))
           : (_hit_noS2_hit_asid_hit_T | io_ptw_resp_bits_s1_entry_perm_g)
             & (_s1_gpaddr_T_24
      ...
      result_ok_last_REG_2 <= _perfEvents_T_2;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        need_clear_need_gpa = _RANDOM[7'h18][10];
        need_gpa_vpn = {_RANDOM[7'h18][31:20], _RANDOM[7'h19][25:0]};
        resp_gpa_gvpn = {_RANDOM[7'h19][31:26], _RANDOM[7'h1A], _RANDOM[7'h1B][5:0]};
        resp_gpa_refill = _RANDOM[7'h1B][6];
        resp_s1_level = _RANDOM[7'h1B][8:7];
        resp_s1_isLeaf = _RANDOM[7'h1B][9];
        resp_s1_isFakePte = _RANDOM[7'h1B][10];
        readResult_p_hit_last_REG = _RANDOM[7'h22][12];
        readResult_p_ppn = {_RANDOM[7'h22][31:13], _RANDOM[7'h23][16:0]};
        readResult_p_pbmt = _RANDOM[7'h23][18:17];
        readResult_p_perm_pf = _RANDOM[7'h23][19];
        readResult_p_perm_af = _RANDOM[7'h23][20];
        readResult_p_perm_v = _RANDOM[7'h23][21];
        readResult_p_perm_a = _RANDOM[7'h23][23];
        readResult_p_perm_u = _RANDOM[7'h23][25];
        readResult_p_perm_x = _RANDOM[7'h23][26];
        readResult_p_perm_w = _RANDOM[7'h23][27];
        readResult_p_perm_r = _RANDOM[7'h23][28];
        readResult_p_gvpn = {_RANDOM[7'h23][31:29], _RANDOM[7'h24], _RANDOM[7'h25][8:0]};
        readResult_p_g_pbmt = _RANDOM[7'h25][10:9];
        readResult_p_g_perm_pf = _RANDOM[7'h25][11];
        readResult_p_g_perm_af = _RANDOM[7'h25][12];
        readResult_p_g_perm_a = _RANDOM[7'h25][15];
        readResult_p_g_perm_x = _RANDOM[7'h25][18];
        readResult_p_s2xlate = _RANDOM[7'h25][22:21];
        readResult_p_s1_level = _RANDOM[7'h25][24:23];
        readResult_p_s1_isLeaf = _RANDOM[7'h25][25];
        readResult_p_s1_isFakePte = _RANDOM[7'h25][26];
        readResult_p_hit_last_REG_1 = _RANDOM[7'h37][26];
        readResult_p_ppn_1 = {_RANDOM[7'h37][31:27], _RANDOM[7'h38][30:0]};
        readResult_p_pbmt_1 = {_RANDOM[7'h38][31], _RANDOM[7'h39][0]};
        readResult_p_perm_1_pf = _RANDOM[7'h39][1];
        readResult_p_perm_1_af = _RANDOM[7'h39][2];
        readResult_p_perm_1_v = _RANDOM[7'h39][3];
        readResult_p_perm_1_a = _RANDOM[7'h39][5];
        readResult_p_perm_1_u = _RANDOM[7'h39][7];
        readResult_p_perm_1_x = _RANDOM[7'h39][8];
        readResult_p_perm_1_w = _RANDOM[7'h39][9];
        readResult_p_perm_1_r = _RANDOM[7'h39][10];
        readResult_p_gvpn_1 = {_RANDOM[7'h39][31:11], _RANDOM[7'h3A][22:0]};
        readResult_p_g_pbmt_1 = _RANDOM[7'h3A][24:23];
        readResult_p_g_perm_1_pf = _RANDOM[7'h3A][25];
        readResult_p_g_perm_1_af = _RANDOM[7'h3A][26];
        readResult_p_g_perm_1_a = _RANDOM[7'h3A][29];
        readResult_p_g_perm_1_x = _RANDOM[7'h3B][0];
        readResult_p_s2xlate_1 = _RANDOM[7'h3B][4:3];
        readResult_p_s1_level_1 = _RANDOM[7'h3B][6:5];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h3B][7];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h3B][8];
        readResult_p_hit_last_REG_2 = _RANDOM[7'h4D][8];
        readResult_p_ppn_2 = {_RANDOM[7'h4D][31:9], _RANDOM[7'h4E][12:0]};
        readResult_p_pbmt_2 = _RANDOM[7'h4E][14:13];
        readResult_p_perm_2_pf = _RANDOM[7'h4E][15];
        readResult_p_perm_2_af = _RANDOM[7'h4E][16];
        readResult_p_perm_2_v = _RANDOM[7'h4E][17];
        readResult_p_perm_2_a = _RANDOM[7'h4E][19];
        readResult_p_perm_2_u = _RANDOM[7'h4E][21];
        readResult_p_perm_2_x = _RANDOM[7'h4E][22];
        readResult_p_perm_2_w = _RANDOM[7'h4E][23];
        readResult_p_perm_2_r = _RANDOM[7'h4E][24];
        readResult_p_gvpn_2 =
          {_RANDOM[7'h4E][31:25], _RANDOM[7'h4F], _RANDOM[7'h50][4:0]};
        readResult_p_g_pbmt_2 = _RANDOM[7'h50][6:5];
        readResult_p_g_perm_2_pf = _RANDOM[7'h50][7];
        readResult_p_g_perm_2_af = _RANDOM[7'h50][8];
        readResult_p_g_perm_2_a = _RANDOM[7'h50][11];
        readResult_p_g_perm_2_x = _RANDOM[7'h50][14];
        readResult_p_s2xlate_2 = _RANDOM[7'h50][18:17];
        readResult_p_s1_level_2 = _RANDOM[7'h50][20:19];
        readResult_p_s1_isLeaf_2 = _RANDOM[7'h50][21];
        readResult_p_s1_isFakePte_2 = _RANDOM[7'h50][22];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h63][15:14];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h63][31:16], _RANDOM[7'h64][18:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[7'h64][31:19], _RANDOM[7'h65][2:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[7'h65][16:3];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h65][17];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h65][22];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h65][28:27];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h67][10:8];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h68][3];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h68][4];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h68][5];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h68][6];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h68][7];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h68][8];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h68][9];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h68][10];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h68][31:21], _RANDOM[7'h69][26:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h6A][24:11];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h6A][25];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h6C][10:9];
        ptw_already_back_last_REG = _RANDOM[7'h6C][25];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h6C][28:27];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h6C][31:29], _RANDOM[7'h6D]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[7'h6E][15:0];
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h6E][29:16];
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h6E][30];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h6F][3];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h6F][9:8];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h70][23:21];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h71][16];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h71][17];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h71][18];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h71][19];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h71][20];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h71][21];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h71][22];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h71][23];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h72][31:2], _RANDOM[7'h73][7:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h73][31:24], _RANDOM[7'h74][5:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h74][6];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h75][23:22];
        ptw_already_back_last_REG_1 = _RANDOM[7'h76][6];
        miss_req_s2xlate_reg = _RANDOM[7'h76][9:8];
        new_coming_last_REG = _RANDOM[7'h76][10];
        miss_v_valid = _RANDOM[7'h76][11];
        miss_req_v_valid = _RANDOM[7'h76][12];
        result_ok_last_REG = _RANDOM[7'h76][22];
        result_ok_last_REG_1 = _RANDOM[7'h76][23];
        result_ok_last_REG_2 = _RANDOM[7'h76][24];
        io_perf_0_value_REG = _RANDOM[7'h76][26:25];
        io_perf_0_value_REG_1 = _RANDOM[7'h76][28:27];
        io_perf_1_value_REG = _RANDOM[7'h76][30:29];
        io_perf_1_value_REG_1 = {_RANDOM[7'h76][31], _RANDOM[7'h77][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
  ...
  TlbStorageWrapper entries (
    ...
    .io_w_valid
      (io_ptw_resp_valid & ~io_ptw_resp_bits_getGpa & ~need_gpa
       & ~maybe_need_gpa_not_allow_refill & ~flush_mmu),
  ...
  assign io_requestor_0_resp_bits_pbmt_0 =
    privNeedTranslate_0 ? _GEN_22[req_out_s2xlate_0] : 2'h0;
  ...
  assign io_requestor_1_resp_bits_pbmt_0 =
    privNeedTranslate_1 ? _GEN_23[req_out_s2xlate_1] : 2'h0;
  ...
  assign io_requestor_2_resp_bits_paddr_0 =
    _GEN_27
      ? {onlyS2_3 | (&io_ptw_resp_bits_s2xlate)
           ? _GEN_30[io_ptw_resp_bits_s2_entry_level][35:0]
           : _GEN_29[io_ptw_resp_bits_s1_entry_level][35:0],
      ...
      ? {8'h0,
         onlyS2_3
           ...
           : {~(_s1_gpaddr_isNonLeaf_T | io_ptw_resp_bits_s1_entry_perm_w)
              ...
              & io_ptw_resp_bits_s1_entry_v
                ? req_out_2_vaddr[11:0]
                : {_GEN_31[{~io_ptw_resp_bits_s1_pf & ~io_ptw_resp_bits_s1_entry_v
                              & ~io_ptw_resp_bits_s1_af & Sv39vsEnable,
                            1'h0}
                     | {2{~io_ptw_resp_bits_s1_pf & ~io_ptw_resp_bits_s1_entry_v
                            & ~io_ptw_resp_bits_s1_af & Sv48vsEnable}}
                     | (io_ptw_resp_bits_s1_pf | io_ptw_resp_bits_s1_entry_v
                        | io_ptw_resp_bits_s1_af
                          ? 2'(io_ptw_resp_bits_s1_entry_level - 2'h1)
                          : 2'h0)],
                   3'h0}}}
      : (readResult_p_hit_last_REG_2
