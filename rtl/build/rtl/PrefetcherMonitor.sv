  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enable = _RANDOM[3'h0][13];
        confidence = _RANDOM[3'h0][14];
        total_prefetch_cnt = _RANDOM[3'h0][25:15];
        late_hit_prefetch_cnt = {_RANDOM[3'h0][31:26], _RANDOM[3'h1][4:0]};
        late_miss_prefetch_cnt = _RANDOM[3'h1][15:5];
        good_prefetch_cnt = _RANDOM[3'h2][26:16];
        bad_prefetch_cnt = {_RANDOM[3'h2][31:27], _RANDOM[3'h3][5:0]};
        back_off_cnt = _RANDOM[3'h3][23:6];
        low_conf_cnt = {_RANDOM[3'h3][31:24], _RANDOM[3'h4][10:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        enable = 1'h1;
        confidence = 1'h1;
