  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_valid = _RANDOM[7'h3E][2];
        deqDelay_0_bits_rf_4_0_addr = _RANDOM[7'h3E][9:3];
        deqDelay_0_bits_rf_3_0_addr = _RANDOM[7'h3E][19:13];
        deqDelay_0_bits_rf_2_0_addr = _RANDOM[7'h3E][29:23];
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h3F][7:1];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h3F][17:11];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h40][31:13], _RANDOM[7'h41][15:0]};
        deqDelay_0_bits_common_fuOpType = _RANDOM[7'h41][24:16];
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h57][25];
        deqDelay_0_bits_common_robIdx_value =
          {_RANDOM[7'h57][31:26], _RANDOM[7'h58][1:0]};
        deqDelay_0_bits_common_pdest = _RANDOM[7'h58][13:7];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h58][14];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h58][15];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h58][18];
        deqDelay_0_bits_common_vpu_vma = _RANDOM[7'h58][27];
        deqDelay_0_bits_common_vpu_vta = _RANDOM[7'h58][28];
        deqDelay_0_bits_common_vpu_vsew = _RANDOM[7'h58][30:29];
        deqDelay_0_bits_common_vpu_vlmul = {_RANDOM[7'h58][31], _RANDOM[7'h59][1:0]};
        deqDelay_0_bits_common_vpu_vm = _RANDOM[7'h59][10];
        deqDelay_0_bits_common_vpu_vstart = _RANDOM[7'h59][18:11];
        deqDelay_0_bits_common_vpu_vuopIdx = {_RANDOM[7'h59][31], _RANDOM[7'h5A][5:0]};
        deqDelay_0_bits_common_vpu_isExt = _RANDOM[7'h5E][21];
        deqDelay_0_bits_common_vpu_isNarrow = _RANDOM[7'h5E][22];
        deqDelay_0_bits_common_vpu_isDstMask = _RANDOM[7'h5E][23];
        deqDelay_0_bits_common_vpu_isOpMask = _RANDOM[7'h5E][24];
        deqDelay_0_bits_common_dataSources_0_value =
          {_RANDOM[7'h5E][31:29], _RANDOM[7'h5F][0]};
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h5F][4:1];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h5F][8:5];
        deqDelay_0_bits_common_dataSources_3_value = _RANDOM[7'h5F][12:9];
        deqDelay_0_bits_common_dataSources_4_value = _RANDOM[7'h5F][16:13];
        io_validCntDeqVec_0_REG = _RANDOM[7'h74][6:2];
        io_validCntDeqVec_1_REG = _RANDOM[7'h74][11:7];
      `endif // RANDOMIZE_REG_INIT
    end // initial
